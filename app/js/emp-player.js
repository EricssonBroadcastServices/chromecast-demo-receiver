...
(function (global, factory) {
  ...
  */
  ...
  var EmpLiveDisplay = /*#__PURE__*/function (_Button) {
    ...
    _proto.updateShowing = function updateShowing() {
      ...
      if (!this.player().timeShiftEnabled()) {
        this.hide();
      } else if (extplayer.getIsProgramEvent(this.player()) && program && this.entitlement && this.entitlement.live && liveTime + marginToEnd >= program.end.getTime()) {
        this.hide();
    ...
    _proto.update = function update(seekBarRect, seekBarPoint) {
      ...
      this.rafId_ = this.requestAnimationFrame(function () {
        ...
        if (_this.player_.noEPG() && _this.player_.isLive()) {
          ...
          var streamStart = _this.player_.seekable().start();

          content = formatTime(streamStart + startTimeLive + seekBarPoint * duration, duration);
        }
  ...
  var EmpForwardButton = /*#__PURE__*/function (_Button) {
    ...
    _proto.updateEnabled = function updateEnabled() {
      if (!this.player().timeShiftEnabled()) {
        this.hide();
      } else if (this.entitlement && !this.entitlement.ffEnabled) {
        this.disable();
  ...
  var EmpRewindButton = /*#__PURE__*/function (_Button) {
    ...
    _proto.updateEnabled = function updateEnabled() {
      if (!this.player().timeShiftEnabled()) {
        this.hide();
      } else if (this.entitlement && !this.entitlement.rwEnabled) {
        this.disable();
        ...
        if (duration) {
          ...
          if (duration > 0xFFFFFFFF) {
            ...
            if (_formattedTime !== this.formattedTime_) {
              ...
              if (remainingTime === 0) {
                this.contentEl_.innerHTML = "<span class=\"vjs-control-text\">" + _localizedText + "</span>";
              } else {
                this.contentEl_.innerHTML = "<span class=\"vjs-control-text\">" + _localizedText + "</span>" + _formattedTime;
              }
            }
  ...
  var EmpStopButton = /*#__PURE__*/function (_Button) {
    ...
    _proto.onTimeshift = function onTimeshift() {
      ...
      if (this.player().timeShiftEnabled() && this.player().duration() !== Infinity) {
        this.hide();
      } else {
        this.show();
      }
    ...
    _proto.buildCSSClass = function buildCSSClass() {
      return 'emp-stop-control emp-icon-stop ' + _Button.prototype.buildCSSClass.call(this);
    };
  ...
  */
  ...
  vttThumbnailsPlugin.VERSION = '2.2.138-577';
  ...
  PlaylistPlugin.VERSION = '2.2.138-577';
  ...
  var Player = /*#__PURE__*/function (_VjsPlayer) {
    ...
    */
    ...
    _proto.src = function src(source) {
      ...
      this.cache_.seekable = null;
      this.cache_.buffered = null;
    ...
    _proto.disableTimeShift = function disableTimeShift(value) {
      ...
      if (value !== undefined) {
        ...
        if (this.options_.timeShiftDisabled && this.isLive() && this.noEPG()) {
    ...
    _proto.duration = function duration(seconds) {
      ...
      if (entitlement && (entitlement.isDynamicCachupAsLive || entitlement.isStaticCachupAsLive) && this.techName_ !== 'EmpCast') {
        ...
        if (duration !== this.cache_.duration) {
          ...
          if (duration === Infinity || !this.timeShiftEnabled() && this.isLive() && this.noEPG()) {
            this.addClass('vjs-live');
    ...
    */
    ...
    _proto.seekable = function seekable() {
      ...
      if (this.seeking() && this.cache_.seekable) {
        return this.cache_.seekable;
      }

      this.cache_.seekable = this.getRange_(range);
      return this.cache_.seekable;
    }
    /**
    ...
    _proto.buffered = function buffered() {
      ...
      if (this.seeking() && this.cache_.buffered) {
        return this.cache_.buffered;
      }

      this.cache_.buffered = this.getRange_(range);
      return this.cache_.buffered;
    }
    /**
     * getRange_
      ...
      if (!this.sessionCreated(currentSessionId)) {
        ...
        this.onGeneric('Created', this.analytics_.created, function () {
          ...
          var params = {
            ...
            player: IS_CHROMECAST ? 'chromecast-receiver-2' : 'html5-player-2'
          };
  ...
  */
  ...
  AnalyticsPlugin.VERSION = '2.2.138-577';
  ...
  var Entitlement = /*#__PURE__*/function () {
    ...
    _proto.initiateV2 = function initiateV2(options) {
      ...
      if (options.contractRestrictions) {
        ...
        this.timeshiftEnabled = contractRestrictions.timeshiftEnabled === undefined ? true : contractRestrictions.timeshiftEnabled;
      }
  ...
  */
  ...
  ProgramService.VERSION = '2.2.138-577';
  ...
  EntitlementExpirationService.VERSION = '2.2.138-577';
              ...
              if (error) {
                ...
                if (entitlement.streamInfo.lowLatency === true) {
                  if (Tech$1.getTech("EmpDashif")) {
                    ...
                    log("lowLatency detected but EmpDashif not available. Dash streams won't play in lowLatency mode");
                  }
  ...
  */
  ...
  EntitlementMiddleware.VERSION = '2.2.138-577';
