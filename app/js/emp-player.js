...
(function (global, factory) {
  ...
  */
  ...
  function (_Button) {
    ...
    _proto.updateShowing = function updateShowing() {
      if (this.player().isLive() && !extplayer.getIsProgramEvent(this.player()) || this.entitlement && this.entitlement.isStaticCachupAsLive && !extplayer.getIsProgramEvent(this.player()) || this.entitlement && this.entitlement.live) {
        this.show();
      } else {
        this.hide();
      }
  ...
  */
  ...
  vttThumbnailsPlugin.VERSION = '2.1.105-398';
  ...
  AnalyticsPlugin.VERSION = '2.1.105-398';
  ...
  */
  ...
  function (_Plugin) {
    ...
    */
    ...
    _proto.eventProgramHasEnded_ = function eventProgramHasEnded_(channelId, programId) {
      ...
      if (this.currentProgram_ && this.isProgramEvent) {
      ...
      this.exposure.verifyEntitlement(program.assetId, this.entitlement().playRequest, function (data, error) {
        ...
        if (!data || data.status !== 'SUCCESS') {
          ...
          _this13.player.trigger(empPlayerEvents.ENTITLEMENT_CHANGE, {
            entitlement: _this13.entitlement()
          });
        }
    ...
    */
    ...
    _createClass(ProgramService, [{
      ...
      key: "isProgramEvent",
      get: function get() {
        if (this.entitlement_ && this.entitlement_.streamInfo && this.entitlement_.streamInfo.event) {
          return true;
        }
  ...
  ProgramService.VERSION = '2.1.105-398';
  ...
  EntitlementExpirationService.VERSION = '2.1.105-398';
  ...
  */
  ...
  EntitlementMiddleware.VERSION = '2.1.105-398';
