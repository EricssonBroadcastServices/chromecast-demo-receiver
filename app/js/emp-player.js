...
var Entitlement = function () {
  function Entitlement(options) {
    ...
    if (options.fairplayConfig) {
      ...
      if (this.isDynamicCachupAsLive || this.isStaticCachupAsLive) {
        //TODO: fix this for new VOD streams
...
ProgramService.VERSION = '2.0.85-104';
...
EntitlementExpirationService.VERSION = '2.0.85-104';
...
EntitlementMiddleware.VERSION = '2.0.85-104';
...
AnalyticsPlugin.VERSION = '2.0.85-104';
