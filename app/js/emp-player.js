  ...
  Player.prototype.src = function src(source) {
    ...
    if (sources[0].type === 'video/emp') {
      ...
      this.loadingSrc_ = setTimeout(function () {
        _this3.loadingSrc_ = null;
        if (_this3.loadNextSrc_) {
          // Call this method
          _this3.src(_this3.loadNextSrc_);
        }
...
ProgramService.VERSION = '2.0.92-163';
...
EntitlementExpirationService.VERSION = '2.0.92-163';
...
EntitlementMiddleware.VERSION = '2.0.92-163';
...
AnalyticsPlugin.VERSION = '2.0.92-163';
