...
var Player = function (_VjsPlayer) {
    ...
    if (data.source && !data.source.licenseServer && (!data.source.licenseServers || isEmpty(data.source.licenseServers)) && !data.source.protection && !IS_CHROMECAST && techs.length > 0) {
      ...
      if (this.options_.techOrder.length > this.options_.excludeTechs.length) {
        ...
        if (data.source.assetId) {
          var asset = { 'assetId': data.source.assetId };
          _VjsPlayer.prototype.src.call(this, { 'type': 'video/emp', 'src': JSON.stringify(asset) });
          return;
        } else if (data.source.channelId) {
          var _asset = { 'channelId': data.source.channelId, 'programId': data.source.programId };
  ...
  */
  ...
  Player.prototype.startPlaybackV2 = function startPlaybackV2(assetId, playbackProperties) {
  ...
  Player.prototype.startPlayback = function startPlayback(assetId, channelId, programId, playbackProperties) {
    ...
    var options = { 'playFrom': playbackProperties.playFrom, 'autoplay': true };
...
AnalyticsPlugin.VERSION = '2.1.99-284';
...
var EntitlementEngine = function () {
  ...
  */
  ...
  EntitlementEngine.prototype.getV2Entitlement = function getV2Entitlement(entitlementRequest, playRequest, callback, preEntitlement) {
  ...
  */
  ...
  EntitlementEngine.prototype.getV2Asset_ = function getV2Asset_(entitlementRequest, playRequest, preEntitlement) {
...
var EricssonExposure = function (_EntitlementEngine) {
  ...
  EricssonExposure.prototype.getV2Entitlement = function getV2Entitlement(entitlementRequest, playRequest, callback, preEntitlement) {
...
ProgramService.VERSION = '2.1.99-284';
...
EntitlementExpirationService.VERSION = '2.1.99-284';
...
EntitlementMiddleware$1.VERSION = '2.1.99-284';
