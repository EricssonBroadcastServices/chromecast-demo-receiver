...
function vb(b,c,d,e,f,g){var h=new Ja(d.uris[f]),k=h.ea;k||(k=location.protocol,k=k.slice(0,-1),Ka(h,k),d.uris[f]=h.toString());var l=(k=rb[k])?k.je:null;if(!l)return ab(new v(2,1,1E3,h));var m;return db($a(e)).T(function(){if(b.c)return bb();m=Date.now();var e=l(d.uris[f],d,c);void 0==e.promise&&(Ga("The scheme plugin interface has changed!  Please update your scheme plugins to the new interface to add support for abort().  Support for the old plugin interface will be removed in v2.5."),e=db(e));
...
n.Fd=function(b){for(var c=new Uint8Array(b.initData),d=0;d<this.a.length;++d)if(Zb(c,this.a[d].initData))return;gc(this,b.initDataType,c);};
...
n.Ee=function(b,c){0>c&&(c+=.001);this.b[b].timestampOffset=c;this.Ma(b);};n.Be=function(b,c,d){this.b[b].appendWindowStart=0;this.b[b].appendWindowEnd=d;this.b[b].appendWindowStart=c;this.Ma(b);};n.Oe=function(b){this.c[b][0].p.reject(new v(2,3,3014,this.f.error?this.f.error.code:0));};n.Ma=function(b){var c=this.c[b][0];c&&(c.p.resolve(),cd(this,b));};
...
n.get=function(b,c){if("video"==b){if(0<=Jd.indexOf(c))return this.Jc.bind(this,b,c)}else if("player"==b){if(Md[c]&&!this.get("player","isLive")())return function(){};if(0<=Pd.indexOf(c))return this.Jc.bind(this,b,c);if(0<=Qd.indexOf(c))return this.pe.bind(this,b,c);if(Ld[c])return this.Gc.bind(this,b,c)}return this.Gc(b,c)};n.set=function(b,c,d){this.a[b][c]=d;Zd({type:"set",targetName:b,property:c,value:d});};
...
n.pe=function(b,c){var d=Array.prototype.slice.call(arguments,2),e=new y,f=this.o.toString();this.o++;this.c[f]=e;Zd({type:"asyncCall",targetName:b,methodName:c,args:d,id:f});return e};n.zc=function(b){var c=this.u();this.f=new y;this.j=!0;this.Tb(c,b);};n.Td=function(b){Vd="available"==b;this.g();};function Yd(b){var c=Wd;c.removeUpdateListener(b.l);c.removeMessageListener("urn:x-cast:com.google.shaka.v2",b.m);}
...
this.a.get("player",b[0])();this.b[c](b);}.bind(b)),b.c.autoplay=f,c&&b.c.play());},function(c){b.b.dispatchEvent(new E("error",{detail:c}));});};n.Xe=function(b){if("addEventListener"==b)return this.f.addEventListener.bind(this.f);if("removeEventListener"==b)return this.f.removeEventListener.bind(this.f);if(this.a.W()&&0==Object.keys(this.a.a.video).length){var c=this.c[b];if("function"!=typeof c)return c}return this.a.W()?this.a.get("video",b):(b=this.c[b],"function"==typeof b&&(b=b.bind(this.c)),b)};
n.Ze=function(b,c){this.a.W()?this.a.set("video",b,c):this.c[b]=c;};n.Ye=function(b){this.a.W()||this.f.dispatchEvent(new E(b.type,b));};
n.he=function(b){if("addEventListener"==b)return this.g.addEventListener.bind(this.g);if("removeEventListener"==b)return this.g.removeEventListener.bind(this.g);if("getMediaElement"==b)return function(){return this.h}.bind(this);if("getNetworkingEngine"==b)return this.b.qc.bind(this.b);if(this.a.W()){if("getManifest"==b)return function(){Ga("getManifest() does not work while casting!");return null};if("attach"==b)return function(){Ga("attach() does not work while casting!");return Promise.resolve()};
if("detach"==b)return function(){Ga("detach() does not work while casting!");return Promise.resolve()}}return this.a.W()&&0==Object.keys(this.a.a.video).length&&Ld[b]||!this.a.W()?this.b[b].bind(this.b):this.a.get("player",b)};n.ie=function(b){this.a.W()||this.g.dispatchEvent(b);};n.Le=function(b,c){this.a.W()&&("video"==b?this.f.dispatchEvent(c):"player"==b&&this.g.dispatchEvent(c));};function ae(b,c,d,e){K.call(this);this.a=b;this.b=c;this.c=new C;this.u={video:b,player:c};this.v=d||function(){};this.A=e||function(b){return b};this.o=!1;this.h=!0;this.g=0;this.m=!1;this.j=!0;this.l=this.i=this.f=null;be(this);}Aa(ae,K);q("shaka.cast.CastReceiver",ae);ae.prototype.isConnected=function(){return this.o};ae.prototype.isConnected=ae.prototype.isConnected;ae.prototype.Ad=function(){return this.h};ae.prototype.isIdle=ae.prototype.Ad;
...
else if(w>=u)break;u=Math.ceil((u-w)/x)-1;}else{if(Infinity==l)break;else if(w/f>=l)break;u=Math.ceil((l*f-w)/x)-1;}0<m.length&&w!=r&&(m[m.length-1].end=w/f);for(var Da=0;Da<=u;++Da)r=w+x,m.push({start:w/f,end:r/f,Ue:w}),w=r;}f=m;}return{timescale:e,O:d,Ba:h,aa:g/e||0,fc:g,I:f}}function ze(b,c,d){return[c(b.w),c(b.S),c(b.Z)].filter(Eb).map(function(b){return b.getAttribute(d)}).reduce(function(b,c){return b||c})}
...
U.prototype.getSeekRangeStart=U.prototype.Ia;U.prototype.ia=function(){var b=this.N()||this.xa()?this.l:0;return Math.max(0,this.wa()-b)};U.prototype.getSeekRangeEnd=U.prototype.ia;function nf(){this.a=this.b=null;this.h=[];this.c=null;this.j=[];this.i=1;this.l={};this.m=0;this.o=new Ba(5);this.f=null;this.g=new pb;}q("shaka.dash.DashParser",nf);n=nf.prototype;n.configure=function(b){this.b=b;};n.start=function(b,c){this.h=[b];this.a=c;return of(this).then(function(b){this.a&&pf(this,b);return this.c}.bind(this))};n.stop=function(){this.b=this.a=null;this.h=[];this.c=null;this.j=[];this.l={};null!=this.f&&(window.clearTimeout(this.f),this.f=null);return this.g.destroy()};
n.update=function(){of(this)["catch"](function(b){if(this.a)this.a.onError(b);}.bind(this));};n.onExpirationUpdated=function(){};function of(b){var c=Date.now(),d=b.a.networkingEngine.request(0,B(b.h,b.b.retryParameters));qb(b.g,d);return d.promise.then(function(c){if(b.a)return qf(b,c.data,c.uri)}).then(function(){var d=(Date.now()-c)/1E3;Ca(b.o,1,d);return d})}
function qf(b,c,d){c=Be(c,"MPD");if(!c)throw new v(2,4,4001,d);c=De(c,b.b.retryParameters,b.b.dash.xlinkFailGracefully,d,b.a.networkingEngine);qb(b.g,c);return c.promise.then(function(c){return rf(b,c,d)})}
...
function uf(b,c,d,e){c.Z=vf(e.node,null,d);c.M=e;c.Z.id||(c.Z.id="__shaka_period_"+e.start);M(e.node,"EventStream").forEach(b.fe.bind(b,e.start,e.duration));d=M(e.node,"AdaptationSet").map(b.de.bind(b,c)).filter(Eb);var f=d.map(function(b){return b.qe}).reduce(Cb,[]),g=f.filter(Fb);if(c.Ha&&f.length!=g.length)throw new v(2,4,4018);var h=d.filter(function(b){return!b.ec});d.filter(function(b){return b.ec}).forEach(function(b){var c=b.streams[0],d=b.ec;h.forEach(function(b){b.id==d&&b.streams.forEach(function(b){b.trickModeVideo=
...
containsEmsgBoxes:b.w.containsEmsgBoxes,roles:h,channelsCount:b.w.Qb}};n.Ne=function(){null!=this.f&&(window.clearTimeout(this.f),this.f=null);of(this).then(function(b){this.a&&pf(this,b);}.bind(this))["catch"](function(b){this.a&&(b.severity=1,this.a.onError(b),pf(this,0));}.bind(this));};function pf(b,c){0>b.m||(b.f=window.setTimeout(b.Ne.bind(b),1E3*Math.max(3,b.m-c,Ea(b.o))));}
...
function Bf(b,c,d,e){c=F(c,[d]);c=B(c,b.b.retryParameters);c.method=e;c=b.a.networkingEngine.request(0,c);qb(b.g,c);return c.promise.then(function(b){if("HEAD"==e){if(!b.headers||!b.headers.date)return 0;b=b.headers.date;}else b=G(b.data);b=Date.parse(b);return isNaN(b)?0:b-Date.now()})}
...
bb:b,drmInfos:kb,Yb:l,Pb:c,Bd:d,duration:u}}.bind(b))}function ug(b){var c=Hf(b.a,"EXT-X-MAP");if(!c.length)return null;if(1<c.length)throw new v(2,4,4020);c=c[0];var d=hg(c,"URI"),e=Kf(b.uri,d);b=0;d=null;if(c=Ff(c,"BYTERANGE"))b=c.split("@"),c=Number(b[0]),b=Number(b[1]),d=b+c-1;return new O(function(){return[e]},b,d)}
...
function th(b,c,d,e,f,g,h){f.containsEmsgBoxes&&(new R).V("emsg",b.ee.bind(b,e,g)).parse(h);return wh(b,c,d).then(function(){if(!this.f)return Yc(this.a.J,c.type,h,g.startTime,g.endTime)}.bind(b)).then(function(){if(!this.f)return c.Ka=f,c.ja=g,Promise.resolve()}.bind(b))}
n.ee=function(b,c,d){var e=d.s.Vb(),f=d.s.Vb(),g=d.s.B(),h=d.s.B(),k=d.s.B(),l=d.s.B();d=d.s.Aa(d.s.F.byteLength-d.s.U());b=b.startTime+c.startTime+h/g;if("urn:mpeg:dash:event:2012"==e)this.a.Kd();else this.a.onEvent(new E("emsg",{detail:{startTime:b,endTime:b+k/g,schemeIdUri:e,value:f,timescale:g,presentationTimeDelta:h,eventDuration:k,id:l,messageData:d}}));};
function wh(b,c,d){var e=Math.max(b.g.bufferBehind,b.b.presentationTimeline.a),f=Uc(b.a.J,c.type);if(null==f)return Promise.resolve();d=d-f-e;return 0>=d?Promise.resolve():b.a.J.remove(c.type,f,f+d).then(function(){}.bind(b))}function uh(b,c){if(!b.o&&(b.o=Jb(b.c).every(function(b){return"text"==b.type?!0:!b.ra&&!b.ua&&b.ja}),b.o)){var d=Dd(b.b,c);b.h[d]||jh(b,d).then(function(){this.f||this.a.vc();}.bind(b))["catch"](Db);for(d=0;d<b.b.periods.length;++d)jh(b,d)["catch"](Db);b.a.Xd&&b.a.Xd();}}
...
this.sa=this.c.preferredAudioChannelCount;c&&c(this);this.u=new A(this.He.bind(this));b&&this.qb(b,!0);}Aa(Y,K);q("shaka.Player",Y);function zi(b){if(!b.Ga)return Promise.resolve();var c=Promise.resolve();b.m&&(c=b.m.stop(),b.m=null);return Promise.all([c,b.Ga()])}
Y.prototype.destroy=function(){var b=this;return ka(function d(){var e;return ya(d,function(d){switch(d.H){case 1:return p(d,b.detach(),2);case 2:return b.ba=!0,e=Promise.all([b.o?b.o.destroy():null,b.u?b.u.destroy():null]),b.ob=!1,b.o=null,b.h=null,b.u=null,b.c=null,p(d,e,0)}})}())};Y.prototype.destroy=Y.prototype.destroy;Y.version="v2.3.6-3";var Ai={};Y.registerSupportPlugin=function(b,c){Ai[b]=c;};
...
if(h)throw h;u=e;return p(g,Bi(e,b,d),5);case 5:u.b=g.Da;e.Bb=b;if(h)throw h;Ci(e);e.l=new ac({Xa:e.u,onError:e.Ra.bind(e),Sb:e.Jd.bind(e),onExpirationUpdated:e.Gd.bind(e),onEvent:e.eb.bind(e)});e.l.configure(e.c.drm);return p(g,e.l.init(e.b,!1),6);case 6:if(h)throw h;e.bc(e.b.periods);e.jb=Date.now()/1E3;e.L=e.c.preferredAudioLanguage;e.Ea=e.c.preferredTextLanguage;e.sa=e.c.preferredAudioChannelCount;Di(e);return p(g,e.l.qb(e.f),7);case 7:if(h)throw h;e.h.init(e.Ie.bind(e));e.i||(e.i=new Rc(e.f));
e.i.o=e.v;e.g=new Jg(e.f,e.b,e.c.streaming,void 0==c?null:c,e.Ge.bind(e),e.eb.bind(e));e.A=new Og(e.f,e.i,e.b,e.c.streaming,e.Sc.bind(e),e.eb.bind(e),e.Fe.bind(e));e.a=new Sg(e.b,{Na:e.g,J:e.i,Xa:e.u,wc:e.Dd.bind(e),vc:e.cd.bind(e),onError:e.Ra.bind(e),onEvent:e.eb.bind(e),Kd:e.Ld.bind(e),Za:e.Vd.bind(e),filterNewPeriod:e.sb.bind(e),filterAllPeriods:e.bc.bind(e)});e.a.configure(e.c.streaming);Ei(e);e.dispatchEvent(new E("streaming"));return p(g,e.a.init(),8);case 8:if(h)throw h;e.c.streaming.startAtSegmentBoundary&&
...
Y.prototype.getConfiguration=function(){var b=xi(this);mb(b,this.c,xi(this),Ii(),"");return b};Y.prototype.getConfiguration=Y.prototype.getConfiguration;Y.prototype.se=function(){this.c=xi(this);Ji(this);};Y.prototype.resetConfiguration=Y.prototype.se;Y.prototype.od=function(){return this.f};Y.prototype.getMediaElement=Y.prototype.od;Y.prototype.qc=function(){return this.u};Y.prototype.getNetworkingEngine=Y.prototype.qc;Y.prototype.Hb=function(){return this.Bb};Y.prototype.getManifestUri=Y.prototype.Hb;
Y.prototype.N=function(){return this.b?this.b.presentationTimeline.N():!1};Y.prototype.isLive=Y.prototype.N;Y.prototype.xa=function(){return this.b?this.b.presentationTimeline.xa():!1};Y.prototype.isInProgress=Y.prototype.xa;Y.prototype.zd=function(){if(!this.b||!this.b.periods.length)return!1;var b=this.b.periods[0].variants;return b.length?!b[0].video:!1};Y.prototype.isAudioOnly=Y.prototype.zd;
Y.prototype.ue=function(){var b=0,c=0;this.b&&(c=this.b.presentationTimeline,b=c.Ia(),c=c.ia());return{start:b,end:c}};Y.prototype.seekRange=Y.prototype.ue;Y.prototype.keySystem=function(){return this.l?this.l.keySystem():""};Y.prototype.keySystem=Y.prototype.keySystem;Y.prototype.drmInfo=function(){return this.l?this.l.b:null};Y.prototype.drmInfo=Y.prototype.drmInfo;Y.prototype.ub=function(){return this.l?this.l.ub():Infinity};Y.prototype.getExpiration=Y.prototype.ub;Y.prototype.tc=function(){return this.nb};
...
Y.prototype.getPlaybackRate=Y.prototype.Ta;Y.prototype.Re=function(b){this.g&&Ig(this.g.a,b);this.a&&dh(this.a,1!=b);};Y.prototype.trickPlay=Y.prototype.Re;Y.prototype.dd=function(){this.g&&Ig(this.g.a,1);this.a&&dh(this.a,!1);};Y.prototype.cancelTrickPlay=Y.prototype.dd;Y.prototype.xd=function(){if(!this.b||!this.g)return[];var b=Cd(this.b,Mg(this.g)),c=this.K[b]||{};return qd(this.b.periods[b],c.audio,c.video)};Y.prototype.getVariantTracks=Y.prototype.xd;
Y.prototype.wd=function(){if(!this.b||!this.g)return[];var b=Cd(this.b,Mg(this.g));return rd(this.b.periods[b],(this.K[b]||{}).text).filter(function(b){return 0>this.kb.indexOf(b.id)}.bind(this))};Y.prototype.getTextTracks=Y.prototype.wd;Y.prototype.ze=function(b){if(this.a){var c=V(this.a);a:{for(var d=0;d<c.textStreams.length;d++)if(c.textStreams[d].id==b.id){b=c.textStreams[d];break a}b=null;}b&&(this.i.l=!1,Mi(this,b,!1),c=b,this.ta?this.G=c:eh(this.a,c,!0),this.Ea=b.language);}};
Y.prototype.selectTextTrack=Y.prototype.ze;Y.prototype.xe=function(){this.i.l=!0;ch(this.a);};Y.prototype.selectEmbeddedTextTrack=Y.prototype.xe;Y.prototype.We=function(){return this.i?this.i.l:!1};Y.prototype.usingEmbeddedTextTrack=Y.prototype.We;
Y.prototype.Ae=function(b,c){if(this.a){this.c.abr.enabled&&Ga("Changing tracks while abr manager is enabled will likely result in the selected track being overriden. Consider disabling abr before calling selectVariantTrack().");var d=V(this.a),e=sd(d,b);e&&td(e)&&(Ni(this,e,!1),Oi(this,e,c),this.L=e.language,e.audio&&e.audio.channelsCount&&(this.sa=e.audio.channelsCount),d=ud(d.variants,this.L,this.Fa,this.sa),this.h.setVariants(d));}};Y.prototype.selectVariantTrack=Y.prototype.Ae;
Y.prototype.ld=function(){if(!this.a)return[];var b=V(this.a);b=pd(b.variants).map(function(b){return b.audio}).filter(Fb);return Pi(b)};Y.prototype.getAudioLanguagesAndRoles=Y.prototype.ld;Y.prototype.vd=function(){if(!this.a)return[];var b=V(this.a);return Pi(b.textStreams)};Y.prototype.getTextLanguagesAndRoles=Y.prototype.vd;Y.prototype.kd=function(){if(!this.a)return[];var b=V(this.a);return pd(b.variants).map(function(b){return b.language}).filter(Fb)};Y.prototype.getAudioLanguages=Y.prototype.kd;
Y.prototype.ud=function(){return this.a?V(this.a).textStreams.map(function(b){return b.language}).filter(Fb):[]};Y.prototype.getTextLanguages=Y.prototype.ud;function Pi(b){var c=[];b.forEach(function(b){if(b){var d=b.language;b.roles.length?b.roles.forEach(function(b){c.push({language:d,role:b});}):c.push({language:d,role:""});}else c.push({language:"und",role:""});});return gb(c,function(b,c){return b.language==c.language&&b.role==c.role})}
Y.prototype.we=function(b,c){if(this.a){var d=V(this.a);this.L=b;this.Fa=c||"";Ki(this,d);}};Y.prototype.selectAudioLanguage=Y.prototype.we;Y.prototype.ye=function(b,c){if(this.a){var d=V(this.a);this.Ea=b;this.hb=c||"";Ki(this,d);}};Y.prototype.selectTextLanguage=Y.prototype.ye;Y.prototype.Lb=function(){return this.v?this.v.isTextVisible():this.ob};Y.prototype.isTextTrackVisible=Y.prototype.Lb;
Y.prototype.De=function(b){this.v&&this.v.setTextVisibility(b);this.ob=b;Qi(this);!this.c.streaming.alwaysStreamText&&this.a&&(b?(b=V(this.a),(b=yd(b.textStreams,this.Ea,this.hb)[0])&&Zg(this.a,b)):ch(this.a));};Y.prototype.setTextTrackVisibility=Y.prototype.De;Y.prototype.qd=function(){return this.b?new Date(1E3*this.b.presentationTimeline.f+1E3*this.f.currentTime):null};Y.prototype.getPlayheadTimeAsDate=Y.prototype.qd;
...
n.generateRequest=function(b,c){this.a=new y;try{this.c=this.g.createSession("video/mp4",new Uint8Array(c),null),D(this.f,this.c,"mskeymessage",this.Pd.bind(this)),D(this.f,this.c,"mskeyadded",this.Nd.bind(this)),D(this.f,this.c,"mskeyerror",this.Od.bind(this)),Nj(this,"status-pending");}catch(d){this.a.reject(d);}return this.a};n.load=function(){return Promise.reject(Error("MediaKeySession.load not yet supported"))};n.update=function(b){this.b=new y;try{this.c.update(new Uint8Array(b));}catch(c){this.b.reject(c);}return this.b};
...
n.Pd=function(b){this.a&&(this.a.resolve(),this.a=null);this.dispatchEvent(new E("message",{messageType:void 0==this.keyStatuses.a?"licenserequest":"licenserenewal",message:b.message.buffer}));};n.Nd=function(){this.a?(Nj(this,"usable"),this.a.resolve(),this.a=null):this.b&&(Nj(this,"usable"),this.b.resolve(),this.b=null);};
n.Od=function(){var b=Error("EME PatchedMediaKeysMs key error");b.errorCode=this.c.error;if(null!=this.a)this.a.reject(b),this.a=null;else if(null!=this.b)this.b.reject(b),this.b=null;else switch(this.c.error.code){case MSMediaKeyError.MS_MEDIA_KEYERR_OUTPUT:case MSMediaKeyError.MS_MEDIA_KEYERR_HARDWARECHANGE:Nj(this,"output-not-allowed");break;default:Nj(this,"internal-error");}};function Nj(b,c){var d=b.keyStatuses;d.size=void 0==c?0:1;d.a=c;b.dispatchEvent(new E("keystatuseschange"));}
...
function Zj(b,c){b.b=c;yb(b.a);var d=Uj;c&&(D(b.a,c,d+"needkey",b.ce.bind(b)),D(b.a,c,d+"keymessage",b.be.bind(b)),D(b.a,c,d+"keyadded",b.$d.bind(b)),D(b.a,c,d+"keyerror",b.ae.bind(b)));}n=ak.prototype;n.createSession=function(b){var c=b||"temporary";if("temporary"!=c&&"persistent-license"!=c)throw new TypeError("Session type "+b+" is unsupported on this platform.");b=this.b||document.createElement("video");b.src||(b.src="about:blank");c=new bk(b,this.g,c);this.c.push(c);return c};
n.setServerCertificate=function(){return Promise.resolve(!1)};n.ce=function(b){var c=document.createEvent("CustomEvent");c.initCustomEvent("encrypted",!1,!1,null);c.initDataType="webm";c.initData=b.initData;this.b.dispatchEvent(c);};n.be=function(b){var c=ck(this,b.sessionId);c&&(b=new E("message",{messageType:void 0==c.keyStatuses.a?"licenserequest":"licenserenewal",message:b.message}),c.b&&(c.b.resolve(),c.b=null),c.dispatchEvent(b));};
n.$d=function(b){if(b=ck(this,b.sessionId))dk(b,"usable"),b.a&&b.a.resolve(),b.a=null;};
