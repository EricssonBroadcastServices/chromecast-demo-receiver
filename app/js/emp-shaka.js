...
function la(){this.g=!1;this.b=null;this.Da=void 0;this.H=1;this.c=this.f=0;this.i=this.a=null;}function ma(b){if(b.g)throw new TypeError("Generator is already running");b.g=!0;}la.prototype.h=function(b){this.Da=b;};function na(b,c){b.a={nc:c,uc:!0};b.H=b.f||b.c;}la.prototype["return"]=function(b){this.a={"return":b};this.H=this.c;};function p(b,c,d){b.H=d;return{value:c}}la.prototype.X=function(b){this.H=b;};function oa(b,c){b.f=2;void 0!=c&&(b.c=c);}function pa(b){b.H=0;b.f=0;}
function qa(b){b.f=0;var c=b.a.nc;b.a=null;return c}function ra(b){b.i=[b.a];b.f=0;b.c=0;}function sa(b){var c=b.i.splice(0)[0];(c=b.a=b.a||c)?c.uc?b.H=b.f||b.c:void 0!=c.X&&b.c<c.X?(b.H=c.X,b.a=null):b.H=b.c:b.H=0;}function ta(b){this.a=new la;this.b=b;}function ua(b,c){ma(b.a);var d=b.a.b;if(d)return va(b,"return"in d?d["return"]:function(b){return{value:b,done:!0}},c,b.a["return"]);b.a["return"](c);return wa(b)}
...
function wa(b){for(;b.a.H;)try{var c=b.b(b.a);if(c)return b.a.g=!1,{value:c.value,done:!1}}catch(d){b.a.Da=void 0,na(b.a,d);}b.a.g=!1;if(b.a.a){c=b.a.a;b.a.a=null;if(c.uc)throw c.nc;return{value:c["return"],done:!0}}return{value:void 0,done:!0}}
...
function Aa(b,c){function d(){}d.prototype=c.prototype;b.cf=c.prototype;b.prototype=new d;b.prototype.constructor=b;b.af=function(b,d,g){return c.prototype[d].apply(b,Array.prototype.slice.call(arguments,2))};}/*
...
STORAGE_NOT_SUPPORTED:9E3,INDEXED_DB_ERROR:9001,DEPRECATED_OPERATION_ABORTED:9002,REQUESTED_ITEM_NOT_FOUND:9003,MALFORMED_OFFLINE_URI:9004,CANNOT_STORE_LIVE_OFFLINE:9005,STORE_ALREADY_IN_PROGRESS:9006,NO_INIT_DATA_FOR_OFFLINE:9007,LOCAL_PLAYER_INSTANCE_REQUIRED:9008,UNSUPPORTED_UPGRADE_REQUEST:9010,NEW_KEY_OPERATION_NOT_SUPPORTED:9011,KEY_NOT_FOUND:9012,MISSING_STORAGE_CELL:9013};var Ia=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#(.*))?$/;function Ja(b){var c;b instanceof Ja?(Ka(this,b.ea),this.Ca=b.Ca,this.ha=b.ha,La(this,b.Oa),this.Y=b.Y,Ma(this,Na(b.a)),this.va=b.va):b&&(c=String(b).match(Ia))?(Ka(this,c[1]||"",!0),this.Ca=Oa(c[2]||""),this.ha=Oa(c[3]||"",!0),La(this,c[4]),this.Y=Oa(c[5]||"",!0),Ma(this,c[6]||"",!0),this.va=Oa(c[7]||"")):this.a=new Pa(null);}n=Ja.prototype;n.ea="";n.Ca="";n.ha="";n.Oa=null;n.Y="";n.va="";
n.toString=function(){var b=[],c=this.ea;c&&b.push(Qa(c,Sa,!0),":");if(c=this.ha){b.push("//");var d=this.Ca;d&&b.push(Qa(d,Sa,!0),"@");b.push(encodeURIComponent(c).replace(/%25([0-9a-fA-F]{2})/g,"%$1"));c=this.Oa;null!=c&&b.push(":",String(c));}if(c=this.Y)this.ha&&"/"!=c.charAt(0)&&b.push("/"),b.push(Qa(c,"/"==c.charAt(0)?Ta:Ua,!0));(c=this.a.toString())&&b.push("?",c);(c=this.va)&&b.push("#",Qa(c,Va));return b.join("")};
n.resolve=function(b){var c=new Ja(this);"data"===c.ea&&(c=new Ja);var d=!!b.ea;d?Ka(c,b.ea):d=!!b.Ca;d?c.Ca=b.Ca:d=!!b.ha;d?c.ha=b.ha:d=null!=b.Oa;var e=b.Y;if(d)La(c,b.Oa);else if(d=!!b.Y){if("/"!=e.charAt(0))if(this.ha&&!this.Y)e="/"+e;else{var f=c.Y.lastIndexOf("/");-1!=f&&(e=c.Y.substr(0,f+1)+e);}if(".."==e||"."==e)e="";else if(-1!=e.indexOf("./")||-1!=e.indexOf("/.")){f=0==e.lastIndexOf("/",0);e=e.split("/");for(var g=[],h=0;h<e.length;){var k=e[h++];"."==k?f&&h==e.length&&g.push(""):".."==k?
((1<g.length||1==g.length&&""!=g[0])&&g.pop(),f&&h==e.length&&g.push("")):(g.push(k),f=!0);}e=g.join("/");}}d?c.Y=e:d=""!==b.a.toString();d?Ma(c,Na(b.a)):d=!!b.va;d&&(c.va=b.va);return c};function Ka(b,c,d){b.ea=d?Oa(c,!0):c;b.ea&&(b.ea=b.ea.replace(/:$/,""));}function La(b,c){if(c){c=Number(c);if(isNaN(c)||0>c)throw Error("Bad port number "+c);b.Oa=c;}else b.Oa=null;}function Ma(b,c,d){c instanceof Pa?b.a=c:(d||(c=Qa(c,Wa)),b.a=new Pa(c));}
...
z.prototype.T=function(b,c){function d(){f.reject(new v(2,7,7001));return e.abort()}var e=this,f=new y;this.promise.then(function(c){e.a?f.reject(new v(2,7,7001)):b?d=fb(b,c,f):f.resolve(c);},function(b){c?d=fb(c,b,f):f.reject(b);});return new z(f,function(){return d()})};z.prototype.chain=z.prototype.T;
...
n.qb=function(b){if(!this.j)return Ab(this.g,b,"encrypted",function(){this.h(new v(2,6,6010));}.bind(this)),Promise.resolve();this.l=b;Ab(this.g,this.l,"play",this.Pd.bind(this));b=this.l.setMediaKeys(this.j);b=b["catch"](function(b){return Promise.reject(new v(2,6,6003,b.message))});var c=null;this.b.serverCertificate&&this.b.serverCertificate.length&&(c=this.j.setServerCertificate(this.b.serverCertificate).then(function(){})["catch"](function(b){return Promise.reject(new v(2,6,6004,b.message))}));
return Promise.all([b,c]).then(function(){if(this.c)return Promise.reject();dc(this);this.b.initData.length||this.m.length||D(this.g,this.l,"encrypted",this.Ed.bind(this));}.bind(this))["catch"](function(b){return this.c?Promise.resolve():Promise.reject(b)}.bind(this))};
...
n.Ed=function(b){for(var c=new Uint8Array(b.initData),d=0;d<this.a.length;++d)if(Zb(c,this.a[d].initData))return;gc(this,b.initDataType,c);};
function fc(b,c){try{var d=b.j.createSession("persistent-license");}catch(g){var e=new v(2,6,6005,g.message);b.h(e);return Promise.reject(e)}D(b.g,d,"message",b.Ec.bind(b));D(b.g,d,"keystatuseschange",b.Ac.bind(b));var f={initData:null,fa:d,loaded:!1,Rb:Infinity,la:null};b.a.push(f);return d.load(c).then(function(b){if(!this.c){if(b)return f.loaded=!0,this.a.every(function(b){return b.loaded})&&this.i.resolve(),d;this.a.splice(this.a.indexOf(f),1);this.h(new v(2,6,6013));}}.bind(b),function(b){this.c||
(this.a.splice(this.a.indexOf(f),1),this.h(new v(2,6,6005,b.message)));}.bind(b))}
function gc(b,c,d){try{var e=b.ba?b.j.createSession("persistent-license"):b.j.createSession();}catch(f){b.h(new v(2,6,6005,f.message));return}D(b.g,e,"message",b.Ec.bind(b));D(b.g,e,"keystatuseschange",b.Ac.bind(b));b.a.push({initData:d,fa:e,loaded:!1,Rb:Infinity,la:null});e.generateRequest(c,d.buffer)["catch"](function(b){if(!this.c){for(var c=0;c<this.a.length;++c)if(this.a[c].fa==e){this.a.splice(c,1);break}this.h(new v(2,6,6006,b.message));}}.bind(b));}
n.Ec=function(b){this.f.delayLicenseRequestUntilPlayed&&this.l.paused&&!this.R?this.K.push(b):nc(this,b);};
...
this.i.resolve();}.bind(this),5E3));}.bind(this))}.bind(b),function(b){if(this.c)return Promise.resolve();b=new v(2,6,6007,b);this.h(b);e&&e.la&&e.la.reject(b);}.bind(b))["catch"](function(b){if(this.c)return Promise.resolve();b=new v(2,6,6008,b.message);this.h(b);e&&e.la&&e.la.reject(b);}.bind(b));}
...
function Vc(b,c){try{return b.b[c].buffered}catch(d){return null}}function Yc(b,c,d,e,f){return"text"==c?Qc(b.a,d,e,f):b.h[c]?Oc(b.h[c],d).then(function(b){this.a||Tc(this,"text/vtt");this.l&&this.a.ic(b.cues);return Zc(this,c,this.Tc.bind(this,c,b.data.buffer))}.bind(b)):Zc(b,c,b.Tc.bind(b,c,d))}n.remove=function(b,c,d){return"text"==b?this.a.remove(c,d):Zc(this,b,this.Uc.bind(this,b,c,d))};
function $c(b,c){return"text"==c?b.a?b.a.remove(0,Infinity):Promise.resolve():Zc(b,c,b.Uc.bind(b,c,0,b.g.duration))}n.flush=function(b){return"text"==b?Promise.resolve():Zc(this,b,this.jd.bind(this,b))};function ad(b,c,d,e,f){return"text"==c?(b.a.g=d,b=b.a,b.i=e,b.h=f,Promise.resolve()):Promise.all([Zc(b,c,b.$c.bind(b,c)),Zc(b,c,b.De.bind(b,c,d)),Zc(b,c,b.Ae.bind(b,c,e,f))])}n.endOfStream=function(b){return bd(this,function(){b?this.g.endOfStream(b):this.g.endOfStream();}.bind(this))};
n.ga=function(b){return bd(this,function(){this.g.duration=b;}.bind(this))};n.P=function(){return this.g.duration};n.Tc=function(b,c){this.b[b].appendBuffer(c);};n.Uc=function(b,c,d){d<=c?this.Ma(b):this.b[b].remove(c,d);};n.$c=function(b){var c=this.b[b].appendWindowStart,d=this.b[b].appendWindowEnd;this.b[b].abort();this.b[b].appendWindowStart=c;this.b[b].appendWindowEnd=d;this.Ma(b);};n.jd=function(b){this.f.currentTime-=.001;this.Ma(b);};
n.De=function(b,c){0>c&&(c+=.001);this.b[b].timestampOffset=c;this.Ma(b);};n.Ae=function(b,c,d){this.b[b].appendWindowStart=0;this.b[b].appendWindowEnd=d;this.b[b].appendWindowStart=c;this.Ma(b);};n.Ne=function(b){this.c[b][0].p.reject(new v(2,3,3014,this.f.error?this.f.error.code:0));};n.Ma=function(b){var c=this.c[b][0];c&&(c.p.resolve(),cd(this,b));};
function Zc(b,c,d){if(b.m)return Promise.reject();d={start:d,p:new y};b.c[c].push(d);if(1==b.c[c].length)try{d.start();}catch(e){"QuotaExceededError"==e.name?d.p.reject(new v(2,3,3017,c)):d.p.reject(new v(2,3,3015,e)),cd(b,c);}return d.p}
function bd(b,c){if(b.m)return Promise.reject();var d=[],e;for(e in b.b){var f=new y,g={start:function(b){b.resolve();}.bind(null,f),p:f};b.c[e].push(g);d.push(f);1==b.c[e].length&&g.start();}return Promise.all(d).then(function(){try{c();}catch(l){var b=Promise.reject(new v(2,3,3015,l));}for(var d in this.b)cd(this,d);return b}.bind(b),function(){return Promise.reject()}.bind(b))}function cd(b,c){b.c[c].shift();var d=b.c[c][0];if(d)try{d.start();}catch(e){d.p.reject(new v(2,3,3015,e)),cd(b,c);}}function dd(b,c,d){return d==c||b>=ed&&d==c.split("-")[0]||b>=fd&&d.split("-")[0]==c.split("-")[0]?!0:!1}var ed=1,fd=2;function gd(b){b=b.toLowerCase().split("-");var c=hd[b[0]];c&&(b[0]=c);return b.join("-")}
...
J.prototype.chooseVariant=function(){var b=Ed(this.a.restrictions,this.g),c=this.b.getBandwidthEstimate(this.a.defaultBandwidthEstimate);if(this.g.length&&!b.length)throw new v(2,4,4012);for(var d=b[0]||null,e=0;e<b.length;++e){var f=b[e],g=(b[e+1]||{bandwidth:Infinity}).bandwidth/this.a.bandwidthUpgradeTarget;c>=f.bandwidth/this.a.bandwidthDowngradeTarget&&c<=g&&(d=f);}this.f=Date.now();return d};J.prototype.chooseVariant=J.prototype.chooseVariant;J.prototype.enable=function(){this.c=!0;};
...
function Sd(b){return JSON.parse(b,function(b,d){return"NaN"==d?NaN:"-Infinity"==d?-Infinity:"Infinity"==d?Infinity:d&&"object"==typeof d&&"TimeRanges"==d.__type__?Td(d):d})}function Td(b){return{length:b.length,start:function(c){return b.start[c]},end:function(c){return b.end[c]}}}function Ud(b,c,d,e,f,g){this.K=b;this.g=c;this.L=d;this.j=!1;this.A=e;this.G=f;this.u=g;this.b=this.h=!1;this.v="";this.i=null;this.l=this.yc.bind(this);this.m=this.Ld.bind(this);this.a={video:{},player:{}};this.o=0;this.c={};this.f=null;}var Vd=!1,Wd=null;n=Ud.prototype;n.destroy=function(){Xd(this);Wd&&Yd(this);this.G=this.A=this.g=null;this.b=this.h=!1;this.m=this.l=this.f=this.c=this.a=this.i=null;return Promise.resolve()};n.W=function(){return this.b};n.Wb=function(){return this.v};
n.init=function(){if(window.chrome&&chrome.cast&&chrome.cast.isAvailable){delete window.__onGCastApiAvailable;this.h=!0;this.g();var b=new chrome.cast.SessionRequest(this.K);b=new chrome.cast.ApiConfig(b,this.zc.bind(this),this.Sd.bind(this),"origin_scoped");chrome.cast.initialize(b,function(){},function(){});Vd&&setTimeout(this.g.bind(this),20);(b=Wd)&&b.status!=chrome.cast.SessionStatus.STOPPED?this.zc(b):Wd=null;}else window.__onGCastApiAvailable=function(b){b&&this.init();}.bind(this);};
n.Zb=function(b){this.i=b;this.b&&Zd({type:"appData",appData:this.i});};n.cast=function(b){if(!this.h)return Promise.reject(new v(1,8,8E3));if(!Vd)return Promise.reject(new v(1,8,8001));if(this.b)return Promise.reject(new v(1,8,8002));this.f=new y;chrome.cast.requestSession(this.Tb.bind(this,b),this.xc.bind(this));return this.f};n.tb=function(){this.b&&(Xd(this),Wd&&(Yd(this),Wd.stop(function(){},function(){}),Wd=null));};
n.get=function(b,c){if("video"==b){if(0<=Jd.indexOf(c))return this.Jc.bind(this,b,c)}else if("player"==b){if(Md[c]&&!this.get("player","isLive")())return function(){};if(0<=Pd.indexOf(c))return this.Jc.bind(this,b,c);if(0<=Qd.indexOf(c))return this.oe.bind(this,b,c);if(Ld[c])return this.Gc.bind(this,b,c)}return this.Gc(b,c)};n.set=function(b,c,d){this.a[b][c]=d;Zd({type:"set",targetName:b,property:c,value:d});};
n.Tb=function(b,c){Wd=c;c.addUpdateListener(this.l);c.addMessageListener("urn:x-cast:com.google.shaka.v2",this.m);this.yc();Zd({type:"init",initState:b,appData:this.i});this.f.resolve();};n.xc=function(b){var c=8003;switch(b.code){case "cancel":c=8004;break;case "timeout":c=8005;break;case "receiver_unavailable":c=8006;}this.f.reject(new v(2,8,c,b));};n.Gc=function(b,c){return this.a[b][c]};n.Jc=function(b,c){Zd({type:"call",targetName:b,methodName:c,args:Array.prototype.slice.call(arguments,2)});};
n.oe=function(b,c){var d=Array.prototype.slice.call(arguments,2),e=new y,f=this.o.toString();this.o++;this.c[f]=e;Zd({type:"asyncCall",targetName:b,methodName:c,args:d,id:f});return e};n.zc=function(b){var c=this.u();this.f=new y;this.j=!0;this.Tb(c,b);};n.Sd=function(b){Vd="available"==b;this.g();};function Yd(b){var c=Wd;c.removeUpdateListener(b.l);c.removeMessageListener("urn:x-cast:com.google.shaka.v2",b.m);}
n.yc=function(){var b=Wd?"connected"==Wd.status:!1;if(this.b&&!b){this.G();for(var c in this.a)this.a[c]={};Xd(this);}this.v=(this.b=b)?Wd.receiver.friendlyName:"";this.g();};function Xd(b){for(var c in b.c){var d=b.c[c];delete b.c[c];d.reject(new v(1,7,7E3));}}
n.Ld=function(b,c){var d=Sd(c);switch(d.type){case "event":var e=d.event;this.A(d.targetName,new E(e.type,e));break;case "update":e=d.update;for(var f in e){d=this.a[f]||{};for(var g in e[f])d[g]=e[f][g];}this.j&&(this.L(),this.j=!1);break;case "asyncComplete":if(f=d.id,d=d.error,g=this.c[f],delete this.c[f],g)if(d){f=new v(d.severity,d.category,d.code);for(e in d)f[e]=d[e];g.reject(f);}else g.resolve();}};function Zd(b){b=Rd(b);Wd.sendMessage("urn:x-cast:com.google.shaka.v2",b,function(){},Ha);}function K(){this.Ab=new xb;this.ib=this;}K.prototype.addEventListener=function(b,c){this.Ab.push(b,c);};K.prototype.removeEventListener=function(b,c){this.Ab.remove(b,c);};K.prototype.dispatchEvent=function(b){for(var c=this.Ab.get(b.type)||[],d=0;d<c.length;++d){b.target=this.ib;b.currentTarget=this.ib;var e=c[d];try{e.handleEvent?e.handleEvent(b):e.call(this,b);}catch(f){}if(b.a)break}return b.defaultPrevented};function L(b,c,d){K.call(this);this.c=b;this.b=c;this.i=this.g=this.f=this.j=this.h=null;this.a=new Ud(d,this.Ie.bind(this),this.Je.bind(this),this.Ke.bind(this),this.Le.bind(this),this.pc.bind(this));$d(this);}Aa(L,K);q("shaka.cast.CastProxy",L);L.prototype.destroy=function(b){b&&this.a&&this.a.tb();b=[this.i?this.i.destroy():null,this.b?this.b.destroy():null,this.a?this.a.destroy():null];this.a=this.i=this.j=this.h=this.b=this.c=null;return Promise.all(b)};L.prototype.destroy=L.prototype.destroy;
L.prototype.xd=function(){return this.h};L.prototype.getVideo=L.prototype.xd;L.prototype.pd=function(){return this.j};L.prototype.getPlayer=L.prototype.pd;L.prototype.bd=function(){return this.a?this.a.h&&Vd:!1};L.prototype.canCast=L.prototype.bd;L.prototype.W=function(){return this.a?this.a.W():!1};L.prototype.isCasting=L.prototype.W;L.prototype.Wb=function(){return this.a?this.a.Wb():""};L.prototype.receiverName=L.prototype.Wb;L.prototype.cast=function(){var b=this.pc();return this.a.cast(b).then(function(){if(this.b)return this.b.fb()}.bind(this))};
L.prototype.cast=L.prototype.cast;L.prototype.Zb=function(b){this.a.Zb(b);};L.prototype.setAppData=L.prototype.Zb;L.prototype.Pe=function(){var b=this.a;if(b.b){var c=b.u();chrome.cast.requestSession(b.Tb.bind(b,c),b.xc.bind(b));}};L.prototype.suggestDisconnect=L.prototype.Pe;L.prototype.tb=function(){this.a.tb();};L.prototype.forceDisconnect=L.prototype.tb;
function $d(b){b.a.init();b.i=new C;Fd.forEach(function(b){D(this.i,this.c,b,this.Xe.bind(this));}.bind(b));Kd.forEach(function(b){D(this.i,this.b,b,this.he.bind(this));}.bind(b));b.h={};for(var c in b.c)Object.defineProperty(b.h,c,{configurable:!1,enumerable:!0,get:b.We.bind(b,c),set:b.Ye.bind(b,c)});b.j={};for(var d in b.b)Object.defineProperty(b.j,d,{configurable:!1,enumerable:!0,get:b.ge.bind(b,d)});b.f=new K;b.f.ib=b.h;b.g=new K;b.g.ib=b.j;}n=L.prototype;
n.pc=function(){var b={video:{},player:{},playerAfterLoad:{},manifest:this.b.Hb(),startTime:null};this.c.pause();Id.forEach(function(c){b.video[c]=this.c[c];}.bind(this));this.c.ended||(b.startTime=this.c.currentTime);Nd.forEach(function(c){var d=c[1];c=this.b[c[0]]();b.player[d]=c;}.bind(this));Od.forEach(function(c){var d=c[1];c=this.b[c[0]]();b.playerAfterLoad[d]=c;}.bind(this));return b};n.Ie=function(){this.dispatchEvent(new E("caststatuschanged"));};
n.Je=function(){this.f.dispatchEvent(new E(this.h.paused?"pause":"play"));};
...
this.a.get("player",b[0])();this.b[c](b);}.bind(b)),b.c.autoplay=f,c&&b.c.play());},function(c){b.b.dispatchEvent(new E("error",{detail:c}));});};n.We=function(b){if("addEventListener"==b)return this.f.addEventListener.bind(this.f);if("removeEventListener"==b)return this.f.removeEventListener.bind(this.f);if(this.a.W()&&0==Object.keys(this.a.a.video).length){var c=this.c[b];if("function"!=typeof c)return c}return this.a.W()?this.a.get("video",b):(b=this.c[b],"function"==typeof b&&(b=b.bind(this.c)),b)};
n.Ye=function(b,c){this.a.W()?this.a.set("video",b,c):this.c[b]=c;};n.Xe=function(b){this.a.W()||this.f.dispatchEvent(new E(b.type,b));};
n.ge=function(b){if("addEventListener"==b)return this.g.addEventListener.bind(this.g);if("removeEventListener"==b)return this.g.removeEventListener.bind(this.g);if("getMediaElement"==b)return function(){return this.h}.bind(this);if("getNetworkingEngine"==b)return this.b.qc.bind(this.b);if(this.a.W()){if("getManifest"==b)return function(){Ga("getManifest() does not work while casting!");return null};if("attach"==b)return function(){Ga("attach() does not work while casting!");return Promise.resolve()};
if("detach"==b)return function(){Ga("detach() does not work while casting!");return Promise.resolve()}}return this.a.W()&&0==Object.keys(this.a.a.video).length&&Ld[b]||!this.a.W()?this.b[b].bind(this.b):this.a.get("player",b)};n.he=function(b){this.a.W()||this.g.dispatchEvent(b);};n.Ke=function(b,c){this.a.W()&&("video"==b?this.f.dispatchEvent(c):"player"==b&&this.g.dispatchEvent(c));};function ae(b,c,d,e){K.call(this);this.a=b;this.b=c;this.c=new C;this.u={video:b,player:c};this.v=d||function(){};this.A=e||function(b){return b};this.o=!1;this.h=!0;this.g=0;this.m=!1;this.j=!0;this.l=this.i=this.f=null;be(this);}Aa(ae,K);q("shaka.cast.CastReceiver",ae);ae.prototype.isConnected=function(){return this.o};ae.prototype.isConnected=ae.prototype.isConnected;ae.prototype.zd=function(){return this.h};ae.prototype.isIdle=ae.prototype.zd;
...
type:"INVALID_REQUEST",reason:"INVALID_COMMAND"},this.i);}};n.Oc=function(b,c,d){this.b&&ge(this,{type:"asyncComplete",id:c,error:d},this.f,b);};function ge(b,c,d,e){b.o&&(b=Rd(c),e?d.getCastChannel(e).send(b):d.broadcast(b));}
function ee(b,c,d){var e=b.a.playbackRate;var f=ie;f=b.h?f.IDLE:b.b.tc()?f.Vc:b.a.paused?f.Xc:f.Yc;e={mediaSessionId:0,playbackRate:e,playerState:f,currentTime:b.a.currentTime,supportedMediaCommands:15,volume:{level:b.a.volume,muted:b.a.muted}};d&&(e.media=d);ge(b,{requestId:c,type:"MEDIA_STATUS",status:[e]},b.i);}var ie={IDLE:"IDLE",Yc:"PLAYING",Vc:"BUFFERING",Xc:"PAUSED"};function je(b,c){var d=M(b,c);return 1!=d.length?null:d[0]}function M(b,c){return Array.prototype.filter.call(b.childNodes,function(b){return b instanceof Element&&b.tagName==c})}function ke(b){var c=b.firstChild;return c&&c.nodeType==Node.TEXT_NODE?b.textContent.trim():null}function N(b,c,d,e){var f=null;b=b.getAttribute(c);null!=b&&(f=d(b));return null==f?void 0!=e?e:null:f}
...
function te(b,c,d){b=ue(b);var e=null,f=[],g=[],h=b.map(function(b){return b.keyId}).filter(Eb);if(h.length&&1<h.filter(Fb).length)throw new v(2,4,4010);d||(g=b.filter(function(b){return"urn:mpeg:dash:mp4protection:2011"==b.Nc?(e=b.init||e,!1):!0}),g.length&&(f=ve(e,c,g),0==f.length&&(f=[Gb("",e)])));!b.length||!d&&g.length||(f=Jb(se).map(function(b){return Gb(b,e)}));var k=h[0]||null;k&&f.forEach(function(b){b.initData.forEach(function(b){b.keyId=k;});});return{jc:k,bf:e,drmInfos:f,oc:!0}}
function we(b,c,d,e){var f=te(b,c,e);if(d.oc){b=1==d.drmInfos.length&&!d.drmInfos[0].keySystem;c=0==f.drmInfos.length;if(0==d.drmInfos.length||b&&!c)d.drmInfos=f.drmInfos;d.oc=!1;}else if(0<f.drmInfos.length&&(d.drmInfos=d.drmInfos.filter(function(b){return f.drmInfos.some(function(c){return c.keySystem==b.keySystem})}),0==d.drmInfos.length))throw new v(2,4,4008);return f.jc||d.jc}
function ve(b,c,d){return d.map(function(d){var e=se[d.Nc];if(e){var g=d.init||b,h="";if(d.node&&d.node.childNodes&&0<d.node.childNodes.length)for(var k=0;k<d.node.childNodes.length;k++){var l=d.node.childNodes[k];"ms:laurl"===l.nodeName&&l instanceof Element&&(h=l.getAttribute("licenseUrl"));}if(!h&&"com.microsoft.playready"===e&&g&&0<g.length&&"cenc"===g[0].initDataType)a:{if((h=g[0].initData)&&0===h.buffer.byteLength%2&&(h=String.fromCharCode.apply(null,new Uint16Array(h.buffer)),d=h.indexOf("<WRMHEADER"))&&
...
function ue(b){return b.map(function(b){var c=b.getAttribute("schemeIdUri"),e=b.getAttribute("cenc:default_KID"),f=M(b,"cenc:pssh").map(ke);if(!c)return null;c=c.toLowerCase();if(e&&(e=e.replace(/-/g,"").toLowerCase(),0<=e.indexOf(" ")))throw new v(2,4,4009);var g=[];try{g=f.map(function(b){return{initDataType:"cenc",initData:Wb(b),keyId:null}});}catch(h){throw new v(2,4,4007);}return{node:b,Nc:c,keyId:e,init:0<g.length?g:null}}).filter(Eb)}function xe(b,c,d,e,f){null!=f&&(f=Math.round(f));var g={RepresentationID:c,Number:d,Bandwidth:e,Time:f};return b.replace(/\$(RepresentationID|Number|Bandwidth|Time)?(?:%0([0-9]+)([diouxX]))?\$/g,function(b,c,d,e){if("$$"==b)return"$";var f=g[c];if(null==f)return b;"RepresentationID"==c&&d&&(d=void 0);switch(e){case void 0:case "d":case "i":case "u":b=f.toString();break;case "o":b=f.toString(8);break;case "x":b=f.toString(16);break;case "X":b=f.toString(16).toUpperCase();break;default:b=f.toString();}d=
window.parseInt(d,10)||1;return Array(Math.max(0,d-b.length)+1).join("0")+b})}
function ye(b,c){var d=ze(b,c,"timescale"),e=1;d&&(e=pe(d)||1);d=ze(b,c,"duration");(d=pe(d||""))&&(d/=e);var f=ze(b,c,"startNumber"),g=Number(ze(b,c,"presentationTimeOffset"))||0,h=qe(f||"");if(null==f||null==h)h=1;var k=Ae(b,c,"SegmentTimeline");f=null;if(k){f=e;var l=b.M.duration||Infinity;k=M(k,"S");for(var m=[],r=0,t=0;t<k.length;++t){var u=k[t],w=N(u,"t",qe),x=N(u,"d",qe);u=N(u,"r",oe);null!=w&&(w-=g);if(!x)break;w=null!=w?w:r;u=u||0;if(0>u)if(t+1<k.length){u=N(k[t+1],"t",qe);if(null==u)break;
else if(w>=u)break;u=Math.ceil((u-w)/x)-1;}else{if(Infinity==l)break;else if(w/f>=l)break;u=Math.ceil((l*f-w)/x)-1;}0<m.length&&w!=r&&(m[m.length-1].end=w/f);for(var Da=0;Da<=u;++Da)r=w+x,m.push({start:w/f,end:r/f,Te:w}),w=r;}f=m;}return{timescale:e,O:d,Ba:h,aa:g/e||0,fc:g,I:f}}function ze(b,c,d){return[c(b.w),c(b.S),c(b.Z)].filter(Eb).map(function(b){return b.getAttribute(d)}).reduce(function(b,c){return b||c})}
...
function Ce(b,c,d,e,f,g){for(var h=b.getAttribute("xlink:href"),k=b.getAttribute("xlink:actuate")||"onRequest",l=0;l<b.attributes.length;l++){var m=b.attributes[l].nodeName;-1!=m.indexOf("xlink:")&&(b.removeAttribute(m),--l);}if(5<=g)return ab(new v(2,4,4028));if("onLoad"!=k)return ab(new v(2,4,4027));var r=F([e],[h]);return f.request(0,B(r,c)).T(function(e){e=Be(e.data,b.tagName);if(!e)return ab(new v(2,4,4001,h));for(;b.childNodes.length;)b.removeChild(b.childNodes[0]);for(;e.childNodes.length;){var k=
...
R.prototype.xb=function(b,c,d){var e=c.U(),f=c.B(),g=c.B();switch(f){case 0:f=c.F.byteLength-e;break;case 1:f=c.Pa();}var h=this.b[g];if(h){var k=null,l=null;1==this.c[g]&&(l=c.B(),k=l>>>24,l&=16777215);g=e+f;d&&g>c.F.byteLength&&(g=c.F.byteLength);g-=c.U();c=0<g?c.Aa(g):new Uint8Array(0);c=new Q(new DataView(c.buffer,c.byteOffset,c.byteLength),0);h({na:this,Fc:d||!1,version:k,flags:l,s:c,size:f,start:e+b});}else c.D(e+f-c.U());};R.prototype.parseNext=R.prototype.xb;
function S(b){for(;b.s.da()&&!b.na.a;)b.na.xb(b.start,b.s,b.Fc);}R.children=S;function He(b){for(var c=b.s.B();0<c&&!b.na.a;--c)b.na.xb(b.start,b.s,b.Fc);}R.sampleDescription=He;function Ie(b){return function(c){b(c.s.Aa(c.s.F.byteLength-c.s.U()));}}R.allData=Ie;function Ge(b){for(var c=0,d=0;d<b.length;d++)c=c<<8|b.charCodeAt(d);return c}function Je(b){return String.fromCharCode(b>>24&255,b>>16&255,b>>8&255,b&255)}R.typeToString=Je;function Ke(b,c,d,e){var f,g=(new R).V("sidx",function(b){f=Le(c,e,d,b);});b&&g.parse(b);if(f)return f;throw new v(2,3,3004);}
function Le(b,c,d,e){var f=[];e.s.D(4);var g=e.s.B();if(0==g)throw new v(2,3,3005);if(0==e.version){var h=e.s.B();var k=e.s.B();}else h=e.s.Pa(),k=e.s.Pa();e.s.D(2);var l=e.s.$a();b=b+e.size+k;for(k=0;k<l;k++){var m=e.s.B(),r=(m&2147483648)>>>31;m&=2147483647;var t=e.s.B();e.s.D(4);if(1==r)throw new v(2,3,3006);f.push(new P(f.length,h/g-c,(h+t)/g-c,function(){return d},b,b+m-1));h+=t;b+=m;}e.na.stop();return f}function T(b){this.a=b;}q("shaka.media.SegmentIndex",T);T.prototype.destroy=function(){this.a=null;return Promise.resolve()};T.prototype.destroy=T.prototype.destroy;T.prototype.find=function(b){for(var c=this.a.length-1;0<=c;--c){var d=this.a[c];if(b>=d.startTime&&b<d.endTime)return d.position}return this.a.length&&b<this.a[0].startTime?this.a[0].position:null};T.prototype.find=T.prototype.find;
...
T.prototype.Ob=function(b){for(var c=[],d=0,e=0;d<this.a.length&&e<b.length;){var f=this.a[d],g=b[e];f.startTime<g.startTime?(c.push(f),d++):(f.startTime>g.startTime?0==d&&c.push(g):(.1<Math.abs(f.endTime-g.endTime)?c.push(new P(f.position,g.startTime,g.endTime,g.c,g.b,g.a)):c.push(f),d++),e++);}for(;d<this.a.length;)c.push(this.a[d++]);if(c.length)for(d=c[c.length-1].position+1;e<b.length;)f=b[e++],f=new P(d++,f.startTime,f.endTime,f.c,f.b,f.a),c.push(f);else c=b;this.a=c;};T.prototype.merge=T.prototype.Ob;
T.prototype.replace=function(b){this.a=b;};T.prototype.Eb=function(b){for(var c=0;c<this.a.length;++c)if(this.a[c].endTime>b){this.a.splice(0,c);return}this.a=[];};T.prototype.evict=T.prototype.Eb;
function Me(b,c){for(;b.a.length;)if(b.a[b.a.length-1].startTime>=c)b.a.pop();else break;for(;b.a.length;)if(0>=b.a[0].endTime)b.a.shift();else break;if(0!=b.a.length){var d=b.a[0];d.startTime<Hb&&(b.a[0]=new P(d.position,0,d.endTime,d.c,d.b,d.a));d=b.a[b.a.length-1];b.a[b.a.length-1]=new P(d.position,d.startTime,c,d.c,d.b,d.a);}}function Ne(b){this.b=b;this.a=new Q(b,0);Oe||(Oe=[new Uint8Array([255]),new Uint8Array([127,255]),new Uint8Array([63,255,255]),new Uint8Array([31,255,255,255]),new Uint8Array([15,255,255,255,255]),new Uint8Array([7,255,255,255,255,255]),new Uint8Array([3,255,255,255,255,255,255]),new Uint8Array([1,255,255,255,255,255,255,255])]);}var Oe;Ne.prototype.da=function(){return this.a.da()};
function Pe(b){var c=Qe(b);if(7<c.length)throw new v(2,3,3002);for(var d=0,e=0;e<c.length;e++)d=256*d+c[e];c=d;d=Qe(b);a:{for(e=0;e<Oe.length;e++)if(Zb(d,Oe[e])){e=!0;break a}e=!1;}if(e)d=b.b.byteLength-b.a.U();else{if(8==d.length&&d[1]&224)throw new v(2,3,3001);e=d[0]&(1<<8-d.length)-1;for(var f=1;f<d.length;f++)e=256*e+d[f];d=e;}d=b.a.U()+d<=b.b.byteLength?d:b.b.byteLength-b.a.U();e=new DataView(b.b.buffer,b.b.byteOffset+b.a.U(),d);b.a.D(d);return new Re(c,e)}
function Qe(b){var c=b.a.$(),d;for(d=1;8>=d&&!(c&1<<8-d);d++);if(8<d)throw new v(2,3,3002);var e=new Uint8Array(d);e[0]=c;for(c=1;c<d;c++)e[c]=b.a.$();return e}function Re(b,c){this.id=b;this.a=c;}function Se(b){if(8<b.a.byteLength)throw new v(2,3,3002);if(8==b.a.byteLength&&b.a.getUint8(0)&224)throw new v(2,3,3001);for(var c=0,d=0;d<b.a.byteLength;d++){var e=b.a.getUint8(d);c=256*c+e;}return c}function Te(){}
Te.prototype.parse=function(b,c,d,e){var f;c=new Ne(new DataView(c));if(440786851!=Pe(c).id)throw new v(2,3,3008);var g=Pe(c);if(408125543!=g.id)throw new v(2,3,3009);c=g.a.byteOffset;g=new Ne(g.a);for(f=null;g.da();){var h=Pe(g);if(357149030==h.id){f=h;break}}if(!f)throw new v(2,3,3010);g=new Ne(f.a);f=1E6;for(h=null;g.da();){var k=Pe(g);if(2807729==k.id)f=Se(k);else if(17545==k.id)if(h=k,4==h.a.byteLength)h=h.a.getFloat32(0);else if(8==h.a.byteLength)h=h.a.getFloat64(0);else throw new v(2,3,3003);
}if(null==h)throw new v(2,3,3011);g=f/1E9;f=h*g;b=Pe(new Ne(new DataView(b)));if(475249515!=b.id)throw new v(2,3,3007);return Ue(b,c,g,f,d,e)};function Ue(b,c,d,e,f,g){function h(){return f}var k=[];b=new Ne(b.a);for(var l=null,m=null;b.da();){var r=Pe(b);if(187==r.id){var t=Ve(r);t&&(r=d*t.Ue,t=c+t.ne,null!=l&&k.push(new P(k.length,l-g,r-g,h,m,t-1)),l=r,m=t);}}null!=l&&k.push(new P(k.length,l-g,e-g,h,m,null));return k}
function Ve(b){var c=new Ne(b.a);b=Pe(c);if(179!=b.id)throw new v(2,3,3013);b=Se(b);c=Pe(c);if(183!=c.id)throw new v(2,3,3012);c=new Ne(c.a);for(var d=0;c.da();){var e=Pe(c);if(241==e.id){d=Se(e);break}}return{Ue:b,ne:d}}function We(b,c){var d=Ae(b,c,"Initialization");if(!d)return null;var e=b.w.ca,f=d.getAttribute("sourceURL");f&&(e=F(b.w.ca,[f]));f=0;var g=null;if(d=N(d,"range",ne))f=d.start,g=d.end;return new O(function(){return e},f,g)}
function Xe(b,c){var d=Number(ze(b,Ye,"presentationTimeOffset"))||0,e=ze(b,Ye,"timescale"),f=1;e&&(f=pe(e)||1);d=d/f||0;e=We(b,Ye);var g=b.w.contentType;f=b.w.mimeType.split("/")[1];if("text"!=g&&"mp4"!=f&&"webm"!=f)throw new v(2,4,4006);if("webm"==f&&!e)throw new v(2,4,4005);g=Ae(b,Ye,"RepresentationIndex");var h=ze(b,Ye,"indexRange"),k=b.w.ca;h=ne(h||"");if(g){var l=g.getAttribute("sourceURL");l&&(k=F(b.w.ca,[l]));h=N(g,"range",ne,h);}if(!h)throw new v(2,4,4002);f=Ze(b,c,e,k,h.start,h.end,f,d);return{createSegmentIndex:f.createSegmentIndex,
findSegmentPosition:f.findSegmentPosition,getSegmentReference:f.getSegmentReference,initSegmentReference:e,aa:d}}
function Ze(b,c,d,e,f,g,h,k){var l=b.presentationTimeline,m=!b.Ha||!b.M.Kb,r=b.M.index,t=b.M.duration,u=c,w=null;return{createSegmentIndex:function(){var b=[u(e,f,g),"webm"==h?u(d.c(),d.b,d.a):null];u=null;return Promise.all(b).then(function(b){var c=b[0];b=b[1]||null;c="mp4"==h?Ke(c,f,e,k):(new Te).parse(c,b,e,k);l.Ya(c,0==r);w=new T(c);m&&Me(w,t);})},findSegmentPosition:function(b){return w.find(b)},getSegmentReference:function(b){return w.get(b)}}}function Ye(b){return b.ab}function $e(b,c){var d=We(b,af);var e=bf(b);var f=ye(b,af),g=f.Ba;0==g&&(g=1);var h=0;f.O?h=f.O*(g-1):f.I&&0<f.I.length&&(h=f.I[0].start);e={O:f.O,startTime:h,Ba:g,aa:f.aa,I:f.I,La:e};if(!e.O&&!e.I&&1<e.La.length)throw new v(2,4,4002);if(!e.O&&!b.M.duration&&!e.I&&1==e.La.length)throw new v(2,4,4002);if(e.I&&0==e.I.length)throw new v(2,4,4002);g=f=null;b.Z.id&&b.w.id&&(g=b.Z.id+","+b.w.id,f=c[g]);h=cf(b.M.duration,e.Ba,b.w.ca,e);f?(f.Ob(h),g=b.presentationTimeline.Ja(),f.Eb(g-b.M.start)):(b.presentationTimeline.Ya(h,
0==b.M.index),f=new T(h),g&&b.Ha&&(c[g]=f));b.Ha&&b.M.Kb||Me(f,b.M.duration);return{createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:f.find.bind(f),getSegmentReference:f.get.bind(f),initSegmentReference:d,aa:e.aa}}function af(b){return b.pa}
function cf(b,c,d,e){var f=e.La.length;e.I&&e.I.length!=e.La.length&&(f=Math.min(e.I.length,e.La.length));for(var g=[],h=e.startTime,k=0;k<f;k++){var l=e.La[k],m=F(d,[l.Bd]),r=void 0;r=null!=e.O?h+e.O:e.I?e.I[k].end:h+b;g.push(new P(k+c,h,r,function(b){return b}.bind(null,m),l.start,l.end));h=r;}return g}
function bf(b){return[b.w.pa,b.S.pa,b.Z.pa].filter(Eb).map(function(b){return M(b,"SegmentURL")}).reduce(function(b,d){return 0<b.length?b:d}).map(function(c){c.getAttribute("indexRange")&&!b.sc&&(b.sc=!0);var d=c.getAttribute("media");c=N(c,"mediaRange",ne,{start:0,end:null});return{Bd:d,start:c.start,end:c.end}})}function df(b,c,d,e){var f=ef(b);var g=ye(b,ff);var h=ze(b,ff,"media"),k=ze(b,ff,"index");g={O:g.O,timescale:g.timescale,Ba:g.Ba,aa:g.aa,fc:g.fc,I:g.I,Nb:h,Wa:k};h=g.Wa?1:0;h+=g.I?1:0;h+=g.O?1:0;if(0==h)throw new v(2,4,4002);1!=h&&(g.Wa&&(g.I=null),g.O=null);if(!g.Wa&&!g.Nb)throw new v(2,4,4002);if(g.Wa){d=b.w.mimeType.split("/")[1];if("mp4"!=d&&"webm"!=d)throw new v(2,4,4006);if("webm"==d&&!f)throw new v(2,4,4005);e=xe(g.Wa,b.w.id,null,b.bandwidth||null,null);e=F(b.w.ca,[e]);b=Ze(b,c,f,e,0,null,
d,g.aa);}else g.O?(e||b.presentationTimeline.wb(g.O),b=gf(b,g)):(e=c=null,b.Z.id&&b.w.id&&(e=b.Z.id+","+b.w.id,c=d[e]),h=hf(b,g),c?(c.Ob(h),d=b.presentationTimeline.Ja(),c.Eb(d-b.M.start)):(b.presentationTimeline.Ya(h,0==b.M.index),c=new T(h),e&&b.Ha&&(d[e]=c)),b.Ha&&b.M.Kb||Me(c,b.M.duration),b={createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:c.find.bind(c),getSegmentReference:c.get.bind(c)});return{createSegmentIndex:b.createSegmentIndex,findSegmentPosition:b.findSegmentPosition,
getSegmentReference:b.getSegmentReference,initSegmentReference:f,aa:g.aa}}function ff(b){return b.cb}
function gf(b,c){var d=b.M.duration,e=c.O,f=c.Ba,g=c.timescale,h=c.Nb,k=b.bandwidth||null,l=b.w.id,m=b.w.ca;return{createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:function(b){return 0>b||d&&b>=d?null:Math.floor(b/e)},getSegmentReference:function(b){var c=b*e,r=c+e;d&&(r=Math.min(r,d));return 0>r||d&&c>=d?null:new P(b,c,r,function(){var d=xe(h,l,b+f,k,c*g);return F(m,[d])},0,null)}}}
function hf(b,c){for(var d=[],e=0;e<c.I.length;e++){var f=e+c.Ba;d.push(new P(f,c.I[e].start,c.I[e].end,function(b,c,d,e,f,r){b=xe(b,c,f,d,r);return F(e,[b]).map(function(b){return b.toString()})}.bind(null,c.Nb,b.w.id,b.bandwidth||null,b.w.ca,f,c.I[e].Te+c.fc),0,null));}return d}function ef(b){var c=ze(b,ff,"initialization");if(!c)return null;var d=b.w.id,e=b.bandwidth||null,f=b.w.ca;return new O(function(){var b=xe(c,d,null,e,null);return F(f,[b])},0,null)}var jf={},kf={};q("shaka.media.ManifestParser.registerParserByExtension",function(b,c){kf[b]=c;});q("shaka.media.ManifestParser.registerParserByMime",function(b,c){jf[b]=c;});function lf(){var b={},c;for(c in jf)b[c]=!0;for(var d in kf)b[d]=!0;["application/dash+xml","application/x-mpegurl","application/vnd.apple.mpegurl","application/vnd.ms-sstr+xml"].forEach(function(c){b[c]=!!jf[c];});["mpd","m3u8","ism"].forEach(function(c){b[c]=!!kf[c];});return b}
function mf(b,c,d,e){var f=e;f||(e=(new Ja(b)).Y.split("/").pop().split("."),1<e.length&&(e=e.pop().toLowerCase(),f=kf[e]));if(f)return Promise.resolve(f);d=B([b],d);d.method="HEAD";return c.request(0,d).promise.then(function(c){(c=c.headers["content-type"])&&(c=c.toLowerCase());return(f=jf[c])?f:Promise.reject(new v(2,4,4E3,b))},function(b){b.severity=2;return Promise.reject(b)})}function U(b,c){this.f=b;this.l=c;this.c=this.b=Infinity;this.a=1;this.j=this.h=0;this.i=!0;this.g=0;}q("shaka.media.PresentationTimeline",U);U.prototype.P=function(){return this.b};U.prototype.getDuration=U.prototype.P;U.prototype.ga=function(b){this.b=b;};U.prototype.setDuration=U.prototype.ga;U.prototype.rd=function(){return this.f};U.prototype.getPresentationStartTime=U.prototype.rd;U.prototype.Pc=function(b){this.j=b;};U.prototype.setClockOffset=U.prototype.Pc;
U.prototype.yb=function(b){this.i=b;};U.prototype.setStatic=U.prototype.yb;U.prototype.ac=function(b){this.c=b;};U.prototype.setSegmentAvailabilityDuration=U.prototype.ac;U.prototype.Qc=function(b){this.l=b;};U.prototype.setDelay=U.prototype.Qc;U.prototype.Ya=function(b,c){0!=b.length&&(c&&(this.h=Math.max(this.h,b[0].startTime)),this.a=b.reduce(function(b,c){return Math.max(b,c.endTime-c.startTime)},this.a));};U.prototype.notifySegments=U.prototype.Ya;
U.prototype.wb=function(b){this.a=Math.max(this.a,b);};U.prototype.notifyMaxSegmentDuration=U.prototype.wb;U.prototype.N=function(){return Infinity==this.b&&!this.i};U.prototype.isLive=U.prototype.N;U.prototype.xa=function(){return Infinity!=this.b&&!this.i};U.prototype.isInProgress=U.prototype.xa;U.prototype.Ja=function(){if(Infinity==this.c)return this.g;var b=this.wa()-this.c;return Math.max(this.g,b)};U.prototype.getSegmentAvailabilityStart=U.prototype.Ja;U.prototype.Rc=function(b){this.g=b;};
U.prototype.setUserSeekStart=U.prototype.Rc;U.prototype.wa=function(){return this.N()||this.xa()?Math.min(Math.max(0,(Date.now()+this.j)/1E3-this.a-this.f),this.b):this.b};U.prototype.getSegmentAvailabilityEnd=U.prototype.wa;U.prototype.Ua=function(b){var c=Math.max(this.h,this.g);if(Infinity==this.c)return c;var d=this.wa()-this.c;b=Math.min(d+b,this.ia());return Math.max(c,b)};U.prototype.getSafeSeekRangeStart=U.prototype.Ua;U.prototype.Ia=function(){return this.Ua(0)};
U.prototype.getSeekRangeStart=U.prototype.Ia;U.prototype.ia=function(){var b=this.N()||this.xa()?this.l:0;return Math.max(0,this.wa()-b)};U.prototype.getSeekRangeEnd=U.prototype.ia;function nf(){this.a=this.b=null;this.h=[];this.c=null;this.j=[];this.i=1;this.l={};this.m=0;this.o=new Ba(5);this.g=null;this.f=new pb;}q("shaka.dash.DashParser",nf);n=nf.prototype;n.configure=function(b){this.b=b;};n.start=function(b,c){this.h=[b];this.a=c;return of(this).then(function(b){this.a&&pf(this,b);return this.c}.bind(this))};n.stop=function(){this.b=this.a=null;this.h=[];this.c=null;this.j=[];this.l={};null!=this.g&&(window.clearTimeout(this.g),this.g=null);return this.f.destroy()};
n.update=function(){of(this)["catch"](function(b){if(this.a)this.a.onError(b);}.bind(this));};n.onExpirationUpdated=function(){};function of(b){var c=Date.now(),d=b.a.networkingEngine.request(0,B(b.h,b.b.retryParameters));qb(b.f,d);return d.promise.then(function(c){if(b.a)return qf(b,c.data,c.uri)}).then(function(){var d=(Date.now()-c)/1E3;Ca(b.o,1,d);return d})}
function qf(b,c,d){c=Be(c,"MPD");if(!c)throw new v(2,4,4001,d);c=De(c,b.b.retryParameters,b.b.dash.xlinkFailGracefully,d,b.a.networkingEngine);qb(b.f,c);return c.promise.then(function(c){return rf(b,c,d)})}
...
parseInt(d,10));d=N(c,"timeShiftBufferDepth",me);var l=N(c,"suggestedPresentationDelay",me),m=N(c,"maxSegmentDuration",me);if(b.c)var r=b.c.presentationTimeline;else{var t=Math.max(b.b.dash.defaultPresentationDelay,1.5*h);r=new U(k,null!=l?l:t);}k=sf(b,{Ha:"static"!=g,presentationTimeline:r,Z:null,M:null,S:null,w:null,bandwidth:0,sc:!1},f,c);l=k.duration;var u=k.periods;r.yb("static"==g);"static"!=g&&k.kc||r.ga(l||Infinity);r.ac(null!=d?d:Infinity);r.wb(m||1);if(b.c)return Promise.resolve();c=M(c,
"UTCTiming");g=r.N();return tf(b,f,c,g).then(function(b){this.a&&(r.Pc(b),this.c={presentationTimeline:r,periods:u,offlineSessionIds:[],minBufferTime:h||0});}.bind(b))}
function sf(b,c,d,e){var f=N(e,"mediaPresentationDuration",me),g=[],h=0;e=M(e,"Period");for(var k=0;k<e.length;k++){var l=e[k];h=N(l,"start",me,h);var m=N(l,"duration",me),r=null;if(k!=e.length-1){var t=N(e[k+1],"start",me);null!=t&&(r=t-h);}else null!=f&&(r=f-h);null==r&&(r=m);l=uf(b,c,d,{start:h,duration:r,node:l,index:k,Kb:null==r||k==e.length-1});g.push(l);m=c.Z.id;-1==b.j.indexOf(m)&&(b.j.push(m),b.c&&(b.a.filterNewPeriod(l),b.c.periods.push(l)));if(null==r){h=null;break}h+=r;}null==b.c&&b.a.filterAllPeriods(g);
return null!=f?{periods:g,duration:f,kc:!1}:{periods:g,duration:h,kc:!0}}
function uf(b,c,d,e){c.Z=vf(e.node,null,d);c.M=e;c.Z.id||(c.Z.id="__shaka_period_"+e.start);M(e.node,"EventStream").forEach(b.ee.bind(b,e.start,e.duration));d=M(e.node,"AdaptationSet").map(b.ce.bind(b,c)).filter(Eb);var f=d.map(function(b){return b.pe}).reduce(Cb,[]),g=f.filter(Fb);if(c.Ha&&f.length!=g.length)throw new v(2,4,4018);var h=d.filter(function(b){return!b.ec});d.filter(function(b){return b.ec}).forEach(function(b){var c=b.streams[0],d=b.ec;h.forEach(function(b){b.id==d&&b.streams.forEach(function(b){b.trickModeVideo=
c;});});});d=wf(h,"video");f=wf(h,"audio");if(!d.length&&!f.length)throw new v(2,4,4004);f.length||(f=[null]);d.length||(d=[null]);c=[];for(g=0;g<f.length;g++)for(var k=0;k<d.length;k++)xf(b,f[g],d[k],c);b=wf(h,"text");d=[];for(f=0;f<b.length;f++)d.push.apply(d,b[f].streams);return{startTime:e.start,textStreams:d,variants:c}}function wf(b,c){return b.filter(function(b){return b.contentType==c})}
...
containsEmsgBoxes:b.w.containsEmsgBoxes,roles:h,channelsCount:b.w.Qb}};n.Me=function(){this.g=null;of(this).then(function(b){this.a&&pf(this,b);}.bind(this))["catch"](function(b){this.a&&(b.severity=1,this.a.onError(b),pf(this,0));}.bind(this));};function pf(b,c){0>b.m||(b.g=window.setTimeout(b.Me.bind(b),1E3*Math.max(3,b.m-c,Ea(b.o))));}
function vf(b,c,d){c=c||{contentType:"",mimeType:"",codecs:"",containsEmsgBoxes:!1,frameRate:void 0,Qb:null};d=d||c.ca;var e=M(b,"BaseURL").map(ke),f=b.getAttribute("contentType")||c.contentType,g=b.getAttribute("mimeType")||c.mimeType,h=b.getAttribute("codecs")||c.codecs,k=N(b,"frameRate",re)||c.frameRate,l=!!M(b,"InbandEventStream").length,m=M(b,"AudioChannelConfiguration");m=Af(m)||c.Qb;f||(f=yf(g,h));return{ca:F(d,e),ab:je(b,"SegmentBase")||c.ab,pa:je(b,"SegmentList")||c.pa,cb:je(b,"SegmentTemplate")||
...
function Af(b){for(var c=0;c<b.length;++c){var d=b[c],e=d.getAttribute("schemeIdUri");if(e&&(d=d.getAttribute("value")))switch(e){case "urn:mpeg:dash:outputChannelPositionList:2012":return d.trim().split(/ +/).length;case "urn:mpeg:dash:23003:3:audio_channel_configuration:2011":case "urn:dts:dash:audio_channel_configuration:2012":e=parseInt(d,10);if(!e)continue;return e;case "tag:dolby.com,2014:dash:audio_channel_configuration:2011":case "urn:dolby:dash:audio_channel_configuration:2011":if(e=parseInt(d,
16)){for(b=0;e;)e&1&&++b,e>>=1;return b}}}return null}function zf(b){var c=b.ab?1:0;c+=b.pa?1:0;c+=b.cb?1:0;if(0==c)return"text"==b.contentType||"application"==b.contentType?!0:!1;1!=c&&(b.ab&&(b.pa=null),b.cb=null);return!0}
function Bf(b,c,d,e){c=F(c,[d]);c=B(c,b.b.retryParameters);c.method=e;c=b.a.networkingEngine.request(0,c);qb(b.f,c);return c.promise.then(function(b){if("HEAD"==e){if(!b.headers||!b.headers.date)return 0;b=b.headers.date;}else b=G(b.data);b=Date.parse(b);return isNaN(b)?0:b-Date.now()})}
function tf(b,c,d,e){d=d.map(function(b){return{scheme:b.getAttribute("schemeIdUri"),value:b.getAttribute("value")}});var f=b.b.dash.clockSyncUri;e&&!d.length&&f&&d.push({scheme:"urn:mpeg:dash:utc:http-head:2014",value:f});return Bb(d,function(b){var d=b.value;switch(b.scheme){case "urn:mpeg:dash:utc:http-head:2014":case "urn:mpeg:dash:utc:http-head:2012":return Bf(this,c,d,"HEAD");case "urn:mpeg:dash:utc:http-xsdate:2014":case "urn:mpeg:dash:utc:http-iso:2014":case "urn:mpeg:dash:utc:http-xsdate:2012":case "urn:mpeg:dash:utc:http-iso:2012":return Bf(this,
...
n.qe=function(b,c,d){b=B(b,this.b.retryParameters);null!=c&&(b.headers.Range="bytes="+c+"-"+(null!=d?d:""));c=this.a.networkingEngine.request(1,b);qb(this.f,c);return c.promise.then(function(b){return b.data})};function yf(b,c){return I[Mb(b,c)]?"text":b.split("/")[0]}kf.mpd=nf;jf["application/dash+xml"]=nf;function Cf(b,c,d,e){this.uri=b;this.type=c;this.a=d;this.segments=e||null;}function Df(b,c,d,e){this.id=b;this.name=c;this.a=d;this.value=e||null;}Df.prototype.toString=function(){function b(b){return b.name+'="'+b.value+'"'}return this.value?"#"+this.name+":"+this.value:0<this.a.length?"#"+this.name+":"+this.a.map(b).join(","):"#"+this.name};function Ef(b,c){this.name=b;this.value=c;}Df.prototype.getAttribute=function(b){var c=this.a.filter(function(c){return c.name==b});return c.length?c[0]:null};
function Ff(b,c,d){d=d||null;return(b=b.getAttribute(c))?b.value:d}function Gf(b,c){this.a=c;this.uri=b;}function Hf(b,c){return b.filter(function(b){return b.name==c})}function If(b,c){var d=Hf(b,c);return d.length?d[0]:null}function Jf(b,c,d){return b.filter(function(b){var e=b.getAttribute("TYPE");b=b.getAttribute("GROUP-ID");return e.value==c&&b.value==d})}function Kf(b,c){return F([b],[c])[0]}function Lf(b){this.b=b;this.a=0;}function Mf(b){Nf(b,/[ \t]+/gm);}function Nf(b,c){c.lastIndex=b.a;var d=c.exec(b.b);d=null==d?null:{position:d.index,length:d[0].length,se:d};if(b.a==b.b.length||null==d||d.position!=b.a)return null;b.a+=d.length;return d.se}function Of(b){return b.a==b.b.length?null:(b=Nf(b,/[^ \t\n]*/gm))?b[0]:null}function Pf(){this.a=0;}
function Qf(b,c,d){c=G(c);c=c.replace(/\r\n|\r(?=[^\n]|$)/gm,"\n").trim();var e=c.split(/\n+/m);if(!/^#EXTM3U($|[ \t\n])/m.test(e[0]))throw new v(2,4,4015);c=0;for(var f=1;f<e.length;f++)if(!/^#(?!EXT)/m.test(e[f])){var g=Rf(b,e[f]);--b.a;if(0<=Sf.indexOf(g.name)){c=1;break}else"EXT-X-STREAM-INF"==g.name&&(f+=1);}f=[];for(g=1;g<e.length;)if(/^#(?!EXT)/m.test(e[g]))g+=1;else{var h=Rf(b,e[g]);if(0<=Tf.indexOf(h.name)){if(1!=c)throw new v(2,4,4017);e=e.splice(g,e.length-g);b=Uf(b,e,f);return new Cf(d,
c,f,b)}f.push(h);g+=1;"EXT-X-STREAM-INF"==h.name&&(h.a.push(new Ef("URI",e[g])),g+=1);}return new Cf(d,c,f)}function Uf(b,c,d){var e=[],f=[];c.forEach(function(c){if(/^(#EXT)/.test(c))c=Rf(b,c),0<=Sf.indexOf(c.name)?d.push(c):f.push(c);else{if(/^#(?!EXT)/m.test(c))return[];e.push(new Gf(c.trim(),f));f=[];}});return e}
function Rf(b,c){a:{var d=b.a++;var e=c.match(/^#(EXT[^:]*)(?::(.*))?$/);if(!e)throw new v(2,4,4016,c);var f=e[1],g=e[2];e=[];if(g&&0<=g.indexOf("=")){g=new Lf(g);for(var h,k=/([^=]+)=(?:"([^"]*)"|([^",]*))(?:,|$)/g;h=Nf(g,k);)e.push(new Ef(h[1],h[2]||h[3]));}else if(g){d=new Df(d,f,e,g);break a}d=new Df(d,f,e);}return d}var Sf="EXT-X-TARGETDURATION EXT-X-MEDIA-SEQUENCE EXT-X-DISCONTINUITY-SEQUENCE EXT-X-PLAYLIST-TYPE EXT-X-MAP EXT-X-I-FRAMES-ONLY EXT-X-ENDLIST".split(" "),Tf="EXTINF EXT-X-BYTERANGE EXT-X-DISCONTINUITY EXT-X-PROGRAM-DATE-TIME EXT-X-KEY EXT-X-DATERANGE".split(" ");function Vf(b){try{var c=Vf.parse(b);return cb({uri:b,data:c.data,headers:{"content-type":c.contentType}})}catch(d){return ab(d)}}q("shaka.net.DataUriPlugin",Vf);
Vf.parse=function(b){var c=b.split(":");if(2>c.length||"data"!=c[0])throw new v(2,1,1004,b);c=c.slice(1).join(":").split(",");if(2>c.length)throw new v(2,1,1004,b);var d=c[0];c=window.decodeURIComponent(c.slice(1).join(","));d=d.split(";");var e=null;1<d.length&&(e=d[1]);if("base64"==e)b=Wb(c).buffer;else{if(e)throw new v(2,1,1005,b);b=Rb(c);}return{data:b,contentType:d[0]}};sb("data",Vf);function Wf(){this.h=this.c=null;this.K=1;this.v={};this.G={};this.R={};this.a={};this.b=null;this.l="";this.u=new Pf;this.j=this.i=null;this.f=Xf;this.m=null;this.g=0;this.A=Infinity;this.o=new pb;}q("shaka.hls.HlsParser",Wf);n=Wf.prototype;n.configure=function(b){this.h=b;};n.start=function(b,c){this.c=c;this.l=b;return Yf(this,b).then(function(c){return Zf(this,c.data,b).then(function(){$f(this,this.i);return this.m}.bind(this))}.bind(this))};
n.stop=function(){this.h=this.c=null;this.v={};this.G={};this.m=null;return this.o.destroy()};n.update=function(){if(this.f!=ag.ma){var b=[],c;for(c in this.a)b.push(bg(this,this.a[c],c));return Promise.all(b)}};
function bg(b,c,d){Yf(b,d).then(function(b){var e=ag,g=Qf(this.u,b.data,d);if(1!=g.type)throw new v(2,4,4017);b=If(g.a,"EXT-X-MEDIA-SEQUENCE");var h=c.stream;eg(this,g,b?Number(b.value):0,h.mimeType,h.codecs).then(function(b){c.bb.replace(b);b=b[b.length-1];If(g.a,"EXT-X-ENDLIST")&&(fg(this,e.ma),this.b.ga(b.endTime));}.bind(this));}.bind(b));}n.onExpirationUpdated=function(){};
function Zf(b,c,d){c=Qf(b.u,c,d);if(0!=c.type)throw new v(2,4,4022);return gg(b,c).then(function(b){this.c.filterAllPeriods([b]);var c=Infinity,d=0,e=0,k=Infinity;for(m in this.a){var l=this.a[m];c=Math.min(c,l.Pb);d=Math.max(d,l.Pb);e=Math.max(e,l.Ad);"text"!=l.stream.type&&(k=Math.min(k,l.duration));}var m=null;l=0;this.f!=ag.ma&&(m=Date.now()/1E3-e,l=3*this.g);this.b=new U(m,l);this.b.yb(this.f==ag.ma);this.b.wb(this.g);if(this.f!=ag.ma){c=3*this.g;this.b.Qc(c);this.i=this.A;this.f==ag.gc&&this.b.ac(c);
...
function gg(b,c){var d=c.a,e=Hf(c.a,"EXT-X-MEDIA").filter(function(b){return"SUBTITLES"==hg(b,"TYPE")}.bind(b)).map(function(b){return ig(this,b)}.bind(b));return Promise.all(e).then(function(b){var e=Hf(d,"EXT-X-STREAM-INF").map(function(b){return jg(this,b,c)}.bind(this));return Promise.all(e).then(function(c){return{startTime:0,variants:c.reduce(Cb,[]),textStreams:b}}.bind(this))}.bind(b))}
function jg(b,c,d){var e=Ff(c,"CODECS","avc1.42E01E,mp4a.40.2").split(","),f=c.getAttribute("RESOLUTION"),g=null,h=null,k=Ff(c,"FRAME-RATE"),l=Number(hg(c,"BANDWIDTH"));if(f){var m=f.value.split("x");g=m[0];h=m[1];}d=Hf(d.a,"EXT-X-MEDIA");var r=Ff(c,"AUDIO"),t=Ff(c,"VIDEO");r?d=Jf(d,"AUDIO",r):t&&(d=Jf(d,"VIDEO",t));if(m=kg("text",e)){var u=Ff(c,"SUBTITLES");u&&(u=Jf(d,"SUBTITLES",u),u.length&&(b.v[u[0].id].stream.codecs=m));e.splice(e.indexOf(m),1);}d=d.map(function(b){return lg(this,b,e)}.bind(b));
var w=[],x=[];return Promise.all(d).then(function(b){r?w=b:t&&(x=b);b=!1;if(w.length||x.length)if(w.length)if(hg(c,"URI")==w[0].Yb){var d="audio";b=!0;}else d="video";else d="audio";else 1==e.length?(d=kg("video",e),d=f||k||d?"video":"audio"):(d="video",e=[e.join(",")]);return b?Promise.resolve():mg(this,c,e,d)}.bind(b)).then(function(b){b&&("audio"==b.stream.type?w=[b]:x=[b]);x&&ng(x);w&&ng(w);return og(this,w,x,l,g,h,k)}.bind(b))}
function ng(b){b.forEach(function(b){var c=b.stream.codecs.split(",");c=c.filter(function(b){return"mp4a.40.34"!=b});b.stream.codecs=c.join(",");});}
function og(b,c,d,e,f,g,h){d.forEach(function(b){if(b=b.stream)b.width=Number(f)||void 0,b.height=Number(g)||void 0,b.frameRate=Number(h)||void 0;}.bind(b));c.length||(c=[null]);d.length||(d=[null]);for(var k=[],l=0;l<c.length;l++)for(var m=0;m<d.length;m++){var r=c[l]?c[l].stream:null,t=d[m]?d[m].stream:null,u=c[l]?c[l].drmInfos:null,w=d[m]?d[m].drmInfos:null,x=void 0;if(r&&t)if(u.length&&w.length?0<rc(u,w).length:1)x=rc(u,w);else continue;else r?x=u:t&&(x=w);u=(d[l]?d[l].Yb:"")+" - "+(c[l]?c[l].Yb:
"");b.G[u]||(r=pg(b,r,t,e,x),k.push(r),b.G[u]=r);}return k}function pg(b,c,d,e,f){return{id:b.K++,language:c?c.language:"und",primary:!!c&&c.primary||!!d&&d.primary,audio:c,video:d,bandwidth:e,drmInfos:f,allowedByApplication:!0,allowedByKeySystem:!0}}function ig(b,c){hg(c,"TYPE");return lg(b,c,[]).then(function(b){return b.stream})}
function lg(b,c,d){var e=hg(c,"URI");e=Kf(b.l,e);if(b.a[e])return Promise.resolve(b.a[e]);var f=hg(c,"TYPE").toLowerCase();"subtitles"==f&&(f="text");var g=gd(Ff(c,"LANGUAGE","und")),h=Ff(c,"NAME"),k=c.getAttribute("DEFAULT"),l=c.getAttribute("AUTOSELECT"),m=Ff(c,"CHANNELS");return qg(b,e,d,f,g,!!k||!!l,h,"audio"==f?rg(m):null).then(function(b){if(this.a[e])return this.a[e];this.v[c.id]=b;return this.a[e]=b}.bind(b))}function rg(b){if(!b)return null;b=b.split("/")[0];return parseInt(b,10)}
function mg(b,c,d,e){var f=hg(c,"URI");f=Kf(b.l,f);return b.a[f]?Promise.resolve(b.a[f]):qg(b,f,d,e,"und",!1,null,null).then(function(b){return this.a[f]?this.a[f]:this.a[f]=b}.bind(b))}
function qg(b,c,d,e,f,g,h,k){var l=c;c=Kf(b.l,c);var m,r="",t;return Yf(b,c).then(function(b){m=Qf(this.u,b.data,c);if(1!=m.type)throw new v(2,4,4017);b=m;var f=ag,g=If(b.a,"EXT-X-PLAYLIST-TYPE"),h=If(b.a,"EXT-X-ENDLIST");h=g&&"VOD"==g.value||h;g=g&&"EVENT"==g.value&&!h;g=!h&&!g;h?fg(this,f.ma):(g?fg(this,f.gc):fg(this,f.Wc),b=sg(b.a,"EXT-X-TARGETDURATION"),b=Number(b.value),this.g=Math.max(b,this.g),this.A=Math.min(b,this.A));if(1==d.length)r=d[0];else if(b=kg(e,d),null!=b)r=b;else throw new v(2,
4,4025,d);return tg(this,e,r,m)}.bind(b)).then(function(b){t=b;b=If(m.a,"EXT-X-MEDIA-SEQUENCE");return eg(this,m,b?Number(b.value):0,t,r)}.bind(b)).then(function(b){var c=b[0].startTime,d=b[b.length-1].endTime,u=d-c;b=new T(b);var Ra=ug(m),cg=void 0;"text"==e&&(cg="subtitle");var Gd=[];m.segments.forEach(function(b){b=Hf(b.a,"EXT-X-KEY");Gd.push.apply(Gd,b);});var jb=!1,kb=[],dg=null;Gd.forEach(function(b){if("NONE"!=hg(b,"METHOD")){jb=!0;var c=hg(b,"KEYFORMAT");if(b=(c=vg[c])?c(b):null)b.keyIds.length&&
(dg=b.keyIds[0]),kb.push(b);}});if(jb&&!kb.length)throw new v(2,4,4026);Ra={id:this.K++,createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:b.find.bind(b),getSegmentReference:b.get.bind(b),initSegmentReference:Ra,presentationTimeOffset:0,mimeType:t,codecs:r,kind:cg,encrypted:jb,keyId:dg,language:f,label:h||null,type:e,primary:g,trickModeVideo:null,containsEmsgBoxes:!1,frameRate:void 0,width:void 0,height:void 0,bandwidth:void 0,roles:[],channelsCount:k};this.R[Ra.id]=b;return{stream:Ra,
bb:b,drmInfos:kb,Yb:l,Pb:c,Ad:d,duration:u}}.bind(b))}function ug(b){var c=Hf(b.a,"EXT-X-MAP");if(!c.length)return null;if(1<c.length)throw new v(2,4,4020);c=c[0];var d=hg(c,"URI"),e=Kf(b.uri,d);b=0;d=null;if(c=Ff(c,"BYTERANGE"))b=c.split("@"),c=Number(b[0]),b=Number(b[1]),d=b+c-1;return new O(function(){return[e]},b,d)}
function wg(b,c,d,e,f){var g=d.a,h=Kf(b.uri,d.uri);b=sg(g,"EXTINF").value.split(",");b=f+Number(b[0]);d=0;var k=null;if(g=If(g,"EXT-X-BYTERANGE"))d=g.value.split("@"),g=Number(d[0]),d=d[1]?Number(d[1]):c.a+1,k=d+g-1;return new P(e,f,b,function(){return[h]},d,k)}
function eg(b,c,d,e,f){var g=c.segments,h=[],k=Kf(c.uri,g[0].uri),l=wg(c,null,g[0],d,0),m=ug(c);return xg(b,c.uri,m,l,e,f).then(function(b){k.split("/").pop();for(var e=0;e<g.length;++e){var f=h[h.length-1];f=wg(c,f,g[e],d+e,0==e?b:f.endTime);h.push(f);}return h}.bind(b))}
function yg(b,c){var d=b.c.networkingEngine,e=B(c.c(),b.h.retryParameters),f={},g=c.b;f.Range="bytes="+g+"-"+(g+2048-1);var h={};if(0!=g||null!=c.a)g="bytes="+g+"-",null!=c.a&&(g+=c.a),h.Range=g;e.headers=f;f=d.request(1,e);qb(b.o,f);return f.promise["catch"](function(){Ga("Unable to fetch a partial HLS segment! Falling back to a full segment request, which is expensive!  Your server should support Range requests and CORS preflights.",e.uris[0]);e.headers=h;return d.request(1,e)})}
function xg(b,c,d,e,f,g){if(b.m&&(c=b.a[c].bb.get(e.position)))return Promise.resolve(c.startTime);e=[yg(b,e)];if("video/mp4"==f||"audio/mp4"==f)d?e.push(yg(b,d)):e.push(e[0]);return Promise.all(e).then(function(b){if("video/mp4"==f||"audio/mp4"==f)return zg(b[0].data,b[1].data);if("audio/mpeg"==f)return 0;if("video/mp2t"==f)return Ag(b[0].data);if("application/mp4"==f||0==f.indexOf("text/")){b=b[0].data;var c=Mb(f,g);if(I[c]){var d=new Pc(null);d.f=new I[c];b=d.Jb(b);}else b=0;return b}throw new v(2,
4,4030);}.bind(b))}function zg(b,c){var d=0;(new R).C("moov",S).C("trak",S).C("mdia",S).V("mdhd",function(b){b.s.D(0==b.version?8:16);d=b.s.B();b.na.stop();}).parse(c,!0);if(!d)throw new v(2,4,4030);var e=0,f=!1;(new R).C("moof",S).C("traf",S).V("tfdt",function(b){e=(0==b.version?b.s.B():b.s.Pa())/d;f=!0;b.na.stop();}).parse(b,!0);if(!f)throw new v(2,4,4030);return e}
function Ag(b){function c(){throw new v(2,4,4030);}b=new Q(new DataView(b),0);for(var d=0,e=0;;)if(d=b.U(),e=b.$(),71!=e&&c(),b.$a()&16384||c(),e=(b.$()&48)>>4,0!=e&&2!=e||c(),3==e&&(e=b.$(),b.D(e)),1!=b.B()>>8)b.seek(d+188),e=b.$(),71!=e&&(b.seek(d+192),e=b.$()),71!=e&&(b.seek(d+204),e=b.$()),71!=e&&c(),b.Mc(1);else return b.D(3),d=b.$()>>6,0!=d&&1!=d||c(),0==b.$()&&c(),d=b.$(),e=b.$a(),b=b.$a(),(1073741824*((d&14)>>1)+((e&65534)<<14|(b&65534)>>1))/9E4}
function kg(b,c){for(var d=Bg[b],e=0;e<d.length;e++)for(var f=0;f<c.length;f++)if(d[e].test(c[f].trim()))return c[f].trim();return"text"==b?"":null}
function tg(b,c,d,e){e=Kf(e.uri,e.segments[0].uri);var f=(new Ja(e)).Y.split(".").pop(),g=Cg[c][f];if(g)return Promise.resolve(g);if("text"==c)return d&&"vtt"!=d?Promise.resolve("application/mp4"):Promise.resolve("text/vtt");c=B([e],b.h.retryParameters);c.method="HEAD";c=b.c.networkingEngine.request(1,c);qb(b.o,c);return c.promise.then(function(b){b=b.headers["content-type"];if(!b)throw new v(2,4,4021,f);return b.split(";")[0]})}
function hg(b,c){var d=b.getAttribute(c);if(!d)throw new v(2,4,4023,c);return d.value}function sg(b,c){var d=If(b,c);if(!d)throw new v(2,4,4024,c);return d}function Yf(b,c){var d=b.c.networkingEngine.request(0,B([c],b.h.retryParameters));qb(b.o,d);return d.promise}
var Bg={audio:[/^vorbis$/,/^opus$/,/^flac$/,/^mp4a/,/^[ae]c-3$/],video:[/^avc/,/^hev/,/^hvc/,/^vp0?[89]/,/^av1$/],text:[/^vtt$/,/^wvtt/,/^stpp/]},Cg={audio:{mp4:"audio/mp4",m4s:"audio/mp4",m4i:"audio/mp4",m4a:"audio/mp4",ts:"video/mp2t"},video:{mp4:"video/mp4",m4s:"video/mp4",m4i:"video/mp4",m4v:"video/mp4",ts:"video/mp2t"},text:{mp4:"application/mp4",m4s:"application/mp4",m4i:"application/mp4",vtt:"text/vtt",ttml:"application/ttml+xml"}};
Wf.prototype.L=function(){this.c&&(this.j=null,this.update().then(function(){$f(this,this.i);}.bind(this))["catch"](function(b){this.c&&(b.severity=1,this.c.onError(b),$f(this,0));}.bind(this)));};function $f(b,c){null!=b.i&&null!=c&&(b.j=window.setTimeout(b.L.bind(b),1E3*c));}function fg(b,c){b.f=c;b.b&&b.b.yb(b.f==ag.ma);b.f==ag.ma&&null!=b.j&&(window.clearTimeout(b.j),b.j=null,b.i=null);}
var vg={"urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed":function(b){var c=hg(b,"METHOD");if("SAMPLE-AES-CENC"!=c&&"SAMPLE-AES-CTR"!=c)return null;c=hg(b,"URI");c=Vf.parse(c);c=new Uint8Array(c.data);c=Gb("com.widevine.alpha",[{initDataType:"cenc",initData:c}]);if(b=Ff(b,"KEYID"))c.keyIds=[b.substr(2).toLowerCase()];return c}},Xf="VOD",ag={ma:Xf,Wc:"EVENT",gc:"LIVE"};kf.m3u8=Wf;jf["application/x-mpegurl"]=Wf;jf["application/vnd.apple.mpegurl"]=Wf;function Dg(b,c,d,e){this.a=b;this.u=c;this.o=d;this.v=e;this.h=new C;this.b=null;this.g=!1;this.m=b.readyState;this.c=!1;this.j=this.A=-1;this.f=this.i=!1;c=this.l.bind(this);D(this.h,b,"waiting",c);this.b=new Sb(c);Ub(this.b,.25);}Dg.prototype.destroy=function(){var b=this.h.destroy();this.v=this.u=this.a=this.h=null;null!=this.b&&(this.b.cancel(),this.b=null);return b};Dg.prototype.Za=function(){this.f=!0;this.l();};
Dg.prototype.l=function(){if(0!=this.a.readyState){if(this.a.seeking){if(!this.g)return}else this.g=!1;if(!this.a.paused){this.a.readyState!=this.m&&(this.c=!1,this.m=this.a.readyState);var b=this.o.smallGapLimit,c=this.a.currentTime,d=this.a.buffered;a:{if(d&&d.length&&!(1==d.length&&1E-6>d.end(0)-d.start(0))){var e=.1;/(Edge\/|Trident\/|Tizen)/.test(navigator.userAgent)&&(e=.5);for(var f=0;f<d.length;f++)if(d.start(f)>c&&(0==f||d.end(f-1)-c<=e)){e=f;break a}}e=null;}if(null==e){if(d=this.a.currentTime,
...
!c.defaultPrevented&&(h=!0)),!b&&!h)||(0!=e&&d.end(e-1),this.a.currentTime=f);}}}}};function Eg(b,c,d){this.a=b;this.i=c;this.h=d;this.c=new C;this.f=1;this.g=!1;this.b=null;0<b.readyState?this.Bc():Ab(this.c,b,"loadedmetadata",this.Bc.bind(this));D(this.c,b,"ratechange",this.Rd.bind(this));}n=Eg.prototype;n.destroy=function(){var b=this.c.destroy();this.c=null;null!=this.b&&(this.b.cancel(),this.b=null);this.i=this.a=null;return b};function Fg(b){return 0<b.a.readyState?b.a.currentTime:b.h}function Gg(b,c){0<b.a.readyState?Hg(b,b.a.currentTime,c):(b.h=c,setTimeout(b.i,0));}n.Ta=function(){return this.f};
function Ig(b,c){null!=b.b&&(b.b.cancel(),b.b=null);b.f=c;b.a.playbackRate=b.g||0>c?0:c;!b.g&&0>c&&(b.b=new Sb(function(){b.a.currentTime+=c/4;}),Ub(b.b,.25));}n.Rd=function(){var b=this.g||0>this.f?0:this.f;this.a.playbackRate&&this.a.playbackRate!=b&&Ig(this,this.a.playbackRate);};n.Bc=function(){.001>Math.abs(this.a.currentTime-this.h)?this.Cc():(Ab(this.c,this.a,"seeking",this.Cc.bind(this)),this.a.currentTime=0==this.a.currentTime?this.h:this.a.currentTime);};
n.Cc=function(){var b=this;D(this.c,this.a,"seeking",function(){return b.i()});};function Hg(b,c,d){function e(){!b.a||10<=f++||b.a.currentTime!=c||(b.a.currentTime=d,setTimeout(e,100));}b.a.currentTime=d;var f=0;setTimeout(e,100);}function Jg(b,c,d,e,f,g){this.c=b;this.b=c;this.h=d;this.i=f;this.f=null;this.g=new Dg(b,c,d,g);c=this.Td.bind(this);d=this.b.presentationTimeline;null==e?e=Infinity>d.P()?d.Ia():d.ia():0>e&&(e=d.ia()+e);e=Kg(this,Lg(this,e));this.a=new Eg(b,c,e);this.f=new Sb(this.Qd.bind(this));Ub(this.f,.25);}n=Jg.prototype;n.destroy=function(){var b=Promise.all([this.a.destroy(),this.g.destroy()]);this.g=this.a=null;null!=this.f&&(this.f.cancel(),this.f=null);this.i=this.h=this.b=this.c=null;return b};
function Mg(b){var c=Fg(b.a);0<b.c.readyState&&(b.c.paused||(c=Lg(b,c)));return c}n.Ta=function(){return this.a.Ta()};n.Za=function(){this.g.Za();};n.Qd=function(){if(0!=this.c.readyState&&!this.c.paused){var b=this.c.currentTime,c=this.b.presentationTimeline,d=c.Ia();c=c.ia();3>c-d&&(d=c-3);b<d&&(b=Ng(this,b),this.c.currentTime=b);}};n.Td=function(){var b=this.g;b.g=!0;b.f=!1;b.c=!1;b=Fg(this.a);var c=Ng(this,b);.001<Math.abs(c-b)?Gg(this.a,c):this.i();};
function Kg(b,c){var d=b.b.presentationTimeline.P();return c>=d?d-b.h.durationBackoff:c}function Ng(b,c){var d=tc.bind(null,b.c.buffered),e=Math.max(b.b.minBufferTime||0,b.h.rebufferingGoal),f=b.b.presentationTimeline,g=f.Ia(),h=f.ia(),k=f.P();3>h-g&&(g=h-3);var l=f.Ua(e),m=f.Ua(5);e=f.Ua(e+5);return c>=k?Kg(b,c):c>h?h:c<g?d(m)?m:e:c>=l||d(c)?c:e}function Lg(b,c){var d=b.b.presentationTimeline.Ia();if(c<d)return d;d=b.b.presentationTimeline.ia();return c>d?d:c}function Og(b,c,d,e,f,g,h){this.a=b;this.v=c;this.g=d;this.u=e;this.l=f;this.h=g;this.A=h;this.c=[];this.j=new C;this.b=!1;this.i=-1;this.f=null;Pg(this);}Og.prototype.destroy=function(){var b=this.j?this.j.destroy():Promise.resolve();this.j=null;Qg(this);this.A=this.h=this.l=this.u=this.g=this.v=this.a=null;this.c=[];return b};
Og.prototype.o=function(b){if(!this.c.some(function(c){return c.info.schemeIdUri==b.schemeIdUri&&c.info.startTime==b.startTime&&c.info.endTime==b.endTime})){var c={info:b,status:1};this.c.push(c);var d=new E("timelineregionadded",{detail:Rg(b)});this.h(d);this.m(!0,c);}};function Rg(b){var c=nb(b);c.eventElement=b.eventElement;return c}
Og.prototype.m=function(b,c){var d=c.info.startTime>this.a.currentTime?1:c.info.endTime<this.a.currentTime?3:2,e=2==c.status,f=2==d;if(d!=c.status){if(!b||e||f)e||this.h(new E("timelineregionenter",{detail:Rg(c.info)})),f||this.h(new E("timelineregionexit",{detail:Rg(c.info)}));c.status=d;}};function Pg(b){Qg(b);b.f=window.setTimeout(b.G.bind(b),250);}function Qg(b){b.f&&(window.clearTimeout(b.f),b.f=null);}
Og.prototype.G=function(){this.f=null;Pg(this);var b=Cd(this.g,this.a.currentTime);b!=this.i&&(-1!=this.i&&this.A(),this.i=b);b=uc(this.a.buffered,this.a.currentTime);var c=sc(this.a.buffered),d=this.g.presentationTimeline,e=d.wa();c=d.N()&&c>=e;d=this.v;d=d.g?"ended"==d.g.readyState:!0;c=c||this.a.ended||d;this.b?(d=Math.max(this.g.minBufferTime||0,this.u.rebufferingGoal),(c||b>=d)&&0!=this.b&&(this.b=!1,this.l(!1))):!c&&.5>b&&1!=this.b&&(this.b=!0,this.l(!0));this.c.forEach(this.m.bind(this,!1));};function Sg(b,c){this.a=c;this.b=b;this.g=null;this.i=1;this.m=Promise.resolve();this.h=[];this.j={};this.c={};this.o=!1;this.A=null;this.v=this.f=this.l=!1;this.u=0;}n=Sg.prototype;n.destroy=function(){for(var b in this.c)Tg(this.c[b]);this.g=this.c=this.j=this.h=this.m=this.b=this.a=null;this.f=!0;return Promise.resolve()};
n.configure=function(b){this.g=b;this.A=new Ya({maxAttempts:Math.max(b.retryParameters.maxAttempts,2),baseDelay:b.retryParameters.baseDelay,backoffFactor:b.retryParameters.backoffFactor,fuzzFactor:b.retryParameters.fuzzFactor,timeout:0},!0);};n.init=function(){var b=Mg(this.a.Na);b=this.a.wc(this.b.periods[Cd(this.b,b)]);return b.variant||b.text?Ug(this,b).then(function(){!this.f&&this.a&&this.a.Hd&&this.a.Hd();}.bind(this)):Promise.reject(new v(2,5,5005))};
function V(b){var c=Mg(b.a.Na);return b.b.periods[Cd(b.b,c)]}function Vg(b){var c=b.c.video||b.c.audio;return c?b.b.periods[c.ya]:null}function Wg(b){return Xg(b,"audio")}function Yg(b){return Xg(b,"video")}function Xg(b,c){var d=b.c[c];return d?d.oa||d.stream:null}
function Zg(b,c){$c(b.a.J,"text");b.u++;b.v=!1;var d=b.u;return b.a.J.init({text:c},!1).then(function(){return $g(b,[c])}).then(function(){if(!b.f&&b.u==d&&!b.c.text&&!b.v){var e=Mg(b.a.Na);b.c.text=ah(c,Cd(b.b,e));bh(b,b.c.text,0);}})}function ch(b){b.v=!0;b.c.text&&(Tg(b.c.text),delete b.c.text);}function dh(b,c){var d=b.c.video;if(d){var e=d.stream;if(e)if(c){var f=e.trickModeVideo;f&&!d.oa&&(eh(b,f,!1),d.oa=e);}else if(e=d.oa)d.oa=null,eh(b,e,!0);}}
function fh(b,c,d){c.video&&eh(b,c.video,d);c.audio&&eh(b,c.audio,d);}function eh(b,c,d){var e=b.c[c.type];if(!e&&"text"==c.type&&b.g.ignoreTextStreamFailures)Zg(b,c);else if(e){var f=Dd(b.b,c);d&&f!=e.ya?gh(b):(e.oa&&(c.trickModeVideo?(e.oa=c,c=c.trickModeVideo):e.oa=null),(f=b.h[f])&&f.Qa&&(f=b.j[c.id])&&f.Qa&&e.stream!=c&&("text"==c.type&&Tc(b.a.J,Mb(c.mimeType,c.codecs)),e.stream=c,e.vb=!0,d&&(e.ua?e.zb=!0:e.za?(e.ra=!0,e.zb=!0):(Tg(e),hh(b,e,!0)))));}}
function ih(b){var c=Mg(b.a.Na);Object.keys(b.c).every(function(b){var d=this.a.J;"text"==b?(b=d.a,b=c>=b.a&&c<b.b):(b=Vc(d,b),b=tc(b,c));return b}.bind(b))||gh(b);}function gh(b){for(var c in b.c){var d=b.c[c];d.ua||d.ra||(d.za?d.ra=!0:null==Uc(b.a.J,c)?null==d.qa&&bh(b,d,0):(Tg(d),hh(b,d,!1)));}}
function Ug(b,c,d){var e=Mg(b.a.Na),f=Cd(b.b,e),g={},h=[];c.variant&&c.variant.audio&&(g.audio=c.variant.audio,h.push(c.variant.audio));c.variant&&c.variant.video&&(g.video=c.variant.video,h.push(c.variant.video));c.text&&(g.text=c.text,h.push(c.text));return b.a.J.init(g,b.g.forceTransmuxTS).then(function(){if(!b.f){var c=b.b.presentationTimeline.P();Infinity>c?b.a.J.ga(c):b.a.J.ga(Math.pow(2,32));return $g(b,h)}}).then(function(){if(!b.f)for(var c in g){var e=g[c];b.c[c]||(b.c[c]=ah(e,f,d),bh(b,
b.c[c],0));}})}function ah(b,c,d){return{stream:b,type:b.type,Ka:null,ja:null,oa:null,vb:!0,ya:c,endOfStream:!1,za:!1,qa:null,ra:!1,zb:!1,ua:!1,Xb:!1,Va:!1,Kc:d||0}}
function jh(b,c){var d=b.h[c];if(d)return d.promise;d={promise:new y,Qa:!1};b.h[c]=d;var e=b.b.periods[c].variants.map(function(b){var c=[];b.audio&&c.push(b.audio);b.video&&c.push(b.video);b.video&&b.video.trickModeVideo&&c.push(b.video.trickModeVideo);return c}).reduce(Cb,[]).filter(Fb);e.push.apply(e,b.b.periods[c].textStreams);b.m=b.m.then(function(){if(!this.f)return $g(this,e)}.bind(b)).then(function(){this.f||(this.h[c].promise.resolve(),this.h[c].Qa=!0);}.bind(b))["catch"](function(b){this.f||
(this.h[c].promise.reject(),delete this.h[c],this.a.onError(b));}.bind(b));return d.promise}
function $g(b,c){c.map(function(b){return b.id}).filter(Fb);for(var d=[],e=0;e<c.length;++e){var f=c[e],g=b.j[f.id];g?d.push(g.promise):(b.j[f.id]={promise:new y,Qa:!1},d.push(f.createSegmentIndex()));}return Promise.all(d).then(function(){if(!this.f)for(var b=0;b<c.length;++b){var d=this.j[c[b].id];d.Qa||(d.promise.resolve(),d.Qa=!0);}}.bind(b))["catch"](function(b){if(!this.f){for(var d=0;d<c.length;d++)this.j[c[d].id].promise.reject(),delete this.j[c[d].id];return Promise.reject(b)}}.bind(b))}
n.Oe=function(b){if(!this.f&&!b.za&&null!=b.qa&&!b.ua)if(b.qa=null,b.ra)hh(this,b,b.zb);else{try{var c=kh(this,b);null!=c&&(bh(this,b,c),b.Va=!1);}catch(d){lh(this,d);return}c=Jb(this.c);mh(this,b);c.every(function(b){return b.endOfStream})&&this.a.J.endOfStream().then(function(){if(!this.f){var b=this.a.J.P();b<this.b.presentationTimeline.P()&&this.b.presentationTimeline.ga(b);}}.bind(this));}};
function kh(b,c){var d=Mg(b.a.Na),e=nh(b,c,d),f=Dd(b.b,c.stream),g=Cd(b.b,e),h=Xc(b.a.J,c.type,d),k=Math.max(b.i*Math.max(b.b.minBufferTime||0,b.g.rebufferingGoal),b.i*b.g.bufferingGoal);if(e>=b.b.presentationTimeline.P())return c.endOfStream=!0,null;c.endOfStream=!1;c.ya=g;if(g!=f)return null;if(h>=k)return.5;g=Wc(b.a.J,c.type);g=oh(b,c,d,g,f);if(!g)return 1;var l=Infinity;Jb(b.c).forEach(function(c){l=Math.min(l,nh(b,c,d));});if(e>=l+b.b.presentationTimeline.a)return 1;c.Kc=0;ph(b,c,d,f,g);return null}
function nh(b,c,d){return c.Ka&&c.ja?b.b.periods[Dd(b.b,c.Ka)].startTime+c.ja.endTime:Math.max(d,c.Kc)}function oh(b,c,d,e,f){if(c.ja&&c.stream==c.Ka)return qh(b,c,f,c.ja.position+1);d=c.ja?c.stream.findSegmentPosition(Math.max(0,b.b.periods[Dd(b.b,c.Ka)].startTime+c.ja.endTime-b.b.periods[f].startTime)):c.stream.findSegmentPosition(Math.max(0,(e||d)-b.b.periods[f].startTime));if(null==d)return null;var g=null;null==e&&(g=qh(b,c,f,Math.max(0,d-1)));return g||qh(b,c,f,d)}
function qh(b,c,d,e){d=b.b.periods[d];c=c.stream.getSegmentReference(e);if(!c)return null;e=b.b.presentationTimeline;b=e.Ja();e=e.wa();return d.startTime+c.endTime<b||d.startTime+c.startTime>e?null:c}
function ph(b,c,d,e,f){var g=b.b.periods[e],h=c.stream,k=b.b.presentationTimeline.P(),l=b.b.periods[e+1];e=rh(b,c,e,Math.max(0,g.startTime-.1),l?l.startTime:k);c.za=!0;c.vb=!1;k=sh(b,f);Promise.all([e,k]).then(function(b){if(!this.f&&!this.l)return th(this,c,d,g,h,f,b[1])}.bind(b)).then(function(){this.f||this.l||(c.za=!1,c.Xb=!1,c.ra||this.a.Za(),bh(this,c,0),uh(this,h));}.bind(b))["catch"](function(b){this.f||this.l||(c.za=!1,"text"==c.type&&this.g.ignoreTextStreamFailures?delete this.c.text:3017==
b.code?vh(this,c,b):(c.Va=!0,b.severity=2,lh(this,b)));}.bind(b));}function vh(b,c,d){if(!Jb(b.c).some(function(b){return b!=c&&b.Xb})){var e=Math.round(100*b.i);if(20<e)b.i-=.2;else if(4<e)b.i-=.04;else{c.Va=!0;b.l=!0;b.a.onError(d);return}c.Xb=!0;}bh(b,c,4);}
function rh(b,c,d,e,f){if(!c.vb)return Promise.resolve();d=ad(b.a.J,c.type,b.b.periods[d].startTime-c.stream.presentationTimeOffset,e,f);if(!c.stream.initSegmentReference)return d;b=sh(b,c.stream.initSegmentReference).then(function(b){if(!this.f)return Yc(this.a.J,c.type,b,null,null)}.bind(b))["catch"](function(b){c.vb=!0;return Promise.reject(b)});return Promise.all([d,b])}
function th(b,c,d,e,f,g,h){f.containsEmsgBoxes&&(new R).V("emsg",b.de.bind(b,e,g)).parse(h);return wh(b,c,d).then(function(){if(!this.f)return Yc(this.a.J,c.type,h,g.startTime,g.endTime)}.bind(b)).then(function(){if(!this.f)return c.Ka=f,c.ja=g,Promise.resolve()}.bind(b))}
n.de=function(b,c,d){var e=d.s.Vb(),f=d.s.Vb(),g=d.s.B(),h=d.s.B(),k=d.s.B(),l=d.s.B();d=d.s.Aa(d.s.F.byteLength-d.s.U());b=b.startTime+c.startTime+h/g;if("urn:mpeg:dash:event:2012"==e)this.a.Jd();else this.a.onEvent(new E("emsg",{detail:{startTime:b,endTime:b+k/g,schemeIdUri:e,value:f,timescale:g,presentationTimeDelta:h,eventDuration:k,id:l,messageData:d}}));};
function wh(b,c,d){var e=Math.max(b.g.bufferBehind,b.b.presentationTimeline.a),f=Uc(b.a.J,c.type);if(null==f)return Promise.resolve();d=d-f-e;return 0>=d?Promise.resolve():b.a.J.remove(c.type,f,f+d).then(function(){}.bind(b))}function uh(b,c){if(!b.o&&(b.o=Jb(b.c).every(function(b){return"text"==b.type?!0:!b.ra&&!b.ua&&b.ja}),b.o)){var d=Dd(b.b,c);b.h[d]||jh(b,d).then(function(){this.f||this.a.vc();}.bind(b))["catch"](Db);for(d=0;d<b.b.periods.length;++d)jh(b,d)["catch"](Db);b.a.Wd&&b.a.Wd();}}
function mh(b,c){if(c.ya!=Dd(b.b,c.stream)){var d=c.ya,e=Jb(b.c);e.every(function(b){return b.ya==d})&&e.every(xh)&&jh(b,d).then(function(){if(!this.f&&e.every(function(b){var c=Dd(this.b,b.stream);return xh(b)&&b.ya==d&&c!=d}.bind(this))){var b=this.b.periods[d],c=this.a.wc(b),h={};c.variant&&c.variant.video&&(h.video=c.variant.video);c.variant&&c.variant.audio&&(h.audio=c.variant.audio);c.text&&(h.text=c.text);for(var k in this.c)if(!h[k]&&"text"!=k){this.a.onError(new v(2,5,5005));return}for(var l in h)if(!this.c[l])if("text"==
l)Ug(this,{text:h.text},b.startTime),delete h[l];else{this.a.onError(new v(2,5,5005));return}for(var m in this.c)(b=h[m])?(eh(this,b,!1),bh(this,this.c[m],0)):delete this.c[m];this.a.vc();}}.bind(b))["catch"](Db);}}function xh(b){return!b.za&&null==b.qa&&!b.ra&&!b.ua}function sh(b,c){var d=B(c.c(),b.g.retryParameters);if(0!=c.b||null!=c.a){var e="bytes="+c.b+"-";null!=c.a&&(e+=c.a);d.headers.Range=e;}return b.a.Xa.request(1,d).promise.then(function(b){return b.data})}
function hh(b,c,d){c.ra=!1;c.zb=!1;c.ua=!0;$c(b.a.J,c.type).then(function(){if(!this.f&&d)return this.a.J.flush(c.type)}.bind(b)).then(function(){this.f||(c.Ka=null,c.ja=null,c.ua=!1,c.endOfStream=!1,bh(this,c,0));}.bind(b));}function bh(b,c,d){c.qa=window.setTimeout(b.Oe.bind(b,c),1E3*d);}function Tg(b){null!=b.qa&&(window.clearTimeout(b.qa),b.qa=null);}function lh(b,c){$a(b.A).then(function(){this.f||(this.a.onError(c),c.handled||this.g.failureCallback(c));}.bind(b));}function yh(b,c,d,e,f,g){if(200<=d&&299>=d&&202!=d)return f&&(e=f),{uri:e,data:c,headers:b,fromCache:!!b["x-shaka-from-cache"]};f=null;try{f=Qb(c);}catch(h){}throw new v(401==d||403==d?2:1,1,1001,e,d,f,b,g);}function W(b,c,d){var e=new W.b;Lb(c.headers,function(b,c){e.append(b,c);});var f=new W.a,g={body:c.body||void 0,headers:e,method:c.method,signal:f.signal,credentials:c.allowCrossSiteCredentials?"include":void 0},h=!1,k=!1,l;c.retryParameters.timeout&&(l=setTimeout(function(){k=!0;f.abort();},c.retryParameters.timeout));c=W.c;g=c(b,g).then(function(c){clearTimeout(l);return c.arrayBuffer().then(function(e){var f={};c.headers.forEach(function(b,c){f[c.trim()]=b;});return yh(f,e,c.status,b,c.url,d)})})["catch"](function(c){clearTimeout(l);
return h?Promise.reject(new v(1,1,7001,b,d)):k?Promise.reject(new v(1,1,1003,b,d)):void 0==c.severity?Promise.reject(new v(1,1,1002,b,c,d)):Promise.reject(c)});return new z(g,function(){h=!0;f.abort();return Promise.resolve()})}q("shaka.net.HttpFetchPlugin",W);W.isSupported=function(){return!(!window.fetch||!window.AbortController)};W.isSupported=W.isSupported;W.c=window.fetch;W.a=window.AbortController;W.b=window.Headers;W.isSupported()&&(sb("http",W,2),sb("https",W,2));function zh(b,c,d){var e=new zh.f,f=new Promise(function(f,h){e.open(c.method,b,!0);e.responseType="arraybuffer";e.timeout=c.retryParameters.timeout;e.withCredentials=c.allowCrossSiteCredentials;e.onabort=function(){h(new v(1,1,7001,b,d));};e.onload=function(c){c=c.target;var e=c.getAllResponseHeaders().trim().split("\r\n").reduce(function(b,c){var d=c.split(": ");b[d[0].toLowerCase()]=d.slice(1).join(": ");return b},{});try{var g=yh(e,c.response,c.status,b,c.responseURL,d);f(g);}catch(t){h(t);}};e.onerror=
function(c){h(new v(1,1,1002,b,c,d));};e.ontimeout=function(){h(new v(1,1,1003,b,d));};for(var g in c.headers)e.setRequestHeader(g.toLowerCase(),c.headers[g]);e.send(c.body);});return new z(f,function(){e.abort();return Promise.resolve()})}q("shaka.net.HttpXHRPlugin",zh);zh.f=window.XMLHttpRequest;sb("http",zh,1);sb("https",zh,1);function Ah(){this.b=null;this.a=[];}function Bh(){if(!window.indexedDB)return Promise.resolve();var b=window.indexedDB.deleteDatabase("shaka_offline_db"),c=new y;b.onsuccess=function(){c.resolve();};b.onerror=Ch.bind(null,b,c);return c}Ah.prototype.init=function(b){var c=this;return Dh(b).then(function(b){c.b=b;})};
Ah.prototype.destroy=function(){var b=this;return Promise.all(this.a.map(function(b){try{b.transaction.abort();}catch(d){}return b.promise["catch"](function(){})})).then(function(){b.b&&(b.b.close(),b.b=null);})};Ah.prototype.Sa=function(b){return Eh(this,"manifest-v3",b)};function Fh(b,c){return Gh(b,c)}function Hh(b,c,d){return Ih(b,"manifest-v3",c,d)}function Jh(b,c){return Kh(b,"segment-v3",c)}
function Eh(b,c,d){var e;return Lh(b,c,"readonly",function(b){e=b.get(d);}).then(function(){return e.result})}function Gh(b,c){return Lh(b,"manifest-v3","readonly",function(b){b.openCursor().onsuccess=function(b){if(b=b.target.result)c(b.key,b.value),b["continue"]();};})}function Mh(b,c,d){return Lh(b,"manifest-v3","readwrite",function(b){b.put(d,c);})}function Kh(b,c,d){var e;return Lh(b,c,"readwrite",function(b){b.add(d).onsuccess=function(b){e=b.target.result;};}).then(function(){return e})}
function Ih(b,c,d,e){return Lh(b,c,"readwrite",function(b){d.forEach(function(c){b["delete"](c).onsuccess=function(){e&&e(c);};});})}function Lh(b,c,d,e){var f={transaction:b.b.transaction([c],d),promise:new y};f.transaction.oncomplete=function(){b.a.splice(b.a.indexOf(f),1);f.promise.resolve();};f.transaction.onabort=function(c){b.a.splice(b.a.indexOf(f),1);Ch(f.transaction,f.promise,c);};f.transaction.onerror=Nh();c=f.transaction.objectStore(c);e(c);b.a.push(f);return f.promise}
function Oh(b,c,d){function e(){var c=g.pop();c?f(c,e):(b.reject(new v(1,9,9010,h)),d.abort());}function f(b,c){d.objectStore(b).openCursor().onsuccess=function(b){(b=b.target.result)?(h.push(b.value.originalManifestUri),b["continue"]()):c();};}var g=["manifest","manifest-v2"].filter(function(b){return c.objectStoreNames.contains(b)}),h=[];e();}function Ch(b,c,d){c.reject(b.error?new v(2,9,9001,b.error):new v(2,9,7001));d.preventDefault();}
function Dh(b){function c(){return new Promise(function(b){return setTimeout(b,1E3)})}var d=b||0,e=0<d;b=Ph(e);for(var f=0;f<d;f++)b=b.then(function(b){return b?b:c().then(function(){return Ph(e)})});return b.then(function(b){return b?b:Promise.reject(new v(2,9,9001,"Failed to issue upgrade after "+d+" retries"))})}
function Ph(b){var c=new y,d=!1,e=window.indexedDB.open("shaka_offline_db",3);e.onupgradeneeded=function(b){var e=b.target.transaction,f=e.db,k={autoIncrement:!0};0==b.oldVersion?(f.createObjectStore("manifest-v3",k),f.createObjectStore("segment-v3",k)):Oh(c,f,e);d=!0;};e.onsuccess=function(e){e=e.target.result;b&&!d?(e.close(),c.resolve(null)):c.resolve(e);};e.onerror=Nh(function(){c.reject(new v(2,9,9001,"Failed to open IndexedDB Connection",e.error.message));});return c}
function Nh(b){return function(c){c.preventDefault();b&&b(c);}}function Qh(b){this.a={};this.c=Promise.resolve();this.h=!1;this.i=b;this.f=this.b=this.g=0;}Qh.prototype.destroy=function(){this.h=!0;var b=this.c["catch"](function(){});this.c=Promise.resolve();return b};function Rh(b,c,d,e,f){b.a[c]=b.a[c]||[];b.a[c].push({request:d,lc:e,Dd:f});}
function Sh(b,c){var d=Jb(b.a);b.a={};d.forEach(function(c){c.forEach(function(c){b.b+=c.lc;});});var e=Promise.resolve().then(function(){Th(b);return Promise.all(d.map(function(d){return Uh(b,c,d)}))});b.c=b.c.then(function(){return e});return e}function Uh(b,c,d){var e=Promise.resolve();d.forEach(function(d){e=e.then(function(){Th(b);return Vh(b,c,d)});});return e}
function Vh(b,c,d){return Promise.resolve().then(function(){Th(b);return c.request(1,d.request).promise}).then(function(c){Th(b);b.g+=d.lc;b.f+=c.data.byteLength;b.i(b.b?b.g/b.b:0,b.f);return d.Dd(c.data)})}function Th(b){if(b.h)throw new v(2,9,7001);}function Wh(b,c){var d=this;this.c=b;this.b=b.objectStore(c);this.a=new y;b.onabort=function(b){b.preventDefault();d.a.reject();};b.onerror=function(b){b.preventDefault();d.a.reject();};b.oncomplete=function(){d.a.resolve();};}Wh.prototype.abort=function(){try{this.c.abort();}catch(b){}return this.a["catch"](function(){})};Wh.prototype.store=function(){return this.b};Wh.prototype.promise=function(){return this.a};function Xh(b){this.b=b;this.a=[];}Xh.prototype.destroy=function(){return Promise.all(this.a.map(function(b){return b.abort()}))};function Yh(b,c,d){d=b.b.transaction([c],d);var e=new Wh(d,c);b.a.push(e);e.promise().then(function(){ib(b.a,e);},function(){ib(b.a,e);});return e}q("shaka.offline.StorageMuxer.register",function(b,c){Zh[b]=c;});q("shaka.offline.StorageMuxer.unregister",function(b){delete Zh[b];});var Zh={};function $h(b,c,d,e){this.a=new Xh(b);this.c=c;this.b=d;this.f=e;}n=$h.prototype;n.destroy=function(){return this.a.destroy()};n.hasFixedKeySpace=function(){return this.f};n.addSegments=function(b){return ai(this,this.c,b)};n.removeSegments=function(b){return bi(this,this.c,b)};n.getSegments=function(b){return ci(this,this.c,b)};n.addManifests=function(b){return ai(this,this.b,b)};
n.updateManifestExpiration=function(b,c){var d=Yh(this.a,this.b,"readwrite"),e=d.store();e.get(b).onsuccess=function(d){if(d=d.target.result)d.expiration=c,e.put(d,b);};return d.promise()};n.removeManifests=function(b){return bi(this,this.b,b)};n.getManifests=function(b){return ci(this,this.b,b)};n.getAllManifests=function(){var b=Yh(this.a,this.b,"readonly"),c={};b.store().openCursor().onsuccess=function(b){if(b=b.target.result)c[b.key]=b.value,b["continue"]();};return b.promise().then(function(){return c})};
function ai(b,c,d){if(b.f)return Promise.reject(new v(1,9,9011,"Cannot add new value to "+c));b=Yh(b.a,c,"readwrite");var e=b.store(),f=[];d.forEach(function(b){e.add(b).onsuccess=function(b){f.push(b.target.result);};});return b.promise().then(function(){return f})}function bi(b,c,d){b=Yh(b.a,c,"readwrite");var e=b.store();d.forEach(function(b){e["delete"](b);});return b.promise()}
function ci(b,c,d){b=Yh(b.a,c,"readonly");var e=b.store(),f={},g=[];d.forEach(function(b){var c=e.get(b);c.onsuccess=function(){void 0==c.result&&g.push(b);f[b]=c.result;};});return b.promise().then(function(){return g.length?Promise.reject(new v(1,9,9012,"Could not find values for "+g)):d.map(function(b){return f[b]})})}function di(){this.c=this.b=this.a=this.f=null;}
di.prototype.init=function(){var b=this,c=new y,d=window.indexedDB.open("shaka_offline_db",3);d.onsuccess=function(d){d=d.target.result;b.f=d;b.a=null;var e=d.objectStoreNames;e=e.contains("manifest-v2")&&e.contains("segment-v2")?new $h(d,"segment-v2","manifest-v2",!0):null;b.b=e;e=d.objectStoreNames;d=e.contains("manifest-v3")&&e.contains("segment-v3")?new $h(d,"segment-v3","manifest-v3",!1):null;b.c=d;c.resolve();};d.onupgradeneeded=function(b){b=b.target.result;var c={autoIncrement:!0};b.createObjectStore("manifest-v3",
c);b.createObjectStore("segment-v3",c);};d.onerror=function(b){c.reject(new v(2,9,9001,d.error));b.preventDefault();};return c};di.prototype.destroy=function(){var b=this;return ka(function d(){return ya(d,function(d){switch(d.H){case 1:if(!b.a){d.X(2);break}return p(d,b.a.destroy(),2);case 2:if(!b.b){d.X(4);break}return p(d,b.b.destroy(),4);case 4:if(!b.c){d.X(6);break}return p(d,b.c.destroy(),6);case 6:b.f.close(),d.H=0;}})}())};
di.prototype.getCells=function(){var b={};this.a&&(b.v1=this.a);this.b&&(b.v2=this.b);this.c&&(b.v3=this.c);return b};di.prototype.erase=function(){var b=this;return ka(function d(){return ya(d,function(d){switch(d.H){case 1:if(!b.a){d.X(2);break}return p(d,b.a.destroy(),2);case 2:if(!b.b){d.X(4);break}return p(d,b.b.destroy(),4);case 4:if(!b.c){d.X(6);break}return p(d,b.c.destroy(),6);case 6:return b.f&&b.f.close(),p(d,ei(),8);case 8:return b.f=null,b.a=null,b.b=null,b.c=null,p(d,b.init(),0)}})}())};
function ei(){var b=new y,c=window.indexedDB.deleteDatabase("shaka_offline_db");c.onblocked=function(){};c.onsuccess=function(){b.resolve();};c.onerror=function(d){b.reject(new v(2,9,9001,c.error));d.preventDefault();};return b}Zh.idb=function(){return new di};function fi(b,c,d,e){this.a=b;this.c=c;this.b=d;this.g=e;this.f=["offline:",b,"/",c,"/",d,"/",e].join("");}fi.prototype.key=function(){return this.g};fi.prototype.toString=function(){return this.f};function gi(b){b=/^offline:([a-z]+)\/([^/]+)\/([^/]+)\/([0-9]+)$/.exec(b);if(null==b)return null;var c=b[1];if("manifest"!=c&&"segment"!=c)return null;var d=b[2];if(!d)return null;var e=b[3];return e&&null!=c?new fi(c,d,e,Number(b[4])):null}function hi(b){return new fi("manifest","mechanism","cell",b)}function ii(b,c){this.b=b;this.a=c;}function ji(b,c){var d=new U(null,0);d.ga(c.duration);var e=c.periods.map(function(c){return ki(b,c,d)}),f=c.drmInfo?[c.drmInfo]:[];c.drmInfo&&e.forEach(function(b){b.variants.forEach(function(b){b.drmInfos=f;});});return{presentationTimeline:d,minBufferTime:2,offlineSessionIds:c.sessionIds,periods:e}}
function ki(b,c,d){var e=c.streams.filter(function(b){return"audio"==b.contentType}),f=c.streams.filter(function(b){return"video"==b.contentType});e=li(b,e,f);f=c.streams.filter(function(b){return"text"==b.contentType}).map(function(c){return mi(b,c)});c.streams.forEach(function(c,e){var f=c.segments.map(function(c,d){return ni(b,d,c)});d.Ya(f,0==e);});return{startTime:c.startTime,variants:e,textStreams:f}}
function li(b,c,d){var e={},f=[];f.push.apply(f,c);f.push.apply(f,d);f.forEach(function(b){b.variantIds.forEach(function(b){e[b]=e[b]||{id:b,language:"",primary:!1,audio:null,video:null,bandwidth:0,drmInfos:[],allowedByApplication:!0,allowedByKeySystem:!0};});});c.forEach(function(c){var d=mi(b,c);c.variantIds.forEach(function(b){b=e[b];b.language=d.language;b.primary=b.primary||d.primary;b.audio=d;});});d.forEach(function(c){var d=mi(b,c);c.variantIds.forEach(function(b){b=e[b];b.primary=b.primary||
d.primary;b.video=d;});});return Jb(e)}
function mi(b,c){var d=c.segments.map(function(c,d){return ni(b,d,c)}),e=new T(d);d={id:c.id,createSegmentIndex:function(){return Promise.resolve()},findSegmentPosition:function(b){return e.find(b)},getSegmentReference:function(b){return e.get(b)},initSegmentReference:null,presentationTimeOffset:c.presentationTimeOffset,mimeType:c.mimeType,codecs:c.codecs,width:c.width||void 0,height:c.height||void 0,frameRate:c.frameRate||void 0,kind:c.kind,encrypted:c.encrypted,keyId:c.keyId,language:c.language,
label:c.label||null,type:c.contentType,primary:c.primary,trickModeVideo:null,containsEmsgBoxes:!1,roles:[],channelsCount:null};null!=c.initSegmentKey&&(d.initSegmentReference=oi(b,c.initSegmentKey));return d}function ni(b,c,d){var e=new fi("segment",b.b,b.a,d.dataKey);return new P(c,d.startTime,d.endTime,function(){return[e.toString()]},0,null)}function oi(b,c){var d=new fi("segment",b.b,b.a,c);return new O(function(){return[d.toString()]},0,null)}function pi(){return qi().then(function(){var b=new Ah;return b.init().then(function(){return b})})}function ri(){return qi().then(function(){return Bh()})}function qi(){return null!=window.indexedDB?Promise.resolve():Promise.reject(new v(2,9,9E3))}function si(){this.a=null;}n=si.prototype;n.configure=function(){};n.start=function(b){var c=this;this.a=gi(b);if(null==this.a||"manifest"!=this.a.a)return Promise.reject(new v(2,1,9004,b));var d=new ii(this.a.c,this.a.b),e;return pi().then(function(b){e=b;return e.Sa(c.a.key())}).then(function(b){if(!b)throw new v(2,9,9003,c.a.key());return ji(d,b)}).then(function(b){return e.destroy().then(function(){return b})},function(b){return e.destroy().then(function(){throw b;})})};n.stop=function(){return Promise.resolve()};
n.update=function(){};n.onExpirationUpdated=function(b,c){var d=this,e;pi().then(function(b){e=b;return e.Sa(d.a.key())}).then(function(f){if(f&&!(0>f.sessionIds.indexOf(b))&&(void 0==f.expiration||f.expiration>c)){f.expiration=c;var g=d.a.key();return Mh(e,g,f)}})["catch"](function(){}).then(function(){return e.destroy()});};jf["application/x-offline-manifest"]=si;function ti(b){var c=gi(b);return c&&"manifest"==c.a?ti.a(b):c&&"segment"==c.a?ti.b(c.key(),b):ab(new v(2,1,9004,b))}q("shaka.offline.OfflineScheme",ti);ti.a=function(b){b={uri:b,data:new ArrayBuffer(0),headers:{"content-type":"application/x-offline-manifest"}};return cb(b)};ti.b=function(b,c){var d,e,f=pi().then(function(c){d=c;return Eh(d,"segment-v3",b)}).then(function(b){e=b;return d.destroy()}).then(function(){if(!e)throw new v(2,9,9003,b);return{uri:c,data:e.data,headers:{}}});return db(f)};
sb("offline",ti);function X(b){this.a=null;this.b=b;for(var c=0;c<b.textTracks.length;++c){var d=b.textTracks[c];d.mode="disabled";"Shaka Player TextTrack"==d.label&&(this.a=d);}this.a||(this.a=b.addTextTrack("subtitles","Shaka Player TextTrack"));this.a.mode="hidden";0<this.a.cues.length&&this.remove(0,Infinity);this.c=this.a.cues;}q("shaka.text.SimpleTextDisplayer",X);X.prototype.remove=function(b,c){if(!this.a)return!1;ui(this,function(d){return d.startTime>=c||d.endTime<=b?!1:!0});return!0};X.prototype.remove=X.prototype.remove;
X.prototype.append=function(b){var c=[];if(window.VTTRegion){var d=b.map(function(b){return b.region});d=d.filter(Fb);for(var e=0;e<d.length;e++){var f=vi(this,d[e]);c.push(f);}}var g=[];for(d=0;d<b.length;d++)(e=wi(b[d],c))&&g.push(e);g.slice().sort(function(b,c){return b.startTime!=c.startTime?b.startTime-c.startTime:b.endTime!=c.endTime?b.endTime-c.startTime:g.indexOf(c)-g.indexOf(b)}).forEach(function(b){this.a.addCue(b);}.bind(this));};X.prototype.append=X.prototype.append;
X.prototype.destroy=function(){this.a&&ui(this,function(){return!0});this.b=this.a=null;return Promise.resolve()};X.prototype.destroy=X.prototype.destroy;X.prototype.isTextVisible=function(){return"showing"==this.a.mode};X.prototype.isTextVisible=X.prototype.isTextVisible;X.prototype.setTextVisibility=function(b){this.a.mode=b?"showing":"hidden";};X.prototype.setTextVisibility=X.prototype.setTextVisibility;
function wi(b,c){if(b.startTime>=b.endTime)return null;var d=new VTTCue(b.startTime,b.endTime,b.payload);d.lineAlign=b.lineAlign;d.positionAlign=b.positionAlign;d.size=b.size;try{d.align=b.textAlign;}catch(f){}"center"==b.textAlign&&"center"!=d.align&&(d.align="middle");2==b.writingDirection?d.vertical="lr":3==b.writingDirection&&(d.vertical="rl");1==b.lineInterpretation&&(d.snapToLines=!1);null!=b.line&&(d.line=b.line);null!=b.position&&(d.position=b.position);if(b.region.id.length){var e=c.filter(function(c){return c.id==
b.region.id});e.length&&(d.region=e[0]);}return d}function vi(b,c){var d=new VTTRegion,e=b.b.offsetWidth,f=b.b.offsetHeight;d.id=c.id;d.regionAnchorX=c.regionAnchorX;d.regionAnchorY=c.regionAnchorY;d.scroll=c.scroll;2==c.heightUnits&&(d.lines=c.height);d.width=0==c.widthUnits?100*c.width/e:c.width;0==c.viewportAnchorUnits?(d.viewportAnchorX=100*c.viewportAnchorX/e,d.viewportAnchorY=100*c.viewportAnchorY/f):(d.viewportAnchorX=c.viewportAnchorX,d.viewportAnchorY=c.viewportAnchorY);return d}
function ui(b,c){for(var d=b.c,e=[],f=0;f<d.length;++f)c(d[f])&&e.push(d[f]);for(d=0;d<e.length;++d)b.a.removeCue(e[d]);}function Y(b,c){K.call(this);this.ba=!1;this.f=null;this.ob=!1;this.v=null;this.o=new C;this.h=this.Bb=this.b=this.m=this.a=this.A=this.g=this.i=this.l=this.u=null;this.Zc=1E9;this.kb=[];this.nb=!1;this.ta=!0;this.R=this.pb=this.Ga=null;this.hc=!1;this.G=null;this.mb=[];this.K={};this.c=xi(this);this.lb={width:Infinity,height:Infinity};this.j=yi();this.jb=0;this.L=this.c.preferredAudioLanguage;this.Ea=this.c.preferredTextLanguage;this.Fa=this.c.preferredVariantRole;this.hb=this.c.preferredTextRole;
this.sa=this.c.preferredAudioChannelCount;c&&c(this);this.u=new A(this.Ge.bind(this));b&&this.qb(b,!0);}Aa(Y,K);q("shaka.Player",Y);function zi(b){if(!b.Ga)return Promise.resolve();var c=Promise.resolve();b.m&&(c=b.m.stop(),b.m=null);return Promise.all([c,b.Ga()])}
Y.prototype.destroy=function(){var b=this;return ka(function d(){var e;return ya(d,function(d){switch(d.H){case 1:return p(d,b.detach(),2);case 2:return b.ba=!0,e=Promise.all([b.o?b.o.destroy():null,b.u?b.u.destroy():null]),b.ob=!1,b.o=null,b.h=null,b.u=null,b.c=null,p(d,e,0)}})}())};Y.prototype.destroy=Y.prototype.destroy;Y.version="v2.3.6-1-g60e74440";var Ai={};Y.registerSupportPlugin=function(b,c){Ai[b]=c;};
...
Y.prototype.qb=function(b,c){var d=this;return ka(function f(){return ya(f,function(f){switch(f.H){case 1:void 0===c&&(c=!0);if(!d.f){f.X(2);break}return p(f,d.detach(),2);case 2:d.f=b;D(d.o,d.f,"error",d.Yd.bind(d));if(c)return d.i=new Rc(d.f),p(f,d.i.j,0);f.X(0);}})}())};Y.prototype.attach=Y.prototype.qb;Y.prototype.detach=function(){var b=this;return ka(function d(){return ya(d,function(d){switch(d.H){case 1:return b.f?p(d,b.fb(!1),2):d["return"]();case 2:b.o.ka(b.f,"error"),b.f=null,d.H=0;}})}())};
Y.prototype.detach=Y.prototype.detach;function Bi(b,c,d){return ka(function f(){var g,h;return ya(f,function(f){switch(f.H){case 1:return p(f,mf(c,b.u,b.c.manifest.retryParameters,d),2);case 2:return g=f.Da,b.m=new g,b.m.configure(b.c.manifest),h={networkingEngine:b.u,filterNewPeriod:b.sb.bind(b),filterAllPeriods:b.bc.bind(b),onTimelineRegionAdded:b.Xd.bind(b),onEvent:b.eb.bind(b),onError:b.Ra.bind(b)},f["return"](b.m.start(c,h))}})}())}
function Ci(b){b.b.periods.some(function(b){return b.variants.some(function(b){return b.video&&b.audio})})&&b.b.periods.forEach(function(b){b.variants=b.variants.filter(function(b){return b.video&&b.audio});});if(0==b.b.periods.length)throw new v(2,4,4014);}function Di(b){var c=b.b.presentationTimeline.P(),d=b.c.playRangeEnd,e=b.c.playRangeStart;0<e&&(b.N()||b.b.presentationTimeline.Rc(e));d<c&&(b.N()||b.b.presentationTimeline.ga(d));}
Y.prototype.load=function(b,c,d){var e=this;return ka(function g(){var h,k,l,m,r,t,u,w,x,Da,Ra;return ya(g,function(g){switch(g.H){case 1:if(!e.f)throw new v(2,7,7002);k=new y;l=function(){h=new v(2,7,7E3);return k};e.dispatchEvent(new E("loading"));m=Date.now();oa(g);r=e.fb();e.Ga=l;return p(g,r,4);case 4:e.j=yi();D(e.o,e.f,"playing",e.gb.bind(e));D(e.o,e.f,"pause",e.gb.bind(e));D(e.o,e.f,"ended",e.gb.bind(e));t=e.c.abrFactory;e.h=new t;e.h.configure(e.c.abr);e.v=new e.c.textDisplayFactory;e.v.setTextVisibility(e.ob);
if(h)throw h;u=e;return p(g,Bi(e,b,d),5);case 5:u.b=g.Da;e.Bb=b;if(h)throw h;Ci(e);e.l=new ac({Xa:e.u,onError:e.Ra.bind(e),Sb:e.Id.bind(e),onExpirationUpdated:e.Fd.bind(e),onEvent:e.eb.bind(e)});e.l.configure(e.c.drm);return p(g,e.l.init(e.b,!1),6);case 6:if(h)throw h;e.bc(e.b.periods);e.jb=Date.now()/1E3;e.L=e.c.preferredAudioLanguage;e.Ea=e.c.preferredTextLanguage;e.sa=e.c.preferredAudioChannelCount;Di(e);return p(g,e.l.qb(e.f),7);case 7:if(h)throw h;e.h.init(e.He.bind(e));e.i||(e.i=new Rc(e.f));
e.i.o=e.v;e.g=new Jg(e.f,e.b,e.c.streaming,void 0==c?null:c,e.Fe.bind(e),e.eb.bind(e));e.A=new Og(e.f,e.i,e.b,e.c.streaming,e.Sc.bind(e),e.eb.bind(e),e.Ee.bind(e));e.a=new Sg(e.b,{Na:e.g,J:e.i,Xa:e.u,wc:e.Cd.bind(e),vc:e.cd.bind(e),onError:e.Ra.bind(e),onEvent:e.eb.bind(e),Jd:e.Kd.bind(e),Za:e.Ud.bind(e),filterNewPeriod:e.sb.bind(e),filterAllPeriods:e.bc.bind(e)});e.a.configure(e.c.streaming);Ei(e);e.dispatchEvent(new E("streaming"));return p(g,e.a.init(),8);case 8:if(h)throw h;e.c.streaming.startAtSegmentBoundary&&
(w=Fi(e,Mg(e.g)),Gg(e.g.a,w));e.b.periods.forEach(e.sb.bind(e));Gi(e);Hi(e);x=V(e.a);Da=ud(x.variants,e.L,e.Fa,e.sa);e.h.setVariants(Da);x.variants.some(function(b){return b.primary});e.mb.forEach(e.A.o.bind(e.A));e.mb=[];Ab(e.o,e.f,"loadeddata",function(){this.j.loadLatency=(Date.now()-m)/1E3;}.bind(e));if(h)throw h;e.Ga=null;pa(g);break;case 2:return Ra=qa(g),k.resolve(),e.Ga==l&&(e.Ga=null,e.dispatchEvent(new E("unloading"))),g["return"](Promise.reject(Ra))}})}())};Y.prototype.load=Y.prototype.load;
function Ei(b){function c(b){return(b.video?b.video.codecs.split(".")[0]:"")+"-"+(b.audio?b.audio.codecs.split(".")[0]:"")}var d=b.b.periods.reduce(function(b,c){return b.concat(c.variants)},[]);d=wd(d,b.c.preferredAudioChannelCount);var e={};d.forEach(function(b){var d=c(b);d in e||(e[d]=[]);e[d].push(b);});var f=null,g=Infinity;Lb(e,function(b,c){var d=0,e=0;c.forEach(function(b){d+=b.bandwidth||0;++e;});var h=d/e;h<g&&(f=b,g=h);});b.b.periods.forEach(function(b){b.variants=b.variants.filter(function(b){return c(b)==
f?!0:!1});});}Y.prototype.configure=function(b){b=mb(this.c,b,xi(this),Ii(),"");Ji(this);return b};Y.prototype.configure=Y.prototype.configure;function Ji(b){b.m&&b.m.configure(b.c.manifest);b.l&&b.l.configure(b.c.drm);if(b.a){b.a.configure(b.c.streaming);try{b.b.periods.forEach(b.sb.bind(b));}catch(f){b.Ra(f);}var c=Wg(b.a),d=Yg(b.a),e=V(b.a);(c=Ad(c,d,e.variants))&&c.allowedByApplication&&c.allowedByKeySystem||Ki(b,e);}b.h&&(b.h.configure(b.c.abr),b.c.abr.enabled&&!b.ta?b.h.enable():b.h.disable());}
Y.prototype.getConfiguration=function(){var b=xi(this);mb(b,this.c,xi(this),Ii(),"");return b};Y.prototype.getConfiguration=Y.prototype.getConfiguration;Y.prototype.re=function(){this.c=xi(this);Ji(this);};Y.prototype.resetConfiguration=Y.prototype.re;Y.prototype.od=function(){return this.f};Y.prototype.getMediaElement=Y.prototype.od;Y.prototype.qc=function(){return this.u};Y.prototype.getNetworkingEngine=Y.prototype.qc;Y.prototype.Hb=function(){return this.Bb};Y.prototype.getManifestUri=Y.prototype.Hb;
Y.prototype.N=function(){return this.b?this.b.presentationTimeline.N():!1};Y.prototype.isLive=Y.prototype.N;Y.prototype.xa=function(){return this.b?this.b.presentationTimeline.xa():!1};Y.prototype.isInProgress=Y.prototype.xa;Y.prototype.yd=function(){if(!this.b||!this.b.periods.length)return!1;var b=this.b.periods[0].variants;return b.length?!b[0].video:!1};Y.prototype.isAudioOnly=Y.prototype.yd;
Y.prototype.te=function(){var b=0,c=0;this.b&&(c=this.b.presentationTimeline,b=c.Ia(),c=c.ia());return{start:b,end:c}};Y.prototype.seekRange=Y.prototype.te;Y.prototype.keySystem=function(){return this.l?this.l.keySystem():""};Y.prototype.keySystem=Y.prototype.keySystem;Y.prototype.drmInfo=function(){return this.l?this.l.b:null};Y.prototype.drmInfo=Y.prototype.drmInfo;Y.prototype.ub=function(){return this.l?this.l.ub():Infinity};Y.prototype.getExpiration=Y.prototype.ub;Y.prototype.tc=function(){return this.nb};
Y.prototype.isBuffering=Y.prototype.tc;Y.prototype.fb=function(b){var c=this;return ka(function e(){return ya(e,function(e){switch(e.H){case 1:if(c.ba)return e["return"]();void 0===b&&(b=!0);c.dispatchEvent(new E("unloading"));return p(e,zi(c),2);case 2:return c.pb||(c.pb=Li(c).then(function(){c.Sc(!1);c.pb=null;})),p(e,c.pb,3);case 3:if(b)return c.i=new Rc(c.f),p(e,c.i.j,0);e.X(0);}})}())};Y.prototype.unload=Y.prototype.fb;Y.prototype.Ta=function(){return this.g?this.g.Ta():0};
Y.prototype.getPlaybackRate=Y.prototype.Ta;Y.prototype.Qe=function(b){this.g&&Ig(this.g.a,b);this.a&&dh(this.a,1!=b);};Y.prototype.trickPlay=Y.prototype.Qe;Y.prototype.dd=function(){this.g&&Ig(this.g.a,1);this.a&&dh(this.a,!1);};Y.prototype.cancelTrickPlay=Y.prototype.dd;Y.prototype.wd=function(){if(!this.b||!this.g)return[];var b=Cd(this.b,Mg(this.g)),c=this.K[b]||{};return qd(this.b.periods[b],c.audio,c.video)};Y.prototype.getVariantTracks=Y.prototype.wd;
Y.prototype.vd=function(){if(!this.b||!this.g)return[];var b=Cd(this.b,Mg(this.g));return rd(this.b.periods[b],(this.K[b]||{}).text).filter(function(b){return 0>this.kb.indexOf(b.id)}.bind(this))};Y.prototype.getTextTracks=Y.prototype.vd;Y.prototype.ye=function(b){if(this.a){var c=V(this.a);a:{for(var d=0;d<c.textStreams.length;d++)if(c.textStreams[d].id==b.id){b=c.textStreams[d];break a}b=null;}b&&(this.i.l=!1,Mi(this,b,!1),c=b,this.ta?this.G=c:eh(this.a,c,!0),this.Ea=b.language);}};
Y.prototype.selectTextTrack=Y.prototype.ye;Y.prototype.we=function(){this.i.l=!0;ch(this.a);};Y.prototype.selectEmbeddedTextTrack=Y.prototype.we;Y.prototype.Ve=function(){return this.i?this.i.l:!1};Y.prototype.usingEmbeddedTextTrack=Y.prototype.Ve;
Y.prototype.ze=function(b,c){if(this.a){this.c.abr.enabled&&Ga("Changing tracks while abr manager is enabled will likely result in the selected track being overriden. Consider disabling abr before calling selectVariantTrack().");var d=V(this.a),e=sd(d,b);e&&td(e)&&(Ni(this,e,!1),Oi(this,e,c),this.L=e.language,e.audio&&e.audio.channelsCount&&(this.sa=e.audio.channelsCount),d=ud(d.variants,this.L,this.Fa,this.sa),this.h.setVariants(d));}};Y.prototype.selectVariantTrack=Y.prototype.ze;
Y.prototype.ld=function(){if(!this.a)return[];var b=V(this.a);b=pd(b.variants).map(function(b){return b.audio}).filter(Fb);return Pi(b)};Y.prototype.getAudioLanguagesAndRoles=Y.prototype.ld;Y.prototype.ud=function(){if(!this.a)return[];var b=V(this.a);return Pi(b.textStreams)};Y.prototype.getTextLanguagesAndRoles=Y.prototype.ud;Y.prototype.kd=function(){if(!this.a)return[];var b=V(this.a);return pd(b.variants).map(function(b){return b.language}).filter(Fb)};Y.prototype.getAudioLanguages=Y.prototype.kd;
Y.prototype.td=function(){return this.a?V(this.a).textStreams.map(function(b){return b.language}).filter(Fb):[]};Y.prototype.getTextLanguages=Y.prototype.td;function Pi(b){var c=[];b.forEach(function(b){if(b){var d=b.language;b.roles.length?b.roles.forEach(function(b){c.push({language:d,role:b});}):c.push({language:d,role:""});}else c.push({language:"und",role:""});});return gb(c,function(b,c){return b.language==c.language&&b.role==c.role})}
Y.prototype.ve=function(b,c){if(this.a){var d=V(this.a);this.L=b;this.Fa=c||"";Ki(this,d);}};Y.prototype.selectAudioLanguage=Y.prototype.ve;Y.prototype.xe=function(b,c){if(this.a){var d=V(this.a);this.Ea=b;this.hb=c||"";Ki(this,d);}};Y.prototype.selectTextLanguage=Y.prototype.xe;Y.prototype.Lb=function(){return this.v?this.v.isTextVisible():this.ob};Y.prototype.isTextTrackVisible=Y.prototype.Lb;
Y.prototype.Ce=function(b){this.v&&this.v.setTextVisibility(b);this.ob=b;Qi(this);!this.c.streaming.alwaysStreamText&&this.a&&(b?(b=V(this.a),(b=yd(b.textStreams,this.Ea,this.hb)[0])&&Zg(this.a,b)):ch(this.a));};Y.prototype.setTextTrackVisibility=Y.prototype.Ce;Y.prototype.qd=function(){return this.b?new Date(1E3*this.b.presentationTimeline.f+1E3*this.f.currentTime):null};Y.prototype.getPlayheadTimeAsDate=Y.prototype.qd;
Y.prototype.sd=function(){return this.b?new Date(1E3*this.b.presentationTimeline.f):null};Y.prototype.getPresentationStartTimeAsDate=Y.prototype.sd;Y.prototype.Fb=function(){return this.i?this.i.Fb():{total:[],audio:[],video:[],text:[]}};Y.prototype.getBufferedInfo=Y.prototype.Fb;
Y.prototype.getStats=function(){Ri(this);this.gb();var b=null,c=null,d=this.f;d=d&&d.getVideoPlaybackQuality?d.getVideoPlaybackQuality():{};if(this.g&&this.b){var e=Cd(this.b,Mg(this.g)),f=this.b.periods[e];if(e=this.K[e])c=Bd(e.audio,e.video,f.variants),b=c.video||{};}b||(b={});c||(c={});return{width:b.width||0,height:b.height||0,streamBandwidth:c.bandwidth||0,decodedFrames:Number(d.totalVideoFrames),droppedFrames:Number(d.droppedVideoFrames),estimatedBandwidth:this.h?this.h.getBandwidthEstimate():
...
Y.prototype.addTextTrack=function(b,c,d,e,f,g){if(!this.a)return Promise.reject();for(var h=V(this.a),k,l=0;l<this.b.periods.length;l++)if(this.b.periods[l]==h){if(l==this.b.periods.length-1){if(k=this.b.presentationTimeline.P()-h.startTime,Infinity==k)return Promise.reject()}else k=this.b.periods[l+1].startTime-h.startTime;break}var m={id:this.Zc++,createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:function(){return 1},getSegmentReference:function(c){return 1!=c?null:new P(1,0,
k,function(){return[b]},0,null)},initSegmentReference:null,presentationTimeOffset:0,mimeType:e,codecs:f||"",kind:d,encrypted:!1,keyId:null,language:c,label:g||null,type:"text",primary:!1,trickModeVideo:null,containsEmsgBoxes:!1,roles:[],channelsCount:null};this.kb.push(m.id);h.textStreams.push(m);return Zg(this.a,m).then(function(){if(!this.ba){var b=this.b.periods.indexOf(h),e=Xg(this.a,"text");e&&(this.K[b].text=e.id);this.kb.splice(this.kb.indexOf(m.id),1);Ki(this,h);Gi(this);return{id:m.id,active:!1,
type:"text",bandwidth:0,language:c,label:g||null,kind:d,width:null,height:null}}}.bind(this))};Y.prototype.addTextTrack=Y.prototype.addTextTrack;Y.prototype.$b=function(b,c){this.lb.width=b;this.lb.height=c;};Y.prototype.setMaxHardwareResolution=Y.prototype.$b;Y.prototype.Lc=function(){if(this.a){var b=this.a;if(b.f)b=!1;else if(b.l)b=!1;else{for(var c in b.c){var d=b.c[c];d.Va&&(d.Va=!1,bh(b,d,.1));}b=!0;}}else b=!1;return b};Y.prototype.retryStreaming=Y.prototype.Lc;Y.prototype.Sa=function(){return this.b};
Y.prototype.getManifest=Y.prototype.Sa;function Ni(b,c,d){c.video&&Si(b,c.video);c.audio&&Si(b,c.audio);var e=Vg(b.a);c!=Ad(Wg(b.a),Yg(b.a),e?e.variants:[])&&b.j.switchHistory.push({timestamp:Date.now()/1E3,id:c.id,type:"variant",fromAdaptation:d,bandwidth:c.bandwidth});}function Mi(b,c,d){Si(b,c);b.j.switchHistory.push({timestamp:Date.now()/1E3,id:c.id,type:"text",fromAdaptation:d,bandwidth:null});}function Si(b,c){var d=Dd(b.b,c);b.K[d]||(b.K[d]={});b.K[d][c.type]=c.id;}
function Li(b){b.o&&(b.o.ka(b.f,"loadeddata"),b.o.ka(b.f,"playing"),b.o.ka(b.f,"pause"),b.o.ka(b.f,"ended"));var c=Promise.all([b.h?b.h.stop():null,b.i?b.i.destroy():null,b.l?b.l.destroy():null,b.g?b.g.destroy():null,b.A?b.A.destroy():null,b.a?b.a.destroy():null,b.m?b.m.stop():null,b.v?b.v.destroy():null]);b.ta=!0;b.l=null;b.i=null;b.g=null;b.A=null;b.a=null;b.m=null;b.v=null;b.b=null;b.Bb=null;b.mb=[];b.K={};b.j=yi();return c}
...
function xi(b){var c=5E5;navigator.connection&&navigator.connection.type&&(c=1E6*navigator.connection.downlink);return{drm:{retryParameters:Za(),servers:{},clearKeys:{},advanced:{},delayLicenseRequestUntilPlayed:!1},manifest:{retryParameters:Za(),dash:{customScheme:function(b){if(b)return null},clockSyncUri:"",ignoreDrmInfo:!1,xlinkFailGracefully:!1,defaultPresentationDelay:10}},streaming:{retryParameters:Za(),failureCallback:b.gd.bind(b),rebufferingGoal:2,bufferingGoal:10,bufferBehind:30,ignoreTextStreamFailures:!1,
...
preferredTextRole:"",preferredAudioChannelCount:2,restrictions:{minWidth:0,maxWidth:Infinity,minHeight:0,maxHeight:Infinity,minPixels:0,maxPixels:Infinity,minBandwidth:0,maxBandwidth:Infinity},playRangeStart:0,playRangeEnd:Infinity}}n=Y.prototype;n.gd=function(b){var c=[1001,1002,1003];this.N()&&0<=c.indexOf(b.code)&&(b.severity=1,this.Lc());};
function yi(){return{width:NaN,height:NaN,streamBandwidth:NaN,decodedFrames:NaN,droppedFrames:NaN,estimatedBandwidth:NaN,loadLatency:NaN,playTime:0,bufferingTime:0,switchHistory:[],stateHistory:[]}}
n.bc=function(b){b.forEach(kd.bind(null,this.l,this.a?Wg(this.a):null,this.a?Yg(this.a):null));var c=lb(b,function(b){return b.variants.some(td)});if(0==c)throw new v(2,4,4032);if(c<b.length)throw new v(2,4,4011);b.forEach(function(b){jd(b,this.c.restrictions,this.lb)&&this.a&&V(this.a)==b&&Gi(this);if(!b.variants.some(td))throw new v(2,4,4012);}.bind(this));};
n.sb=function(b){kd(this.l,this.a?Wg(this.a):null,this.a?Yg(this.a):null,b);var c=b.variants,d=c.some(td);jd(b,this.c.restrictions,this.lb)&&this.a&&V(this.a)==b&&Gi(this);b=c.some(td);if(!d)throw new v(2,4,4011);if(!b)throw new v(2,4,4012);};function Oi(b,c,d){b.ta?(b.R=c,b.hc=d||!1):fh(b.a,c,d||!1);}function Ri(b){if(b.b){var c=Date.now()/1E3;b.nb?b.j.bufferingTime+=c-b.jb:b.j.playTime+=c-b.jb;b.jb=c;}}
function Fi(b,c){function d(b,c){if(!b)return null;var d=b.findSegmentPosition(c-g.startTime);return null==d?null:(d=b.getSegmentReference(d))?d.startTime+g.startTime:null}var e=Wg(b.a),f=Yg(b.a),g=V(b.a);e=d(e,c);f=d(f,c);return null!=f&&null!=e?Math.max(f,e):null!=f?f:null!=e?e:c}n.Ge=function(b,c){this.h&&this.h.segmentDownloaded(b,c);};n.Sc=function(b){Ri(this);this.nb=b;this.gb();if(this.g){var c=this.g.a;b!=c.g&&(c.g=b,Ig(c,c.f));}this.dispatchEvent(new E("buffering",{buffering:b}));};n.Ee=function(){Gi(this);};
n.gb=function(){if(!this.ba){var b=this.nb?"buffering":this.f.ended?"ended":this.f.paused?"paused":"playing";var c=Date.now()/1E3;if(this.j.stateHistory.length){var d=this.j.stateHistory[this.j.stateHistory.length-1];d.duration=c-d.timestamp;if(b==d.state)return}this.j.stateHistory.push({timestamp:c,state:b,duration:0});}};n.Fe=function(){if(this.A){var b=this.A;b.c.forEach(b.m.bind(b,!0));}this.a&&ih(this.a);};
function Ti(b,c){if(!c||!c.length)return b.Ra(new v(2,4,4012)),null;b.h.setVariants(c);return b.h.chooseVariant()}function Ki(b,c){var d=ud(c.variants,b.L,b.Fa,b.sa),e=yd(c.textStreams,b.Ea,b.hb);if(d=Ti(b,d))Ni(b,d,!0),Oi(b,d,!0);(e=e[0])&&(b.c.streaming.alwaysStreamText||b.Lb())&&(Mi(b,e,!0),b.ta?b.G=e:eh(b.a,e,!0));Hi(b);}
n.Cd=function(b){this.ta=!0;this.h.disable();var c={audio:!1,text:!1},d=ud(b.variants,this.L,this.Fa,this.sa,c),e=yd(b.textStreams,this.Ea,this.hb,c);d=Ti(this,d);e=e[0]||null;if(this.R){a:{var f=this.b;for(var g=0;g<f.periods.length;++g)for(var h=f.periods[g],k=0;k<h.variants.length;++k)if(h.variants[k]==this.R){f=g;break a}f=-1;}this.b.periods[f]==b&&(d=this.R);this.R=null;}this.G&&(this.b.periods[Dd(this.b,this.G)]==b&&(e=this.G),this.G=null);d&&Ni(this,d,!0);e&&(Mi(this,e,!0),!Vg(this.a)&&d&&d.audio&&
c.text&&e.language!=d.audio.language&&(this.v.setTextVisibility(!0),Qi(this)));return this.c.streaming.alwaysStreamText||this.Lb()?{variant:d,text:e}:{variant:d,text:null}};n.cd=function(){this.ta=!1;this.c.abr.enabled&&this.h.enable();this.R&&(fh(this.a,this.R,this.hc),this.R=null);this.G&&(eh(this.a,this.G,!0),this.G=null);};n.Kd=function(){this.m&&this.m.update&&this.m.update();};n.Ud=function(){this.g&&this.g.Za();};n.He=function(b,c){Ni(this,b,!0);this.a&&(fh(this.a,b,c||!1),Hi(this));};
function Hi(b){Promise.resolve().then(function(){this.ba||this.dispatchEvent(new E("adaptation"));}.bind(b));}function Gi(b){Promise.resolve().then(function(){this.ba||this.dispatchEvent(new E("trackschanged"));}.bind(b));}function Qi(b){b.dispatchEvent(new E("texttrackvisibility"));}n.Ra=function(b){if(!this.ba){var c=new E("error",{detail:b});this.dispatchEvent(c);c.defaultPrevented&&(b.handled=!0);}};n.Xd=function(b){this.A?this.A.o(b):this.mb.push(b);};n.eb=function(b){this.dispatchEvent(b);};
n.Yd=function(){if(this.f.error){var b=this.f.error.code;if(1!=b){var c=this.f.error.msExtendedCode;c&&(0>c&&(c+=Math.pow(2,32)),c=c.toString(16));this.Ra(new v(2,3,3016,b,c,this.f.error.message));}}};
n.Id=function(b){var c=["output-restricted","internal-error"],d=V(this.a),e=!1,f=Object.keys(b),g=1==f.length&&"00"==f[0];f.length&&d.variants.forEach(function(d){var f=[];d.audio&&f.push(d.audio);d.video&&f.push(d.video);f.forEach(function(f){var h=d.allowedByKeySystem;f.keyId&&(f=b[g?"00":f.keyId],d.allowedByKeySystem=!!f&&0>c.indexOf(f));h!=d.allowedByKeySystem&&(e=!0);});});(f=Ad(Wg(this.a),Yg(this.a),d.variants))&&!f.allowedByKeySystem&&Ki(this,d);e&&(Gi(this),d=ud(d.variants,this.L,this.Fa,this.sa),
this.h.setVariants(d));};n.Fd=function(b,c){if(this.m&&this.m.onExpirationUpdated)this.m.onExpirationUpdated(b,c);this.dispatchEvent(new E("expirationupdated"));};
n.ue=function(b){if(this.ba)return Promise.resolve();if(this.b&&this.b.presentationTimeline){var c=this.b.presentationTimeline.Ja();if(b<c)return Promise.reject();c=this.b.presentationTimeline.wa();if(b>c)return Promise.reject();c=Yg(this.a);if(!c){a:{for(c=this.b.periods.length-1;0<c;--c)if(b>=this.b.periods[c].startTime)break a;c=0;}c=this.b.periods[c].variants[0].video;}b=c.findSegmentPosition(b);return(b=null!=b?c.getSegmentReference(b):null)?Ui(this,b):Promise.reject()}return Promise.resolve()};
Y.prototype.segmentExist=Y.prototype.ue;function Ui(b,c){var d=B(c.c(),Za());if(0!=c.b||null!=c.a){var e="bytes="+c.b+"-";null!=c.a&&(e+=c.a);d.headers.Range=e;}return b.u.request(1,d).promise.then(function(b){return b.data})}function Vi(b,c,d){var e=void 0==c.expiration?Infinity:c.expiration,f=c.presentationTimeline.P();c=od(c.periods[0]);return{offlineUri:null,originalManifestUri:b,duration:f,size:0,expiration:e,tracks:c,appMetadata:d}}function Wi(b,c){var d=ki(new ii(b.c,b.b),c.periods[0],new U(null,0)),e=c.appMetadata||{};d=od(d);return{offlineUri:b.toString(),originalManifestUri:c.originalManifestUri,duration:c.duration,size:c.size,expiration:c.expiration,tracks:d,appMetadata:e}}function Xi(){this.a={};}function Yi(b,c,d){d=d.endTime-d.startTime;return Zi(b,c)*d}function Zi(b,c){var d=b.a[c];null==d&&(d=0);return d}function Z(b){if(!b||b.constructor!=Y)throw new v(2,9,9008);this.a=b;this.b=$i(this);this.g=!1;this.c=null;this.f=[];}q("shaka.offline.Storage",Z);function aj(){return null!=window.indexedDB}Z.support=aj;Z.prototype.destroy=function(){this.a=this.b=null;return Promise.resolve()};Z.prototype.destroy=Z.prototype.destroy;Z.prototype.configure=function(b){mb(this.b,b,$i(this),{},"");};Z.prototype.configure=Z.prototype.configure;
Z.prototype.store=function(b,c,d){var e=this;return ka(function g(){var h,k,l,m;return ya(g,function(g){switch(g.H){case 1:bj();if(e.g)return g["return"](Promise.reject(new v(2,9,9006)));e.g=!0;h=c||{};k=null;return p(g,cj(e,b,function(b){k=b;},d),2);case 2:l=g.Da;m=!l.manifest.presentationTimeline.N()&&!l.manifest.presentationTimeline.xa();if(!m)throw new v(2,9,9005,b);dj(e);if(k)throw k;return g["return"](ej(function(c){return ob(l.Db,function(){return ka(function w(){var d,g,m,r,t,jb,kb;return ya(w,
function(x){switch(x.H){case 1:return oa(x,3),fj(e,l.Db,l.manifest.periods),p(x,gj(e,c,l.Db,l.manifest,b,h),5);case 5:return d=x.Da,p(x,Kh(c,"manifest-v3",d),6);case 6:return g=x.Da,m=hi(g),r=Wi(m,d),x["return"](r);case 3:ra(x);e.g=!1;e.c=null;e.f=[];sa(x);break;case 2:return t=qa(x),jb=e.f,kb=function(){},p(x,Ih(c,"segment-v3",jb,kb),7);case 7:throw k||t;}})}())})}))}})}())};Z.prototype.store=Z.prototype.store;
function gj(b,c,d,e,f,g){var h=Vi(f,e,g),k=new Qh(function(c,d){h.size=d;b.b.progressCallback(h,c);}),l;return ob(k,function(){l=hj(b,k,c,d,e,f,g);return Sh(k,b.a.u)}).then(function(){l.size=h.size;return l})}Z.prototype.remove=function(b){var c=this;bj();var d=gi(b);return null!=d&&"manifest"==d.a?ej(function(e){return e.Sa(d.key()).then(function(f){return f?Promise.all([ij(c,d,f),jj(c,e,d,f)]):Promise.reject(new v(2,9,9003,b))})}):Promise.reject(new v(2,9,9004,b))};Z.prototype.remove=Z.prototype.remove;
function ij(b,c,d){var e,f=new ac({Xa:b.a.u,onError:function(b){6013!=b.code&&(e=b);},Sb:function(){},onExpirationUpdated:function(){},onEvent:function(){}});f.configure(b.a.getConfiguration().drm);var g=ji(new ii(c.c,c.b),d);return ob(f,function(){return Promise.resolve().then(function(){return f.init(g,b.b.usePersistentLicense)}).then(function(){return ec(f,d.sessionIds)})}).then(function(){if(e)throw e;})}
function jj(b,c,d,e){function f(){k++;g(h,k/l);}var g=b.b.progressCallback,h=Wi(d,e);b=kj(e);var k=0,l=b.length+1;return Promise.all([Ih(c,"segment-v3",b,f),Hh(c,[d.key()],f)])}Z.prototype.list=function(){bj();var b=[];return ej(function(c){return Fh(c,function(c,e){var d=Wi(hi(c),e);b.push(d);})}).then(function(){return b})};Z.prototype.list=Z.prototype.list;
function cj(b,c,d,e){function f(){}var g=b.a.u,h=b.a.getConfiguration(),k,l,m;return mf(c,g,h.manifest.retryParameters,e).then(function(b){var e=this;dj(this);l=new ac({Xa:g,onError:d,Sb:f,onExpirationUpdated:function(){},onEvent:function(){}});l.configure(h.drm);var k={networkingEngine:g,filterAllPeriods:function(b){fj(e,l,b);},filterNewPeriod:function(b){lj(e,l,b);},onTimelineRegionAdded:function(){},onEvent:function(){},onError:d};m=new b;m.configure(h.manifest);return m.start(c,k)}.bind(b)).then(function(b){dj(this);
k=b;return l.init(k,this.b.usePersistentLicense)}.bind(b)).then(function(){dj(this);return mj(k)}.bind(b)).then(function(){dj(this);return dc(l)}.bind(b)).then(function(){dj(this);return m.stop()}.bind(b)).then(function(){dj(this);return{manifest:k,Db:l}}.bind(b))["catch"](function(b){if(m)return m.stop().then(function(){throw b;});throw b;})}
...
c){return c.height-b.height}),g=k.filter(function(b){return b.height==k[0].height}));g.sort(function(b,c){return b.bandwidth-c.bandwidth});g.length&&c.push(g[Math.floor(g.length/2)]);c.push.apply(c,b.filter(function(b){return"text"==b.type}));return c};function $i(b){return{trackSelectionCallback:b.h.bind(b),progressCallback:function(b,d){if(b||d)return null},usePersistentLicense:!0}}function fj(b,c,d){d.forEach(function(d){return lj(b,c,d)});}
function lj(b,c,d){var e=null;if(b.c){var f=b.c.filter(function(b){return"variant"==b.type})[0];f&&(e=sd(d,f));}var g=f=null;e&&(e.audio&&(f=e.audio),e.video&&(g=e.video));kd(c,f,g,d);jd(d,b.a.getConfiguration().restrictions,{width:Infinity,height:Infinity});}
function mj(b){var c=b.periods.map(function(b){return b.variants}).reduce(Cb,[]).map(function(b){var c=[];b.audio&&c.push(b.audio);b.video&&c.push(b.video);return c}).reduce(Cb,[]).filter(Fb);b=b.periods.map(function(b){return b.textStreams}).reduce(Cb,[]);c.push.apply(c,b);return Promise.all(c.map(function(b){return b.createSegmentIndex()}))}
function hj(b,c,d,e,f,g,h){var k=new Xi,l=f.periods.map(function(g){return nj(b,c,d,k,e,f,g)}),m=e.b,r=hc(e);if(m&&b.b.usePersistentLicense){if(!r.length)throw new v(2,9,9007,g);m.initData=[];}return{originalManifestUri:g,duration:f.presentationTimeline.P(),size:0,expiration:e.ub(),periods:l,sessionIds:b.b.usePersistentLicense?r:[],drmInfo:m,appMetadata:h}}
function nj(b,c,d,e,f,g,h){var k=qd(h,null,null),l=rd(h,null);k=b.b.trackSelectionCallback(k.concat(l));null==b.c&&(b.c=k,fj(b,f,g.periods));oj(k);g.periods.forEach(function(b){b.variants.forEach(function(b){var c=b.audio,d=b.video;c&&!d&&(e.a[c.id]=c.bandwidth||b.bandwidth);!c&&d&&(e.a[d.id]=d.bandwidth||b.bandwidth);if(c&&d){var f=c.bandwidth||393216,g=d.bandwidth||b.bandwidth-f;0>=g&&(g=b.bandwidth);e.a[c.id]=f;e.a[d.id]=g;}});b.textStreams.forEach(function(b){e.a[b.id]=52;});});var m={};k.forEach(function(b){"variant"==
...
function qj(b,c,d,e,f,g){var h={id:g.id,primary:g.primary,presentationTimeOffset:g.presentationTimeOffset||0,contentType:g.type,mimeType:g.mimeType,codecs:g.codecs,frameRate:g.frameRate,kind:g.kind,language:g.language,label:g.label,width:g.width||null,height:g.height||null,initSegmentKey:null,encrypted:g.encrypted,keyId:g.keyId,segments:[],variantIds:[]};f=f.presentationTimeline.Ja();var k=g.id;rj(g,f,function(f){Rh(c,k,sj(b,f),Yi(e,g.id,f),function(c){return Jh(d,{data:c}).then(function(c){b.f.push(c);
h.segments.push({startTime:f.startTime,endTime:f.endTime,dataKey:c});})});});(f=g.initSegmentReference)&&Rh(c,k,sj(b,f),.5*Zi(e,g.id),function(c){return Jh(d,{data:c}).then(function(c){b.f.push(c);h.initSegmentKey=c;})});return h}function rj(b,c,d){c=b.findSegmentPosition(c);for(var e=null==c?null:b.getSegmentReference(c);e;)d(e),e=b.getSegmentReference(++c);}function dj(b){if(!b.a)throw new v(2,9,7001);}function bj(){if(null==window.indexedDB)throw new v(2,9,9E3);}
function sj(b,c){var d=b.a.getConfiguration().streaming.retryParameters;d=B(c.c(),d);if(0!=c.b||null!=c.a)d.headers.Range="bytes="+c.b+"-"+(null==c.a?"":c.a);return d}function kj(b){var c=[];b.periods.forEach(function(b){b.streams.forEach(function(b){null!=b.initSegmentKey&&c.push(b.initSegmentKey);b.segments.forEach(function(b){c.push(b.dataKey);});});});return c}function ej(b){return pi().then(function(c){return ob(c,function(){return b(c)})})}Z.deleteAll=function(){return ri()};
function oj(b){b.some(function(c){return b.some(function(b){return c!=b&&c.type==b.type&&c.kind==b.kind&&c.language==b.language})});}function pj(b){var c={};b.periods.forEach(function(b){b.textStreams.forEach(function(b){c[b.id]=b;});b.variants.forEach(function(b){b.audio&&(c[b.audio.id]=b.audio);b.video&&(c[b.video.id]=b.video);});});return Jb(c)}Ai.offline=aj;q("shaka.polyfill.installAll",function(){for(var b=0;b<tj.length;++b)tj[b].ad();});var tj=[];function uj(b,c){c=c||0;for(var d={priority:c,ad:b},e=0;e<tj.length;e++)if(tj[e].priority<c){tj.splice(e,0,d);return}tj.push(d);}q("shaka.polyfill.register",uj);uj(function(){var b=navigator.userAgent;b&&0<=b.indexOf("CrKey")&&delete window.indexedDB;});var vj;function wj(b,c,d){if("input"==b)switch(this.type){case "range":b="change";}vj.call(this,b,c,d);}uj(function(){0>navigator.userAgent.indexOf("Trident/")||HTMLInputElement.prototype.addEventListener==wj||(vj=HTMLInputElement.prototype.addEventListener,HTMLInputElement.prototype.addEventListener=wj);});uj(function(){});function xj(){var b=MediaSource.prototype.addSourceBuffer;MediaSource.prototype.addSourceBuffer=function(){var c=b.apply(this,arguments);c.abort=function(){};return c};}function yj(){var b=SourceBuffer.prototype.remove;SourceBuffer.prototype.remove=function(c,d){return b.call(this,c,d-.001)};}
function zj(){var b=MediaSource.prototype.endOfStream;MediaSource.prototype.endOfStream=function(){for(var c=0,d=0;d<this.sourceBuffers.length;++d){var g=this.sourceBuffers[d];g=g.buffered.end(g.buffered.length-1);c=Math.max(c,g);}if(!isNaN(this.duration)&&c<this.duration)for(this.rc=!0,c=0;c<this.sourceBuffers.length;++c)this.sourceBuffers[c].mc=!1;return b.apply(this,arguments)};var c=!1,d=MediaSource.prototype.addSourceBuffer;MediaSource.prototype.addSourceBuffer=function(){var b=d.apply(this,arguments);
b.mediaSource_=this;b.addEventListener("updateend",Aj,!1);c||(this.addEventListener("sourceclose",Bj,!1),c=!0);return b};}function Aj(b){var c=b.target,d=c.mediaSource_;if(d.rc){b.preventDefault();b.stopPropagation();b.stopImmediatePropagation();c.mc=!0;for(b=0;b<d.sourceBuffers.length;++b)if(0==d.sourceBuffers[b].mc)return;d.rc=!1;}}
function Bj(b){b=b.target;for(var c=0;c<b.sourceBuffers.length;++c)b.sourceBuffers[c].removeEventListener("updateend",Aj,!1);b.removeEventListener("sourceclose",Bj,!1);}function Cj(){var b=MediaSource.isTypeSupported;MediaSource.isTypeSupported=function(c){return"mp2t"==c.split(/ *; */)[0].split("/")[1]?!1:b(c)};}
function Dj(){var b=MediaSource.isTypeSupported,c=/^dv(?:he|av)\./;MediaSource.isTypeSupported=function(d){for(var e=d.split(/ *; */),f=e[0],g={},h=1;h<e.length;++h){var k=e[h].split("="),l=k[0];k=k[1].replace(/"(.*)"/,"$1");g[l]=k;}e=g.codecs;if(!e)return b(d);var m=!1,r=!1;d=e.split(",").filter(function(b){if(c.test(b))return r=!0,!1;/^(hev|hvc)1\.2/.test(b)&&(m=!0);return!0});r&&(m=!1);g.codecs=d.join(",");m&&(g.eotf="smpte2084");for(var t in g)f+="; "+t+'="'+g[t]+'"';return cast.__platform__.canDisplayType(f)};}
uj(function(){if(window.MediaSource)if(window.cast&&cast.__platform__&&cast.__platform__.canDisplayType)Dj();else if(navigator.vendor&&0<=navigator.vendor.indexOf("Apple")){var b=navigator.appVersion;Cj();0<=b.indexOf("Version/8")?window.MediaSource=null:0<=b.indexOf("Version/9")?xj():0<=b.indexOf("Version/10")?(xj(),zj()):0<=b.indexOf("Version/11")&&(xj(),yj());}});function Ej(b){this.f=[];this.b=[];this.a=[];(new R).V("pssh",this.c.bind(this)).parse(b.buffer);}Ej.prototype.c=function(b){if(!(1<b.version)){var c=Yb(b.s.Aa(16)),d=[];if(0<b.version)for(var e=b.s.B(),f=0;f<e;++f){var g=Yb(b.s.Aa(16));d.push(g);}e=b.s.B();b.s.D(e);this.b.push.apply(this.b,d);this.f.push(c);this.a.push({start:b.start,end:b.start+b.size-1});}};function Fj(b,c){try{var d=new Gj(b,c);return Promise.resolve(d)}catch(e){return Promise.reject(e)}}
function Gj(b,c){this.keySystem=b;for(var d=!1,e=0;e<c.length;++e){var f=c[e],g={audioCapabilities:[],videoCapabilities:[],persistentState:"optional",distinctiveIdentifier:"optional",initDataTypes:f.initDataTypes,sessionTypes:["temporary"],label:f.label},h=!1;if(f.audioCapabilities)for(var k=0;k<f.audioCapabilities.length;++k){var l=f.audioCapabilities[k];if(l.contentType){h=!0;var m=l.contentType.split(";")[0];MSMediaKeys.isTypeSupported(this.keySystem,m)&&(g.audioCapabilities.push(l),d=!0);}}if(f.videoCapabilities)for(k=
0;k<f.videoCapabilities.length;++k)l=f.videoCapabilities[k],l.contentType&&(h=!0,m=l.contentType.split(";")[0],MSMediaKeys.isTypeSupported(this.keySystem,m)&&(g.videoCapabilities.push(l),d=!0));h||(d=MSMediaKeys.isTypeSupported(this.keySystem,"video/mp4"));"required"==f.persistentState&&(d=!1);if(d){this.a=g;return}}d=Error("Unsupported keySystem");d.name="NotSupportedError";d.code=DOMException.NOT_SUPPORTED_ERR;throw d;}Gj.prototype.createMediaKeys=function(){var b=new Hj(this.keySystem);return Promise.resolve(b)};
Gj.prototype.getConfiguration=function(){return this.a};function Ij(b){var c=this.mediaKeys;c&&c!=b&&Jj(c,null);delete this.mediaKeys;return(this.mediaKeys=b)?Jj(b,this):Promise.resolve()}function Hj(b){this.a=new MSMediaKeys(b);this.b=new C;}Hj.prototype.createSession=function(b){var c=b||"temporary";if("temporary"!=c)throw new TypeError("Session type "+b+" is unsupported on this platform.");return new Kj(this.a,c)};Hj.prototype.setServerCertificate=function(){return Promise.resolve(!1)};
function Jj(b,c){function d(){c.msSetMediaKeys(e.a);c.removeEventListener("loadedmetadata",d);}yb(b.b);if(!c)return Promise.resolve();D(b.b,c,"msneedkey",Lj);var e=b;try{return 1<=c.readyState?c.msSetMediaKeys(b.a):c.addEventListener("loadedmetadata",d),Promise.resolve()}catch(f){return Promise.reject(f)}}function Kj(b){K.call(this);this.c=null;this.g=b;this.b=this.a=null;this.f=new C;this.sessionId="";this.expiration=NaN;this.closed=new y;this.keyStatuses=new Mj;}Aa(Kj,K);n=Kj.prototype;
n.generateRequest=function(b,c){this.a=new y;try{this.c=this.g.createSession("video/mp4",new Uint8Array(c),null),D(this.f,this.c,"mskeymessage",this.Od.bind(this)),D(this.f,this.c,"mskeyadded",this.Md.bind(this)),D(this.f,this.c,"mskeyerror",this.Nd.bind(this)),Nj(this,"status-pending");}catch(d){this.a.reject(d);}return this.a};n.load=function(){return Promise.reject(Error("MediaKeySession.load not yet supported"))};n.update=function(b){this.b=new y;try{this.c.update(new Uint8Array(b));}catch(c){this.b.reject(c);}return this.b};
...
function Lj(b){var c=document.createEvent("CustomEvent");c.initCustomEvent("encrypted",!1,!1,null);c.initDataType="cenc";if(b=b.initData){var d=new Ej(b);if(!(1>=d.a.length)){for(var e=[],f=0;f<d.a.length;f++)e.push(b.subarray(d.a[f].start,d.a[f].end+1));b=gb(e,Oj);for(e=d=0;e<b.length;e++)d+=b[e].length;d=new Uint8Array(d);for(f=e=0;f<b.length;f++)d.set(b[f],e),e+=b[f].length;b=d;}}c.initData=b;this.dispatchEvent(c);}function Oj(b,c){return Zb(b,c)}
n.Od=function(b){this.a&&(this.a.resolve(),this.a=null);this.dispatchEvent(new E("message",{messageType:void 0==this.keyStatuses.a?"licenserequest":"licenserenewal",message:b.message.buffer}));};n.Md=function(){this.a?(Nj(this,"usable"),this.a.resolve(),this.a=null):this.b&&(Nj(this,"usable"),this.b.resolve(),this.b=null);};
n.Nd=function(){var b=Error("EME PatchedMediaKeysMs key error");b.errorCode=this.c.error;if(null!=this.a)this.a.reject(b),this.a=null;else if(null!=this.b)this.b.reject(b),this.b=null;else switch(this.c.error.code){case MSMediaKeyError.MS_MEDIA_KEYERR_OUTPUT:case MSMediaKeyError.MS_MEDIA_KEYERR_HARDWARECHANGE:Nj(this,"output-not-allowed");break;default:Nj(this,"internal-error");}};function Nj(b,c){var d=b.keyStatuses;d.size=void 0==c?0:1;d.a=c;b.dispatchEvent(new E("keystatuseschange"));}
function Mj(){this.size=0;this.a=void 0;}var Pj;n=Mj.prototype;n.forEach=function(b){this.a&&b(this.a,Pj);};n.get=function(b){if(this.has(b))return this.a};n.has=function(b){var c=Pj;return this.a&&Zb(new Uint8Array(b),new Uint8Array(c))?!0:!1};n.entries=function(){};n.keys=function(){};n.values=function(){};
uj(function(){!window.HTMLVideoElement||!window.MSMediaKeys||navigator.requestMediaKeySystemAccess&&MediaKeySystemAccess.prototype.getConfiguration||(Pj=(new Uint8Array([0])).buffer,delete HTMLMediaElement.prototype.mediaKeys,HTMLMediaElement.prototype.mediaKeys=null,HTMLMediaElement.prototype.setMediaKeys=Ij,window.MediaKeys=Hj,window.MediaKeySystemAccess=Gj,navigator.requestMediaKeySystemAccess=Fj);});function Qj(){return Promise.reject(Error("The key system specified is not supported."))}function Rj(b){return null==b?Promise.resolve():Promise.reject(Error("MediaKeys not supported."))}function Sj(){throw new TypeError("Illegal constructor.");}Sj.prototype.createSession=function(){};Sj.prototype.setServerCertificate=function(){};function Tj(){throw new TypeError("Illegal constructor.");}Tj.prototype.getConfiguration=function(){};Tj.prototype.createMediaKeys=function(){};
uj(function(){!window.HTMLVideoElement||navigator.requestMediaKeySystemAccess&&MediaKeySystemAccess.prototype.getConfiguration||(navigator.requestMediaKeySystemAccess=Qj,delete HTMLMediaElement.prototype.mediaKeys,HTMLMediaElement.prototype.mediaKeys=null,HTMLMediaElement.prototype.setMediaKeys=Rj,window.MediaKeys=Sj,window.MediaKeySystemAccess=Tj);},-10);var Uj="";function Vj(b){var c=Uj;return c?c+b.charAt(0).toUpperCase()+b.slice(1):b}function Wj(b,c){try{var d=new Xj(b,c);return Promise.resolve(d)}catch(e){return Promise.reject(e)}}function Yj(b){var c=this.mediaKeys;c&&c!=b&&Zj(c,null);delete this.mediaKeys;(this.mediaKeys=b)&&Zj(b,this);return Promise.resolve()}
function Xj(b,c){this.a=this.keySystem=b;var d=!1;"org.w3.clearkey"==b&&(this.a="webkit-org.w3.clearkey",d=!1);var e=!1;var f=document.getElementsByTagName("video");f=f.length?f[0]:document.createElement("video");for(var g=0;g<c.length;++g){var h=c[g],k={audioCapabilities:[],videoCapabilities:[],persistentState:"optional",distinctiveIdentifier:"optional",initDataTypes:h.initDataTypes,sessionTypes:["temporary"],label:h.label},l=!1;if(h.audioCapabilities)for(var m=0;m<h.audioCapabilities.length;++m){var r=
...
e=!1);if(e){this.b=k;return}}d="Unsupported keySystem";if("org.w3.clearkey"==b||"com.widevine.alpha"==b)d="None of the requested configurations were supported.";d=Error(d);d.name="NotSupportedError";d.code=DOMException.NOT_SUPPORTED_ERR;throw d;}Xj.prototype.createMediaKeys=function(){var b=new ak(this.a);return Promise.resolve(b)};Xj.prototype.getConfiguration=function(){return this.b};function ak(b){this.g=b;this.b=null;this.a=new C;this.c=[];this.f={};}
function Zj(b,c){b.b=c;yb(b.a);var d=Uj;c&&(D(b.a,c,d+"needkey",b.be.bind(b)),D(b.a,c,d+"keymessage",b.ae.bind(b)),D(b.a,c,d+"keyadded",b.Zd.bind(b)),D(b.a,c,d+"keyerror",b.$d.bind(b)));}n=ak.prototype;n.createSession=function(b){var c=b||"temporary";if("temporary"!=c&&"persistent-license"!=c)throw new TypeError("Session type "+b+" is unsupported on this platform.");b=this.b||document.createElement("video");b.src||(b.src="about:blank");c=new bk(b,this.g,c);this.c.push(c);return c};
n.setServerCertificate=function(){return Promise.resolve(!1)};n.be=function(b){var c=document.createEvent("CustomEvent");c.initCustomEvent("encrypted",!1,!1,null);c.initDataType="webm";c.initData=b.initData;this.b.dispatchEvent(c);};n.ae=function(b){var c=ck(this,b.sessionId);c&&(b=new E("message",{messageType:void 0==c.keyStatuses.a?"licenserequest":"licenserenewal",message:b.message}),c.b&&(c.b.resolve(),c.b=null),c.dispatchEvent(b));};
n.Zd=function(b){if(b=ck(this,b.sessionId))dk(b,"usable"),b.a&&b.a.resolve(),b.a=null;};
n.$d=function(b){var c=ck(this,b.sessionId);if(c){var d=Error("EME v0.1b key error");d.errorCode=b.errorCode;d.errorCode.systemCode=b.systemCode;!b.sessionId&&c.b?(d.method="generateRequest",45==b.systemCode&&(d.message="Unsupported session type."),c.b.reject(d),c.b=null):b.sessionId&&c.a?(d.method="update",c.a.reject(d),c.a=null):(d=b.systemCode,b.errorCode.code==MediaKeyError.MEDIA_KEYERR_OUTPUT?dk(c,"output-restricted"):1==d?dk(c,"expired"):dk(c,"internal-error"));}};
function ck(b,c){var d=b.f[c];return d?d:(d=b.c.shift())?(d.sessionId=c,b.f[c]=d):null}function bk(b,c,d){K.call(this);this.f=b;this.h=!1;this.a=this.b=null;this.c=c;this.g=d;this.sessionId="";this.expiration=NaN;this.closed=new y;this.keyStatuses=new ek;}Aa(bk,K);
function fk(b,c,d){if(b.h)return Promise.reject(Error("The session is already initialized."));b.h=!0;try{if("persistent-license"==b.g)if(d)var e=new Uint8Array(Rb("LOAD_SESSION|"+d));else{var f=Rb("PERSISTENT|"),g=new Uint8Array(f.byteLength+c.byteLength);g.set(new Uint8Array(f),0);g.set(new Uint8Array(c),f.byteLength);e=g;}else e=new Uint8Array(c);}catch(k){return Promise.reject(k)}b.b=new y;var h=Vj("generateKeyRequest");try{b.f[h](b.c,e);}catch(k){if("InvalidStateError"!=k.name)return b.b=null,Promise.reject(k);
setTimeout(function(){try{this.f[h](this.c,e);}catch(l){this.b.reject(l),this.b=null;}}.bind(b),10);}return b.b}n=bk.prototype;
n.cc=function(b,c){if(this.a)this.a.then(this.cc.bind(this,b,c))["catch"](this.cc.bind(this,b,c));else{this.a=b;if("webkit-org.w3.clearkey"==this.c){var d=G(c);var e=JSON.parse(d);"oct"!=e.keys[0].kty&&(this.a.reject(Error("Response is not a valid JSON Web Key Set.")),this.a=null);d=Wb(e.keys[0].k);e=Wb(e.keys[0].kid);}else d=new Uint8Array(c),e=null;var f=Vj("addKey");try{this.f[f](this.c,d,e,this.sessionId);}catch(g){this.a.reject(g),this.a=null;}}};
function dk(b,c){var d=b.keyStatuses;d.size=void 0==c?0:1;d.a=c;b.dispatchEvent(new E("keystatuseschange"));}n.generateRequest=function(b,c){return fk(this,c,null)};n.load=function(b){return"persistent-license"==this.g?fk(this,null,b):Promise.reject(Error("Not a persistent session."))};n.update=function(b){var c=new y;this.cc(c,b);return c};
n.close=function(){if("persistent-license"!=this.g){if(!this.sessionId)return this.closed.reject(Error("The session is not callable.")),this.closed;var b=Vj("cancelKeyRequest");try{this.f[b](this.c,this.sessionId);}catch(c){}}this.closed.resolve();return this.closed};n.remove=function(){return"persistent-license"!=this.g?Promise.reject(Error("Not a persistent session.")):this.close()};function ek(){this.size=0;this.a=void 0;}var gk;n=ek.prototype;n.forEach=function(b){this.a&&b(this.a,gk);};n.get=function(b){if(this.has(b))return this.a};
n.has=function(b){var c=gk;return this.a&&Zb(new Uint8Array(b),new Uint8Array(c))?!0:!1};n.entries=function(){};n.keys=function(){};n.values=function(){};
uj(function(){if(!(!window.HTMLVideoElement||navigator.requestMediaKeySystemAccess&&MediaKeySystemAccess.prototype.getConfiguration)){if(HTMLMediaElement.prototype.webkitGenerateKeyRequest)Uj="webkit";else if(!HTMLMediaElement.prototype.generateKeyRequest)return;gk=(new Uint8Array([0])).buffer;navigator.requestMediaKeySystemAccess=Wj;delete HTMLMediaElement.prototype.mediaKeys;HTMLMediaElement.prototype.mediaKeys=null;HTMLMediaElement.prototype.setMediaKeys=Yj;window.MediaKeys=ak;window.MediaKeySystemAccess=
Xj;}});uj(function(){if(window.HTMLMediaElement){var b=HTMLMediaElement.prototype.play;HTMLMediaElement.prototype.play=function(){var c=b.apply(this,arguments);c&&c["catch"](function(){});return c};}});function hk(){return{droppedVideoFrames:this.webkitDroppedFrameCount,totalVideoFrames:this.webkitDecodedFrameCount,corruptedVideoFrames:0,creationTime:NaN,totalFrameDelay:0}}uj(function(){if(window.HTMLVideoElement){var b=HTMLVideoElement.prototype;!b.getVideoPlaybackQuality&&"webkitDroppedFrameCount"in b&&(b.getVideoPlaybackQuality=hk);}});function ik(b,c,d){return new window.TextTrackCue(b,c,d)}function jk(b,c,d){return new window.TextTrackCue(b+"-"+c+"-"+d,b,c,d)}uj(function(){if(!window.VTTCue&&window.TextTrackCue){var b=TextTrackCue.length;if(3==b)window.VTTCue=ik;else if(6==b)window.VTTCue=jk;else{try{var c=!!ik(1,2,"");}catch(d){c=!1;}c&&(window.VTTCue=ik);}}});function kk(){}kk.prototype.parseInit=function(){};
kk.prototype.parseMedia=function(b,c){var d=G(b),e=[],f=new DOMParser,g=null;try{g=f.parseFromString(d,"text/xml");}catch(Da){throw new v(2,2,2005);}if(g){if(f=g.getElementsByTagName("tt")[0]){g=f.getAttribute("ttp:frameRate");var h=f.getAttribute("ttp:subFrameRate");var k=f.getAttribute("ttp:frameRateMultiplier");var l=f.getAttribute("ttp:tickRate");d=f.getAttribute("xml:space")||"default";}else throw new v(2,2,2005);if("default"!=d&&"preserve"!=d)throw new v(2,2,2005);d="default"==d;g=new lk(g,h,
k,l);h=mk(f.getElementsByTagName("styling")[0]);k=mk(f.getElementsByTagName("layout")[0]);l=[];for(var m=0;m<k.length;m++){var r=k[m],t=h;var u=new wc;var w=r.getAttribute("xml:id");if(w){u.id=w;var x;if(x=nk(r,t,"tts:extent"))x=(w=ok.exec(x))||pk.exec(x),null!=x&&(u.width=Number(x[1]),u.height=Number(x[2]),u.widthUnits=w?Jc:0,u.heightUnits=w?Jc:0);if(r=nk(r,t,"tts:origin"))x=(w=ok.exec(r))||pk.exec(r),null!=x&&(u.viewportAnchorX=Number(x[1]),u.viewportAnchorY=Number(x[2]),u.viewportAnchorUnits=w?
Jc:0);}else u=null;u&&l.push(u);}f=mk(f.getElementsByTagName("body")[0]);for(m=0;m<f.length;m++)(u=qk(f[m],c.periodStart,g,h,k,l,d))&&e.push(u);}return e};
var ok=/^(\d{1,2}|100)% (\d{1,2}|100)%$/,rk=/^(\d+px|\d+em)$/,pk=/^(\d+)px (\d+)px$/,sk=/^(\d{2,}):(\d{2}):(\d{2}):(\d{2})\.?(\d+)?$/,tk=/^(?:(\d{2,}):)?(\d{2}):(\d{2})$/,uk=/^(?:(\d{2,}):)?(\d{2}):(\d{2}\.\d{2,})$/,vk=/^(\d*(?:\.\d*)?)f$/,wk=/^(\d*(?:\.\d*)?)t$/,xk=/^(?:(\d*(?:\.\d*)?)h)?(?:(\d*(?:\.\d*)?)m)?(?:(\d*(?:\.\d*)?)s)?(?:(\d*(?:\.\d*)?)ms)?$/,yk={left:"start",center:Bc,right:"end",start:"start",end:"end"},zk={left:"line-left",center:"center",right:"line-right"};
function mk(b){var c=[];if(!b)return c;for(var d=b.childNodes,e=0;e<d.length;e++){var f="span"==d[e].nodeName&&"p"==b.nodeName;d[e].nodeType!=Node.ELEMENT_NODE||"br"==d[e].nodeName||f||(f=mk(d[e]),c=c.concat(f));}c.length||c.push(b);return c}function Ak(b,c){for(var d=b.childNodes,e=0;e<d.length;e++)if("br"==d[e].nodeName&&0<e)d[e-1].textContent+="\n";else if(0<d[e].childNodes.length)Ak(d[e],c);else if(c){var f=d[e].textContent.trim();f=f.replace(/\s+/g," ");d[e].textContent=f;}}
function qk(b,c,d,e,f,g,h){if(!b.hasAttribute("begin")&&!b.hasAttribute("end")&&/^\s*$/.test(b.textContent))return null;Ak(b,h);h=Bk(b.getAttribute("begin"),d);var k=Bk(b.getAttribute("end"),d);d=Bk(b.getAttribute("dur"),d);var l=b.textContent;null==k&&null!=d&&(k=h+d);if(null==h||null==k)throw new v(2,2,2001);c=new H(h+c,k+c,l);if((f=Ck(b,"region",f))&&f.getAttribute("xml:id")){var m=f.getAttribute("xml:id");g=g.filter(function(b){return b.id==m});c.region=g[0];}Dk(c,b,f,e);return c}
function Dk(b,c,d,e){"rtl"==Ek(c,d,e,"tts:direction")&&(b.writingDirection=1);var f=Ek(c,d,e,"tts:writingMode");"tb"==f||"tblr"==f?b.writingDirection=2:"tbrl"==f?b.writingDirection=3:"rltb"==f||"rl"==f?b.writingDirection=1:f&&(b.writingDirection=zc);if(f=Ek(c,d,e,"tts:textAlign"))b.positionAlign=zk[f],b.lineAlign=yk[f],b.textAlign=Fc[f.toUpperCase()];if(f=Ek(c,d,e,"tts:displayAlign"))b.displayAlign=Gc[f.toUpperCase()];if(f=Ek(c,d,e,"tts:color"))b.color=f;if(f=Ek(c,d,e,"tts:backgroundColor"))b.backgroundColor=
f;if(f=Ek(c,d,e,"tts:fontFamily"))b.fontFamily=f;(f=Ek(c,d,e,"tts:fontWeight"))&&"bold"==f&&(b.fontWeight=700);(f=Ek(c,d,e,"tts:wrapOption"))&&"noWrap"==f&&(b.wrapLine=!1);(f=Ek(c,d,e,"tts:lineHeight"))&&f.match(rk)&&(b.lineHeight=f);(f=Ek(c,d,e,"tts:fontSize"))&&f.match(rk)&&(b.fontSize=f);if(f=Ek(c,d,e,"tts:fontStyle"))b.fontStyle=Ic[f.toUpperCase()];(d=nk(d,e,"tts:textDecoration"))&&Fk(b,d);(c=Gk(c,e,"tts:textDecoration"))&&Fk(b,c);}
function Fk(b,c){for(var d=c.split(" "),e=0;e<d.length;e++)switch(d[e]){case "underline":0>b.textDecoration.indexOf("underline")&&b.textDecoration.push("underline");break;case "noUnderline":0<=b.textDecoration.indexOf("underline")&&ib(b.textDecoration,"underline");break;case "lineThrough":0>b.textDecoration.indexOf("lineThrough")&&b.textDecoration.push("lineThrough");break;case "noLineThrough":0<=b.textDecoration.indexOf("lineThrough")&&ib(b.textDecoration,"lineThrough");break;case "overline":0>b.textDecoration.indexOf("overline")&&
b.textDecoration.push("overline");break;case "noOverline":0<=b.textDecoration.indexOf("overline")&&ib(b.textDecoration,"overline");}}function Ek(b,c,d,e){return(b=Gk(b,d,e))?b:nk(c,d,e)}function nk(b,c,d){for(var e=mk(b),f=0;f<e.length;f++){var g=e[f].getAttribute(d);if(g)return g}return(b=Ck(b,"style",c))?b.getAttribute(d):null}function Gk(b,c,d){return(b=Ck(b,"style",c))?b.getAttribute(d):null}
function Ck(b,c,d){if(!b||1>d.length)return null;var e=null,f=b;for(b=null;f&&!(b=f.getAttribute(c))&&(f=f.parentNode,f instanceof Element););if(c=b)for(b=0;b<d.length;b++)if(d[b].getAttribute("xml:id")==c){e=d[b];break}return e}
function Bk(b,c){var d=null;if(sk.test(b)){d=sk.exec(b);var e=Number(d[1]),f=Number(d[2]),g=Number(d[3]),h=Number(d[4]);h+=(Number(d[5])||0)/c.b;g+=h/c.frameRate;d=g+60*f+3600*e;}else tk.test(b)?d=Hk(tk,b):uk.test(b)?d=Hk(uk,b):vk.test(b)?(d=vk.exec(b),d=Number(d[1])/c.frameRate):wk.test(b)?(d=wk.exec(b),d=Number(d[1])/c.a):xk.test(b)&&(d=Hk(xk,b));return d}
function Hk(b,c){var d=b.exec(c);return null==d||""==d[0]?null:(Number(d[4])||0)/1E3+(Number(d[3])||0)+60*(Number(d[2])||0)+3600*(Number(d[1])||0)}function lk(b,c,d,e){this.frameRate=Number(b)||30;this.b=Number(c)||1;this.a=Number(e);0==this.a&&(this.a=b?this.frameRate*this.b:1);d&&(b=/^(\d+) (\d+)$/g.exec(d))&&(this.frameRate*=b[1]/b[2]);}I["application/ttml+xml"]=kk;function Ik(){this.a=new kk;}Ik.prototype.parseInit=function(b){var c=!1;(new R).C("moov",S).C("trak",S).C("mdia",S).C("minf",S).C("stbl",S).V("stsd",He).C("stpp",function(b){c=!0;b.na.stop();}).parse(b);if(!c)throw new v(2,2,2007);};Ik.prototype.parseMedia=function(b,c){var d=!1,e=[];(new R).C("mdat",Ie(function(b){d=!0;e=e.concat(this.a.parseMedia(b,c));}.bind(this))).parse(b);if(!d)throw new v(2,2,2007);return e};I['application/mp4; codecs="stpp"']=Ik;
I['application/mp4; codecs="stpp.TTML.im1t"']=Ik;function Jk(){}Jk.prototype.parseInit=function(){};
Jk.prototype.parseMedia=function(b,c){var d=G(b);d=d.replace(/\r\n|\r(?=[^\n]|$)/gm,"\n");d=d.split(/\n{2,}/m);if(!/^WEBVTT($|[ \t\n])/m.test(d[0]))throw new v(2,2,2E3);var e=c.segmentStart;if(null==e&&(e=0,0<=d[0].indexOf("X-TIMESTAMP-MAP"))){var f=d[0].match(/LOCAL:((?:(\d{1,}):)?(\d{2}):(\d{2})\.(\d{3}))/m),g=d[0].match(/MPEGTS:(\d+)/m);f&&g&&(e=Kk(new Lf(f[1])),e=c.periodStart+(Number(g[1])/9E4-e));}g=[];var h=d[0].split("\n");for(f=1;f<h.length;f++)if(/^Region:/.test(h[f])){var k=new Lf(h[f]),
l=new wc;Of(k);Mf(k);for(var m=Of(k);m;){var r=l,t=m;(m=/^id=(.*)$/.exec(t))?r.id=m[1]:(m=/^width=(\d{1,2}|100)%$/.exec(t))?r.width=Number(m[1]):(m=/^lines=(\d+)$/.exec(t))?(r.height=Number(m[1]),r.heightUnits=2):(m=/^regionanchor=(\d{1,2}|100)%,(\d{1,2}|100)%$/.exec(t))?(r.regionAnchorX=Number(m[1]),r.regionAnchorY=Number(m[2])):(m=/^viewportanchor=(\d{1,2}|100)%,(\d{1,2}|100)%$/.exec(t))?(r.viewportAnchorX=Number(m[1]),r.viewportAnchorY=Number(m[2])):/^scroll=up$/.exec(t)&&(r.scroll="up");Mf(k);
m=Of(k);}g.push(l);}f=[];for(k=1;k<d.length;k++){h=d[k].split("\n");m=h;t=e;h=g;if(1==m.length&&!m[0]||/^NOTE($|[ \t])/.test(m[0])||"STYLE"==m[0])h=null;else{l=null;0>m[0].indexOf("--\x3e")&&(l=m[0],m.splice(0,1));r=new Lf(m[0]);var u=Kk(r),w=Nf(r,/[ \t]+--\x3e[ \t]+/g),x=Kk(r);if(null==u||null==w||null==x)throw new v(2,2,2001);m=new H(u+t,x+t,m.slice(1).join("\n").trim());Mf(r);for(t=Of(r);t;)Lk(m,t,h),Mf(r),t=Of(r);null!=l&&(m.id=l);h=m;}h&&f.push(h);}return f};
...
else if(e=/^region:(.*)$/.exec(c)){if(c=Mk(d,e[1]))b.region=c;}else if(d=/^line:([\d.]+)%(?:,(start|end|center))?$/.exec(c))b.lineInterpretation=1,b.line=Number(d[1]),d[2]&&(b.lineAlign=Hc[d[2].toUpperCase()]);else if(d=/^line:(-?\d+)(?:,(start|end|center))?$/.exec(c))b.lineInterpretation=Ac,b.line=Number(d[1]),d[2]&&(b.lineAlign=Hc[d[2].toUpperCase()]);}function Mk(b,c){var d=b.filter(function(b){return b.id==c});return d.length?d[0]:null}
function Kk(b){b=Nf(b,/(?:(\d{1,}):)?(\d{2}):(\d{2})\.(\d{3})/g);if(null==b)return null;var c=Number(b[2]),d=Number(b[3]);return 59<c||59<d?null:Number(b[4])/1E3+d+60*c+3600*(Number(b[1])||0)}I["text/vtt"]=Jk;I['text/vtt; codecs="vtt"']=Jk;function Nk(){this.a=null;}Nk.prototype.parseInit=function(b){var c=!1;(new R).C("moov",S).C("trak",S).C("mdia",S).V("mdhd",function(b){0==b.version?(b.s.D(4),b.s.D(4),this.a=b.s.B(),b.s.D(4)):(b.s.D(8),b.s.D(8),this.a=b.s.B(),b.s.D(8));b.s.D(4);}.bind(this)).C("minf",S).C("stbl",S).V("stsd",He).C("wvtt",function(){c=!0;}).parse(b);if(!this.a)throw new v(2,2,2008);if(!c)throw new v(2,2,2008);};
Nk.prototype.parseMedia=function(b,c){var d=this;if(!this.a)throw new v(2,2,2008);var e=0,f=[],g,h=[],k=!1,l=!1,m=!1,r=null;(new R).C("moof",S).C("traf",S).V("tfdt",function(b){k=!0;e=0==b.version?b.s.B():b.s.Pa();}).V("tfhd",function(b){var c=b.flags;b=b.s;b.D(4);c&1&&b.D(8);c&2&&b.D(4);r=c&8?b.B():null;}).V("trun",function(b){l=!0;var c=b.version,d=b.flags;b=b.s;var e=b.B();d&1&&b.D(4);d&4&&b.D(4);for(var g=[],h=0;h<e;h++){var k={duration:null,sampleSize:null,dc:null};d&256&&(k.duration=b.B());d&
512&&(k.sampleSize=b.B());d&1024&&b.D(4);d&2048&&(k.dc=0==c?b.B():b.Ic());g.push(k);}f=g;}).C("mdat",Ie(function(b){m=!0;g=b;})).parse(b);if(!m&&!k&&!l)throw new v(2,2,2008);var t=e,u=new DataView(g.buffer,g.byteOffset,g.byteLength),w=new Q(u,0);f.forEach(function(b){var f=b.duration||r,g=b.dc?e+b.dc:t;t=g+(f||0);var k=0;do{var l=w.B();k+=l;var m=w.B(),u=null;"vttc"==Je(m)?8<l&&(u=w.Aa(l-8)):w.D(l-8);f&&u&&h.push(Ok(u,c.periodStart+g/d.a,c.periodStart+t/d.a));}while(b.sampleSize&&k<b.sampleSize)});return h.filter(Eb)};
function Ok(b,c,d){var e,f,g;(new R).C("payl",Ie(function(b){e=G(b);})).C("iden",Ie(function(b){f=G(b);})).C("sttg",Ie(function(b){g=G(b);})).parse(b);return e?Pk(e,f,g,c,d):null}function Pk(b,c,d,e,f){b=new H(e,f,b);c&&(b.id=c);if(d)for(c=new Lf(d),d=Of(c);d;)Lk(b,d,[]),Mf(c),d=Of(c);return b}I['application/mp4; codecs="wvtt"']=Nk;}.call(g,this));
