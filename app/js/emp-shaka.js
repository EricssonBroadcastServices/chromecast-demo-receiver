...
function Aa(b,c){function d(){}d.prototype=c.prototype;b.sf=c.prototype;b.prototype=new d;b.prototype.constructor=b;b.pf=function(b,d,g){return c.prototype[d].apply(b,Array.prototype.slice.call(arguments,2))};}/*
...
function xb(b,c,d,e,f,g){var h=new Ka(d.uris[f]),k=h.na;k||(k=location.protocol,k=k.slice(0,-1),La(h,k),d.uris[f]=h.toString());var l=(k=sb[k])?k.ye:null;if(!l)return fb(new A(2,1,1E3,h));var m;return ib(eb(e)).X(function(){if(b.c)return gb();m=Date.now();var e=l(d.uris[f],d,c);void 0==e.promise&&(Ha("The scheme plugin interface has changed!  Please update your scheme plugins to the new interface to add support for abort().  Support for the old plugin interface will be removed in v2.5."),e=ib(e));
...
function $b(b){for(var c=[],d=0;d<arguments.length;++d)c[d]=arguments[d];for(var e=d=0;e<c.length;++e)d+=c[e].length;d=new Uint8Array(d);for(var f=e=0;f<c.length;++f)d.set(c[f],e),e+=c[f].length;return d}x("shaka.util.Uint8ArrayUtils.concat",$b);function ac(b){var c=this;this.u=b;this.l=this.j=this.w=null;this.M=!1;this.b=null;this.g=new Ab;this.a=[];this.o=[];this.i=new y;this.f=null;this.h=function(d){c.i.reject(d);b.onError(d);};this.m={};this.I=new Sb(function(){return bc(c)});this.Z=this.c=!1;this.K=[];this.V=!1;this.A=new Sb(function(){return cc(c)});Ub(this.A,1);this.i["catch"](function(){});}n=ac.prototype;
n.destroy=function(){this.c=!0;var b=[];this.a.forEach(function(c){c=c.ha.close()["catch"](F.Ha);var d=dc(1E3);b.push(Promise.race([c,d]));});this.i.reject();this.g&&b.push(this.g.destroy());this.l&&b.push(this.l.setMediaKeys(null)["catch"](F.Ha));this.A&&(this.A.cancel(),this.A=null);this.I&&(this.I.cancel(),this.I=null);this.g=this.l=this.j=this.w=this.b=null;this.a=[];this.o=[];this.u=this.h=this.f=null;return Promise.all(b)};n.configure=function(b){this.f=b;};
n.init=function(b,c){var d={},e=[],f=b.periods.some(function(b){return b.variants.some(function(b){return b.drmInfos.length})});this.Z=c;this.o=b.offlineSessionIds;ec(this,b,c||0<b.offlineSessionIds.length,d,e,f);return e.length?fc(this,d,e,f):(this.M=!0,Promise.resolve())};
...
6,6004,b.message))}));return Promise.all([b,d]).then(function(){if(c.c)return Promise.reject();hc(c);c.b.initData.length||c.o.length||D(c.g,c.l,"encrypted",function(b){a:{for(var d=new Uint8Array(b.initData),e=0;e<c.a.length;++e)if(Zb(d,c.a[e].initData)){b=void 0;break a}ic(c,b.initDataType,d);b=void 0;}return b});})["catch"](function(b){return c.c?Promise.resolve():Promise.reject(b)})};function jc(b,c){return Promise.all(c.map(function(c){return kc(b,c)}))}
...
!0,this.a.every(function(b){return b.loaded})&&this.i.resolve());"expired"==b&&(d=!0);f=Yb(new Uint8Array(e));this.m[f]=b;}.bind(this));var e=b.expiration-Date.now();(0>e||d&&1E3>e)&&!this.a[c].ia&&(this.a.splice(c,1),b.close()["catch"](function(){}));Tb(this.I);}};function bc(b){function c(b,c){return"expired"==c}!Hb(b.m)&&Ib(b.m,c)&&b.h(new A(2,6,6014));b.u.Ib(b.m);}
...
f.persistentStateRequired,videoRobustness:g.videoRobustness||f.videoRobustness,audioRobustness:g.audioRobustness||f.audioRobustness,serverCertificate:g.serverCertificate||f.serverCertificate,initData:h,keyIds:k});break}return d}function cc(b){b.a.forEach(function(b){var c=b.gc,e=b.ha.expiration;isNaN(e)&&(e=Infinity);e!=c&&(this.u.onExpirationUpdated(b.ha.sessionId,e),b.gc=e);}.bind(b));}function dc(b){return new Promise(function(c){return setTimeout(c,b)})}function yc(b){return!b||1==b.length&&1E-6>b.end(0)-b.start(0)?null:b.length?b.end(b.length-1):null}function Cc(b,c,d){d=void 0===d?0:d;return!b||!b.length||1==b.length&&1E-6>b.end(0)-b.start(0)||c>b.end(b.length-1)?!1:c+d>=b.start(0)}function Dc(b,c){if(!b||!b.length||1==b.length&&1E-6>b.end(0)-b.start(0))return 0;for(var d=0,e=b.length-1;0<=e&&b.end(e)>c;--e)d+=b.end(e)-Math.max(b.start(e),c);return d}
...
n.get=function(b,c){if("video"==b){if(0<=Rd.indexOf(c))return this.Wc.bind(this,b,c)}else if("player"==b){if(Ud[c]&&!this.get("player","isLive")())return function(){};if(0<=Xd.indexOf(c))return this.Wc.bind(this,b,c);if(0<=Yd.indexOf(c))return this.Ce.bind(this,b,c);if(Td[c])return this.Tc.bind(this,b,c)}return this.Tc(b,c)};n.set=function(b,c,d){this.a[b][c]=d;ge({type:"set",targetName:b,property:c,value:d});};
...
n.Wc=function(b,c,d){for(var e=[],f=2;f<arguments.length;++f)e[f-2]=arguments[f];ge({type:"call",targetName:b,methodName:c,args:e});};n.Ce=function(b,c,d){for(var e=[],f=2;f<arguments.length;++f)e[f-2]=arguments[f];f=new y;var g=this.o.toString();this.o++;this.c[g]=f;ge({type:"asyncCall",targetName:b,methodName:c,args:e,id:g});return f};n.Mc=function(b){var c=this.u();this.f=new y;this.j=!0;this.hc(c,b);};n.ie=function(b){ce="available"==b;this.g();};
...
}if(null==h)throw new A(2,3,3011);g=f/1E9;f=h*g;b=Pe(new Ne(new DataView(b)));if(475249515!=b.id)throw new A(2,3,3007);return Ue(b,c,g,f,d,e)};function Ue(b,c,d,e,f,g){function h(){return f}var k=[];b=new Ne(b.a);for(var l=null,m=null;b.ka();){var r=Pe(b);if(187==r.id){var t=Ve(r);t&&(r=d*t.gf,t=c+t.Be,null!=l&&k.push(new N(k.length,l-g,r-g,h,m,t-1)),l=r,m=t);}}null!=l&&k.push(new N(k.length,l-g,e-g,h,m,null));return k}
function Ve(b){var c=new Ne(b.a);b=Pe(c);if(179!=b.id)throw new A(2,3,3013);b=Se(b);c=Pe(c);if(183!=c.id)throw new A(2,3,3012);c=new Ne(c.a);for(var d=0;c.ka();){var e=Pe(c);if(241==e.id){d=Se(e);break}}return{gf:b,Be:d}}function We(b,c){var d=ze(b,c,"Initialization");if(!d)return null;var e=b.v.ga,f=d.getAttribute("sourceURL");f&&(e=Eb(b.v.ga,[f]));f=0;var g=null;if(d=M.F(d,"range",M.Lb))f=d.start,g=d.end;return new De(function(){return e},f,g)}
...
T.prototype.qb=function(b){this.l=b;};T.prototype.setStatic=T.prototype.qb;T.prototype.pc=function(b){this.f=b;};T.prototype.setSegmentAvailabilityDuration=T.prototype.pc;T.prototype.Oe=function(b){this.Mb=b;};T.prototype.setDelay=T.prototype.Oe;T.prototype.Cd=function(){return this.Mb};T.prototype.getDelay=T.prototype.Cd;
...
function uf(b,c,d,e){c.da=wf(e.node,null,d);c.O=e;c.da.id||(c.da.id="__shaka_period_"+e.start);M.N(e.node,"EventStream").forEach(b.ve.bind(b,e.start,e.duration));d=M.N(e.node,"AdaptationSet").map(b.se.bind(b,c)).filter(F.ma);if(c.Pa){c=d.map(function(b){return b.De}).reduce(F.ja,[]);var f=c.filter(F.la);if(c.length!=f.length)throw new A(2,4,4018);}var g=d.filter(function(b){return!b.sc});d.filter(function(b){return b.sc}).forEach(function(b){var c=b.streams[0],d=b.sc;g.forEach(function(b){b.id==d&&
...
height:b.v.height,kind:d,encrypted:0<c.drmInfos.length,keyId:k,language:e,label:f,type:b.W.contentType,primary:g,trickModeVideo:null,containsEmsgBoxes:b.v.containsEmsgBoxes,roles:h,channelsCount:b.v.fc}};n.Ze=function(){this.g=null;qf(this).then(function(b){this.a&&rf(this,b);}.bind(this))["catch"](function(b){this.a&&(b.severity=1,this.a.onError(b),rf(this,0));}.bind(this));};function rf(b,c){0>b.m||(b.g=window.setTimeout(b.Ze.bind(b),1E3*Math.max(3,b.m-c,Da(b.o))));}
...
function Cf(b,c,d,e){c=Eb(c,[d]);c=ub(c,b.b.retryParameters);c.method=e;c=b.a.networkingEngine.request(4,c);rb(b.f,c);return c.promise.then(function(b){if("HEAD"==e){if(!b.headers||!b.headers.date)return 0;b=b.headers.date;}else b=Nb(b.data);b=Date.parse(b);return isNaN(b)?0:b-Date.now()})}
...
ob:b,drmInfos:Q,mc:l,dc:c,rf:d,duration:u}}.bind(b))}function Dg(b){var c=If(b.a,"EXT-X-MAP");if(!c.length)return null;if(1<c.length)throw new A(2,4,4020);c=c[0];var d=qg(c,"URI"),e=Lf(b.uri,d);b=0;d=null;if(c=Gf(c,"BYTERANGE"))b=c.split("@"),c=Number(b[0]),b=Number(b[1]),d=b+c-1;return new De(function(){return[e]},b,d)}
...
function Fh(b,c,d,e,f,g,h){f.containsEmsgBoxes&&(new P).$("emsg",b.ue.bind(b,e,g)).parse(h);return Ih(b,c,d).then(function(){if(!this.f)return gd(this.a.L,c.type,h,g.startTime,g.endTime)}.bind(b)).then(function(){if(!this.f)return c.Ta=f,c.sa=g,Promise.resolve()}.bind(b))}
n.ue=function(b,c,d){var e=d.reader.jc(),f=d.reader.jc(),g=d.reader.B(),h=d.reader.B(),k=d.reader.B(),l=d.reader.B();d=d.reader.Ka(d.reader.H.byteLength-d.reader.Y());b=b.startTime+c.startTime+h/g;if("urn:mpeg:dash:event:2012"==e)this.a.ae();else this.a.onEvent(new E("emsg",{detail:{startTime:b,endTime:b+k/g,schemeIdUri:e,value:f,timescale:g,presentationTimeDelta:h,eventDuration:k,id:l,messageData:d}}));};
function Ih(b,c,d){var e=Math.max(b.g.bufferBehind,b.b.presentationTimeline.a),f=cd(b.a.L,c.type);if(null==f)return Promise.resolve();d=d-f-e;return 0>=d?Promise.resolve():b.a.L.remove(c.type,f,f+d).then(function(){}.bind(b))}function Gh(b,c){if(!b.o&&(b.o=G(b.c).every(function(b){return"text"==b.type?!0:!b.ya&&!b.Da&&b.sa}),b.o)){var d=Md(b.b,c);b.h[d]||vh(b,d).then(function(){this.f||this.a.Ic();}.bind(b))["catch"](F.Ha);for(d=0;d<b.b.periods.length;++d)vh(b,d)["catch"](F.Ha);b.a.me&&b.a.me();}}
...
W.prototype.destroy=function(){var b=this;return p(function d(){return w(d,function(d){switch(d.s){case 1:return q(d,b.detach(),2);case 2:return q(d,b.Aa.destroy(),0)}})})};W.prototype.destroy=W.prototype.destroy;W.version="v2.4.3-3";var Pi=["output-restricted","internal-error"],Qi={};W.registerSupportPlugin=function(b,c){Qi[b]=c;};
...
e.u=new u;e.u.setTextVisibility(e.fb);if(h)throw h;z=v=null;d&&("string"==typeof d?z=d:(Ha("Loading with a manifest parser factory is deprecated. Instead please register a manifest parser and pass in the mime type."),v=d));Y=e;if(v){ba=new v;g.P(5);break}return q(g,Ri(e,b,z),6);case 6:ba=g.C;case 5:return Y.m=ba,e.m.configure(e.c.manifest),e.cb=b,Ea=e,q(g,Si(e),7);case 7:Ea.b=g.C;if(h)throw h;Ti(e);e.i=new ac({Va:e.I,onError:e.bb.bind(e),Ib:e.$d.bind(e),onExpirationUpdated:e.Xd.bind(e),onEvent:e.rb.bind(e)});
e.i.configure(e.c.drm);return q(g,e.i.init(e.b,!1),8);case 8:if(h)throw h;e.dd(e.b.periods);e.vb=Date.now()/1E3;e.M=e.c.preferredAudioLanguage;e.za=e.c.preferredTextLanguage;e.Z=e.c.preferredAudioChannelCount;Ui(e.b.presentationTimeline,e.c.playRangeStart,e.c.playRangeEnd,e.U());return q(g,e.i.Ab(e.f),9);case 9:if(h)throw h;e.h.init(e.Ue.bind(e));e.j||(e.j=new $c(e.f));e.j.o=e.u;e.g=new Sg(e.f,e.b.presentationTimeline,e.b.minBufferTime||0,e.c.streaming,c,e.Te.bind(e),e.rb.bind(e));e.w=new Zg(e.f,
e.b.minBufferTime,e.c.streaming,e.ed.bind(e),e.rb.bind(e),e.Se.bind(e),new ch(e.f,e.j,e.b));e.a=new dh(e.b,{Ja:e.g,L:e.j,Va:e.I,Jc:e.Vd.bind(e),Ic:e.rd.bind(e),onError:e.bb.bind(e),onEvent:e.rb.bind(e),ae:e.be.bind(e),lb:e.ke.bind(e)});e.a.configure(e.c.streaming);Vi(e);e.dispatchEvent(new E("streaming"));return q(g,e.a.init(),10);case 10:if(h)throw h;e.c.streaming.startAtSegmentBoundary&&(Fa=Wi(e,Vg(e.g)),Pg(e.g.b,Fa));e.b.periods.forEach(e.Tb.bind(e));Xi(e);Yi(e);X=U(e.a);Q=Dd(X.variants,e.M,e.Na,
...
W.prototype.Fe=function(){this.c=Li(this);$i(this);};W.prototype.resetConfiguration=W.prototype.Fe;W.prototype.Hd=function(){return this.f};W.prototype.getMediaElement=W.prototype.Hd;W.prototype.Qa=function(){return this.I};W.prototype.getNetworkingEngine=W.prototype.Qa;W.prototype.Ub=function(){return this.cb};W.prototype.getAssetUri=W.prototype.Ub;W.prototype.Gd=function(){Ha('"getManifestUri" is deprecated and will be removed in v2.6. Please use "getAssetUri" instead.');return this.cb};
W.prototype.getManifestUri=W.prototype.Gd;W.prototype.U=function(){return this.b?this.b.presentationTimeline.U():!1};W.prototype.isLive=W.prototype.U;W.prototype.Fa=function(){return this.b?this.b.presentationTimeline.Fa():!1};W.prototype.isInProgress=W.prototype.Fa;W.prototype.Sd=function(){if(!this.b||!this.b.periods.length)return!1;var b=this.b.periods[0].variants;return b.length?!b[0].video:!1};W.prototype.isAudioOnly=W.prototype.Sd;
W.prototype.He=function(){var b=0,c=0;this.b&&(c=this.b.presentationTimeline,b=c.Ra(),c=c.ra());return{start:b,end:c}};W.prototype.seekRange=W.prototype.He;W.prototype.keySystem=function(){return this.i?this.i.keySystem():""};W.prototype.keySystem=W.prototype.keySystem;W.prototype.drmInfo=function(){return this.i?this.i.b:null};W.prototype.drmInfo=W.prototype.drmInfo;W.prototype.Gb=function(){return this.i?this.i.Gb():Infinity};W.prototype.getExpiration=W.prototype.Gb;W.prototype.Gc=function(){return this.yb};
...
W.prototype.getPlaybackRate=W.prototype.gb;W.prototype.cf=function(b){this.g&&Rg(this.g.b,b);this.a&&ph(this.a,1!=b);};W.prototype.trickPlay=W.prototype.cf;W.prototype.sd=function(){this.g&&Rg(this.g.b,1);this.a&&ph(this.a,!1);};W.prototype.cancelTrickPlay=W.prototype.sd;W.prototype.Pd=function(){if(!this.b||!this.g)return[];var b=Ld(this.b,Vg(this.g)),c=this.K[b]||{};return zd(this.b.periods[b],c.audio,c.video)};W.prototype.getVariantTracks=W.prototype.Pd;
W.prototype.Od=function(){if(!this.b||!this.g)return[];var b=Ld(this.b,Vg(this.g)),c=this.K[b]||{};if(!c.text){var d=Hd(this.b.periods[b].textStreams,this.za,this.eb);d.length&&(c.text=d[0].id);}return Ad(this.b.periods[b],c.text).filter(function(b){return 0>this.Pb.indexOf(b.id)}.bind(this))};W.prototype.getTextTracks=W.prototype.Od;
W.prototype.Le=function(b){if(this.a){var c=U(this.a);a:{for(var d=0;d<c.textStreams.length;d++)if(c.textStreams[d].id==b.id){b=c.textStreams[d];break a}b=null;}b&&(this.j.l=!1,cj(this,b,!1),c=b,this.Ba?this.A=c:qh(this.a,c,!0,0),this.za=b.language);}};W.prototype.selectTextTrack=W.prototype.Le;W.prototype.Je=function(){this.j.l=!0;oh(this.a);};W.prototype.selectEmbeddedTextTrack=W.prototype.Je;W.prototype.hf=function(){return this.j?this.j.l:!1};W.prototype.usingEmbeddedTextTrack=W.prototype.hf;
W.prototype.Me=function(b,c,d){d=void 0===d?0:d;if(this.a){this.c.abr.enabled&&Ha("Changing tracks while abr manager is enabled will likely result in the selected track being overriden. Consider disabling abr before calling selectVariantTrack().");var e=U(this.a);(b=Bd(e,b))&&Cd(b)&&(dj(this,b,!1),ej(this,b,c,d),this.M=b.language,b.audio&&b.audio.channelsCount&&(this.Z=b.audio.channelsCount),c=Dd(e.variants,this.M,this.Na,this.Z),this.h.setVariants(c));}};W.prototype.selectVariantTrack=W.prototype.Me;
W.prototype.Bd=function(){if(!this.a)return[];var b=U(this.a);b=yd(b.variants).map(function(b){return b.audio}).filter(F.la);return fj(b)};W.prototype.getAudioLanguagesAndRoles=W.prototype.Bd;W.prototype.Nd=function(){if(!this.a)return[];var b=U(this.a);return fj(b.textStreams)};W.prototype.getTextLanguagesAndRoles=W.prototype.Nd;W.prototype.Ad=function(){if(!this.a)return[];var b=U(this.a);return yd(b.variants).map(function(b){return b.language}).filter(F.la)};W.prototype.getAudioLanguages=W.prototype.Ad;
W.prototype.Md=function(){return this.a?U(this.a).textStreams.map(function(b){return b.language}).filter(F.la):[]};W.prototype.getTextLanguages=W.prototype.Md;function fj(b){var c=[];b.forEach(function(b){if(b){var d=b.language;b.roles.length?b.roles.forEach(function(b){c.push({language:d,role:b});}):c.push({language:d,role:""});}else c.push({language:"und",role:""});});return lb(c,function(b,c){return b.language==c.language&&b.role==c.role})}
W.prototype.Ie=function(b,c){if(this.a){var d=U(this.a);this.M=b;this.Na=c||"";aj(this,d);}};W.prototype.selectAudioLanguage=W.prototype.Ie;W.prototype.Ke=function(b,c){if(this.a){var d=U(this.a);this.za=b;this.eb=c||"";aj(this,d);}};W.prototype.selectTextLanguage=W.prototype.Ke;W.prototype.$b=function(){return this.u?this.u.isTextVisible():this.fb};W.prototype.isTextTrackVisible=W.prototype.$b;
W.prototype.Qe=function(b){this.u&&this.u.setTextVisibility(b);this.fb=b;gj(this);!this.c.streaming.alwaysStreamText&&this.a&&(b?(b=U(this.a),(b=Hd(b.textStreams,this.za,this.eb)[0])&&kh(this.a,b,!0)):oh(this.a));};W.prototype.setTextTrackVisibility=W.prototype.Qe;W.prototype.Jd=function(){return this.b?new Date(1E3*this.b.presentationTimeline.b+1E3*this.f.currentTime):null};W.prototype.getPlayheadTimeAsDate=W.prototype.Jd;
...
n.generateRequest=function(b,c){this.a=new y;try{this.c=this.g.createSession("video/mp4",new Uint8Array(c),null),D(this.f,this.c,"mskeymessage",this.fe.bind(this)),D(this.f,this.c,"mskeyadded",this.de.bind(this)),D(this.f,this.c,"mskeyerror",this.ee.bind(this)),mk(this,"status-pending");}catch(d){this.a.reject(d);}return this.a};n.load=function(){return Promise.reject(Error("MediaKeySession.load not yet supported"))};n.update=function(b){this.b=new y;try{this.c.update(new Uint8Array(b));}catch(c){this.b.reject(c);}return this.b};
...
n.fe=function(b){this.a&&(this.a.resolve(),this.a=null);this.dispatchEvent(new E("message",{messageType:void 0==this.keyStatuses.a?"licenserequest":"licenserenewal",message:b.message.buffer}));};n.de=function(){this.a?(mk(this,"usable"),this.a.resolve(),this.a=null):this.b&&(mk(this,"usable"),this.b.resolve(),this.b=null);};
n.ee=function(){var b=Error("EME PatchedMediaKeysMs key error");b.errorCode=this.c.error;if(null!=this.a)this.a.reject(b),this.a=null;else if(null!=this.b)this.b.reject(b),this.b=null;else switch(this.c.error.code){case MSMediaKeyError.MS_MEDIA_KEYERR_OUTPUT:case MSMediaKeyError.MS_MEDIA_KEYERR_HARDWARECHANGE:mk(this,"output-not-allowed");break;default:mk(this,"internal-error");}};function mk(b,c){var d=b.keyStatuses;d.size=void 0==c?0:1;d.a=c;b.dispatchEvent(new E("keystatuseschange"));}
...
function yk(b,c){b.b=c;Bb(b.a);var d=tk;c&&(D(b.a,c,d+"needkey",b.re.bind(b)),D(b.a,c,d+"keymessage",b.qe.bind(b)),D(b.a,c,d+"keyadded",b.oe.bind(b)),D(b.a,c,d+"keyerror",b.pe.bind(b)));}n=zk.prototype;n.createSession=function(b){b=b||"temporary";if("temporary"!=b&&"persistent-license"!=b)throw new TypeError("Session type "+b+" is unsupported on this platform.");var c=this.b||document.createElement("video");c.src||(c.src="about:blank");b=new Ak(c,this.g,b);this.c.push(b);return b};
n.setServerCertificate=function(){return Promise.resolve(!1)};n.re=function(b){var c=document.createEvent("CustomEvent");c.initCustomEvent("encrypted",!1,!1,null);c.initDataType="webm";c.initData=b.initData;this.b.dispatchEvent(c);};n.qe=function(b){var c=Bk(this,b.sessionId);c&&(b=new E("message",{messageType:void 0==c.keyStatuses.a?"licenserequest":"licenserenewal",message:b.message}),c.b&&(c.b.resolve(),c.b=null),c.dispatchEvent(b));};
n.oe=function(b){if(b=Bk(this,b.sessionId))Ck(b,"usable"),b.a&&b.a.resolve(),b.a=null;};
n.pe=function(b){var c=Bk(this,b.sessionId);if(c){var d=Error("EME v0.1b key error");d.errorCode=b.errorCode;d.errorCode.systemCode=b.systemCode;!b.sessionId&&c.b?(d.method="generateRequest",45==b.systemCode&&(d.message="Unsupported session type."),c.b.reject(d),c.b=null):b.sessionId&&c.a?(d.method="update",c.a.reject(d),c.a=null):(d=b.systemCode,b.errorCode.code==MediaKeyError.MEDIA_KEYERR_OUTPUT?Ck(c,"output-restricted"):1==d?Ck(c,"expired"):Ck(c,"internal-error"));}};
...
var DownloadService = function (_Plugin) {
  ...
  DownloadService.prototype.deleteAll = function deleteAll() {
    shaka$1.offline.Storage.doNotReleaseLicense(true);
...
DownloadService.VERSION = '2.0.89-129';
