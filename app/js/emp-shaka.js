...
n.init=function(b,c){var d={},e=[],f=b.periods.some(function(b){return b.variants.some(function(b){return b.drmInfos.length})});this.fa=c;this.s=b.offlineSessionIds;ec(this,b,c||0<b.offlineSessionIds.length,d,e);return e.length?fc(this,d,e,f):(this.L=!0,Promise.resolve())};
...
return Promise.all([b,c]).then(function(){if(this.c)return Promise.reject();gc(this);this.b.initData.length||this.s.length||E(this.g,this.l,"encrypted",this.Gd.bind(this));}.bind(this))["catch"](function(b){return this.c?Promise.resolve():Promise.reject(b)}.bind(this))};
function hc(b,c){return Promise.all(c.map(function(b){return ic(this,b).then(function(b){if(b){for(var c=new z,d=0;d<this.a.length;d++)if(this.a[d].ia==b){this.a[d].oa=c;break}return Promise.all([b.remove(),c])}}.bind(this))}.bind(b)))}function gc(b){var c=b.b?b.b.initData:[];c.forEach(function(b){jc(this,b.initDataType,b.initData);}.bind(b));b.s.forEach(function(b){ic(this,b);}.bind(b));c.length||b.s.length||b.i.resolve();return b.i}n.keySystem=function(){return this.b?this.b.keySystem:""};
...
function ec(b,c,d,e,f){var g=lc(b),h=mc(b,c);c.periods.forEach(function(b){b.variants.forEach(function(b){g&&(b.drmInfos=[g]);h&&(b.drmInfos=h);b.drmInfos.forEach(function(c){nc(this,c);var g=e[c.keySystem];g||(g={audioCapabilities:[],videoCapabilities:[],distinctiveIdentifier:"optional",persistentState:d?"required":"optional",sessionTypes:[d?"persistent-license":"temporary"],label:c.keySystem,drmInfos:[]},e[c.keySystem]=g,f.push(c.keySystem));g.drmInfos.push(c);c.distinctiveIdentifierRequired&&(g.distinctiveIdentifier=
...
function od(b,c,d,e){e.variants=e.variants.filter(function(e){return b&&b.L&&!uc(b,e)?!1:pd(e.audio,b,c)&&pd(e.video,b,d)});e.textStreams=e.textStreams.filter(function(b){return!!I[Mb(b.mimeType,b.codecs)]});}
...
function Id(b,c){b&&(c=c.filter(function(c){return md(c,b,{width:Infinity,height:Infinity})}));return c.sort(function(b,c){return b.bandwidth-c.bandwidth})}var Jd="ended play playing pause pausing ratechange seeked seeking timeupdate volumechange".split(" "),Kd="buffered currentTime duration ended loop muted paused playbackRate seeking videoHeight videoWidth volume".split(" "),Od=["loop","playbackRate"],Pd=["pause","play"],Qd="adaptation buffering emsg error loading streaming texttrackvisibility timelineregionadded timelineregionenter timelineregionexit trackschanged unloading".split(" "),Rd={getAudioLanguages:2,getAudioLanguagesAndRoles:2,getBufferedInfo:2,
...
n.pc=function(){var b={video:{},player:{},playerAfterLoad:{},manifest:this.b.Gb(),startTime:null};this.c.pause();Od.forEach(function(c){b.video[c]=this.c[c];}.bind(this));this.c.ended||(b.startTime=this.c.currentTime);Td.forEach(function(c){var d=c[1];c=this.b[c[0]]();b.player[d]=c;}.bind(this));Ud.forEach(function(c){var d=c[1];c=this.b[c[0]]();b.playerAfterLoad[d]=c;}.bind(this));return b};n.Je=function(){this.dispatchEvent(new F("caststatuschanged"));};
n.Ke=function(){this.f.dispatchEvent(new F(this.h.paused?"pause":"play"));};
n.Me=function(){var b=this;Td.forEach(function(b){var c=b[1];b=this.a.get("player",b[0])();this.b[c](b);}.bind(this));var c=this.a.get("player","getManifestUri")(),d=this.a.get("video","ended"),e=Promise.resolve(),f=this.c.autoplay,g=null;d||(g=this.a.get("video","currentTime"));c&&(this.c.autoplay=!1,e=this.b.load(c,g));var h={};Od.forEach(function(b){h[b]=this.a.get("video",b);}.bind(this));e.then(function(){b.c&&(Od.forEach(function(b){this.c[b]=h[b];}.bind(b)),Ud.forEach(function(b){var c=b[1];b=
...
n.stop=function(){this.g=this.c=null;this.u={};this.J={};this.o=null;return this.h.destroy()};n.update=function(){if(this.f!=jg.pa){var b=[],c;for(c in this.a)b.push(kg(this,this.a[c],c));return Promise.all(b)}};
function kg(b,c,d){fg(b,d).then(function(b){var e=jg,g=Yf(this.s,b.data,d);if(1!=g.type)throw new A(2,4,4017);b=Qf(g.a,"EXT-X-MEDIA-SEQUENCE");var h=c.stream;lg(this,g,b?Number(b.value):0,h.mimeType,h.codecs).then(function(b){c.cb.a=b;b=b[b.length-1];Qf(g.a,"EXT-X-ENDLIST")&&(mg(this,e.pa),this.b.ja(b.endTime));}.bind(this));}.bind(b));}n.onExpirationUpdated=function(){};
function gg(b,c,d){c=Yf(b.s,c,d);if(0!=c.type)throw new A(2,4,4022);return ng(b,c).then(function(b){this.c.filterAllPeriods([b]);var c=Infinity,d=0,e=0,k=Infinity;for(m in this.a){var l=this.a[m];c=Math.min(c,l.Ob);d=Math.max(d,l.Ob);e=Math.max(e,l.Cd);"text"!=l.stream.type&&(k=Math.min(k,l.duration));}var m=null;l=0;this.f!=jg.pa&&(m=Date.now()/1E3-e,l=3*this.l);this.b=new U(m,l);this.b.xb(this.f==jg.pa);og(this);if(this.f!=jg.pa){c=3*this.l;this.b.Pc(c);this.i=this.A;this.f==jg.fc&&(isNaN(this.g.availabilityWindowOverride)||
...
function yg(b,c,d,e,f,g,h,k){var l=c;c=Sf(b.m,c);var m,r="",t;return fg(b,c).then(function(b){m=Yf(this.s,b.data,c);if(1!=m.type)throw new A(2,4,4017);b=m;var f=jg,g=Qf(b.a,"EXT-X-PLAYLIST-TYPE"),h=Qf(b.a,"EXT-X-ENDLIST");h=g&&"VOD"==g.value||h;g=g&&"EVENT"==g.value&&!h;g=!h&&!g;h?mg(this,f.pa):(g?mg(this,f.fc):mg(this,f.Wc),b=Ag(b.a,"EXT-X-TARGETDURATION"),b=Number(b.value),this.l=Math.max(b,this.l),this.A=Math.min(b,this.A));if(1==d.length)r=d[0];else if(b=sg(e,d),null!=b)r=b;else throw new A(2,
4,4025,d);return Bg(this,e,r,m)}.bind(b)).then(function(b){t=b;b=Qf(m.a,"EXT-X-MEDIA-SEQUENCE");return lg(this,m,b?Number(b.value):0,t,r)}.bind(b)).then(function(b){var c=b[0].startTime,d=b[b.length-1].endTime,u=d-c;b=new T(b);var Wa=Cg(m),ig=void 0;"text"==e&&(ig="subtitle");var Ld=[];m.segments.forEach(function(b){b=Pf(b.a,"EXT-X-KEY");Ld.push.apply(Ld,b);});var Md=!1,Nd=[],Lb=null;Ld.forEach(function(b){if("NONE"!=pg(b,"METHOD")){Md=!0;var c=pg(b,"KEYFORMAT");if(b=(c=Dg[c])?c(b):null)b.keyIds.length&&
(Lb=b.keyIds[0]),Nd.push(b);}});if(Md&&!Nd.length)throw new A(2,4,4026);Wa={id:this.L++,createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:b.find.bind(b),getSegmentReference:b.get.bind(b),initSegmentReference:Wa,presentationTimeOffset:0,mimeType:t,codecs:r,kind:ig,encrypted:Md,keyId:Lb,language:f,label:h||null,type:e,primary:g,trickModeVideo:null,containsEmsgBoxes:!1,frameRate:void 0,width:void 0,height:void 0,bandwidth:void 0,roles:[],channelsCount:k};this.X[Wa.id]=b;return{stream:Wa,
cb:b,drmInfos:Nd,Xb:l,Ob:c,Cd:d,duration:u}}.bind(b))}function Cg(b){var c=Pf(b.a,"EXT-X-MAP");if(!c.length)return null;if(1<c.length)throw new A(2,4,4020);c=c[0];var d=pg(c,"URI"),e=Sf(b.uri,d);b=0;d=null;if(c=Nf(c,"BYTERANGE"))b=c.split("@"),c=Number(b[0]),b=Number(b[1]),d=b+c-1;return new O(function(){return[e]},b,d)}
...
b.mediaSource_=this;b.addEventListener("updateend",Hj,!1);c||(this.addEventListener("sourceclose",Ij,!1),c=!0);return b};}function Hj(b){var c=b.target,d=c.mediaSource_;if(d.rc){b.preventDefault();b.stopPropagation();b.stopImmediatePropagation();c.mc=!0;for(b=0;b<d.sourceBuffers.length;++b)if(0==d.sourceBuffers[b].mc)return;d.rc=!1;}}
function Ij(b){b=b.target;for(var c=0;c<b.sourceBuffers.length;++c)b.sourceBuffers[c].removeEventListener("updateend",Hj,!1);b.removeEventListener("sourceclose",Ij,!1);}function Jj(){var b=MediaSource.isTypeSupported;MediaSource.isTypeSupported=function(c){return"mp2t"==c.split(/ *; */)[0].split("/")[1]?!1:b(c)};}
function Kj(){var b=MediaSource.isTypeSupported,c=/^dv(?:he|av)\./;MediaSource.isTypeSupported=function(d){for(var e=d.split(/ *; */),f=e[0],g={},h=1;h<e.length;++h){var k=e[h].split("="),l=k[0];k=k[1].replace(/"(.*)"/,"$1");g[l]=k;}e=g.codecs;if(!e)return b(d);var m=!1,r=!1;d=e.split(",").filter(function(b){if(c.test(b))return r=!0,!1;/^(hev|hvc)1\.2/.test(b)&&(m=!0);return!0});r&&(m=!1);g.codecs=d.join(",");m&&(g.eotf="smpte2084");for(var t in g)f+="; "+t+'="'+g[t]+'"';return cast.__platform__.canDisplayType(f)};}
Bj(function(){if(window.MediaSource)if(window.cast&&cast.__platform__&&cast.__platform__.canDisplayType)Kj();else if(navigator.vendor&&0<=navigator.vendor.indexOf("Apple")){var b=navigator.appVersion;Jj();0<=b.indexOf("Version/8")?window.MediaSource=null:0<=b.indexOf("Version/9")?Ej():0<=b.indexOf("Version/10")?(Ej(),Gj()):0<=b.indexOf("Version/11")&&(Ej(),Fj());}});function Lj(b){this.f=[];this.b=[];this.a=[];(new R).Y("pssh",this.c.bind(this)).parse(b.buffer);}Lj.prototype.c=function(b){if(!(1<b.version)){var c=$b(b.reader.Ba(16)),d=[];if(0<b.version)for(var e=b.reader.B(),f=0;f<e;++f){var g=$b(b.reader.Ba(16));d.push(g);}e=b.reader.B();b.reader.F(e);this.b.push.apply(this.b,d);this.f.push(c);this.a.push({start:b.start,end:b.start+b.size-1});}};function Mj(b,c){try{var d=new Nj(b,c);return Promise.resolve(d)}catch(e){return Promise.reject(e)}}
function Nj(b,c){this.keySystem=b;for(var d=!1,e=0;e<c.length;++e){var f=c[e],g={audioCapabilities:[],videoCapabilities:[],persistentState:"optional",distinctiveIdentifier:"optional",initDataTypes:f.initDataTypes,sessionTypes:["temporary"],label:f.label},h=!1;if(f.audioCapabilities)for(var k=0;k<f.audioCapabilities.length;++k){var l=f.audioCapabilities[k];if(l.contentType){h=!0;var m=l.contentType.split(";")[0];MSMediaKeys.isTypeSupported(this.keySystem,m)&&(g.audioCapabilities.push(l),d=!0);}}if(f.videoCapabilities)for(k=
0;k<f.videoCapabilities.length;++k)l=f.videoCapabilities[k],l.contentType&&(h=!0,m=l.contentType.split(";")[0],MSMediaKeys.isTypeSupported(this.keySystem,m)&&(g.videoCapabilities.push(l),d=!0));h||(d=MSMediaKeys.isTypeSupported(this.keySystem,"video/mp4"));"required"==f.persistentState&&(d=!1);if(d){this.a=g;return}}d=Error("Unsupported keySystem");d.name="NotSupportedError";d.code=DOMException.NOT_SUPPORTED_ERR;throw d;}Nj.prototype.createMediaKeys=function(){var b=new Oj(this.keySystem);return Promise.resolve(b)};
Nj.prototype.getConfiguration=function(){return this.a};function Pj(b){var c=this.mediaKeys;c&&c!=b&&Qj(c,null);delete this.mediaKeys;return(this.mediaKeys=b)?Qj(b,this):Promise.resolve()}function Oj(b){this.a=new MSMediaKeys(b);this.b=new D;}Oj.prototype.createSession=function(b){var c=b||"temporary";if("temporary"!=c)throw new TypeError("Session type "+b+" is unsupported on this platform.");return new Rj(this.a,c)};Oj.prototype.setServerCertificate=function(){return Promise.resolve(!1)};
function Qj(b,c){function d(){c.msSetMediaKeys(e.a);c.removeEventListener("loadedmetadata",d);}xb(b.b);if(!c)return Promise.resolve();E(b.b,c,"msneedkey",Sj);var e=b;try{return 1<=c.readyState?c.msSetMediaKeys(b.a):c.addEventListener("loadedmetadata",d),Promise.resolve()}catch(f){return Promise.reject(f)}}function Rj(b){K.call(this);this.c=null;this.g=b;this.b=this.a=null;this.f=new D;this.sessionId="";this.expiration=NaN;this.closed=new z;this.keyStatuses=new Tj;}Aa(Rj,K);n=Rj.prototype;
n.generateRequest=function(b,c){this.a=new z;try{this.c=this.g.createSession("video/mp4",new Uint8Array(c),null),E(this.f,this.c,"mskeymessage",this.Qd.bind(this)),E(this.f,this.c,"mskeyadded",this.Od.bind(this)),E(this.f,this.c,"mskeyerror",this.Pd.bind(this)),Uj(this,"status-pending");}catch(d){this.a.reject(d);}return this.a};n.load=function(){return Promise.reject(Error("MediaKeySession.load not yet supported"))};n.update=function(b){this.b=new z;try{this.c.update(new Uint8Array(b));}catch(c){this.b.reject(c);}return this.b};
...
function Sj(b){var c=document.createEvent("CustomEvent");c.initCustomEvent("encrypted",!1,!1,null);c.initDataType="cenc";if(b=b.initData){var d=new Lj(b);if(!(1>=d.a.length)){for(var e=[],f=0;f<d.a.length;f++)e.push(b.subarray(d.a[f].start,d.a[f].end+1));b=gb(e,Vj);for(e=d=0;e<b.length;e++)d+=b[e].length;d=new Uint8Array(d);for(f=e=0;f<b.length;f++)d.set(b[f],e),e+=b[f].length;b=d;}}c.initData=b;this.dispatchEvent(c);}function Vj(b,c){return ac(b,c)}
n.Qd=function(b){this.a&&(this.a.resolve(),this.a=null);this.dispatchEvent(new F("message",{messageType:void 0==this.keyStatuses.a?"licenserequest":"licenserenewal",message:b.message.buffer}));};n.Od=function(){this.a?(Uj(this,"usable"),this.a.resolve(),this.a=null):this.b&&(Uj(this,"usable"),this.b.resolve(),this.b=null);};
n.Pd=function(){var b=Error("EME PatchedMediaKeysMs key error");b.errorCode=this.c.error;if(null!=this.a)this.a.reject(b),this.a=null;else if(null!=this.b)this.b.reject(b),this.b=null;else switch(this.c.error.code){case MSMediaKeyError.MS_MEDIA_KEYERR_OUTPUT:case MSMediaKeyError.MS_MEDIA_KEYERR_HARDWARECHANGE:Uj(this,"output-not-allowed");break;default:Uj(this,"internal-error");}};function Uj(b,c){var d=b.keyStatuses;d.size=void 0==c?0:1;d.a=c;b.dispatchEvent(new F("keystatuseschange"));}
function Tj(){this.size=0;this.a=void 0;}var Wj;n=Tj.prototype;n.forEach=function(b){this.a&&b(this.a,Wj);};n.get=function(b){if(this.has(b))return this.a};n.has=function(b){var c=Wj;return this.a&&ac(new Uint8Array(b),new Uint8Array(c))?!0:!1};n.entries=function(){};n.keys=function(){};n.values=function(){};
Bj(function(){!window.HTMLVideoElement||!window.MSMediaKeys||navigator.requestMediaKeySystemAccess&&MediaKeySystemAccess.prototype.getConfiguration||(Wj=(new Uint8Array([0])).buffer,delete HTMLMediaElement.prototype.mediaKeys,HTMLMediaElement.prototype.mediaKeys=null,HTMLMediaElement.prototype.setMediaKeys=Pj,window.MediaKeys=Oj,window.MediaKeySystemAccess=Nj,navigator.requestMediaKeySystemAccess=Mj);});function Xj(){return Promise.reject(Error("The key system specified is not supported."))}function Yj(b){return null==b?Promise.resolve():Promise.reject(Error("MediaKeys not supported."))}function Zj(){throw new TypeError("Illegal constructor.");}Zj.prototype.createSession=function(){};Zj.prototype.setServerCertificate=function(){};function ak(){throw new TypeError("Illegal constructor.");}ak.prototype.getConfiguration=function(){};ak.prototype.createMediaKeys=function(){};
Bj(function(){!window.HTMLVideoElement||navigator.requestMediaKeySystemAccess&&MediaKeySystemAccess.prototype.getConfiguration||(navigator.requestMediaKeySystemAccess=Xj,delete HTMLMediaElement.prototype.mediaKeys,HTMLMediaElement.prototype.mediaKeys=null,HTMLMediaElement.prototype.setMediaKeys=Yj,window.MediaKeys=Zj,window.MediaKeySystemAccess=ak);},-10);var bk="";function ck(b){var c=bk;return c?c+b.charAt(0).toUpperCase()+b.slice(1):b}function dk(b,c){try{var d=new ek(b,c);return Promise.resolve(d)}catch(e){return Promise.reject(e)}}function fk(b){var c=this.mediaKeys;c&&c!=b&&gk(c,null);delete this.mediaKeys;(this.mediaKeys=b)&&gk(b,this);return Promise.resolve()}
function ek(b,c){this.a=this.keySystem=b;var d=!1;"org.w3.clearkey"==b&&(this.a="webkit-org.w3.clearkey",d=!1);var e=!1;var f=document.getElementsByTagName("video");f=f.length?f[0]:document.createElement("video");for(var g=0;g<c.length;++g){var h=c[g],k={audioCapabilities:[],videoCapabilities:[],persistentState:"optional",distinctiveIdentifier:"optional",initDataTypes:h.initDataTypes,sessionTypes:["temporary"],label:h.label},l=!1;if(h.audioCapabilities)for(var m=0;m<h.audioCapabilities.length;++m){var r=
...
e=!1);if(e){this.b=k;return}}d="Unsupported keySystem";if("org.w3.clearkey"==b||"com.widevine.alpha"==b)d="None of the requested configurations were supported.";d=Error(d);d.name="NotSupportedError";d.code=DOMException.NOT_SUPPORTED_ERR;throw d;}ek.prototype.createMediaKeys=function(){var b=new hk(this.a);return Promise.resolve(b)};ek.prototype.getConfiguration=function(){return this.b};function hk(b){this.g=b;this.b=null;this.a=new D;this.c=[];this.f={};}
function gk(b,c){b.b=c;xb(b.a);var d=bk;c&&(E(b.a,c,d+"needkey",b.de.bind(b)),E(b.a,c,d+"keymessage",b.ce.bind(b)),E(b.a,c,d+"keyadded",b.ae.bind(b)),E(b.a,c,d+"keyerror",b.be.bind(b)));}n=hk.prototype;n.createSession=function(b){var c=b||"temporary";if("temporary"!=c&&"persistent-license"!=c)throw new TypeError("Session type "+b+" is unsupported on this platform.");b=this.b||document.createElement("video");b.src||(b.src="about:blank");c=new ik(b,this.g,c);this.c.push(c);return c};
n.setServerCertificate=function(){return Promise.resolve(!1)};n.de=function(b){var c=document.createEvent("CustomEvent");c.initCustomEvent("encrypted",!1,!1,null);c.initDataType="webm";c.initData=b.initData;this.b.dispatchEvent(c);};n.ce=function(b){var c=jk(this,b.sessionId);c&&(b=new F("message",{messageType:void 0==c.keyStatuses.a?"licenserequest":"licenserenewal",message:b.message}),c.b&&(c.b.resolve(),c.b=null),c.dispatchEvent(b));};
n.ae=function(b){if(b=jk(this,b.sessionId))kk(b,"usable"),b.a&&b.a.resolve(),b.a=null;};
n.be=function(b){var c=jk(this,b.sessionId);if(c){var d=Error("EME v0.1b key error");d.errorCode=b.errorCode;d.errorCode.systemCode=b.systemCode;!b.sessionId&&c.b?(d.method="generateRequest",45==b.systemCode&&(d.message="Unsupported session type."),c.b.reject(d),c.b=null):b.sessionId&&c.a?(d.method="update",c.a.reject(d),c.a=null):(d=b.systemCode,b.errorCode.code==MediaKeyError.MEDIA_KEYERR_OUTPUT?kk(c,"output-restricted"):1==d?kk(c,"expired"):kk(c,"internal-error"));}};
function jk(b,c){var d=b.f[c];return d?d:(d=b.c.shift())?(d.sessionId=c,b.f[c]=d):null}function ik(b,c,d){K.call(this);this.f=b;this.h=!1;this.a=this.b=null;this.c=c;this.g=d;this.sessionId="";this.expiration=NaN;this.closed=new z;this.keyStatuses=new lk;}Aa(ik,K);
function mk(b,c,d){if(b.h)return Promise.reject(Error("The session is already initialized."));b.h=!0;try{if("persistent-license"==b.g)if(d)var e=new Uint8Array(Sb("LOAD_SESSION|"+d));else{var f=Sb("PERSISTENT|"),g=new Uint8Array(f.byteLength+c.byteLength);g.set(new Uint8Array(f),0);g.set(new Uint8Array(c),f.byteLength);e=g;}else e=new Uint8Array(c);}catch(k){return Promise.reject(k)}b.b=new z;var h=ck("generateKeyRequest");try{b.f[h](b.c,e);}catch(k){if("InvalidStateError"!=k.name)return b.b=null,Promise.reject(k);
setTimeout(function(){try{this.f[h](this.c,e);}catch(l){this.b.reject(l),this.b=null;}}.bind(b),10);}return b.b}n=ik.prototype;
n.bc=function(b,c){if(this.a)this.a.then(this.bc.bind(this,b,c))["catch"](this.bc.bind(this,b,c));else{this.a=b;if("webkit-org.w3.clearkey"==this.c){var d=Ob(c);var e=JSON.parse(d);"oct"!=e.keys[0].kty&&(this.a.reject(Error("Response is not a valid JSON Web Key Set.")),this.a=null);d=Yb(e.keys[0].k);e=Yb(e.keys[0].kid);}else d=new Uint8Array(c),e=null;var f=ck("addKey");try{this.f[f](this.c,d,e,this.sessionId);}catch(g){this.a.reject(g),this.a=null;}}};
function kk(b,c){var d=b.keyStatuses;d.size=void 0==c?0:1;d.a=c;b.dispatchEvent(new F("keystatuseschange"));}n.generateRequest=function(b,c){return mk(this,c,null)};n.load=function(b){return"persistent-license"==this.g?mk(this,null,b):Promise.reject(Error("Not a persistent session."))};n.update=function(b){var c=new z;this.bc(c,b);return c};
n.close=function(){if("persistent-license"!=this.g){if(!this.sessionId)return this.closed.reject(Error("The session is not callable.")),this.closed;var b=ck("cancelKeyRequest");try{this.f[b](this.c,this.sessionId);}catch(c){}}this.closed.resolve();return this.closed};n.remove=function(){return"persistent-license"!=this.g?Promise.reject(Error("Not a persistent session.")):this.close()};function lk(){this.size=0;this.a=void 0;}var nk;n=lk.prototype;n.forEach=function(b){this.a&&b(this.a,nk);};n.get=function(b){if(this.has(b))return this.a};
n.has=function(b){var c=nk;return this.a&&ac(new Uint8Array(b),new Uint8Array(c))?!0:!1};n.entries=function(){};n.keys=function(){};n.values=function(){};
Bj(function(){if(!(!window.HTMLVideoElement||navigator.requestMediaKeySystemAccess&&MediaKeySystemAccess.prototype.getConfiguration)){if(HTMLMediaElement.prototype.webkitGenerateKeyRequest)bk="webkit";else if(!HTMLMediaElement.prototype.generateKeyRequest)return;nk=(new Uint8Array([0])).buffer;navigator.requestMediaKeySystemAccess=dk;delete HTMLMediaElement.prototype.mediaKeys;HTMLMediaElement.prototype.mediaKeys=null;HTMLMediaElement.prototype.setMediaKeys=fk;window.MediaKeys=hk;window.MediaKeySystemAccess=
ek;}});Bj(function(){if(window.HTMLMediaElement){var b=HTMLMediaElement.prototype.play;HTMLMediaElement.prototype.play=function(){var c=b.apply(this,arguments);c&&c["catch"](function(){});return c};}});function ok(){return{droppedVideoFrames:this.webkitDroppedFrameCount,totalVideoFrames:this.webkitDecodedFrameCount,corruptedVideoFrames:0,creationTime:NaN,totalFrameDelay:0}}Bj(function(){if(window.HTMLVideoElement){var b=HTMLVideoElement.prototype;!b.getVideoPlaybackQuality&&"webkitDroppedFrameCount"in b&&(b.getVideoPlaybackQuality=ok);}});function pk(b,c,d){return new window.TextTrackCue(b,c,d)}function qk(b,c,d){return new window.TextTrackCue(b+"-"+c+"-"+d,b,c,d)}Bj(function(){if(!window.VTTCue&&window.TextTrackCue){var b=TextTrackCue.length;if(3==b)window.VTTCue=pk;else if(6==b)window.VTTCue=qk;else{try{var c=!!pk(1,2,"");}catch(d){c=!1;}c&&(window.VTTCue=pk);}}});function rk(){}rk.prototype.parseInit=function(){};
rk.prototype.parseMedia=function(b,c){var d=Ob(b),e=[],f=new DOMParser,g=null;try{g=f.parseFromString(d,"text/xml");}catch(Ha){throw new A(2,2,2005);}if(g){if(f=g.getElementsByTagName("tt")[0]){g=f.getAttribute("ttp:frameRate");var h=f.getAttribute("ttp:subFrameRate");var k=f.getAttribute("ttp:frameRateMultiplier");var l=f.getAttribute("ttp:tickRate");d=f.getAttribute("xml:space")||"default";}else throw new A(2,2,2005);if("default"!=d&&"preserve"!=d)throw new A(2,2,2005);d="default"==d;g=new sk(g,h,
k,l);h=tk(f.getElementsByTagName("styling")[0]);k=tk(f.getElementsByTagName("layout")[0]);l=[];for(var m=0;m<k.length;m++){var r=k[m],t=h;var u=new Ac;var w=r.getAttribute("xml:id");if(w){u.id=w;var y;if(y=uk(r,t,"tts:extent"))y=(w=vk.exec(y))||wk.exec(y),null!=y&&(u.width=Number(y[1]),u.height=Number(y[2]),u.widthUnits=w?Nc:0,u.heightUnits=w?Nc:0);if(r=uk(r,t,"tts:origin"))y=(w=vk.exec(r))||wk.exec(r),null!=y&&(u.viewportAnchorX=Number(y[1]),u.viewportAnchorY=Number(y[2]),u.viewportAnchorUnits=w?
Nc:0);}else u=null;u&&l.push(u);}f=tk(f.getElementsByTagName("body")[0]);for(m=0;m<f.length;m++)(u=xk(f[m],c.periodStart,g,h,k,l,d))&&e.push(u);}return e};
var vk=/^(\d{1,2}|100)% (\d{1,2}|100)%$/,yk=/^(\d+px|\d+em)$/,wk=/^(\d+)px (\d+)px$/,zk=/^(\d{2,}):(\d{2}):(\d{2}):(\d{2})\.?(\d+)?$/,Ak=/^(?:(\d{2,}):)?(\d{2}):(\d{2})$/,Bk=/^(?:(\d{2,}):)?(\d{2}):(\d{2}\.\d{2,})$/,Ck=/^(\d*(?:\.\d*)?)f$/,Dk=/^(\d*(?:\.\d*)?)t$/,Ek=/^(?:(\d*(?:\.\d*)?)h)?(?:(\d*(?:\.\d*)?)m)?(?:(\d*(?:\.\d*)?)s)?(?:(\d*(?:\.\d*)?)ms)?$/,Fk={left:"start",center:Fc,right:"end",start:"start",end:"end"},Gk={left:"line-left",center:"center",right:"line-right"};
function tk(b){var c=[];if(!b)return c;for(var d=b.childNodes,e=0;e<d.length;e++){var f="span"==d[e].nodeName&&"p"==b.nodeName;d[e].nodeType!=Node.ELEMENT_NODE||"br"==d[e].nodeName||f||(f=tk(d[e]),c=c.concat(f));}c.length||c.push(b);return c}function Hk(b,c){for(var d=b.childNodes,e=0;e<d.length;e++)if("br"==d[e].nodeName&&0<e)d[e-1].textContent+="\n";else if(0<d[e].childNodes.length)Hk(d[e],c);else if(c){var f=d[e].textContent.trim();f=f.replace(/\s+/g," ");d[e].textContent=f;}}
function xk(b,c,d,e,f,g,h){if(!b.hasAttribute("begin")&&!b.hasAttribute("end")&&/^\s*$/.test(b.textContent))return null;Hk(b,h);h=Ik(b.getAttribute("begin"),d);var k=Ik(b.getAttribute("end"),d);d=Ik(b.getAttribute("dur"),d);var l=b.textContent;null==k&&null!=d&&(k=h+d);if(null==h||null==k)throw new A(2,2,2001);c=new H(h+c,k+c,l);if((f=Jk(b,"region",f))&&f.getAttribute("xml:id")){var m=f.getAttribute("xml:id");g=g.filter(function(b){return b.id==m});c.region=g[0];}Kk(c,b,f,e);return c}
function Kk(b,c,d,e){"rtl"==Lk(c,d,e,"tts:direction")&&(b.writingDirection=1);var f=Lk(c,d,e,"tts:writingMode");"tb"==f||"tblr"==f?b.writingDirection=2:"tbrl"==f?b.writingDirection=3:"rltb"==f||"rl"==f?b.writingDirection=1:f&&(b.writingDirection=Dc);if(f=Lk(c,d,e,"tts:textAlign"))b.positionAlign=Gk[f],b.lineAlign=Fk[f],b.textAlign=Jc[f.toUpperCase()];if(f=Lk(c,d,e,"tts:displayAlign"))b.displayAlign=Kc[f.toUpperCase()];if(f=Lk(c,d,e,"tts:color"))b.color=f;if(f=Lk(c,d,e,"tts:backgroundColor"))b.backgroundColor=
f;if(f=Lk(c,d,e,"tts:fontFamily"))b.fontFamily=f;(f=Lk(c,d,e,"tts:fontWeight"))&&"bold"==f&&(b.fontWeight=700);(f=Lk(c,d,e,"tts:wrapOption"))&&"noWrap"==f&&(b.wrapLine=!1);(f=Lk(c,d,e,"tts:lineHeight"))&&f.match(yk)&&(b.lineHeight=f);(f=Lk(c,d,e,"tts:fontSize"))&&f.match(yk)&&(b.fontSize=f);if(f=Lk(c,d,e,"tts:fontStyle"))b.fontStyle=Mc[f.toUpperCase()];(d=uk(d,e,"tts:textDecoration"))&&Mk(b,d);(c=Nk(c,e,"tts:textDecoration"))&&Mk(b,c);}
function Mk(b,c){for(var d=c.split(" "),e=0;e<d.length;e++)switch(d[e]){case "underline":0>b.textDecoration.indexOf("underline")&&b.textDecoration.push("underline");break;case "noUnderline":0<=b.textDecoration.indexOf("underline")&&ib(b.textDecoration,"underline");break;case "lineThrough":0>b.textDecoration.indexOf("lineThrough")&&b.textDecoration.push("lineThrough");break;case "noLineThrough":0<=b.textDecoration.indexOf("lineThrough")&&ib(b.textDecoration,"lineThrough");break;case "overline":0>b.textDecoration.indexOf("overline")&&
b.textDecoration.push("overline");break;case "noOverline":0<=b.textDecoration.indexOf("overline")&&ib(b.textDecoration,"overline");}}function Lk(b,c,d,e){return(b=Nk(b,d,e))?b:uk(c,d,e)}function uk(b,c,d){for(var e=tk(b),f=0;f<e.length;f++){var g=e[f].getAttribute(d);if(g)return g}return(b=Jk(b,"style",c))?b.getAttribute(d):null}function Nk(b,c,d){return(b=Jk(b,"style",c))?b.getAttribute(d):null}
function Jk(b,c,d){if(!b||1>d.length)return null;var e=null,f=b;for(b=null;f&&!(b=f.getAttribute(c))&&(f=f.parentNode,f instanceof Element););if(c=b)for(b=0;b<d.length;b++)if(d[b].getAttribute("xml:id")==c){e=d[b];break}return e}
function Ik(b,c){var d=null;if(zk.test(b)){d=zk.exec(b);var e=Number(d[1]),f=Number(d[2]),g=Number(d[3]),h=Number(d[4]);h+=(Number(d[5])||0)/c.b;g+=h/c.frameRate;d=g+60*f+3600*e;}else Ak.test(b)?d=Ok(Ak,b):Bk.test(b)?d=Ok(Bk,b):Ck.test(b)?(d=Ck.exec(b),d=Number(d[1])/c.frameRate):Dk.test(b)?(d=Dk.exec(b),d=Number(d[1])/c.a):Ek.test(b)&&(d=Ok(Ek,b));return d}
function Ok(b,c){var d=b.exec(c);return null==d||""==d[0]?null:(Number(d[4])||0)/1E3+(Number(d[3])||0)+60*(Number(d[2])||0)+3600*(Number(d[1])||0)}function sk(b,c,d,e){this.frameRate=Number(b)||30;this.b=Number(c)||1;this.a=Number(e);0==this.a&&(this.a=b?this.frameRate*this.b:1);d&&(b=/^(\d+) (\d+)$/g.exec(d))&&(this.frameRate*=b[1]/b[2]);}I["application/ttml+xml"]=rk;function Pk(){this.a=new rk;}Pk.prototype.parseInit=function(b){var c=!1;(new R).C("moov",S).C("trak",S).C("mdia",S).C("minf",S).C("stbl",S).Y("stsd",Pe).C("stpp",function(b){c=!0;b.parser.stop();}).parse(b);if(!c)throw new A(2,2,2007);};Pk.prototype.parseMedia=function(b,c){var d=!1,e=[];(new R).C("mdat",Qe(function(b){d=!0;e=e.concat(this.a.parseMedia(b,c));}.bind(this))).parse(b);if(!d)throw new A(2,2,2007);return e};I['application/mp4; codecs="stpp"']=Pk;
I['application/mp4; codecs="stpp.TTML.im1t"']=Pk;function Qk(){}Qk.prototype.parseInit=function(){};
Qk.prototype.parseMedia=function(b,c){var d=Ob(b);d=d.replace(/\r\n|\r(?=[^\n]|$)/gm,"\n");d=d.split(/\n{2,}/m);if(!/^WEBVTT($|[ \t\n])/m.test(d[0]))throw new A(2,2,2E3);var e=c.segmentStart;if(null==e&&(e=0,0<=d[0].indexOf("X-TIMESTAMP-MAP"))){var f=d[0].match(/LOCAL:((?:(\d{1,}):)?(\d{2}):(\d{2})\.(\d{3}))/m),g=d[0].match(/MPEGTS:(\d+)/m);f&&g&&(e=Rk(new Tf(f[1])),e=c.periodStart+(Number(g[1])/9E4-e));}g=[];var h=d[0].split("\n");for(f=1;f<h.length;f++)if(/^Region:/.test(h[f])){var k=new Tf(h[f]),
...
m=Wf(k);}g.push(l);}f=[];for(k=1;k<d.length;k++){h=d[k].split("\n");m=h;t=e;h=g;if(1==m.length&&!m[0]||/^NOTE($|[ \t])/.test(m[0])||"STYLE"==m[0])h=null;else{l=null;0>m[0].indexOf("--\x3e")&&(l=m[0],m.splice(0,1));r=new Tf(m[0]);var u=Rk(r),w=Vf(r,/[ \t]+--\x3e[ \t]+/g),y=Rk(r);if(null==u||null==w||null==y)throw new A(2,2,2001);m=new H(u+t,y+t,m.slice(1).join("\n").trim());Uf(r);for(t=Wf(r);t;)Sk(m,t,h),Uf(r),t=Wf(r);null!=l&&(m.id=l);h=m;}h&&f.push(h);}return f};
...
else if(e=/^region:(.*)$/.exec(c)){if(c=Tk(d,e[1]))b.region=c;}else if(d=/^line:([\d.]+)%(?:,(start|end|center))?$/.exec(c))b.lineInterpretation=1,b.line=Number(d[1]),d[2]&&(b.lineAlign=Lc[d[2].toUpperCase()]);else if(d=/^line:(-?\d+)(?:,(start|end|center))?$/.exec(c))b.lineInterpretation=Ec,b.line=Number(d[1]),d[2]&&(b.lineAlign=Lc[d[2].toUpperCase()]);}function Tk(b,c){var d=b.filter(function(b){return b.id==c});return d.length?d[0]:null}
function Rk(b){b=Vf(b,/(?:(\d{1,}):)?(\d{2}):(\d{2})\.(\d{3})/g);if(null==b)return null;var c=Number(b[2]),d=Number(b[3]);return 59<c||59<d?null:Number(b[4])/1E3+d+60*c+3600*(Number(b[1])||0)}I["text/vtt"]=Qk;I['text/vtt; codecs="vtt"']=Qk;function Uk(){this.a=null;}Uk.prototype.parseInit=function(b){var c=!1;(new R).C("moov",S).C("trak",S).C("mdia",S).Y("mdhd",function(b){0==b.version?(b.reader.F(4),b.reader.F(4),this.a=b.reader.B(),b.reader.F(4)):(b.reader.F(8),b.reader.F(8),this.a=b.reader.B(),b.reader.F(8));b.reader.F(4);}.bind(this)).C("minf",S).C("stbl",S).Y("stsd",Pe).C("wvtt",function(){c=!0;}).parse(b);if(!this.a)throw new A(2,2,2008);if(!c)throw new A(2,2,2008);};
Uk.prototype.parseMedia=function(b,c){var d=this;if(!this.a)throw new A(2,2,2008);var e=0,f=[],g,h=[],k=!1,l=!1,m=!1,r=null;(new R).C("moof",S).C("traf",S).Y("tfdt",function(b){k=!0;e=0==b.version?b.reader.B():b.reader.Qa();}).Y("tfhd",function(b){var c=b.flags;b=b.reader;b.F(4);c&1&&b.F(8);c&2&&b.F(4);r=c&8?b.B():null;}).Y("trun",function(b){l=!0;var c=b.version,d=b.flags;b=b.reader;var e=b.B();d&1&&b.F(4);d&4&&b.F(4);for(var g=[],h=0;h<e;h++){var k={duration:null,sampleSize:null,cc:null};d&256&&(k.duration=
b.B());d&512&&(k.sampleSize=b.B());d&1024&&b.F(4);d&2048&&(k.cc=0==c?b.B():b.Hc());g.push(k);}f=g;}).C("mdat",Qe(function(b){m=!0;g=b;})).parse(b);if(!m&&!k&&!l)throw new A(2,2,2008);var t=e,u=new DataView(g.buffer,g.byteOffset,g.byteLength),w=new Q(u,0);f.forEach(function(b){var f=b.duration||r,g=b.cc?e+b.cc:t;t=g+(f||0);var k=0;do{var l=w.B();k+=l;var m=w.B(),u=null;"vttc"==Re(m)?8<l&&(u=w.Ba(l-8)):w.F(l-8);f&&u&&h.push(Vk(u,c.periodStart+g/d.a,c.periodStart+t/d.a));}while(b.sampleSize&&k<b.sampleSize)});
return h.filter(Db)};function Vk(b,c,d){var e,f,g;(new R).C("payl",Qe(function(b){e=Ob(b);})).C("iden",Qe(function(b){f=Ob(b);})).C("sttg",Qe(function(b){g=Ob(b);})).parse(b);return e?Wk(e,f,g,c,d):null}function Wk(b,c,d,e,f){b=new H(e,f,b);c&&(b.id=c);if(d)for(c=new Tf(d),d=Wf(c);d;)Sk(b,d,[]),Uf(c),d=Wf(c);return b}I['application/mp4; codecs="wvtt"']=Uk;}).call(exportTo,innerGlobal,innerGlobal);for(var k in exportTo.shaka)exports[k]=exportTo.shaka[k];})();
...
DownloadService.VERSION = '2.0.93-184';
