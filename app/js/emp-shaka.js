...
(function (global, factory) {
  ...
  function jc(b,c){var d=c.some(function(b){return 0<b.drmInfos.length});if(!d){var e=Kb(b.f.servers);nc(c,e);}var f=oc(b);if(f){var g=q(c);for(e=g.next();!e.done;e=g.next())e.value.drmInfos=[f];}f=q(c);for(e=f.next();!e.done;e=f.next())for(e=q(e.value.drmInfos),g=e.next();!g.done;g=e.next())pc(g.value,Kb(b.f.servers),Kb(b.f.advanced||{}));f=q(c);for(e=f.next();!e.done;e=f.next())for(e=e.value,g=e.drmInfos.length;g--;)"com.chromecast.playready"===e.drmInfos[g].keySystem&&e.drmInfos.splice(g,1);e=qc(b,
  c);if(!e.size)return b.R=!0,Promise.resolve();e=mc(b,e);return d?e:e["catch"](function(){})}
  ...
  function ne(b,c,d){var e=[];d=q(d);for(var f=d.next();!f.done;f=d.next()){f=f.value;var g=ke.get(f.Bd);if(g)e.push(Vc(g,f.init||b));else for(f=c(f.node)||[],f=q(f),g=f.next();!g.done;g=f.next())e.push(g.value);}return e}
  (new Map).set("com.widevine.alpha",function(b){return (b=M.Wc(b.node,"urn:microsoft","laurl"))?b.getAttribute("licenseUrl")||"":""}).set("com.microsoft.playready",function(b){b=M.Wc(b.node,"urn:microsoft:playready","pro");if(!b)return "";b=Zb(b.textContent);b=pe(b.buffer).filter(function(b){return 1===b.type})[0];if(!b)return "";b=Ub(b.value,!0);return (b=M.td(b,"WRMHEADER"))?qe(b):""});function me(b){var c=[];b=q(b);for(var d=b.next();!d.done;d=b.next())(d=re(d.value))&&c.push(d);return c}
  function re(b){var c=b.getAttribute("schemeIdUri"),d=M.getAttributeNS(b,"urn:mpeg:cenc:2013","default_KID"),e=M.Xc(b,"urn:mpeg:cenc:2013","pssh").map(M.Lb);if(!c)return null;c=c.toLowerCase();if(d&&(d=d.replace(/-/g,"").toLowerCase(),d.includes(" ")))throw new B(2,4,4009);var f=[];try{f=e.map(function(b){return {initDataType:"cenc",initData:Zb(b),keyId:null}});}catch(g){throw new B(2,4,4007);}return {node:b,Bd:c,keyId:d,init:0<f.length?f:null}}function se(b,c,d,e,f){var g={RepresentationID:c,Number:d,Bandwidth:e,Time:f};return b.replace(/\$(RepresentationID|Number|Bandwidth|Time)?(?:%0([0-9]+)([diouxX]))?\$/g,function(b,c,d,e){if("$$"==b)return "$";var f=g[c];if(null==f)return b;"RepresentationID"==c&&d&&(d=void 0);"Time"==c&&(f=Math.round(f));switch(e){case void 0:case "d":case "i":case "u":b=f.toString();break;case "o":b=f.toString(8);break;case "x":b=f.toString(16);break;case "X":b=f.toString(16).toUpperCase();break;default:b=f.toString();}d=
  window.parseInt(d,10)||1;return Array(Math.max(0,d-b.length)+1).join("0")+b})}
  function te(b,c){var d=ue(b,c,"timescale"),e=1;d&&(e=M.Qb(d)||1);d=ue(b,c,"duration");(d=M.Qb(d||""))&&(d/=e);var f=ue(b,c,"startNumber"),g=Number(ue(b,c,"presentationTimeOffset"))||0,h=M.Za(f||"");if(null==f||null==h)h=1;var k=ve(b,c,"SegmentTimeline");f=null;if(k){f=e;var l=b.O.duration||Infinity;k=M.N(k,"S");for(var m=[],p=0,r=0;r<k.length;++r){var w=k[r],x=M.G(w,"t",M.Za),A=M.G(w,"d",M.Za);w=M.G(w,"r",M.parseInt);null!=x&&(x-=g);if(!A)break;x=null!=x?x:p;w=w||0;if(0>w)if(r+1<k.length){w=M.G(k[r+
  1],"t",M.Za);if(null==w)break;else if(x>=w)break;w=Math.ceil((w-x)/A)-1;}else{if(Infinity==l)break;else if(x/f>=l)break;w=Math.ceil((l*f-x)/A)-1;}0<m.length&&x!=p&&(m[m.length-1].end=x/f);for(var P=0;P<=w;++P)p=x+A,m.push({start:x/f,end:p/f,Nf:x}),x=p;}f=m;}return {timescale:e,V:d,La:h,ga:g/e||0,Gc:g,K:f}}function ue(b,c,d){return [c(b.w),c(b.Y),c(b.ea)].filter(H.wa).map(function(b){return b.getAttribute(d)}).reduce(function(b,c){return b||c})}
  function ve(b,c,d){return [c(b.w),c(b.Y),c(b.ea)].filter(H.wa).map(function(b){return M.Ib(b,d)}).reduce(function(b,c){return b||c})}
  ...
  Q.prototype.parseNext=Q.prototype.Pb;function R(b){for(;b.reader.ja()&&!b.parser.a;)b.parser.Pb(b.start,b.reader,b.partialOkay);}Q.children=R;function Ce(b){for(var c=b.reader.C();0<c&&!b.parser.a;--c)b.parser.Pb(b.start,b.reader,b.partialOkay);}Q.sampleDescription=Ce;function De(b){return function(c){b(c.reader.Ja(c.reader.H.byteLength-c.reader.X()));}}Q.allData=De;function Be(b){for(var c=0,d=0;d<b.length;d++)c=c<<8|b.charCodeAt(d);return c}
  ...
  }if(null==h)throw new B(2,3,3011);g=f/1E9;f=h*g;b=Ke(new Ie(new DataView(b)));if(475249515!=b.id)throw new B(2,3,3007);return Pe(b,c,g,f,d,e)};function Pe(b,c,d,e,f,g){function h(){return f}var k=[];b=new Ie(b.a);for(var l=null,m=null;b.ja();){var p=Ke(b);if(187==p.id){var r=Qe(p);r&&(p=d*r.Of,r=c+r.lf,null!=l&&k.push(new N(k.length,l-g,p-g,h,m,r-1)),l=p,m=r);}}null!=l&&k.push(new N(k.length,l-g,e-g,h,m,null));return k}
  function Qe(b){var c=new Ie(b.a);b=Ke(c);if(179!=b.id)throw new B(2,3,3013);b=Ne(b);c=Ke(c);if(183!=c.id)throw new B(2,3,3012);c=new Ie(c.a);for(var d=0;c.ja();){var e=Ke(c);if(241==e.id){d=Ne(e);break}}return {Of:b,lf:d}}function Re(b,c){var d=ve(b,c,"Initialization");if(!d)return null;var e=b.w.ia,f=d.getAttribute("sourceURL");f&&(e=Uc(b.w.ia,[f]));f=0;var g=null;if(d=M.G(d,"range",M.Rb))f=d.start,g=d.end;return new ye(function(){return e},f,g)}
  function Se(b,c){var d=Number(ue(b,Te,"presentationTimeOffset"))||0,e=ue(b,Te,"timescale"),f=1;e&&(f=M.Qb(e)||1);d=d/f||0;e=Re(b,Te);var g=b.w.contentType;f=b.w.mimeType.split("/")[1];if("text"!=g&&"mp4"!=f&&"webm"!=f)throw new B(2,4,4006);if("webm"==f&&!e)throw new B(2,4,4005);g=ve(b,Te,"RepresentationIndex");var h=ue(b,Te,"indexRange"),k=b.w.ia;h=M.Rb(h||"");if(g){var l=g.getAttribute("sourceURL");l&&(k=Uc(b.w.ia,[l]));h=M.G(g,"range",M.Rb,h);}if(!h)throw new B(2,4,4002);f=Ue(b,c,e,k,h.start,h.end,
  ...
  function Ue(b,c,d,e,f,g,h,k){var l=b.presentationTimeline,m=!b.Qa||!b.O.gc,p=b.O.start,r=b.O.duration,w=c,x=null;return {createSegmentIndex:function(){var b=[w(e,f,g),"webm"==h?w(d.c(),d.b,d.a):null];w=null;return Promise.all(b).then(function(b){var c=b[0];b=b[1]||null;c="mp4"==h?Fe(c,f,e,k):(new Oe).parse(c,b,e,k);l.Xa(c,p);x=new S(c);m&&He(x,r);})},findSegmentPosition:function(b){return x.find(b)},getSegmentReference:function(b){return x.get(b)}}}function Te(b){return b.sb}function Ve(b,c){var d=Re(b,We);var e=Xe(b);var f=te(b,We),g=f.La;0==g&&(g=1);var h=0;f.V?h=f.V*(g-1):f.K&&0<f.K.length&&(h=f.K[0].start);e={V:f.V,startTime:h,La:g,ga:f.ga,K:f.K,Wa:e};if(!e.V&&!e.K&&1<e.Wa.length)throw new B(2,4,4002);if(!e.V&&!b.O.duration&&!e.K&&1==e.Wa.length)throw new B(2,4,4002);if(e.K&&0==e.K.length)throw new B(2,4,4002);g=f=null;b.ea.id&&b.w.id&&(g=b.ea.id+","+b.w.id,f=c[g]);h=Ye(b.O.duration,e.La,b.w.ia,e);f?(f.lc(h),g=b.presentationTimeline.lb(),f.$b(g-b.O.start)):(b.presentationTimeline.Xa(h,
  b.O.start),f=new S(h),g&&b.Qa&&(c[g]=f));b.Qa&&b.O.gc||He(f,b.O.duration);return {createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:f.find.bind(f),getSegmentReference:f.get.bind(f),initSegmentReference:d,ga:e.ga}}function We(b){return b.za}
  function Ye(b,c,d,e){var f=e.Wa.length;e.K&&e.K.length!=e.Wa.length&&(f=Math.min(e.K.length,e.Wa.length));for(var g=[],h=e.startTime,k=0;k<f;k++){var l=e.Wa[k],m=Uc(d,[l.Ge]),p=void 0;p=null!=e.V?h+e.V:e.K?e.K[k].end:h+b;g.push(new N(k+c,h,p,function(b){return b}.bind(null,m),l.start,l.end));h=p;}return g}
  function Xe(b){return [b.w.za,b.Y.za,b.ea.za].filter(H.wa).map(function(b){return M.N(b,"SegmentURL")}).reduce(function(b,d){return 0<b.length?b:d}).map(function(c){c.getAttribute("indexRange")&&!b.ed&&(b.ed=!0);var d=c.getAttribute("media");c=M.G(c,"mediaRange",M.Rb,{start:0,end:null});return {Ge:d,start:c.start,end:c.end}})}function Ze(b,c,d,e){var f=$e(b);var g=te(b,af);var h=ue(b,af,"media"),k=ue(b,af,"index");g={V:g.V,timescale:g.timescale,La:g.La,ga:g.ga,Gc:g.Gc,K:g.K,jc:h,nb:k};h=g.nb?1:0;h+=g.K?1:0;h+=g.V?1:0;if(0==h)throw new B(2,4,4002);1!=h&&(g.nb&&(g.K=null),g.V=null);if(!g.nb&&!g.jc)throw new B(2,4,4002);if(g.nb){d=b.w.mimeType.split("/")[1];if("mp4"!=d&&"webm"!=d)throw new B(2,4,4006);if("webm"==d&&!f)throw new B(2,4,4005);e=se(g.nb,b.w.id,null,b.bandwidth||null,null);e=Uc(b.w.ia,[e]);b=Ue(b,c,f,e,0,null,
  d,g.ga);}else g.V?(e||(b.presentationTimeline.nc(g.V),b.presentationTimeline.oc(b.O.start)),b=bf(b,g)):(h=c=null,b.ea.id&&b.w.id&&(h=b.ea.id+","+b.w.id,c=d[h]),k=cf(b,g),e=!b.Qa||!b.O.gc,c?(e&&He(new S(k),b.O.duration),c.lc(k),d=b.presentationTimeline.lb(),c.$b(d-b.O.start)):(b.presentationTimeline.Xa(k,b.O.start),c=new S(k),h&&b.Qa&&(d[h]=c)),e&&He(c,b.O.duration),b={createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:c.find.bind(c),getSegmentReference:c.get.bind(c)});return {createSegmentIndex:b.createSegmentIndex,
  findSegmentPosition:b.findSegmentPosition,getSegmentReference:b.getSegmentReference,initSegmentReference:f,ga:g.ga}}function af(b){return b.ub}
  function bf(b,c){var d=b.O.duration,e=c.V,f=c.La,g=c.timescale,h=c.jc,k=b.bandwidth||null,l=b.w.id,m=b.w.ia;return {createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:function(b){return 0>b||d&&b>=d?null:Math.floor(b/e)},getSegmentReference:function(b){var c=b*e,p=c+e;d&&(p=Math.min(p,d));return 0>p||d&&c>=d?null:new N(b,c,p,function(){var d=se(h,l,b+f,k,c*g);return Uc(m,[d])},0,null)}}}
  function cf(b,c){for(var d=[],e=0;e<c.K.length;e++){var f=e+c.La;d.push(new N(f,c.K[e].start,c.K[e].end,function(b,c,d,e,f,p){b=se(b,c,f,d,p);return Uc(e,[b]).map(function(b){return b.toString()})}.bind(null,c.jc,b.w.id,b.bandwidth||null,b.w.ia,f,c.K[e].Nf+c.Gc),0,null));}return d}function $e(b){var c=ue(b,af,"initialization");if(!c)return null;var d=b.w.id,e=b.bandwidth||null,f=b.w.ia;return new ye(function(){var b=se(c,d,null,e,null);return Uc(f,[b])},0,null)}var df={},ef={};y("shaka.media.ManifestParser.registerParserByExtension",function(b,c){ef[b]=c;});y("shaka.media.ManifestParser.registerParserByMime",function(b,c){df[b]=c;});function ff(){var b={},c;for(c in df)b[c]=!0;for(var d in ef)b[d]=!0;["application/dash+xml","application/x-mpegurl","application/vnd.apple.mpegurl","application/vnd.ms-sstr+xml"].forEach(function(c){b[c]=!!df[c];});["mpd","m3u8","ism"].forEach(function(c){b[c]=!!ef[c];});return b}
  function gf(b,c,d,e){return t(function g(){var h;return v(g,function(g){switch(g.j){case 1:return qa(g,2),u(g,hf(b,c,d,e),4);case 4:return g["return"](g.u);case 2:throw h=ta(g),h.severity=2,h;}})})}
  function hf(b,c,d,e){return t(function g(){var h,k,l,m,p,r,w,x,A,P;return v(g,function(g){switch(g.j){case 1:if(e&&(h=e.toLowerCase(),k=df[h]))return g["return"](k);l=new Qa(b);m=l.da.split("/");p=m.pop();r=p.split(".");return 1<r.length&&(w=r.pop().toLowerCase(),x=ef[w])?g["return"](x):u(g,jf(b,c,d),2);case 2:A=g.u;if(P=df[A])return g["return"](P);throw new B(2,4,4E3,b);}})})}
  function jf(b,c,d){return t(function f(){var g,h,k;return v(f,function(f){switch(f.j){case 1:return g=Ab([b],d),g.method="HEAD",u(f,c.request(0,g).promise,2);case 2:return h=f.u,k=h.headers["content-type"],f["return"](k?k.toLowerCase():"")}})})}function T(b,c){this.f=b;this.Sb=c;this.h=this.g=Infinity;this.b=1;this.c=this.a=null;this.l=0;this.m=!0;this.i=0;}y("shaka.media.PresentationTimeline",T);T.prototype.T=function(){return this.g};T.prototype.getDuration=T.prototype.T;T.prototype.ma=function(b){this.g=b;};T.prototype.setDuration=T.prototype.ma;T.prototype.te=function(){return this.f};T.prototype.getPresentationStartTime=T.prototype.te;T.prototype.Ed=function(b){this.l=b;};T.prototype.setClockOffset=T.prototype.Ed;
  ...
  T.prototype.Xa=function(b,c){if(0!=b.length){var d=b[b.length-1].endTime+c;this.oc(b[0].startTime+c);this.b=b.reduce(function(b,c){return Math.max(b,c.endTime-c.startTime)},this.b);this.c=Math.max(this.c,d);null!=this.f&&(this.f=(Date.now()+this.l)/1E3-this.c-this.b);}};T.prototype.notifySegments=T.prototype.Xa;T.prototype.oc=function(b){null==this.a?this.a=b:(this.a=Math.max(this.a,b),window.cast&&window.cast.__platform__&&(this.a=Math.ceil(this.a*Math.pow(10,4))/Math.pow(10,4)));};
  T.prototype.notifyMinSegmentStartTime=T.prototype.oc;T.prototype.nc=function(b){this.b=Math.max(this.b,b);};T.prototype.notifyMaxSegmentDuration=T.prototype.nc;T.prototype.offset=function(b){null!=this.a&&(this.a+=b);null!=this.c&&(this.c+=b);};T.prototype.offset=T.prototype.offset;T.prototype.U=function(){return Infinity==this.g&&!this.m};T.prototype.isLive=T.prototype.U;T.prototype.Ha=function(){return Infinity!=this.g&&!this.m};T.prototype.isInProgress=T.prototype.Ha;
  T.prototype.lb=function(){if(Infinity==this.h)return this.i;var b=this.Ta()-this.h;return Math.max(this.i,b)};T.prototype.getSegmentAvailabilityStart=T.prototype.lb;T.prototype.Gd=function(b){this.i=b;};T.prototype.setUserSeekStart=T.prototype.Gd;T.prototype.Ta=function(){return this.U()||this.Ha()?Math.min(Math.max(0,(Date.now()+this.l)/1E3-this.b-this.f),this.g):this.g};T.prototype.getSegmentAvailabilityEnd=T.prototype.Ta;
  T.prototype.kb=function(b){var c=Math.max(this.a,this.i);if(Infinity==this.h)return c;var d=this.Ta()-this.h;b=Math.min(d+b,this.qa());return Math.max(c,b)};T.prototype.getSafeSeekRangeStart=T.prototype.kb;T.prototype.Sa=function(){return this.kb(0)};T.prototype.getSeekRangeStart=T.prototype.Sa;T.prototype.qa=function(){var b=this.U()||this.Ha()?this.Sb:0;return Math.max(0,this.Ta()-b)};T.prototype.getSeekRangeEnd=T.prototype.qa;T.prototype.Kd=function(){return null==this.f||null!=this.c?!1:!0};
  T.prototype.usingPresentationStartTime=T.prototype.Kd;function kf(){this.a=this.b=null;this.h=[];this.c=null;this.l=[];this.i=1;this.m={};this.o=0;this.s=new Ha(5);this.g=null;this.f=new wb;}y("shaka.dash.DashParser",kf);n=kf.prototype;n.configure=function(b){this.b=b;};n.start=function(b,c){this.h=[b];this.a=c;return lf(this).then(function(b){this.a&&mf(this,b);return this.c}.bind(this))};n.stop=function(){this.b=this.a=null;this.h=[];this.c=null;this.l=[];this.m={};null!=this.g&&(window.clearTimeout(this.g),this.g=null);return this.f.destroy()};
  ...
  function nf(b,c,d){c=M.sd(c,"MPD");if(!c)throw new B(2,4,4001,d);c=xe(c,b.b.retryParameters,b.b.dash.xlinkFailGracefully,d,b.a.networkingEngine);xb(b.f,c);return c.promise.then(function(c){return of(b,c,d)})}
  ...
  m.sa);Ja=m.G(c,"maxSegmentDuration",m.sa);Wa=c.getAttribute("type")||"static";b.c?ia=b.c.presentationTimeline:(mg=Math.max(b.b.dash.defaultPresentationDelay,1.5*U),Lc=null!=ha?ha:mg,ia=new T(X,Lc));ng={Qa:"static"!=Wa,presentationTimeline:ia,ea:null,O:null,Y:null,w:null,bandwidth:0,ed:!1};for(var tg=ng,ak=A,Mc=M.G(c,"mediaPresentationDuration",M.sa),Nc=[],Xa=0,Rb=M.N(c,"Period"),sb=0;sb<Rb.length;sb++){var hb=Rb[sb];Xa=M.G(hb,"start",M.sa,Xa);var Oc=M.G(hb,"duration",M.sa),Ya=null;if(sb!=Rb.length-
  1){var ug=M.G(Rb[sb+1],"start",M.sa);null!=ug&&(Ya=ug-Xa);}else null!=Mc&&(Ya=Mc-Xa);null==Ya&&(Ya=Oc);hb=pf(b,tg,ak,{start:Xa,duration:Ya,node:hb,gc:null==Ya||sb==Rb.length-1});Nc.push(hb);Oc=tg.ea.id;b.l.includes(Oc)||(b.l.push(Oc),b.c&&(b.a.filterNewPeriod(hb),b.c.periods.push(hb)));if(null==Ya){Xa=null;break}Xa+=Ya;}null==b.c&&b.a.filterAllPeriods(Nc);null!=Mc?(g=Nc,h=Mc,k=!1):(g=Nc,h=Xa,k=!0);og=h;pg=g;ia.vb("static"==Wa);"static"!=Wa&&k||ia.ma(og||Infinity);(qg=ia.U())&&!isNaN(b.b.availabilityWindowOverride)&&
  (ea=b.b.availabilityWindowOverride);null==ea&&(ea=Infinity);ia.Bc(ea);ia.nc(Ja||1);if(b.c){f.B(0);break}b.c={presentationTimeline:ia,periods:pg,offlineSessionIds:[],minBufferTime:U||0};if(!ia.Kd()){f.B(0);break}rg=m.N(c,"UTCTiming");return u(f,qf(b,A,rg,qg),4);case 4:sg=f.u;if(!b.a)return f["return"]();ia.Ed(sg);f.j=0;}})})}
  function pf(b,c,d,e){c.ea=rf(e.node,null,d);c.O=e;c.ea.id||(c.ea.id="__shaka_period_"+e.start);M.N(e.node,"EventStream").forEach(b.ef.bind(b,e.start,e.duration));d=M.N(e.node,"AdaptationSet").map(b.bf.bind(b,c)).filter(H.wa);if(c.Qa){c=[];for(var f=q(d),g=f.next();!g.done;g=f.next()){g=q(g.value.pf);for(var h=g.next();!h.done;h=g.next())c.push(h.value);}if(c.length!=(new Set(c)).size)throw new B(2,4,4018);}var k=d.filter(function(b){return !b.Fc});d.filter(function(b){return b.Fc}).forEach(function(b){var c=
  ...
  "AudioChannelConfiguration");m=wf(m)||c.pc;h||(h=uf(k,l));return {ia:Uc(d,g),sb:M.Ib(b,"SegmentBase")||c.sb,za:M.Ib(b,"SegmentList")||c.za,ub:M.Ib(b,"SegmentTemplate")||c.ub,width:M.G(b,"width",e)||c.width,height:M.G(b,"height",e)||c.height,contentType:h,mimeType:k,codecs:l,frameRate:f,emsgSchemeIdUris:p,id:b.getAttribute("id"),pc:m}}
  ...
  16)){for(b=0;e;)e&1&&++b,e>>=1;return b}}}return null}function vf(b){var c=b.sb?1:0;c+=b.za?1:0;c+=b.ub?1:0;if(0==c)return "text"==b.contentType||"application"==b.contentType?!0:!1;1!=c&&(b.sb&&(b.za=null),b.ub=null);return !0}
  function xf(b,c,d,e){c=Uc(c,[d]);c=Ab(c,b.b.retryParameters);c.method=e;c=b.a.networkingEngine.request(4,c);xb(b.f,c);return c.promise.then(function(b){if("HEAD"==e){if(!b.headers||!b.headers.date)return 0;b=b.headers.date;}else b=Sb(b.data);b=Date.parse(b);return isNaN(b)?0:b-Date.now()})}
  function qf(b,c,d,e){d=d.map(function(b){return {scheme:b.getAttribute("schemeIdUri"),value:b.getAttribute("value")}});var f=b.b.dash.clockSyncUri;e&&!d.length&&f&&d.push({scheme:"urn:mpeg:dash:utc:http-head:2014",value:f});return H.be(d,function(b){var d=b.value;switch(b.scheme){case "urn:mpeg:dash:utc:http-head:2014":case "urn:mpeg:dash:utc:http-head:2012":return xf(this,c,d,"HEAD");case "urn:mpeg:dash:utc:http-xsdate:2014":case "urn:mpeg:dash:utc:http-iso:2014":case "urn:mpeg:dash:utc:http-xsdate:2012":case "urn:mpeg:dash:utc:http-iso:2012":return xf(this,
  ...
  Qf.parse=function(b){var c=b.split(":");if(2>c.length||"data"!=c[0])throw new B(2,1,1004,b);c=c.slice(1).join(":").split(",");if(2>c.length)throw new B(2,1,1004,b);var d=c[0];c=window.decodeURIComponent(c.slice(1).join(","));d=d.split(";");var e=null;1<d.length&&(e=d[1]);if("base64"==e)b=Zb(c).buffer;else{if(e)throw new B(2,1,1005,b);b=Wb(c);}return {data:b,contentType:d[0]}};zb("data",Qf);function Rf(){this.g=this.c=null;this.$=1;this.D=new Map;this.R=new Set;this.a=new Map;this.b=null;this.v="";this.s=new Kf;this.l=this.i=null;this.f=Sf;this.o=null;this.A=0;this.M=Infinity;this.h=new wb;this.P=[];this.m=new Map;}y("shaka.hls.HlsParser",Rf);n=Rf.prototype;n.configure=function(b){this.g=b;};n.start=function(b,c){this.c=c;return Tf(this,b).then(function(b){this.v=b.uri;return Uf(this,b.data).then(function(){Vf(this,this.i);return this.o}.bind(this))}.bind(this))};
  n.stop=function(){this.g=this.c=null;this.D.clear();this.R.clear();this.a.clear();this.o=null;return this.h.destroy()};n.update=function(){if(this.f!=Wf.Ca){for(var b=[],c=q(this.a.values()),d=c.next();!d.done;d=c.next())b.push(Xf(this,d.value));return Promise.all(b)}};
  function Xf(b,c){Tf(b,c.Ud).then(function(b){var d=Wf,f=Lf(this.s,b.data,b.uri);if(1!=f.type)throw new B(2,4,4017);b=Ef(f.a,"EXT-X-MEDIA-SEQUENCE");var g=c.stream;Yf(this,c.Ub,f,b?Number(b.value):0,g.mimeType,g.codecs).then(function(b){c.tb.a=b;b=b[b.length-1];Ef(f.a,"EXT-X-ENDLIST")&&(Zf(this,d.Ca),this.b.ma(b.endTime));}.bind(this));}.bind(b));}n.onExpirationUpdated=function(){};
  function Uf(b,c){var d=Lf(b.s,c,b.v);if(0!=d.type)throw new B(2,4,4022);return $f(b,d).then(function(b){this.c.filterAllPeriods([b]);for(var c=Infinity,d=0,e=Infinity,k=q(this.a.values()),l=k.next();!l.done;l=k.next())l=l.value,c=Math.min(c,l.mc),d=Math.max(d,l.mc),"text"!=l.stream.type&&(e=Math.min(e,l.duration));this.f!=Wf.Ca?(this.b=new T(0,3*this.A),this.b.vb(!1)):(this.b=new T(null,0),this.b.vb(!0));ag(this);if(this.f!=Wf.Ca){this.i=this.M;this.f==Wf.Ic&&(c=this.b.Sb,isNaN(this.g.availabilityWindowOverride)||
  (c=this.g.availabilityWindowOverride),this.b.Bc(c));for(c=0;95443.7176888889<=d;)c+=95443.7176888889,d-=95443.7176888889;if(c)for(d=q(this.a.values()),l=d.next();!l.done;l=d.next())e=l.value,95443.7176888889>e.mc&&(e.stream.presentationTimeOffset=-c,e.tb.offset(c));}else for(this.b.ma(e),this.b.offset(-c),d=q(this.a.values()),l=d.next();!l.done;l=d.next())l=l.value,l.stream.presentationTimeOffset=c,l.tb.offset(-c),He(l.tb,e);this.o={presentationTimeline:this.b,periods:[b],offlineSessionIds:[],minBufferTime:0};}.bind(b))}
  function $f(b,c){var d=c.a,e=Df(c.a,"EXT-X-MEDIA"),f=e.filter(function(b){return "SUBTITLES"==V(b,"TYPE")}.bind(b)).map(function(b){return bg(this,b)}.bind(b));e=e.filter(function(b){return "CLOSED-CAPTIONS"==V(b,"TYPE")});cg(b,e);return Promise.all(f).then(function(b){var e=Df(d,"EXT-X-STREAM-INF").map(function(b){return dg(this,b,c)}.bind(this));return Promise.all(e).then(function(c){return {startTime:0,variants:c.reduce(H.Yb,[]),textStreams:b}}.bind(this))}.bind(b))}
  ...
  function lg(b){if(!b)return null;b=b.split("/")[0];return parseInt(b,10)}function gg(b,c,d,e){var f=V(c,"URI");if(b.a.has(f))return Promise.resolve(b.a.get(f));c=Bf(c,"CLOSED-CAPTIONS");var g=null;"video"==e&&c&&"NONE"!=c&&(g=b.m.get(c));return kg(b,f,d,e,"und",!1,null,null,g).then(function(b){if(this.a.has(f))return this.a.get(f);this.a.set(f,b);return b}.bind(b))}
  function kg(b,c,d,e,f,g,h,k,l){var m=Uc([b.v],[c])[0],p,r="",w;return Tf(b,m).then(function(c){m=c.uri;p=Lf(b.s,c.data,m);if(1!=p.type)throw new B(2,4,4017);c=p;var f=Wf,g=Ef(c.a,"EXT-X-PLAYLIST-TYPE"),h=Ef(c.a,"EXT-X-ENDLIST");h=g&&"VOD"==g.value||h;g=g&&"EVENT"==g.value&&!h;g=!h&&!g;h?Zf(b,f.Ca):(g?Zf(b,f.Ic):Zf(b,f.Pd),c=vg(c.a,"EXT-X-TARGETDURATION"),c=Number(c.value),b.A=Math.max(c,b.A),b.M=Math.min(c,b.M));if(1==d.length)r=d[0];else if(c=eg(e,d),null!=c)r=c;else throw new B(2,4,4025,d);return wg(b,
  e,r,p)}).then(function(d){w=d;d=Ef(p.a,"EXT-X-MEDIA-SEQUENCE");return Yf(b,c,p,d?Number(d.value):0,w,r)}).then(function(d){var A=d[0].startTime,x=d[d.length-1].endTime,U=x-A;d=new S(d);var X=xg(p),ea=void 0;"text"==e&&(ea="subtitle");var ha=[];p.segments.forEach(function(b){b=Df(b.b,"EXT-X-KEY");ha.push.apply(ha,b);});var Ja=!1,Wa=[],ia=null;ha.forEach(function(b){if("NONE"!=V(b,"METHOD")){Ja=!0;var c=V(b,"KEYFORMAT");if(b=(c=yg[c])?c(b):null)b.keyIds.length&&(ia=b.keyIds[0]),Wa.push(b);}});if(Ja&&
  ...
  duration:U}})}function xg(b){var c=Df(b.a,"EXT-X-MAP");if(!c.length)return null;if(1<c.length)throw new B(2,4,4020);c=c[0];var d=V(c,"URI"),e=Uc([b.b],[d])[0];b=0;d=null;if(c=Bf(c,"BYTERANGE"))b=c.split("@"),c=Number(b[0]),b=Number(b[1]),d=b+c-1;return new ye(function(){return [e]},b,d)}
  function zg(b,c,d,e){var f=c.b,g=c.a;c=vg(f,"EXTINF").value.split(",");c=e+Number(c[0]);var h=0,k=null;if(f=Ef(f,"EXT-X-BYTERANGE"))h=f.value.split("@"),f=Number(h[0]),h=h[1]?Number(h[1]):b.a+1,k=h+f-1;return new N(d,e,c,function(){return [g]},h,k)}function ag(b){b.b&&(b.P.forEach(function(c){b.b.Xa(c,0);}),b.P=[]);}
  function Yf(b,c,d,e,f,g){var h=d.segments,k=[],l=h[0].a,m=zg(null,h[0],e,0);d=xg(d);return Ag(b,c,d,m,f,g).then(function(b){l.split("/").pop();for(var c=0;c<h.length;++c){var d=k[k.length-1];d=zg(d,h[c],e+c,0==c?b:d.endTime);k.push(d);}this.P.push(k);ag(this);return k}.bind(b))}
  ...
  function Ag(b,c,d,e,f,g){if(b.o&&(c=b.a.get(c).tb.get(e.position)))return Promise.resolve(c.startTime);e=[Bg(b,e)];if("video/mp4"==f||"audio/mp4"==f)d?e.push(Bg(b,d)):e.push(e[0]);return Promise.all(e).then(function(b){if("video/mp4"==f||"audio/mp4"==f)return Cg(b[0].data,b[1].data);if("audio/mpeg"==f)return 0;if("video/mp2t"==f)return Dg(b[0].data);if("application/mp4"==f||f.startsWith("text/")){b=b[0].data;var c=Mb(f,g);if(dd(c)){var d=new bd(null);ed(d,c);b=d.fc(b);}else b=0;return b}throw new B(2,
  4,4030);}.bind(b))}function Cg(b,c){var d=0;(new Q).F("moov",R).F("trak",R).F("mdia",R).aa("mdhd",function(b){b.reader.I(0==b.version?8:16);d=b.reader.C();b.parser.stop();}).parse(c,!0);if(!d)throw new B(2,4,4030);var e=0,f=!1;(new Q).F("moof",R).F("traf",R).aa("tfdt",function(b){e=(0==b.version?b.reader.C():b.reader.ab())/d;f=!0;b.parser.stop();}).parse(b,!0);if(!f)throw new B(2,4,4030);return e}
  function Dg(b){function c(){throw new B(2,4,4030);}b=new O(new DataView(b),0);for(var d=0,e=0;;)if(d=b.X(),e=b.fa(),71!=e&&c(),b.rb()&16384||c(),e=(b.fa()&48)>>4,0!=e&&2!=e||c(),3==e&&(e=b.fa(),b.I(e)),1!=b.C()>>8)b.seek(d+188),e=b.fa(),71!=e&&(b.seek(d+192),e=b.fa()),71!=e&&(b.seek(d+204),e=b.fa()),71!=e&&c(),b.Ad(1);else return b.I(3),d=b.fa()>>6,0!=d&&1!=d||c(),0==b.fa()&&c(),d=b.fa(),e=b.rb(),b=b.rb(),(1073741824*((d&14)>>1)+((e&65534)<<14|(b&65534)>>1))/9E4}
  function eg(b,c){for(var d=Eg[b],e=0;e<d.length;e++)for(var f=0;f<c.length;f++)if(d[e].test(c[f].trim()))return c[f].trim();return "text"==b?"":null}
  ...
  Rf.prototype.ha=function(){this.c&&(this.l=null,this.update().then(function(){Vf(this,this.i);}.bind(this))["catch"](function(b){this.c&&(b.severity=1,this.c.onError(b),Vf(this,0));}.bind(this)));};function Vf(b,c){null!=b.i&&null!=c&&(b.l=window.setTimeout(b.ha.bind(b),1E3*c));}function Zf(b,c){b.f=c;b.b&&b.b.vb(b.f==Wf.Ca);b.f==Wf.Ca&&null!=b.l&&(window.clearTimeout(b.l),b.l=null,b.i=null);}
  var yg={"urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed":function(b){var c=V(b,"METHOD");Dd("HLS SAMPLE-AES-CENC","SAMPLE-AES-CENC will no longer be supported, see Issue #1227");if(!["SAMPLE-AES","SAMPLE-AES-CTR","SAMPLE-AES-CENC"].includes(c))return null;c=V(b,"URI");c=Qf.parse(c);c=new Uint8Array(c.data);c=Vc("com.widevine.alpha",[{initDataType:"cenc",initData:c}]);if(b=Bf(b,"KEYID"))c.keyIds=[b.substr(2).toLowerCase()];return c}},Sf="VOD",Wf={Ca:Sf,Pd:"EVENT",Ic:"LIVE"};ef.m3u8=Rf;
  ...
  Og.prototype.create=function(b){var c=[];c=Pg(b,this.c);var d=b.filter(function(b){return b.primary});c=c.length?c:d.length?d:b;this.b&&(b=Qg(c,this.b),b.length&&(c=b));this.a&&(b=J.Vc(c,this.a),b.length&&(c=b));b=new Jg(c[0]);c=q(c);for(d=c.next();!d.done;d=c.next())d=d.value,Kg(b.a,d)&&b.add(d);return b};function Pg(b,c){var d=I(c),e=Ad(d,b.map(function(b){return zd(b)}));return e?b.filter(function(b){return e==zd(b)}):[]}
  function Qg(b,c){return b.filter(function(b){var d=b.audio;b=b.video;return d&&0<=d.roles.indexOf(c)||b&&0<=b.roles.indexOf(c)})}function Rg(b){var c=this;this.c=b;this.a=new Set;this.b=new Xb(function(){Sg(c,!1);});this.b.start(.25,!0);}Rg.prototype.L=function(){this.b.stop();for(var b=q(this.a),c=b.next();!c.done;c=b.next())c.value.L();this.a.clear();};function Sg(b,c){for(var d=q(b.a),e=d.next();!e.done;e=d.next())e.value.g(b.c.currentTime,c);}function Tg(b,c,d){var e=this;this.c=Ug;this.f=.5;this.h=b;this.l=d;this.i=c;this.b=function(){};this.a=function(){};this.m=[{Md:Ug,is:Vg,Qc:function(){return e.a()}},{Md:Vg,is:Ug,Qc:function(){return e.b()}}];this.f>=this.h&&(Na("Rebuffering threshold is set too low!  This could cause poor buffering behavior during playback!"),this.f=this.h/2);}Tg.prototype.L=function(){this.b=function(){};this.a=function(){};};
  Tg.prototype.g=function(b){var c=this.c==Vg?this.f:this.h;b=this.i(b);c=this.l()||b>=c?Vg:Ug;b=q(this.m);for(var d=b.next();!d.done;d=b.next())d=d.value,this.c==d.Md&&c==d.is&&d.Qc();this.c=c;};function Wg(b,c,d){b.b=c;b.a=d;}var Ug=0,Vg=1;function Xg(b){this.g=b;this.f=Yg(b);this.a=b.a.currentTime;this.b=Date.now()/1E3;this.c=function(){};}function Zg(b,c){b.c=c;}function $g(b){this.a=b;}function Yg(b){if(b.a.paused||0==b.a.playbackRate||null==b.a.buffered)var c=!1;else a:{c=b.a.buffered;b=b.a.currentTime;for(var d=0;d<c.length;d++){var e=c.start(d),f=c.end(d);if(!(b<e||b>f-.5)){c=!0;break a}}c=!1;}return c}function ah(b,c,d,e){this.a=b;this.s=c;this.m=d;this.o=e;this.f=new Eb;this.b=null;this.h=!1;this.l=b.readyState;this.c=!1;this.v=new Xg(new $g(b));Zg(this.v,function(){b.currentTime+=.1;});this.g=!1;c=this.i.bind(this);G(this.f,b,"waiting",c);this.b=new Xb(c);this.b.start(.25,!0);}ah.prototype.L=function(){this.f&&(this.f.L(),this.f=null);null!=this.b&&(this.b.stop(),this.b=null);this.a=this.s=this.o=null;};ah.prototype.qb=function(){this.g=!0;this.i();};
  ah.prototype.i=function(){if(0!=this.a.readyState){if(this.a.seeking){if(!this.h)return}else this.h=!1;if(!this.a.paused){this.a.readyState!=this.l&&(this.c=!1,this.l=this.a.readyState);var b=this.m.smallGapLimit,c=this.a.currentTime,d=this.a.buffered;a:{if(d&&d.length&&!(1==d.length&&1E-6>d.end(0)-d.start(0))){var e=Qb("Edge/")||Qb("Trident/")||Qb("Tizen")||Qb("CrKey")?.5:.1;for(var f=0;f<d.length;f++)if(d.start(f)>c&&(0==f||d.end(f-1)-c<=e)){e=f;break a}}e=null;}if(null==e){d=this.v;e=d.g;c=Yg(e);
  e=e.a.currentTime;f=Date.now()/1E3;if(d.a!=e||d.f!=c)d.b=f,d.a=e,d.f=c;e=f-d.b;1<=e&&c&&d.c(d.a,e);}else if(0!=e||this.g){f=d.start(e);var g=this.s.qa();if(!(f>=g)){g=f-c;b=g<=b;var h=!1;.001>g||(b||this.c||(this.c=!0,c=new D("largegap",{currentTime:c,gapSize:g}),c.cancelable=!0,this.o(c),this.m.jumpLargeGaps&&!c.defaultPrevented&&(h=!0)),!b&&!h)||(0!=e&&d.end(e-1),this.a.currentTime=f);}}}}};function bh(b){this.c=b;this.a=null;this.b=function(){};}bh.prototype.L=function(){this.a=this.c=null;this.b=function(){};};bh.prototype.g=function(b){for(var c=this.a,d=this.c.periods[0],e=q(this.c.periods),f=e.next();!f.done;f=e.next())f=f.value,b>=f.startTime&&(d=f);b=d;c!=b&&this.b(b);this.a=b;};function ch(b,c){b.b=c;}function dh(b,c,d){this.a=b;this.i=c;this.h=d;this.c=new Eb;this.f=1;this.g=!1;this.b=null;0<b.readyState?this.od():Hb(this.c,b,"loadedmetadata",this.od.bind(this));G(this.c,b,"ratechange",this.Re.bind(this));}n=dh.prototype;n.L=function(){this.c&&(this.c.L(),this.c=null);null!=this.b&&(this.b.stop(),this.b=null);this.a=this.i=null;};function eh(b){return 0<b.a.readyState?b.a.currentTime:b.h}function fh(b,c){0<b.a.readyState?gh(b,b.a.currentTime,c):(b.h=c,setTimeout(b.i,0));}n.jb=function(){return this.f};
  function hh(b,c){null!=b.b&&(b.b.stop(),b.b=null);b.f=c;b.a.playbackRate=b.g||0>c?0:c;!b.g&&0>c&&(b.b=new Xb(function(){b.a.currentTime+=c/4;}),b.b.start(.25,!0));}n.Re=function(){var b=this.g||0>this.f?0:this.f;this.a.playbackRate&&this.a.playbackRate!=b&&hh(this,this.a.playbackRate);};n.od=function(){.001>Math.abs(this.a.currentTime-this.h)?this.pd():(Hb(this.c,this.a,"seeking",this.pd.bind(this)),this.a.currentTime=0==this.a.currentTime?this.h:this.a.currentTime);};
  n.pd=function(){var b=this;G(this.c,this.a,"seeking",function(){return b.i()});};function gh(b,c,d){function e(){!b.a||10<=f++||b.a.currentTime!=c||(b.a.currentTime=d,setTimeout(e,100));}b.a.currentTime=d;var f=0;setTimeout(e,100);}function ih(b,c,d,e,f,g,h){this.c=b;this.a=c;this.m=d;this.h=e;this.l=g;this.f=null;this.g=new ah(b,c,e,h);c=this.Te.bind(this);null==f?f=Infinity>this.a.T()?this.a.Sa():this.a.qa():0>f&&(f=this.a.qa()+f);f=jh(this,kh(this,f));this.b=new dh(b,c,f);this.f=new Xb(this.Qe.bind(this));this.f.start(.25,!0);}n=ih.prototype;n.L=function(){this.b&&(this.b.L(),this.b=null);this.g&&(this.g.L(),this.g=null);this.f&&(this.f.stop(),this.f=null);this.c=this.b=this.a=this.l=this.h=null;};
  function lh(b){var c=eh(b.b);0<b.c.readyState&&(b.c.paused||(c=kh(b,c)));return c}n.jb=function(){return this.b.jb()};n.qb=function(){this.g.qb();};n.Qe=function(){if(0!=this.c.readyState&&!this.c.paused){var b=this.c.currentTime,c=this.a.Sa(),d=this.a.qa();3>d-c&&(c=d-3);b<c&&(b=mh(this,b),this.c.currentTime=b);}};n.Te=function(){var b=this.g;b.h=!0;b.g=!1;b.c=!1;var c=eh(this.b);b=mh(this,c);if(.001<Math.abs(b-c)&&(c=(new Date).getTime()/1E3,!this.i||this.i<c-1)){this.i=c;fh(this.b,b);return}this.l();};
  function jh(b,c){var d=b.a.T();return c>=d?d-b.h.durationBackoff:c}function mh(b,c){var d=Rc.bind(null,b.c.buffered),e=Math.max(b.m,b.h.rebufferingGoal),f=b.h.safeSeekOffset,g=b.a.Sa(),h=b.a.qa(),k=b.a.T();3>h-g&&(g=h-3);var l=b.a.kb(e),m=b.a.kb(f);e=b.a.kb(e+f);return c>=k?jh(b,c):c>h?h:c<g?d(m)?m:e:c>=l||d(c)?c:e}function kh(b,c){var d=b.a.Sa();if(c<d)return d;d=b.a.qa();return c>d?d:c}function nh(){this.b=function(){};this.a=new Set;}nh.prototype.L=function(){this.b=function(){};this.a.clear();};function oh(b,c){b.b=c;}function ph(b){var c=this;this.h=b;this.f=new Map;this.a=function(){};this.b=function(){};this.c=function(){};this.i=[{Oa:null,Na:qh,Ga:function(b,e){return c.a(b,e)}},{Oa:rh,Na:qh,Ga:function(b,e){return c.a(b,e)}},{Oa:sh,Na:qh,Ga:function(b,e){return c.a(b,e)}},{Oa:qh,Na:rh,Ga:function(b,e){return c.b(b,e)}},{Oa:qh,Na:sh,Ga:function(b,e){return c.b(b,e)}},{Oa:rh,Na:sh,Ga:function(b,e){return c.c(b,e)}},{Oa:sh,Na:rh,Ga:function(b,e){return c.c(b,e)}}];}
  ph.prototype.L=function(){this.h=null;this.f.clear();this.a=function(){};this.b=function(){};this.c=function(){};};ph.prototype.g=function(b,c){for(var d=q(this.h.a),e=d.next();!e.done;e=d.next()){e=e.value;var f=this.f.get(e),g=b<e.startTime?rh:b>e.endTime?sh:qh;this.f.set(e,g);for(var h=q(this.i),k=h.next();!k.done;k=h.next())k=k.value,k.Oa==f&&k.Na==g&&k.Ga(e,c);}};function th(b,c,d,e){b.a=c;b.b=d;b.c=e;}var rh=1,qh=2,sh=3;function uh(b,c){this.a=c;this.b=b;this.g=null;this.l=1;this.s=Promise.resolve();this.h=[];this.i=new Map;this.c=new Map;this.o=!1;this.D=null;this.A=this.f=this.m=!1;this.v=0;}n=uh.prototype;n.destroy=function(){for(var b=q(this.c.values()),c=b.next();!c.done;c=b.next())vh(c.value);this.c.clear();this.i.clear();this.g=this.h=this.s=this.b=this.a=null;this.f=!0;return Promise.resolve()};
  ...
  n.init=function(){var b=this;return t(function d(){var e,f,g;return v(d,function(d){switch(d.j){case 1:return e=b.a.Ra(),f=J.Jb(b.b,e),g=b.a.jd(b.b.periods[f]),g.variant||g.text?u(d,wh(b,g.variant?g.variant.audio:null,g.variant?g.variant.video:null,g.text,e),2):d["return"](Promise.reject(new B(2,5,5005)));case 2:if(b.f)return d["return"]();b.a&&b.a.Je&&b.a.Je();d.j=0;}})})};function xh(b){return yh(b,"audio")}function zh(b){return yh(b,"video")}
  function yh(b,c){var d=b.c.get(c);return d?d.ya||d.stream:null}function Ah(b,c){return t(function e(){var f,g,h,k,l,m,p,r;return v(e,function(e){switch(e.j){case 1:return f=Wc,sd(b.a.J,f.Pa),b.v++,b.A=!1,g=b.v,h=b.a.J,k=new Map,l=new Set,k.set(f.Pa,c),l.add(c),u(e,h.init(k,!1),2);case 2:return b.f?e["return"]():u(e,Bh(b,l),3);case 3:if(b.f)return e["return"]();b.v!=g||b.c.has(f.Pa)||b.A||(m=b.a.Ra(),p=J.Jb(b.b,m),r=Ch(c,p,0),b.c.set(f.Pa,r),b.o&&Dh(b,r,0));e.j=0;}})})}
  function Eh(b,c){var d=b.c.get("video");if(d){var e=d.stream;if(e)if(c){var f=e.trickModeVideo;f&&!d.ya&&(Fh(b,f,!1,0),d.ya=e);}else if(e=d.ya)d.ya=null,Fh(b,e,!0,0);}}function Gh(b,c,d,e){c.video&&Fh(b,c.video,d,e);c.audio&&Fh(b,c.audio,d,e);}
  function Fh(b,c,d,e){var f=b.c.get(c.type);if(!f&&"text"==c.type&&b.g.ignoreTextStreamFailures)Ah(b,c);else if(f){var g=J.Ea(b.b,c);d&&g!=f.xa?Hh(b):(f.ya&&(c.trickModeVideo?(f.ya=c,c=c.trickModeVideo):f.ya=null),(g=b.h[g])&&g.bb&&(g=b.i.get(c.id))&&g.bb&&f.stream!=c&&("text"==c.type&&ld(b.a.J,Mb(c.mimeType,c.codecs)),f.stream=c,f.Ob=!0,d&&(f.Da?f.Vb=!0:f.Ia?(f.Ba=!0,f.Fb=e,f.Vb=!0):(vh(f),Ih(b,f,!0,e)))));}}
  function Jh(b){var c=b.a.Ra(),d=b.g.smallGapLimit;Array.from(b.c.keys()).every(function(e){var f=b.a.J;"text"==e?(e=f.a,e=c>=e.a&&c<e.b):(e=nd(f,e),e=Rc(e,c,d));return e})||Hh(b);}function Hh(b){b.c.forEach(function(c,d){c.Da||c.Ba||(c.Ia?(c.Ba=!0,c.Fb=0):null==md(b.a.J,d)?null==c.Aa&&Dh(b,c,0):(vh(c),Ih(b,c,!1,0)));});}
  function wh(b,c,d,e,f){return t(function h(){var k,l,m,p,r,w,x;return v(h,function(h){switch(h.j){case 1:return k=b.a.Ra(),l=J.Jb(b.b,k),m=Wc,p=new Map,r=new Set,c&&(p.set(m.Nd,c),r.add(c)),d&&(p.set(m.Sd,d),r.add(d)),e&&(p.set(m.Pa,e),r.add(e)),w=b.a.J,x=b.g.forceTransmuxTS,u(h,w.init(p,x),2);case 2:if(b.f)return h["return"]();Kh(b);return u(h,Bh(b,r),3);case 3:if(b.f)return h["return"]();p.forEach(function(c,d){if(!b.c.has(d)){var e=Ch(c,l,f);b.c.set(d,e);Dh(b,e,0);}});h.j=0;}})})}
  function Ch(b,c,d){return {stream:b,type:b.type,Va:null,ra:null,ya:null,Ob:!0,xa:c,endOfStream:!1,Ia:!1,Aa:null,Ba:!1,Fb:0,Vb:!1,Da:!1,wc:!1,mb:!1,zd:d}}
  function Lh(b,c){var d=b.h[c];if(d)return d.promise;d={promise:new z,bb:!1};b.h[c]=d;for(var e=new Set,f=q(b.b.periods[c].variants),g=f.next();!g.done;g=f.next())g=g.value,g.video&&e.add(g.video),g.video&&g.video.trickModeVideo&&e.add(g.video.trickModeVideo),g.audio&&e.add(g.audio);f=q(b.b.periods[c].textStreams);for(g=f.next();!g.done;g=f.next())e.add(g.value);b.s=b.s.then(function(){if(!this.f)return Bh(this,e)}.bind(b)).then(function(){this.f||(this.h[c].promise.resolve(),this.h[c].bb=!0);}.bind(b))["catch"](function(b){this.f||
  (this.h[c].promise["catch"](function(){}),this.h[c].promise.reject(),delete this.h[c],this.a.onError(b));}.bind(b));return d.promise}
  function Bh(b,c){return t(function e(){var f,g,h,k,l,m,p;return v(e,function(e){switch(e.j){case 1:f=[];for(var r=q(c),x=r.next();!x.done;x=r.next())g=x.value,(h=b.i.get(g.id))?f.push(h.promise):(b.i.set(g.id,{promise:new z,bb:!1}),f.push(g.createSegmentIndex()));qa(e,2);return u(e,Promise.all(f),4);case 4:if(b.f)return e["return"]();sa(e,3);break;case 2:k=ta(e);if(b.f)return e["return"]();e=q(c);for(x=e.next();!x.done;x=e.next())l=x.value,b.i.get(l.id).promise["catch"](function(){}),b.i.get(l.id).promise.reject(),
  b.i["delete"](l.id);throw k;case 3:r=q(c);for(x=r.next();!x.done;x=r.next())m=x.value,p=b.i.get(m.id),p.bb||(p.promise.resolve(),p.bb=!0);e.j=0;}})})}function Kh(b){var c=b.b.presentationTimeline.T();Infinity>c?b.a.J.ma(c):b.a.J.ma(Math.pow(2,32));}
  n.If=function(b){if(!this.f&&!b.Ia&&null!=b.Aa&&!b.Da)if(b.Aa=null,b.Ba)Ih(this,b,b.Vb,b.Fb);else{try{var c=Mh(this,b);null!=c&&(Dh(this,b,c),b.mb=!1);}catch(d){Nh(this,d);return}c=Array.from(this.c.values());Oh(this,b);c.every(function(b){return b.endOfStream})&&this.a.J.endOfStream().then(function(){if(!this.f){var b=this.a.J.T();b<this.b.presentationTimeline.T()&&this.b.presentationTimeline.ma(b);}}.bind(this));}};
  function Mh(b,c){function d(b){return "text"==b.type&&"application/cea-608"==b.stream.mimeType}if(d(c))return b.a.J.Tb(c.stream.originalId||""),null;var e=b.a.Ra(),f=Ph(b,c,e),g=J.Ea(b.b,c.stream),h=J.Jb(b.b,f),k=pd(b.a.J,c.type,e),l=Math.max(b.b.minBufferTime||0,b.g.rebufferingGoal,b.g.bufferingGoal)*b.l;if(f>=b.b.presentationTimeline.T())return c.endOfStream=!0,"video"==c.type&&(f=b.c.get("text"))&&"application/cea-608"==f.stream.mimeType&&(f.endOfStream=!0),null;c.endOfStream=!1;c.xa=h;if(h!=g)return null;
  if(k>=l)return .5;h=od(b.a.J,c.type);h=Qh(b,c,e,h,g);if(!h)return 1;var m=Infinity;Array.from(b.c.values()).forEach(function(c){d(c)||(m=Math.min(m,Ph(b,c,e)));});if(f>=m+b.b.presentationTimeline.b)return 1;c.zd=0;Rh(b,c,e,g,h);return null}function Ph(b,c,d){return c.Va&&c.ra?b.b.periods[J.Ea(b.b,c.Va)].startTime+c.ra.endTime:Math.max(d,c.zd)}
  function Qh(b,c,d,e,f){if(c.ra&&c.stream==c.Va)return Sh(b,c,f,c.ra.position+1);d=c.ra?c.stream.findSegmentPosition(Math.max(0,b.b.periods[J.Ea(b.b,c.Va)].startTime+c.ra.endTime-b.b.periods[f].startTime)):c.stream.findSegmentPosition(Math.max(0,(e||d)-b.b.periods[f].startTime));if(null==d)return null;var g=null;null==e&&(g=Sh(b,c,f,Math.max(0,d-1)));return g||Sh(b,c,f,d)}
  function Sh(b,c,d,e){d=b.b.periods[d];c=c.stream.getSegmentReference(e);if(!c)return null;e=b.b.presentationTimeline;b=e.lb();e=e.Ta();return d.startTime+c.endTime<b||d.startTime+c.startTime>e?null:c}
  function Rh(b,c,d,e,f){var g=b.b.periods[e],h=c.stream,k=b.b.presentationTimeline.T(),l=b.b.periods[e+1];e=Th(b,c,e,Math.max(0,g.startTime-.1),l?l.startTime+.01:k);c.Ia=!0;c.Ob=!1;k=Uh(b,f);Promise.all([e,k]).then(function(b){if(!this.f&&!this.m)return Vh(this,c,d,g,h,f,b[1])}.bind(b)).then(function(){this.f||this.m||(c.Ia=!1,c.wc=!1,c.Ba||this.a.qb(),Dh(this,c,0),Wh(this,h));}.bind(b))["catch"](function(b){this.f||this.m||(c.Ia=!1,"text"==c.type&&this.g.ignoreTextStreamFailures?this.c["delete"]("text"):
  3017==b.code?Xh(this,c,b):(c.mb=!0,b.severity=2,Nh(this,b)));}.bind(b));}function Xh(b,c,d){if(!Array.from(b.c.values()).some(function(b){return b!=c&&b.wc})){var e=Math.round(100*b.l);if(20<e)b.l-=.2;else if(4<e)b.l-=.04;else{c.mb=!0;b.m=!0;b.a.onError(d);return}c.wc=!0;}Dh(b,c,4);}
  function Th(b,c,d,e,f){if(!c.Ob)return Promise.resolve();d=td(b.a.J,c.type,b.b.periods[d].startTime-c.stream.presentationTimeOffset,e,f);if(!c.stream.initSegmentReference)return d;b=Uh(b,c.stream.initSegmentReference).then(function(b){if(!this.f)return qd(this.a.J,c.type,b,null,null,c.stream.closedCaptions&&0<c.stream.closedCaptions.size)}.bind(b))["catch"](function(b){c.Ob=!0;return Promise.reject(b)});return Promise.all([d,b])}
  function Vh(b,c,d,e,f,g,h){var k=f.closedCaptions&&0<f.closedCaptions.size;null!=f.emsgSchemeIdUris&&0<f.emsgSchemeIdUris.length&&(new Q).aa("emsg",b.df.bind(b,e,g,f.emsgSchemeIdUris)).parse(h);return Yh(b,c,d).then(function(){if(!this.f)return qd(this.a.J,c.type,h,g.startTime+e.startTime,g.endTime+e.startTime,k)}.bind(b)).then(function(){if(!this.f)return c.Va=f,c.ra=g,Promise.resolve()}.bind(b))}
  ...
  function Yh(b,c,d){var e=Math.max(b.g.bufferBehind,b.b.presentationTimeline.b),f=md(b.a.J,c.type);if(null==f)return Promise.resolve();d=d-f-e;return 0>=d?Promise.resolve():b.a.J.remove(c.type,f,f+d).then(function(){}.bind(b))}
  function Wh(b,c){if(!b.o&&(b.o=Array.from(b.c.values()).every(function(b){return "text"==b.type?!0:!b.Ba&&!b.Da&&b.ra}),b.o)){var d=J.Ea(b.b,c);b.h[d]||Lh(b,d).then(function(){this.f||this.a.hd();}.bind(b))["catch"](H.pb);for(d=0;d<b.b.periods.length;++d)Lh(b,d)["catch"](H.pb);b.a.We&&b.a.We();}}
  function Oh(b,c){if(c.xa!=J.Ea(b.b,c.stream)){var d=c.xa,e=Array.from(b.c.values());e.every(function(b){return b.xa==d})&&e.every(Zh)&&Lh(b,d).then(function(){if(!this.f&&e.every(function(b){var c=J.Ea(this.b,b.stream);return Zh(b)&&b.xa==d&&c!=d}.bind(this))){var b=this.b.periods[d],c=this.a.jd(b),h=new Map;c.variant&&c.variant.video&&h.set("video",c.variant.video);c.variant&&c.variant.audio&&h.set("audio",c.variant.audio);c.text&&h.set("text",c.text);var k=q(this.c.keys());for(c=k.next();!c.done;c=
  k.next())if(c=c.value,!h.has(c)&&"text"!=c){this.a.onError(new B(2,5,5005));return}k=q(Array.from(h.keys()));for(c=k.next();!c.done;c=k.next())if(c=c.value,!this.c.has(c))if("text"==c)wh(this,null,null,h.get("text"),b.startTime),h["delete"](c);else{this.a.onError(new B(2,5,5005));return}b=q(Array.from(this.c.keys()));for(c=b.next();!c.done;c=b.next())c=c.value,(k=h.get(c))?(Fh(this,k,!1,0),Dh(this,this.c.get(c),0)):this.c["delete"](c);this.a.hd();}}.bind(b))["catch"](H.pb);}}
  function Zh(b){return !b.Ia&&null==b.Aa&&!b.Ba&&!b.Da}function Uh(b,c){var d=Ab(c.c(),b.g.retryParameters);if(0!=c.b||null!=c.a){var e="bytes="+c.b+"-";null!=c.a&&(e+=c.a);d.headers.Range=e;}return b.a.ob.request(1,d).promise.then(function(b){return b.data})}
  function Ih(b,c,d,e){t(function g(){var h,k,l;return v(g,function(g){switch(g.j){case 1:return c.Ba=!1,c.Vb=!1,c.Fb=0,c.Da=!0,e?(k=b.a.Ra(),l=b.a.J.T(),h=b.a.J.remove(c.type,k+e,l)):h=sd(b.a.J,c.type).then(function(){if(!this.f&&d)return this.a.J.flush(c.type)}.bind(b)),u(g,h,2);case 2:if(b.f)return g["return"]();c.Va=null;c.ra=null;c.Da=!1;c.endOfStream=!1;Dh(b,c,0);g.j=0;}})});}function Dh(b,c,d){c.Aa=window.setTimeout(b.If.bind(b,c),1E3*d);}
  function vh(b){null!=b.Aa&&(window.clearTimeout(b.Aa),b.Aa=null);}function Nh(b,c){ib(b.D).then(function(){this.f||(this.a.onError(c),c.handled||this.g.failureCallback(c));}.bind(b));}function $h(b,c,d,e,f,g){if(200<=d&&299>=d&&202!=d)return f&&(e=f),{uri:e,data:c,headers:b,fromCache:!!b["x-shaka-from-cache"]};f=null;try{f=Vb(c);}catch(h){}throw new B(401==d||403==d?2:1,1,1001,e,d,f,b,g);}function W(b,c,d,e){var f=new W.b;Kb(c.headers).forEach(function(b,c){f.append(c,b);});var g=new W.a,h={body:c.body||void 0,headers:f,method:c.method,signal:g.signal,credentials:c.allowCrossSiteCredentials?"include":void 0},k={Oc:!1,Jd:!1},l;c.retryParameters.timeout&&(l=setTimeout(function(){k.Jd=!0;g.abort();},c.retryParameters.timeout));b=W.h(b,d,h,k,l,e);return new C(b,function(){k.Oc=!0;g.abort();return Promise.resolve()})}y("shaka.net.HttpFetchPlugin",W);
  ...
  c();},new m({start:U}),u(k,p.arrayBuffer(),6);case 6:r=k.u;case 3:ua(k);clearTimeout(f);va(k,4);break;case 2:X=ta(k);if(e.Oc)throw new B(1,1,7001,b,c);if(e.Jd)throw new B(1,1,1003,b,c);throw new B(1,1,1002,b,X,c);case 4:return ea={},ha=p.headers,ha.forEach(function(b,c){ea[c.trim()]=b;}),k["return"]($h(ea,r,p.status,b,p.url,c))}})})};W.isSupported=function(){if(window.ReadableStream)try{new ReadableStream({});}catch(b){return !1}else return !1;return !(!window.fetch||!window.AbortController)};
  W.isSupported=W.isSupported;W.g=window.fetch;W.a=window.AbortController;W.c=window.ReadableStream;W.b=window.Headers;W.isSupported()&&(zb("http",W,2),zb("https",W,2));function ai(b,c,d,e){var f=new ai.f,g=Date.now(),h=0,k=new Promise(function(k,m){f.open(c.method,b,!0);f.responseType="arraybuffer";f.timeout=c.retryParameters.timeout;f.withCredentials=c.allowCrossSiteCredentials;f.onabort=function(){m(new B(1,1,7001,b,d));};f.onload=function(c){c=c.target;var e=c.getAllResponseHeaders().trim().split("\r\n"),f={};e=q(e);for(var g=e.next();!g.done;g=e.next())g=g.value.split(": "),f[g[0].toLowerCase()]=g.slice(1).join(": ");try{var h=$h(f,c.response,c.status,b,c.responseURL,
  d);k(h);}catch(U){m(U);}};f.onerror=function(c){m(new B(1,1,1002,b,c,d));};f.ontimeout=function(){m(new B(1,1,1003,b,d));};f.onprogress=function(b){var c=Date.now();if(100<c-g||b.lengthComputable&&b.loaded==b.total)e(c-g,b.loaded-h),h=b.loaded,g=c;};for(var l in c.headers)f.setRequestHeader(l.toLowerCase(),c.headers[l]);f.send(c.body);});return new C(k,function(){f.abort();return Promise.resolve()})}y("shaka.net.HttpXHRPlugin",ai);ai.f=window.XMLHttpRequest;zb("http",ai,1);zb("https",ai,1);function bi(b,c){this.i=b;this.c=new Map;this.g=!1;this.h=c;this.a=this.b=this.f=0;}bi.prototype.destroy=function(){this.g=!0;return Promise.all(this.c.values()).then(function(){},function(){})};
  function ci(b,c,d,e,f){b.b+=e;var g=b.c.get(c)||Promise.resolve();b.c.set(c,g.then(function(){return t(function k(){var c,g;return v(k,function(k){switch(k.j){case 1:return u(k,di(b,d),2);case 2:c=k.u;if(b.g)throw new B(2,9,7001);b.f+=e;b.a+=c.byteLength;g=b.b?b.f/b.b:0;b.h(g,b.a);return k["return"](f(c))}})})}));}function ei(b){return t(function d(){return v(d,function(d){switch(d.j){case 1:return u(d,Promise.all(b.c.values()),2);case 2:return d["return"](b.a)}})})}
  function di(b,c){return t(function e(){var f,g;return v(e,function(e){switch(e.j){case 1:return f=b.i.request(1,c),u(e,f.promise,2);case 2:return g=e.u,e["return"](g.data)}})})}function fi(b,c){var d=this;this.c=b;this.b=b.objectStore(c);this.a=new z;b.onabort=function(b){b.preventDefault();d.a.reject();};b.onerror=function(b){b.preventDefault();d.a.reject();};b.oncomplete=function(){d.a.resolve();};}fi.prototype.abort=function(){try{this.c.abort();}catch(b){}return this.a["catch"](function(){})};
  function gi(b,c){return new Promise(function(d,e){var f=b.b.openCursor();f.onerror=e;f.onsuccess=function(b){b=b.target.result;if(!b)return d();c(b.key,b.value,b);b["continue"]();};})}fi.prototype.store=function(){return this.b};fi.prototype.promise=function(){return this.a};function hi(b){this.b=b;this.a=[];}hi.prototype.destroy=function(){return Promise.all(this.a.map(function(b){return b.abort()}))};function ii(b,c){return ji(b,c,"readonly")}function ki(b,c){return ji(b,c,"readwrite")}function ji(b,c,d){d=b.b.transaction([c],d);var e=new fi(d,c);b.a.push(e);e.promise().then(function(){tb(b.a,e);},function(){tb(b.a,e);});return e}function li(b){this.a=new hi(b);}li.prototype.destroy=function(){return this.a.destroy()};li.prototype.getAll=function(){var b=this;return t(function d(){var e,f;return v(d,function(d){switch(d.j){case 1:return e=ii(b.a,"session-ids"),f=[],u(d,gi(e,function(b,d){f.push(d);}),2);case 2:return u(d,e.promise(),3);case 3:return d["return"](f)}})})};li.prototype.add=function(b){var c=ki(this.a,"session-ids"),d=c.store();b=q(b);for(var e=b.next();!e.done;e=b.next())d.add(e.value);return c.promise()};
  li.prototype.remove=function(b){var c=this;return t(function e(){var f;return v(e,function(e){switch(e.j){case 1:return f=ki(c.a,"session-ids"),u(e,gi(f,function(c,e,f){0<=b.indexOf(e.sessionId)&&f["delete"]();}),2);case 2:return u(e,f.promise(),0)}})})};function mi(){this.a=new Map;}mi.prototype.destroy=function(){for(var b=[],c=q(this.a.values()),d=c.next();!d.done;d=c.next())b.push(d.value.destroy());this.a.clear();return Promise.all(b)};mi.prototype.init=function(){var b=this;ni.forEach(function(c,d){var e=c();e&&b.a.set(d,e);});for(var c=[],d=q(this.a.values()),e=d.next();!e.done;e=d.next())c.push(e.value.init());return Promise.all(c)};
  function oi(b){var c=null;b.a.forEach(function(b,e){b.getCells().forEach(function(b,d){b.hasFixedKeySpace()||c||(c={path:{ka:e,W:d},W:b});});});if(c)return c;throw new B(2,9,9013,"Could not find a cell that supports add-operations");}function pi(b,c){b.a.forEach(function(b,e){b.getCells().forEach(function(b,d){c({ka:e,W:d},b);});});}
  function qi(b,c,d){b=b.a.get(c);if(!b)throw new B(2,9,9013,"Could not find mechanism with name "+c);c=b.getCells().get(d);if(!c)throw new B(2,9,9013,"Could not find cell with name "+d);return c}function ri(b,c){b.a.forEach(function(b){c(b.getEmeSessionCell());});}function si(b){var c=Array.from(b.a.keys());if(!c.length)throw new B(2,9,9E3,"No supported storage mechanisms found");return b.a.get(c[0]).getEmeSessionCell()}
  mi.prototype.erase=function(){var b=this;return t(function d(){var e,f,g;return v(d,function(d){switch(d.j){case 1:return e=Array.from(b.a.values()),f=0<e.length,f||(g=ni,g.forEach(function(b){(b=b())&&e.push(b);})),u(d,Promise.all(e.map(function(b){return b.erase()})),2);case 2:if(f)d.B(0);else return u(d,Promise.all(e.map(function(b){return b.destroy()})),0)}})})};function ti(b,c){ni.set(b,c);}y("shaka.offline.StorageMuxer.register",ti);y("shaka.offline.StorageMuxer.unregister",function(b){ni["delete"](b);});
  function ui(){for(var b=q(ni.values()),c=b.next();!c.done;c=b.next())if(c=c.value,c=c())return c.destroy(),!0;return !1}var ni=new Map;function vi(b){this.a=new hi(b);}n=vi.prototype;n.destroy=function(){return this.a.destroy()};n.hasFixedKeySpace=function(){return !0};n.addSegments=function(){return wi("segment")};n.removeSegments=function(b,c){return xi(this,"segment",b,c)};n.getSegments=function(b){return yi(this,"segment",b).then(function(b){return b.map(zi)})};n.addManifests=function(){return wi("manifest")};
  n.updateManifestExpiration=function(b,c){var d=ki(this.a,"manifest"),e=d.store(),f=new z;e.get(b).onsuccess=function(d){(d=d.target.result)?(d.expiration=c,e.put(d),f.resolve()):f.reject(new B(2,9,9012,"Could not find values for "+b));};return d.promise().then(function(){return f})};n.removeManifests=function(b,c){return xi(this,"manifest",b,c)};n.getManifests=function(b){return yi(this,"manifest",b).then(function(b){return b.map(Ai)})};
  n.getAllManifests=function(){var b=this;return t(function d(){var e,f,g;return v(d,function(d){switch(d.j){case 1:return e=Ai,f=ii(b.a,"manifest"),g=new Map,u(d,gi(f,function(b,d){g.set(b,e(d));}),2);case 2:return u(d,f.promise(),3);case 3:return d["return"](g)}})})};function wi(b){return Promise.reject(new B(2,9,9011,"Cannot add new value to "+b))}function xi(b,c,d,e){b=ki(b.a,c);var f=b.store();d.forEach(function(b){f["delete"](b).onsuccess=function(){return e(b)};});return b.promise()}
  function yi(b,c,d){b=ii(b.a,c);var e=b.store(),f={},g=[];d.forEach(function(b){e.get(b).onsuccess=function(c){c=c.target.result;void 0==c&&g.push(b);f[b]=c;};});return b.promise().then(function(){return g.length?Promise.reject(new B(2,9,9012,"Could not find values for "+g)):d.map(function(b){return f[b]})})}
  function Ai(b){return {originalManifestUri:b.originalManifestUri,duration:b.duration,size:b.size,expiration:null==b.expiration?Infinity:b.expiration,periods:b.periods.map(Bi),sessionIds:b.sessionIds,drmInfo:b.drmInfo,appMetadata:b.appMetadata}}function Bi(b){Ci(b);b.streams.forEach(function(){});return {startTime:b.startTime,streams:b.streams.map(Di)}}
  function Di(b){var c=b.Be?Ei(b.Be):null;return {id:b.id,originalId:null,primary:b.primary,presentationTimeOffset:b.presentationTimeOffset,contentType:b.contentType,mimeType:b.mimeType,codecs:b.codecs,frameRate:b.frameRate,kind:b.kind,language:b.language,label:b.label,width:b.width,height:b.height,initSegmentKey:c,encrypted:b.encrypted,keyId:b.keyId,segments:b.segments.map(Fi),variantIds:b.variantIds}}function Fi(b){var c=Ei(b.uri);return {startTime:b.startTime,endTime:b.endTime,dataKey:c}}
  function zi(b){return {data:b.data}}function Ei(b){var c;if((c=/^offline:[0-9]+\/[0-9]+\/([0-9]+)$/.exec(b))||(c=/^offline:segment\/([0-9]+)$/.exec(b)))return Number(c[1]);throw new B(2,9,9004,"Could not parse uri "+b);}
  function Ci(b){var c=b.streams.filter(function(b){return "audio"==b.contentType}),d=b.streams.filter(function(b){return "video"==b.contentType});if(!c.every(function(b){return b.variantIds})||!d.every(function(b){return b.variantIds})){c.forEach(function(b){b.variantIds=[];});d.forEach(function(b){b.variantIds=[];});var e=0;if(d.length&&!c.length){var f=e++;d.forEach(function(b){b.variantIds.push(f);});}if(!d.length&&c.length){var g=e++;c.forEach(function(b){b.variantIds.push(g);});}d.length&&c.length&&c.forEach(function(b){d.forEach(function(c){var d=
  e++;b.variantIds.push(d);c.variantIds.push(d);});});}}function Gi(b,c,d,e){this.a=new hi(b);this.c=c;this.b=d;this.f=e;}n=Gi.prototype;n.destroy=function(){return this.a.destroy()};n.hasFixedKeySpace=function(){return this.f};n.addSegments=function(b){return Hi(this,this.c,b)};n.removeSegments=function(b,c){return Ii(this,this.c,b,c)};n.getSegments=function(b){return Ji(this,this.c,b)};n.addManifests=function(b){return Hi(this,this.b,b)};
  n.updateManifestExpiration=function(b,c){var d=ki(this.a,this.b),e=d.store();e.get(b).onsuccess=function(d){if(d=d.target.result)d.expiration=c,e.put(d,b);};return d.promise()};n.removeManifests=function(b,c){return Ii(this,this.b,b,c)};n.getManifests=function(b){return Ji(this,this.b,b)};
  n.getAllManifests=function(){var b=this;return t(function d(){var e,f;return v(d,function(d){switch(d.j){case 1:return e=ii(b.a,b.b),f=new Map,u(d,gi(e,function(b,d){f.set(b,d);}),2);case 2:return u(d,e.promise(),3);case 3:return d["return"](f)}})})};
  function Hi(b,c,d){if(b.f)return Promise.reject(new B(1,9,9011,"Cannot add new value to "+c));b=ki(b.a,c);var e=b.store(),f=[];d.forEach(function(b){e.add(b).onsuccess=function(b){f.push(b.target.result);};});return b.promise().then(function(){return f})}function Ii(b,c,d,e){b=ki(b.a,c);var f=b.store();d.forEach(function(b){f["delete"](b).onsuccess=function(){return e(b)};});return b.promise()}
  function Ji(b,c,d){b=ii(b.a,c);var e=b.store(),f={},g=[];d.forEach(function(b){var c=e.get(b);c.onsuccess=function(){void 0==c.result&&g.push(b);f[b]=c.result;};});return b.promise().then(function(){return g.length?Promise.reject(new B(1,9,9012,"Could not find values for "+g)):d.map(function(b){return f[b]})})}function Ki(){this.g=this.c=this.b=this.a=this.f=null;}n=Ki.prototype;
  n.init=function(){var b=this,c=new z,d=window.indexedDB.open("shaka_offline_db",4);d.onsuccess=function(d){d=d.target.result;b.f=d;var e=d.objectStoreNames;e=e.contains("manifest")&&e.contains("segment")?new vi(d):null;b.a=e;e=d.objectStoreNames;e=e.contains("manifest-v2")&&e.contains("segment-v2")?new Gi(d,"segment-v2","manifest-v2",!0):null;b.b=e;e=d.objectStoreNames;e=e.contains("manifest-v3")&&e.contains("segment-v3")?new Gi(d,"segment-v3","manifest-v3",!1):null;b.c=e;d=d.objectStoreNames.contains("session-ids")?
  new li(d):null;b.g=d;c.resolve();};d.onupgradeneeded=function(b){b=b.target.result;for(var c=q(["segment-v3","manifest-v3","session-ids"]),d=c.next();!d.done;d=c.next())d=d.value,b.objectStoreNames.contains(d)||b.createObjectStore(d,{autoIncrement:!0});};d.onerror=function(b){c.reject(new B(2,9,9001,d.error));b.preventDefault();};return c};
  ...
  n.erase=function(){var b=this;return t(function d(){return v(d,function(d){switch(d.j){case 1:if(!b.a){d.B(2);break}return u(d,b.a.destroy(),2);case 2:if(!b.b){d.B(4);break}return u(d,b.b.destroy(),4);case 4:if(!b.c){d.B(6);break}return u(d,b.c.destroy(),6);case 6:return b.f&&b.f.close(),u(d,Li(),8);case 8:return b.f=null,b.a=null,b.b=null,b.c=null,u(d,b.init(),0)}})})};
  function Li(){var b=new z,c=window.indexedDB.deleteDatabase("shaka_offline_db");c.onblocked=function(){};c.onsuccess=function(){b.resolve();};c.onerror=function(d){b.reject(new B(2,9,9001,c.error));d.preventDefault();};return b}ti("idb",function(){return window.indexedDB?new Ki:null});function Mi(b,c,d,e){this.a=b;this.g=c;this.f=d;this.c=e;this.b=["offline:",b,"/",c,"/",d,"/",e].join("");}Mi.prototype.ka=function(){return this.g};Mi.prototype.W=function(){return this.f};Mi.prototype.key=function(){return this.c};Mi.prototype.toString=function(){return this.b};
  function Ni(b){b=/^offline:([a-z]+)\/([^/]+)\/([^/]+)\/([0-9]+)$/.exec(b);if(null==b)return null;var c=b[1];if("manifest"!=c&&"segment"!=c)return null;var d=b[2];if(!d)return null;var e=b[3];return e&&null!=c?new Mi(c,d,e,Number(b[4])):null}function Oi(b,c){this.b=b;this.a=c;}function Pi(b,c){var d=new T(null,0);d.ma(c.duration);var e=c.periods.map(function(c){return Qi(b,c,d)}),f=c.drmInfo?[c.drmInfo]:[];c.drmInfo&&e.forEach(function(b){b.variants.forEach(function(b){b.drmInfos=f;});});return {presentationTimeline:d,minBufferTime:2,offlineSessionIds:c.sessionIds,periods:e}}
  function Qi(b,c,d){var e=c.streams.filter(function(b){return "audio"==b.contentType}),f=c.streams.filter(function(b){return "video"==b.contentType});e=Ri(b,e,f);f=c.streams.filter(function(b){return "text"==b.contentType}).map(function(c){return Si(b,c)});c.streams.forEach(function(e){e=e.segments.map(function(c,d){return Ti(b,d,c)});d.Xa(e,c.startTime);});return {startTime:c.startTime,variants:Array.from(e.values()),textStreams:f}}
  ...
  e.value,g=Si(b,e),h=q(e.variantIds),e=h.next();!e.done;e=h.next())e=f.get(e.value),e.language=g.language,e.primary=e.primary||g.primary,e.audio=g;d=q(d);for(c=d.next();!c.done;c=d.next())for(e=c.value,c=Si(b,e),g=q(e.variantIds),e=g.next();!e.done;e=g.next())e=f.get(e.value),e.primary=e.primary||c.primary,e.video=c;return f}
  function Si(b,c){var d=c.segments.map(function(c,d){return Ti(b,d,c)}),e=new S(d);d={id:c.id,originalId:c.originalId,createSegmentIndex:function(){return Promise.resolve()},findSegmentPosition:function(b){return e.find(b)},getSegmentReference:function(b){return e.get(b)},initSegmentReference:null,presentationTimeOffset:c.presentationTimeOffset,mimeType:c.mimeType,codecs:c.codecs,width:c.width||void 0,height:c.height||void 0,frameRate:c.frameRate||void 0,kind:c.kind,encrypted:c.encrypted,keyId:c.keyId,
  language:c.language,label:c.label||null,type:c.contentType,primary:c.primary,trickModeVideo:null,emsgSchemeIdUris:null,roles:[],channelsCount:null,closedCaptions:null};null!=c.initSegmentKey&&(d.initSegmentReference=Ui(b,c.initSegmentKey));return d}function Ti(b,c,d){var e=new Mi("segment",b.b,b.a,d.dataKey);return new N(c,d.startTime,d.endTime,function(){return [e.toString()]},0,null)}function Ui(b,c){var d=new Mi("segment",b.b,b.a,c);return new ye(function(){return [d.toString()]},0,null)}function Vi(b){this.a=!1;this.b=new z;this.c=b;}Vi.prototype.destroy=function(){var b=this;if(this.a)return this.b;this.a=!0;return this.c().then(function(){b.b.resolve();},function(){b.b.resolve();})};function Wi(b,c){return t(function e(){return v(e,function(e){switch(e.j){case 1:return ra(e,2),u(e,Promise.resolve(c()),4);case 4:return e["return"](e.u);case 2:return ua(e),u(e,Promise.all(b.map(function(b){return b.destroy()})),5);case 5:va(e,0);}})})}function Xi(){this.a=null;}n=Xi.prototype;n.configure=function(){};n.start=function(b){var c=Ni(b);this.a=c;if(null==c||"manifest"!=c.a)return Promise.reject(new B(2,1,9004,c));var d=new mi;return Wi([d],function(){return t(function f(){var b,h,k,l;return v(f,function(f){switch(f.j){case 1:return u(f,d.init(),2);case 2:return u(f,qi(d,c.ka(),c.W()),3);case 3:return b=f.u,u(f,b.getManifests([c.key()]),4);case 4:return h=f.u,k=h[0],l=new Oi(c.ka(),c.W()),f["return"](Pi(l,k))}})})})};n.stop=function(){return Promise.resolve()};
  n.update=function(){};n.onExpirationUpdated=function(b,c){var d=this.a,e=new mi;return Wi([e],function(){return t(function g(){var h,k,l,m,p;return v(g,function(g){switch(g.j){case 1:return u(g,e.init(),2);case 2:return u(g,qi(e,d.ka(),d.W()),3);case 3:return h=g.u,u(g,h.getManifests([d.key()]),4);case 4:k=g.u;l=k[0];m=l.sessionIds.includes(b);p=void 0==l.expiration||l.expiration>c;if(m&&p)return u(g,h.updateManifestExpiration(d.key(),c),0);g.B(0);}})})})["catch"](function(){})};
  df["application/x-offline-manifest"]=Xi;function Yi(b){var c=Ni(b);return c&&"manifest"==c.a?Yi.a(b):c&&"segment"==c.a?Yi.b(c.key(),c):jb(new B(2,1,9004,b))}y("shaka.offline.OfflineScheme",Yi);Yi.a=function(b){b={uri:b,data:new ArrayBuffer(0),headers:{"content-type":"application/x-offline-manifest"}};return lb(b)};
  Yi.b=function(b,c){var d=new mi,e=Wi([d],function(){return t(function g(){var b,e,l;return v(g,function(g){switch(g.j){case 1:return u(g,d.init(),2);case 2:return u(g,qi(d,c.ka(),c.W()),3);case 3:return b=g.u,u(g,b.getSegments([c.key()]),4);case 4:return e=g.u,l=e[0],g["return"]({uri:c,data:l.data,headers:{}})}})})});return mb(e)};zb("offline",Yi);function Zi(b,c,d){return t(function f(){var g,h,k,l,m,p;return v(f,function(f){switch(f.j){case 1:g=[];for(var r=[],x=q(d),A=x.next();!A.done;A=x.next()){A=A.value;for(var P=!1,U=q(r),X=U.next();!X.done;X=U.next())if(X=X.value,$i(X.info,A)){X.sessionIds.push(A.sessionId);P=!0;break}P||r.push({info:A,sessionIds:[A.sessionId]});}h=q(r);k=h.next();case 2:if(k.done){f.B(4);break}l=k.value;m=aj(b,c,l);return u(f,m,5);case 5:p=f.u;g=g.concat(p);k=h.next();f.B(2);break;case 4:return f["return"](g)}})})}
  ...
  function $i(b,c){function d(b,c){return b.robustness==c.robustness&&b.contentType==c.contentType}return b.keySystem==c.keySystem&&b.licenseUri==c.licenseUri&&vb(b.audioCapabilities,c.audioCapabilities,d)&&vb(b.videoCapabilities,c.videoCapabilities,d)}function bj(b,c,d,e,f){var g=f in e,h=!0,k;for(k in c){var l=f+"."+k,m=g?e[f]:d[k];g||k in d?void 0===c[k]?void 0===m||g?delete b[k]:b[k]=qb(m):m.constructor==Object&&c[k]&&c[k].constructor==Object?(b[k]||(b[k]=qb(m)),l=bj(b[k],c[k],m,e,l),h=h&&l):typeof c[k]!=typeof m||null==c[k]||c[k].constructor!=m.constructor?h=!1:b[k]=c[k]:h=!1;}return h}y("shaka.util.ConfigUtils.mergeConfigObjects",bj);function cj(){var b=5E5,c=Infinity;navigator.connection&&navigator.connection.type&&(b=1E6*navigator.connection.downlink,navigator.connection.saveData&&(c=360));var d={trackSelectionCallback:function(b){return b},progressCallback:function(){},usePersistentLicense:!0},e={drm:{retryParameters:gb(),servers:{},clearKeys:{},advanced:{},delayLicenseRequestUntilPlayed:!1},manifest:{retryParameters:gb(),availabilityWindowOverride:NaN,dash:{customScheme:function(b){if(b)return null},clockSyncUri:"",ignoreDrmInfo:!1,
  ...
  maxWidth:Infinity,minHeight:0,maxHeight:c,minPixels:0,maxPixels:Infinity,minBandwidth:0,maxBandwidth:Infinity}},preferredAudioLanguage:"",preferredTextLanguage:"",preferredVariantRole:"",preferredTextRole:"",preferredAudioChannelCount:2,restrictions:{minWidth:0,maxWidth:Infinity,minHeight:0,maxHeight:Infinity,minPixels:0,maxPixels:Infinity,minBandwidth:0,maxBandwidth:Infinity},playRangeStart:0,playRangeEnd:Infinity,textDisplayFactory:function(){return null}};d.trackSelectionCallback=function(b){return dj(b,
  e.preferredAudioLanguage)};return e}function ej(b,c,d){return bj(b,c,d||cj(),{".drm.servers":"",".drm.clearKeys":"",".drm.advanced":{distinctiveIdentifierRequired:!1,persistentStateRequired:!1,videoRobustness:"",audioRobustness:"",serverCertificate:new Uint8Array(0),individualizationServer:""}},"")}
  function dj(b,c){var d=b.filter(function(b){return "variant"==b.type}),e=[],f=Ad(c,d.map(function(b){return b.language}));f&&(e=d.filter(function(b){return I(b.language)==f}));0==e.length&&(e=d.filter(function(b){return b.primary}));0==e.length&&(d.map(function(b){return b.language}),e=d);var g=e.filter(function(b){return b.height&&480>=b.height});g.length&&(g.sort(function(b,c){return c.height-b.height}),e=g.filter(function(b){return b.height==g[0].height}));d=[];if(e.length){var h=Math.floor(e.length/
  2);e.sort(function(b,c){return b.bandwidth-c.bandwidth});d.push(e[h]);}e=q(b);for(h=e.next();!h.done;h=e.next())h=h.value,"text"==h.type&&d.push(h);return d}function fj(b){this.c=b;this.a=null;this.b=[];}function gj(b){function c(b){return {timestamp:b.timestamp,state:b.state,duration:b.duration}}for(var d=[],e=q(b.b),f=e.next();!f.done;f=e.next())d.push(c(f.value));b.a&&d.push(c(b.a));return d}function hj(b,c){return c?"buffering":b.c.ended?"ended":b.c.paused?"paused":"playing"}function ij(){this.b=this.c=null;this.a=[];}function jj(b,c,d){b.b!=c&&(b.b=c,b.a.push({timestamp:Date.now()/1E3,id:c.id,type:"text",fromAdaptation:d,bandwidth:null}));}function kj(b){this.l=this.A=NaN;this.b=this.h=0;this.i=this.v=this.f=this.g=this.o=this.s=NaN;this.c=null;this.m=new fj(b);this.a=new ij;}function lj(b,c){var d=Date.now()/1E3,e=null==b.c?0:d-b.c;c?b.b+=e:b.h+=e;b.c=d;}function Y(b,c){var d=this;E.call(this);this.f=null;this.gb=!1;this.o=new Eb;this.Wb=this.g=this.va=this.c=this.m=this.a=this.R=this.ha=this.i=this.s=this.h=this.A=null;this.Lc=1E9;this.Ab=new Set;this.eb=!1;this.oa=!0;this.M=this.Cb=this.$=null;this.Kc=!1;this.Jc=0;this.D=null;this.v=new Gg;this.b=mj(this);this.Bb={width:Infinity,height:Infinity};this.l=null;this.yb=new Og(this.b.preferredAudioLanguage,this.b.preferredVariantRole,this.b.preferredAudioChannelCount);this.P=this.b.preferredTextLanguage;
  this.cb=this.b.preferredTextRole;c&&c(this);this.A=nj(this);b&&this.Db(b,!0);this.fb=new Vi(function(){d.o&&(d.o.L(),d.o=null);var b=[];d.A&&(b.push(d.A.destroy()),d.A=null);d.gb=!1;d.o=null;d.g=null;d.Wb=null;d.b=null;return Promise.all(b)});G(this.o,window,"online",function(){d.yc();});}Ga(Y,E);y("shaka.Player",Y);function oj(b){if(!b.$)return Promise.resolve();var c=Promise.resolve();b.m&&(c=b.m.stop(),b.m=null);return Promise.all([c,b.$()])}
  Y.prototype.destroy=function(){var b=this;return t(function d(){return v(d,function(d){switch(d.j){case 1:return u(d,b.detach(),2);case 2:return u(d,b.fb.destroy(),0)}})})};Y.prototype.destroy=Y.prototype.destroy;Y.version="v2.5.0-b2-2";var pj=["2","5"];Ed=new function(b){this.a=b;this.c=Fd;this.b=Gd;}(new Cd(Number(pj[0]),Number(pj[1])));var qj=["output-restricted","internal-error"],rj={};Y.registerSupportPlugin=function(b,c){rj[b]=c;};
  Y.isBrowserSupported=function(){return !!window.Promise&&!!window.Uint8Array&&!!Array.prototype.forEach&&!!window.MediaSource&&!!MediaSource.isTypeSupported&&!!window.MediaKeys&&!!window.navigator&&!!window.navigator.requestMediaKeySystemAccess&&!!window.MediaKeySystemAccess&&!!window.MediaKeySystemAccess.prototype.getConfiguration};Y.probeSupport=function(){return Gc().then(function(b){var c=ff(),d=kd();b={manifest:c,media:d,drm:b};for(var e in rj)b[e]=rj[e]();return b})};
  Y.prototype.Db=function(b,c){var d=this;return t(function f(){return v(f,function(f){switch(f.j){case 1:void 0===c&&(c=!0);if(!d.f){f.B(2);break}return u(f,d.detach(),2);case 2:d.f=b;G(d.o,d.f,"error",d.Xe.bind(d));if(c)return d.s=sj(d),u(f,d.s.o,0);f.B(0);}})})};Y.prototype.attach=Y.prototype.Db;Y.prototype.detach=function(){var b=this;return t(function d(){return v(d,function(d){switch(d.j){case 1:return b.f?u(d,b.xb(!1),2):d["return"]();case 2:b.o.ua(b.f,"error"),b.f=null,d.j=0;}})})};
  Y.prototype.detach=Y.prototype.detach;function tj(b,c,d){return t(function f(){var g;return v(f,function(f){switch(f.j){case 1:return u(f,gf(c,b.A,b.b.manifest.retryParameters,d),2);case 2:return g=f.u,f["return"](new g)}})})}
  function uj(b){b.R=new nh;oh(b.R,function(c){vj(b,"timelineregionadded",c);});return b.m.start(b.va,{networkingEngine:b.A,filterNewPeriod:b.ac.bind(b),filterAllPeriods:b.Tc.bind(b),onTimelineRegionAdded:function(c){var d=b.R;a:{var e=q(d.a);for(var f=e.next();!f.done;f=e.next())if(f=f.value,f.schemeIdUri==c.schemeIdUri&&f.startTime==c.startTime&&f.endTime==c.endTime){e=f;break a}e=null;}null==e&&(d.a.add(c),d.b(c));},onEvent:b.wb.bind(b),onError:b.Ka.bind(b)})}
  function wj(b){function c(b){return b.video&&b.audio||b.video&&b.video.codecs.includes(",")}b.c.periods.some(function(b){return b.variants.some(c)})&&b.c.periods.forEach(function(b){b.variants=b.variants.filter(c);});if(0==b.c.periods.length)throw new B(2,4,4014);}
  Y.prototype.load=function(b,c,d){c=void 0===c?null:c;var e=this;return t(function g(){var h,k,l,m,p,r,w,x,A,P,U,X,ea,ha,Ja;return v(g,function(g){switch(g.j){case 1:if(!e.f)throw new B(2,7,7002);k=new z;l=function(){h=new B(2,7,7E3);return k};e.dispatchEvent(new D("loading"));qa(g,2);m=e.f;p=e.xb();e.$=l;return u(g,p,4);case 4:e.l=new kj(m);e.l.g=Date.now()/1E3;G(e.o,m,"playing",function(){xj(e);});G(e.o,m,"pause",function(){xj(e);});G(e.o,m,"ended",function(){xj(e);});r=e.b.abrFactory;e.g&&e.Wb==r||
  (e.Wb=r,e.g=new r,e.g.configure(e.b.abr));if(h)throw h;x=w=null;d&&("string"==typeof d?x=d:(Dd("Loading with a manifest parser factory","Please register a manifest parser and for the mime-type."),w=d));A=e;if(w){P=new w;g.B(5);break}return u(g,tj(e,b,x),6);case 6:P=g.u;case 5:return A.m=P,e.m.configure(e.b.manifest),e.va=b,u(g,uj(e),7);case 7:U=g.u;e.c=U;if(h)throw h;wj(e);X=e;return u(g,yj(e,U),8);case 8:X.h=g.u;if(h)throw h;e.Tc(e.c.periods);zj(e,e.c.periods);e.yb=new Og(e.b.preferredAudioLanguage,
  e.b.preferredVariantRole,e.b.preferredAudioChannelCount);e.P=e.b.preferredTextLanguage;Aj(e.c.presentationTimeline,e.b.playRangeStart,e.b.playRangeEnd);return u(g,e.h.Db(m),9);case 9:if(h)throw h;e.g.init(function(b,c,d){c=void 0===c?!1:c;d=void 0===d?0:d;Bj(e,e.c.periods[J.ee(e.c,b)],b,!0);e.a&&(Gh(e.a,b,c,d),Cj(e));});e.s||(e.s=sj(e));e.i=new ih(e.f,e.c.presentationTimeline,e.c.minBufferTime||0,e.b.streaming,c,e.Bf.bind(e),e.wb.bind(e));e.ha=Dj(e);e.a=Ej(e);e.a.configure(e.b.streaming);Fj(e);e.dispatchEvent(new D("streaming"));
  return u(g,e.a.init(),10);case 10:if(h)throw h;e.b.streaming.startAtSegmentBoundary&&(ea=Gj(e,lh(e.i)),fh(e.i.b,ea));e.c.periods.forEach(e.ac.bind(e));Hj(e);Cj(e);ha=Ij(e);ha.variants.some(function(b){return b.primary});Jj(e,ha.variants);Hb(e.o,m,"loadeddata",function(){e.l.f=Date.now()/1E3;});if(h)throw h;e.$=null;sa(g,0);break;case 2:return Ja=ta(g),k.resolve(),e.$==l&&(e.$=null,e.dispatchEvent(new D("unloading"))),g["return"](Promise.reject(h||Ja))}})})};Y.prototype.load=Y.prototype.load;
  function Fj(b){function c(b){var c="";b.video&&(c=Pb(b.video.codecs)[0]);var d="";b.audio&&(d=Pb(b.audio.codecs)[0]);return c+"-"+d}var d=b.c.periods.reduce(function(b,c){return b.concat(c.variants)},[]);d=J.Vc(d,b.b.preferredAudioChannelCount);var e=new pb;d.forEach(function(b){var d=c(b);e.push(d,b);});var f=null,g=Infinity;e.forEach(function(b,c){var d=0,e=0;c.forEach(function(b){d+=b.bandwidth||0;++e;});var h=d/e;h<g&&(f=b,g=h);});b.c.periods.forEach(function(b){b.variants=b.variants.filter(function(b){return c(b)==
  f?!0:!1});});}function yj(b,c){return t(function e(){var f,g,h;return v(e,function(e){switch(e.j){case 1:return f={ob:b.A,onError:function(c){b.Ka(c);},rc:function(c){Kj(b,c);},onExpirationUpdated:function(c,e){if(b.m&&b.m.onExpirationUpdated)b.m.onExpirationUpdated(c,e);b.dispatchEvent(new D("expirationupdated"));},onEvent:function(c){b.wb(c);}},g=new dc(f),g.configure(b.b.drm),h=J.Zc(c),u(e,kc(g,h,c.offlineSessionIds),2);case 2:return e["return"](g)}})})}
  function nj(b){return new F(function(c,d){b.g&&b.g.segmentDownloaded(c,d);})}
  function Dj(b){var c=new bh(b.c);ch(c,function(){Hj(b);});var d=new ph(b.R);th(d,function(c){vj(b,"timelineregionenter",c);},function(c){vj(b,"timelineregionexit",c);},function(c,d){d||(vj(b,"timelineregionenter",c),vj(b,"timelineregionexit",c));});var e=new Tg(Math.max(b.c.minBufferTime,b.b.streaming.rebufferingGoal),function(c){return Sc(b.f.buffered,c)},function(){var c;a:if((c=b.f.ended)||(c=b.s,c=c.g?"ended"==c.g.readyState:!0),c)c=!0;else{if(b.c.presentationTimeline.U()&&(c=b.c.presentationTimeline.Ta(),
  Qc(b.f.buffered)>=c)){c=!0;break a}c=!1;}return c});Wg(e,function(){return Lj(b,!0)},function(){return Lj(b,!1)});var f=new Rg(b.f);f.a.add(c);f.a.add(d);f.a.add(e);return f}function sj(b){var c=window.muxjs?new Kc:new Pc,d=new b.b.textDisplayFactory;d.setTextVisibility(b.gb);return new id(b.f,c,d)}function Ej(b){return new uh(b.c,{Ra:function(){return lh(b.i)},J:b.s,ob:b.A,jd:b.He.bind(b),hd:b.Yd.bind(b),onError:b.Ka.bind(b),onEvent:b.wb.bind(b),Ke:b.Le.bind(b),qb:b.Ue.bind(b)})}
  Y.prototype.configure=function(b,c){if(2==arguments.length&&"string"==typeof b){for(var d=b,e={},f=e,g=0,h=0;;){g=d.indexOf(".",g);if(0>g)break;if(0==g||"\\"!=d[g-1])h=d.substring(h,g).replace(/\\\./g,"."),f[h]={},f=f[h],h=g+1;g+=1;}f[d.substring(h).replace(/\\\./g,".")]=c;b=e;}d=ej(this.b,b,mj(this));Mj(this);return d};Y.prototype.configure=Y.prototype.configure;
  function Mj(b){b.m&&b.m.configure(b.b.manifest);b.h&&b.h.configure(b.b.drm);if(b.a){b.a.configure(b.b.streaming);try{b.c.periods.forEach(b.ac.bind(b));}catch(f){b.Ka(f);}var c=xh(b.a),d=zh(b.a),e=Ij(b);c=J.bd(c,d,e.variants);b.g&&c&&c.allowedByApplication&&c.allowedByKeySystem?Jj(b,e.variants):Nj(b,e);}b.g&&(b.g.configure(b.b.abr),b.b.abr.enabled&&!b.oa?b.g.enable():b.g.disable());}Y.prototype.getConfiguration=function(){var b=mj(this);ej(b,this.b,mj(this));return b};Y.prototype.getConfiguration=Y.prototype.getConfiguration;
  Y.prototype.rf=function(){for(var b in this.b)delete this.b[b];ej(this.b,mj(this),mj(this));Mj(this);};Y.prototype.resetConfiguration=Y.prototype.rf;Y.prototype.pe=function(){return this.f};Y.prototype.getMediaElement=Y.prototype.pe;Y.prototype.ib=function(){return this.A};Y.prototype.getNetworkingEngine=Y.prototype.ib;Y.prototype.bc=function(){return this.va};Y.prototype.getAssetUri=Y.prototype.bc;Y.prototype.oe=function(){Dd("getManifestUri",'Please use "getAssetUri" instead.');return this.va};
  ...
  Y.prototype.isBuffering=Y.prototype.fd;Y.prototype.xb=function(b){var c=this;return t(function e(){return v(e,function(e){switch(e.j){case 1:if(c.fb.a)return e["return"]();void 0===b&&(b=!0);c.dispatchEvent(new D("unloading"));return u(e,oj(c),2);case 2:return c.Cb||(c.Cb=Oj(c).then(function(){Lj(c,!1);c.Cb=null;})),u(e,c.Cb,3);case 3:if(b)return c.s=sj(c),u(e,c.s.o,0);e.B(0);}})})};Y.prototype.unload=Y.prototype.xb;Y.prototype.jb=function(){return this.i?this.i.jb():0};
  Y.prototype.getPlaybackRate=Y.prototype.jb;Y.prototype.Kf=function(b){this.i&&hh(this.i.b,b);this.a&&Eh(this.a,1!=b);};Y.prototype.trickPlay=Y.prototype.Kf;Y.prototype.Zd=function(){this.i&&hh(this.i.b,1);this.a&&Eh(this.a,!1);};Y.prototype.cancelTrickPlay=Y.prototype.Zd;Y.prototype.ye=function(){for(var b=Pj(this),c=[],d=q(Qj(this)),e=d.next();!e.done;e=d.next()){e=e.value;var f=J.Hc(e);f.active=e==b;c.push(f);}return c};Y.prototype.getVariantTracks=Y.prototype.ye;
  Y.prototype.ad=function(){var b=Ij(this);if(null==b)b=null;else{if(!Hg(this.v,b).text){var c=J.Hb(b.textStreams,this.P,this.cb);c.length&&(c=c[0],Hg(this.v,b).text=c);}b=Hg(this.v,b).text;}c=[];for(var d=q(Rj(this)),e=d.next();!e.done;e=d.next()){e=e.value;var f=J.Dc(e);f.active=e==b;c.push(f);}return c};Y.prototype.getTextTracks=Y.prototype.ad;Y.prototype.Cd=function(b){var c=Ij(this);null!=c&&(b=J.fe(c,b))&&(Hg(this.v,c).text=b,jj(this.l.a,b,!1),Sj(this,b),this.P=b.language);};
  ...
  Y.prototype.xf=function(b,c,d){d=void 0===d?0:d;var e=Ij(this);null!=e&&(this.b.abr.enabled&&Na("Changing tracks while abr manager is enabled will likely result in the selected track being overriden. Consider disabling abr before calling selectVariantTrack()."),(b=J.ge(e,b))&&J.Ua(b)&&(Bj(this,e,b,!1),Tj(this,b,c,d),this.yb=new Ng(b),Jj(this,e.variants)));};Y.prototype.selectVariantTrack=Y.prototype.xf;
  Y.prototype.je=function(){for(var b=[],c=q(Qj(this)),d=c.next();!d.done;d=c.next())b.push(d.value.audio);return Uj(b)};Y.prototype.getAudioLanguagesAndRoles=Y.prototype.je;Y.prototype.we=function(){return Uj(Rj(this))};Y.prototype.getTextLanguagesAndRoles=Y.prototype.we;Y.prototype.ie=function(){for(var b=[],c=q(Qj(this)),d=c.next();!d.done;d=c.next())b.push(d.value.audio);return Array.from(Vj(b))};Y.prototype.getAudioLanguages=Y.prototype.ie;Y.prototype.ve=function(){return Array.from(Vj(Rj(this)))};
  Y.prototype.getTextLanguages=Y.prototype.ve;Y.prototype.uf=function(b,c){var d=Ij(this);null!=d&&(this.yb=new Og(b,c||"",0),Nj(this,d));};Y.prototype.selectAudioLanguage=Y.prototype.uf;Y.prototype.wf=function(b,c){var d=Ij(this);null!=d&&(this.P=b,this.cb=c||"",Nj(this,d));};Y.prototype.selectTextLanguage=Y.prototype.wf;Y.prototype.hc=function(){return this.gb};Y.prototype.isTextTrackVisible=Y.prototype.hc;
  Y.prototype.Fd=function(b){var c=this;return t(function e(){var f,g,h,k;return v(e,function(e){switch(e.j){case 1:if(b==c.gb)return e["return"]();c.s&&c.s.l.setTextVisibility(b);c.gb=b;Wj(c);if(c.b.streaming.alwaysStreamText||!c.a)return e["return"]();f=J;if(b){if(g=Ij(c),h=f.Hb(g.textStreams,c.P,c.cb),k=h[0])return u(e,Ah(c.a,k),0)}else{var l=c.a;l.A=!0;var p=l.c.get("text");p&&(vh(p),l.c["delete"]("text"));}e.B(0);}})})};Y.prototype.setTextTrackVisibility=Y.prototype.Fd;
  ...
  Y.prototype.getStats=function(){if(null==this.l)return {width:NaN,height:NaN,streamBandwidth:NaN,decodedFrames:NaN,droppedFrames:NaN,estimatedBandwidth:NaN,loadLatency:NaN,playTime:NaN,bufferingTime:NaN,switchHistory:[],stateHistory:[]};lj(this.l,this.eb);xj(this);var b=this.f;if(b.getVideoPlaybackQuality){b=b.getVideoPlaybackQuality();var c=this.l,d=Number(b.totalVideoFrames);c.s=Number(b.droppedVideoFrames);c.o=d;}if(b=Pj(this))this.l.v=b.bandwidth;b&&b.video&&(c=this.l,d=b.video.height||NaN,c.A=
  b.video.width||NaN,c.l=d);this.g&&(b=this.g.getBandwidthEstimate(),this.l.i=b);b=this.l;c=b.A;d=b.l;for(var e=b.v,f=b.o,g=b.s,h=b.i,k=b.f>b.g?b.f-b.g:NaN,l=b.h,m=b.b,p=[],r=q(b.a.a),w=r.next();!w.done;w=r.next())w=w.value,p.push({timestamp:w.timestamp,id:w.id,type:w.type,fromAdaptation:w.fromAdaptation,bandwidth:w.bandwidth});return {width:c,height:d,streamBandwidth:e,decodedFrames:f,droppedFrames:g,estimatedBandwidth:h,loadLatency:k,playTime:l,bufferingTime:m,switchHistory:p,stateHistory:gj(b.m)}};
  Y.prototype.getStats=Y.prototype.getStats;
  Y.prototype.addTextTrack=function(b,c,d,e,f,g){var h=Ij(this);if(null==h)return Promise.reject();var k=this.c.periods.indexOf(h)+1,l=(k>=this.c.periods.length?this.c.presentationTimeline.T():this.c.periods[k].startTime)-h.startTime;if(Infinity==l)return Promise.reject(new B(1,4,4033));var m={id:this.Lc++,originalId:null,createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:function(){return 1},getSegmentReference:function(c){return 1!=c?null:new N(1,0,l,function(){return [b]},0,null)},
  initSegmentReference:null,presentationTimeOffset:0,mimeType:e,codecs:f||"",kind:d,encrypted:!1,keyId:null,language:c,label:g||null,type:"text",primary:!1,trickModeVideo:null,emsgSchemeIdUris:null,roles:[],channelsCount:null,closedCaptions:null};this.Ab.add(m);h.textStreams.push(m);return Ah(this.a,m).then(function(){if(!this.fb.a){var b=yh(this.a,"text");b&&(Hg(this.v,h).text=b);this.Ab["delete"](m);Nj(this,h);Hj(this);return {id:m.id,active:!1,type:"text",bandwidth:0,language:c,label:g||null,kind:d,
  width:null,height:null}}}.bind(this))};Y.prototype.addTextTrack=Y.prototype.addTextTrack;Y.prototype.Ac=function(b,c){this.Bb.width=b;this.Bb.height=c;};Y.prototype.setMaxHardwareResolution=Y.prototype.Ac;Y.prototype.yc=function(){if(this.a){var b=this.a;if(b.f)b=!1;else if(b.m)b=!1;else{for(var c=q(b.c.values()),d=c.next();!d.done;d=c.next())d=d.value,d.mb&&(d.mb=!1,Dh(b,d,.1));b=!0;}}else b=!1;return b};Y.prototype.retryStreaming=Y.prototype.yc;Y.prototype.ne=function(){return this.c};
  Y.prototype.getManifest=Y.prototype.ne;function Bj(b,c,d,e){Hg(b.v,c).variant=d;b=b.l.a;b.c!=d&&(b.c=d,b.a.push({timestamp:Date.now()/1E3,id:d.id,type:"variant",fromAdaptation:e,bandwidth:d.bandwidth}));}
  function Oj(b){b.o&&(b.o.ua(b.f,"loadeddata"),b.o.ua(b.f,"playing"),b.o.ua(b.f,"pause"),b.o.ua(b.f,"ended"));b.ha&&(b.ha.L(),b.ha=null);b.i&&(b.i.L(),b.i=null);var c=b.h,d=Promise.all([b.g?b.g.stop():null,b.s?b.s.destroy():null,b.a?b.a.destroy():null,b.m?b.m.stop():null]).then(function(){return c?c.destroy():null});b.R&&(b.R.L(),b.R=null);b.oa=!0;b.h=null;b.s=null;b.a=null;b.m=null;b.c=null;b.va=null;b.v.a.clear();b.Ab.clear();b.l=null;return d}
  function mj(b){var c=cj();c.streaming.failureCallback=function(c){var d=[1001,1002,1003];b.U()&&d.includes(c.code)&&(c.severity=1,b.yc());};c.textDisplayFactory=function(){return new Xj(b.f)};return c}
  function zj(b,c){for(var d=0;d<c.length;d++){for(var e=c[d],f=new Map,g=q(e.variants),h=g.next();!h.done;h=g.next())if(h=h.value,h.video&&h.video.closedCaptions){h=h.video;for(var k=q(h.closedCaptions.keys()),l=k.next();!l.done;l=k.next())if(l=l.value,!f.has(l)){var m={id:b.Lc++,originalId:l,createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:function(){return null},getSegmentReference:function(){return null},initSegmentReference:null,presentationTimeOffset:0,mimeType:"application/cea-608",
  ...
  n.Tc=function(b){var c=this.a?xh(this.a):null,d=this.a?zh(this.a):null;b.forEach(J.filterNewPeriod.bind(null,this.h,c,d));c=ub(b,function(b){return b.variants.some(J.Ua)});if(0==c)throw new B(2,4,4032);if(c<b.length)throw new B(2,4,4011);b.forEach(function(b){J.Mc(b.variants,this.b.restrictions,this.Bb)&&this.a&&Ij(this)==b&&Hj(this);Yj(this,b.variants);}.bind(this));};
  n.ac=function(b){var c=this.a?xh(this.a):null,d=this.a?zh(this.a):null;J.filterNewPeriod(this.h,c,d,b);c=b.variants;if(!c.some(J.Ua))throw new B(2,4,4011);Yj(this,b.variants);J.Mc(c,this.b.restrictions,this.Bb)&&this.a&&Ij(this)==b&&Hj(this);if(b=this.h?this.h.a:null)for(c=q(c),d=c.next();!d.done;d=c.next()){d=q(d.value.drmInfos);for(var e=d.next();!e.done;e=d.next())if(e=e.value,e.keySystem==b.keySystem){e=q(e.initData||[]);for(var f=e.next();!f.done;f=e.next())f=f.value,uc(this.h,f.initDataType,
  f.initData);}}};function Tj(b,c,d,e){d=void 0===d?!1:d;e=void 0===e?0:e;b.oa?(b.M=c,b.Kc=d,b.Jc=e):(Gh(b.a,c,d,e),Zj(b,new D("variantchanged")));}function Sj(b,c){b.oa?b.D=c:(Fh(b.a,c,!0,0),Zj(b,new D("textchanged")));}function Gj(b,c){function d(b,c){if(!b)return null;var d=b.findSegmentPosition(c-g.startTime);return null==d?null:(d=b.getSegmentReference(d))?d.startTime+g.startTime:null}var e=xh(b.a),f=zh(b.a),g=Ij(b);e=d(e,c);f=d(f,c);return null!=f&&null!=e?Math.max(f,e):null!=f?f:null!=e?e:c}
  function Lj(b,c){b.l&&lj(b.l,b.eb);b.eb=c;xj(b);if(b.i){var d=b.i.b;c!=d.g&&(d.g=c,hh(d,d.f));}b.dispatchEvent(new D("buffering",{buffering:c}));}function xj(b){if(b.l){var c=b.l.m,d=b.eb;null==c.a?c.a={timestamp:Date.now()/1E3,state:hj(c,d),duration:0}:(b=Date.now()/1E3,d=hj(c,d),c.a.duration=b-c.a.timestamp,c.a.state!=d&&(c.b.push(c.a),c.a={timestamp:b,state:d,duration:0}));}}n.Bf=function(){this.ha&&Sg(this.ha,!0);this.a&&Jh(this.a);};
  function Jj(b,c){try{Yj(b,c);}catch(e){return b.Ka(e),null}var d=c.filter(function(b){return J.Ua(b)});d=b.yb.create(d);b.g.setVariants(Array.from(d.values()));return b.g.chooseVariant()}function Nj(b,c){var d=Jj(b,c.variants);d&&(Bj(b,c,d,!0),Tj(b,d,!0));(d=J.Hb(c.textStreams,b.P,b.cb)[0]||null)&&(b.b.streaming.alwaysStreamText||b.hc())&&(Hg(b.v,c).text=d,jj(b.l.a,d,!0),Sj(b,d));Cj(b);}
  n.He=function(b){try{this.oa=!0;this.g.disable();var c=Jj(this,b.variants),d=J.Hb(b.textStreams,this.P,this.cb)[0]||null;this.M&&(b.variants.includes(this.M)&&(c=this.M),this.M=null);this.D&&(b.textStreams.includes(this.D)&&(d=this.D),this.D=null);c&&Bj(this,b,c,!0);if(d){var e=d;Hg(this.v,b).text=e;jj(this.l.a,e,!0);}var f=this.a,g=f.c.get("video");if(g)var h=f.b.periods[g.xa];else{var k=f.c.get("audio");h=k?f.b.periods[k.xa]:null;}var l=c?c.audio:null,m;if(m=!h&&l&&d){b=d;var p=I(this.b.preferredTextLanguage),
  r=I(l.language),w=I(b.language);m=wd(w,p)&&!wd(r,w);}m&&(this.Fd(!0),Wj(this));return this.b.streaming.alwaysStreamText||this.hc()?{variant:c,text:d}:{variant:c,text:null}}catch(x){return this.Ka(x),{variant:null,text:null}}};n.Yd=function(){this.oa=!1;this.b.abr.enabled&&this.g.enable();this.M&&(Gh(this.a,this.M,this.Kc,this.Jc),this.M=null);this.D&&(Fh(this.a,this.D,!0,0),this.D=null);};n.Le=function(){this.m&&this.m.update&&this.m.update();};n.Ue=function(){this.i&&this.i.qb();};
  function Cj(b){Zj(b,new D("adaptation"));}function Hj(b){Zj(b,new D("trackschanged"));}function Wj(b){b.dispatchEvent(new D("texttrackvisibility"));}n.Ka=function(b){if(!this.fb.a){var c=new D("error",{detail:b});this.dispatchEvent(c);c.defaultPrevented&&(b.handled=!0);}};n.wb=function(b){this.dispatchEvent(b);};function vj(b,c,d){b.wb(new D(c,{detail:{schemeIdUri:d.schemeIdUri,value:d.value,startTime:d.startTime,endTime:d.endTime,id:d.id,eventElement:d.eventElement}}));}
  ...
  function Kj(b,c){var d=Ij(b),e=!1,f=Object.keys(c),g=1==f.length&&"00"==f[0];f.length&&d.variants.forEach(function(b){J.xe(b).forEach(function(d){var f=b.allowedByKeySystem;d.keyId&&(d=c[g?"00":d.keyId],b.allowedByKeySystem=!!d&&!qj.includes(d));f!=b.allowedByKeySystem&&(e=!0);});});f=xh(b.a);var h=zh(b.a);(f=J.bd(f,h,d.variants))&&!f.allowedByKeySystem&&Nj(b,d);e&&(Hj(b),Jj(b,d.variants));}function Aj(b,c,d){0<c&&(b.U()||b.Gd(c));d<b.T()&&(b.U()||b.ma(d));}
  function Yj(b,c){var d=b.h?Lb(b.h.$):{},e=Object.keys(d);e=e.length&&"00"==e[0];for(var f=!1,g=!1,h=[],k=[],l=q(c),m=l.next();!m.done;m=l.next()){m=m.value;var p=[];m.audio&&p.push(m.audio);m.video&&p.push(m.video);p=q(p);for(var r=p.next();!r.done;r=p.next())if(r=r.value,r.keyId){var w=d[e?"00":r.keyId];w?qj.includes(w)&&(k.includes(w)||k.push(w)):h.includes(r.keyId)||h.push(r.keyId);}m.allowedByApplication?m.allowedByKeySystem&&(f=!0):g=!0;}if(!f)throw new B(2,4,4012,{hasAppRestrictions:g,missingKeys:h,
  restrictedKeyStatuses:k});}function Zj(b,c){t(function e(){return v(e,function(e){switch(e.j){case 1:return u(e,Promise.resolve(),2);case 2:b.fb.a||b.dispatchEvent(c),e.j=0;}})});}function Vj(b){var c=new Set;b=q(b);for(var d=b.next();!d.done;d=b.next())(d=d.value)&&d.language?c.add(I(d.language)):c.add("und");return c}
  function Uj(b){var c=new Map,d=[""];b=q(b);for(var e=b.next();!e.done;e=b.next()){var f=e.value;e="und";var g=d;f&&f.language&&(e=I(f.language));f&&f.roles.length&&(g=f.roles);c.has(e)||c.set(e,new Set);f=q(g);for(g=f.next();!g.done;g=f.next())g=g.value,c.get(e).add(g);}var h=[];c.forEach(function(b,c){for(var d=q(b),e=d.next();!e.done;e=d.next())h.push({language:c,role:e.value});});return h}function Qj(b){b=Ij(b);return null==b?[]:b.variants.filter(function(b){return J.Ua(b)})}
  function Rj(b){var c=Ij(b);return null==c?[]:c.textStreams.filter(function(c){return !b.Ab.has(c)})}function Ij(b){if(null==b.c||null==b.i)return null;var c=lh(b.i),d=null;b=q(b.c.periods);for(var e=b.next();!e.done;e=b.next())e=e.value,e.startTime<=c&&(d=e);return d}function Pj(b){var c=Ij(b);return c?Hg(b.v,c).variant:null}function bk(b,c,d){var e=void 0==c.expiration?Infinity:c.expiration,f=c.presentationTimeline.T();c=ck(c.periods[0]);return {offlineUri:null,originalManifestUri:b,duration:f,size:0,expiration:e,tracks:c,appMetadata:d}}function dk(b,c){var d=Qi(new Oi(b.ka(),b.W()),c.periods[0],new T(null,0)),e=c.appMetadata||{};d=ck(d);return {offlineUri:b.toString(),originalManifestUri:c.originalManifestUri,duration:c.duration,size:c.size,expiration:c.expiration,tracks:d,appMetadata:e}}
  function ck(b){var c=[],d=J.qe(b.variants);d=q(d);for(var e=d.next();!e.done;e=d.next())c.push(J.Hc(e.value));b=q(b.textStreams);for(d=b.next();!d.done;d=b.next())c.push(J.Dc(d.value));return c}function ek(){this.a={};}function fk(b,c,d){d=d.endTime-d.startTime;return gk(b,c)*d}function gk(b,c){var d=b.a[c];null==d&&(d=0);return d}function hk(b,c){for(var d={width:Infinity,height:Infinity},e=q(b.periods),f=e.next();!f.done;f=e.next())f=f.value,f.variants=f.variants.filter(function(b){return J.kc(b,c,d)});}function ik(b){b=q(b.periods);for(var c=b.next();!c.done;c=b.next())c=c.value,c.variants=c.variants.filter(function(b){var c=!0;b.audio&&(c=c&&jd(b.audio));b.video&&(c=c&&jd(b.video));return c});}
  function jk(b,c){for(var d=q(b.periods),e=d.next();!e.done;e=d.next())e=e.value,e.variants=e.variants.filter(function(b){return Hc(c,b)});}function kk(b){var c=new lk;b.periods.forEach(function(b,d){var e=mk(b.variants);if(0==d){e=q(e.a);for(var f=e.next();!f.done;f=e.next())c.add(f.value);}else nk(c,e);});b=q(b.periods);for(var d=b.next();!d.done;d=b.next())d=d.value,d.variants=d.variants.filter(function(b){return ok(c,new pk(b))});}
  function qk(b,c){var d=new lk;b.periods.forEach(function(b,f){0<f&&(b.variants=b.variants.filter(function(b){return ok(d,new pk(b))}));c(b);d=mk(b.variants);});}function pk(b){var c=b.audio;b=b.video;this.b=c?c.mimeType:null;this.a=c?c.codecs.split(".")[0]:null;this.f=b?b.mimeType:null;this.c=b?b.codecs.split(".")[0]:null;}function lk(){this.a=[];}lk.prototype.add=function(b){ok(this,b)||this.a.push(b);};function nk(b,c){b.a=b.a.filter(function(b){return ok(c,b)});}
  function ok(b,c){return b.a.some(function(b){return c.b==b.b&&c.a==b.a&&c.f==b.f&&c.c==b.c})}function mk(b){var c=new lk;b=q(b);for(var d=b.next();!d.done;d=b.next())c.add(new pk(d.value));return c}function Z(b){var c=this;if(b&&b.constructor!=Y)throw new B(2,9,9008);this.b=this.a=null;b?(this.a=b.b,this.b=b.ib()):(this.a=cj(),this.b=new F);this.g=!1;this.c=[];this.f=[];var d=!b;this.h=new Vi(function(){return t(function f(){var b;return v(f,function(f){switch(f.j){case 1:return b=function(){},u(f,Promise.all(c.f.map(function(c){return c.then(b,b)})),2);case 2:if(!d){f.B(3);break}return u(f,c.b.destroy(),3);case 3:c.a=null,c.b=null,f.j=0;}})})});}y("shaka.offline.Storage",Z);
  function rk(){return ui()}Z.support=rk;Z.prototype.destroy=function(){return this.h.destroy()};Z.prototype.destroy=Z.prototype.destroy;
  Z.prototype.configure=function(b){var c=!1;null!=b.trackSelectionCallback&&(c=!0,b.offline=b.offline||{},b.offline.trackSelectionCallback=b.trackSelectionCallback);null!=b.progressCallback&&(c=!0,b.offline=b.offline||{},b.offline.progressCallback=b.progressCallback);null!=b.usePersistentLicense&&(c=!0,b.offline=b.offline||{},b.offline.usePersistentLicense=b.usePersistentLicense);c&&Dd("Storage.configure with OfflineConfig","Please configure storage with a player configuration.");return ej(this.a,
  ...
  Z.prototype.store=function(b,c,d){var e=this;return sk(this,tk(this,b,c||{},function(){return t(function g(){var c;return v(g,function(g){switch(g.j){case 1:if(d&&"string"!=typeof d){Dd("Storing with a manifest parser factory","Please register a manifest parser and for the mime-type.");c=d;g.B(2);break}return u(g,gf(b,e.b,e.a.manifest.retryParameters,d),3);case 3:c=g.u;case 2:return g["return"](new c)}})})}))};Z.prototype.store=Z.prototype.store;
  function tk(b,c,d,e){return t(function g(){var h,k,l,m,p,r,w,x,A,P;return v(g,function(g){switch(g.j){case 1:uk();if(b.g)return g["return"](Promise.reject(new B(2,9,9006)));b.g=!0;return u(g,vk(b,c,e),2);case 2:h=g.u;wk(b);k=!h.presentationTimeline.U()&&!h.presentationTimeline.Ha();if(!k)throw new B(2,9,9005,c);l=null;m=new mi;r=p=null;qa(g,3,4);return u(g,xk(b,h,function(b){r=r||b;}),6);case 6:l=g.u;wk(b);if(r)throw r;yk(b,h,l);return u(g,m.init(),7);case 7:return wk(b),u(g,oi(m),8);case 8:return p=
  g.u,wk(b),u(g,zk(b,p.W,l,h,c,d),9);case 9:w=g.u;wk(b);if(r)throw r;return u(g,p.W.addManifests([w]),10);case 10:return x=g.u,wk(b),A=new Mi("manifest",p.path.ka,p.path.W,x[0]),g["return"](dk(A,w));case 4:return ua(g),b.g=!1,b.c=[],u(g,m.destroy(),11);case 11:if(!l){g.B(12);break}return u(g,l.destroy(),12);case 12:va(g,0);break;case 3:P=ta(g);if(!p){g.B(14);break}return u(g,p.W.removeSegments(b.c,function(){}),14);case 14:throw r||P;}})})}
  function yk(b,c,d){hk(c,b.a.restrictions);ik(c);jk(c,d);kk(c);qk(c,function(c){for(var d=[],e=q(c.variants),h=e.next();!h.done;h=e.next())d.push(J.Hc(h.value));e=q(c.textStreams);for(h=e.next();!h.done;h=e.next())d.push(J.Dc(h.value));d=b.a.offline.trackSelectionCallback(d);var k=new Set,l=new Set;d=q(d);for(e=d.next();!e.done;e=d.next())e=e.value,"variant"==e.type&&k.add(e.id),"text"==e.type&&l.add(e.id);c.variants=c.variants.filter(function(b){return k.has(b.id)});c.textStreams=c.textStreams.filter(function(b){return l.has(b.id)});});
  Ak(c);}function zk(b,c,d,e,f,g){return t(function k(){var l,m,p,r;return v(k,function(k){switch(k.j){case 1:return l=bk(f,e,g),m=new bi(b.b,function(c,d){l.size=d;b.a.offline.progressCallback(l,c);}),ra(k,2),r=p=Bk(b,m,c,d,e,f,g),u(k,ei(m),4);case 4:return r.size=k.u,k["return"](p);case 2:return ua(k),u(k,m.destroy(),5);case 5:va(k,0);}})})}Z.prototype.remove=function(b){return sk(this,Ck(this,b))};Z.prototype.remove=Z.prototype.remove;
  function Ck(b,c){uk();var d=Ni(c);if(null==d||"manifest"!=d.a)return Promise.reject(new B(2,9,9004,c));var e=new mi;return Wi([e],function(){return t(function g(){var c,k,l;return v(g,function(g){switch(g.j){case 1:return u(g,e.init(),2);case 2:return u(g,qi(e,d.ka(),d.W()),3);case 3:return c=g.u,u(g,c.getManifests([d.key()]),4);case 4:return k=g.u,l=k[0],u(g,Promise.all([Dk(b,l,e),Ek(b,c,d,l)]),0)}})})})}
  function Fk(b,c){for(var d=[],e=q(b.periods),f=e.next();!f.done;f=e.next()){f=q(f.value.streams);for(var g=f.next();!g.done;g=f.next())g=g.value,c&&"video"==g.contentType?d.push({contentType:Mb(g.mimeType,g.codecs),robustness:b.drmInfo.videoRobustness}):c||"audio"!=g.contentType||d.push({contentType:Mb(g.mimeType,g.codecs),robustness:b.drmInfo.audioRobustness});}return d}function Dk(b,c,d){return t(function f(){return v(f,function(f){switch(f.j){case 1:return u(f,Gk(b.b,b.a.drm,d,c),0)}})})}
  function Ek(b,c,d,e){function f(){k+=1;b.a.offline.progressCallback(l,k/h);}var g=Hk(e),h=g.length+1,k=0,l=dk(d,e);return Promise.all([c.removeSegments(g,f),c.removeManifests([d.key()],f)])}Z.prototype.nf=function(){return sk(this,Ik(this))};Z.prototype.removeEmeSessions=Z.prototype.nf;
  function Ik(b){uk();var c=b.b,d=b.a.drm,e=new mi;return Wi([e],function(){return t(function g(){var b,k,l,m,p,r,w;return v(g,function(g){switch(g.j){case 1:return u(g,e.init(),2);case 2:b=!1,k=[],ri(e,function(b){return k.push(b)}),l=q(k),m=l.next();case 3:if(m.done){g.B(5);break}p=m.value;return u(g,p.getAll(),6);case 6:return r=g.u,u(g,Zi(d,c,r),7);case 7:return w=g.u,u(g,p.remove(w),8);case 8:w.length!=r.length&&(b=!0);m=l.next();g.B(3);break;case 5:return g["return"](!b)}})})})}
  Z.prototype.list=function(){return sk(this,Jk())};Z.prototype.list=Z.prototype.list;
  function Jk(){function b(b,d){return t(function h(){var e;return v(h,function(f){switch(f.j){case 1:return u(f,d.getAllManifests(),2);case 2:e=f.u,e.forEach(function(d,e){var f=dk(new Mi("manifest",b.ka,b.W,e),d);c.push(f);}),f.j=0;}})})}uk();var c=[],d=new mi;return Wi([d],function(){return t(function f(){var c;return v(f,function(f){switch(f.j){case 1:return u(f,d.init(),2);case 2:return c=Promise.resolve(),pi(d,function(d,f){c=c.then(function(){return b(d,f)});}),u(f,c,0)}})})}).then(function(){return c})}
  function vk(b,c,d){return t(function f(){var g,h,k,l,m,p;return v(f,function(f){switch(f.j){case 1:return g=null,h=b.b,k={networkingEngine:h,filterAllPeriods:function(){},filterNewPeriod:function(){},onTimelineRegionAdded:function(){},onEvent:function(){},onError:function(b){g=b;}},u(f,d(),2);case 2:return l=f.u,l.configure(b.a.manifest),wk(b),ra(f,3),u(f,l.start(c,k),5);case 5:return m=f.u,wk(b),p=Kk(m),u(f,Promise.all(Array.from(p).map(function(b){return b.createSegmentIndex()})),6);case 6:wk(b);
  if(g)throw g;return f["return"](m);case 3:return ua(f),u(f,l.stop(),7);case 7:va(f,0);}})})}function xk(b,c,d){return t(function f(){var g,h,k;return v(f,function(f){switch(f.j){case 1:return g=new dc({ob:b.b,onError:d,rc:function(){},onExpirationUpdated:function(){},onEvent:function(){}}),h=J.Zc(c),k=b.a,g.configure(k.drm),u(f,ic(g,h,k.offline.usePersistentLicense),2);case 2:return u(f,sc(g),3);case 3:return u(f,tc(g),4);case 4:return f["return"](g)}})})}
  function Bk(b,c,d,e,f,g,h){var k=new ek,l=f.periods.map(function(e){return Lk(b,c,d,k,f,e)}),m=e.a,p=zc(e);if(m&&b.a.offline.usePersistentLicense){if(!p.length)throw new B(2,9,9007,g);m.initData=[];}return {originalManifestUri:g,duration:f.presentationTimeline.T(),size:0,expiration:e.Mb(),periods:l,sessionIds:b.a.offline.usePersistentLicense?p:[],drmInfo:m,appMetadata:h}}
  function Lk(b,c,d,e,f,g){f.periods.forEach(function(b){b.variants.forEach(function(b){var c=b.audio,d=b.video;c&&!d&&(e.a[c.id]=c.bandwidth||b.bandwidth);!c&&d&&(e.a[d.id]=d.bandwidth||b.bandwidth);if(c&&d){var f=c.bandwidth||393216,g=d.bandwidth||b.bandwidth-f;0>=g&&(g=b.bandwidth);e.a[c.id]=f;e.a[d.id]=g;}});b.textStreams.forEach(function(b){e.a[b.id]=52;});});var h=Kk(f),k=new Map;h=q(h);for(var l=h.next();!l.done;l=h.next()){l=l.value;var m=Mk(b,c,d,e,f,l);k.set(l.id,m);}g.variants.forEach(function(b){b.audio&&
  ...
  function Mk(b,c,d,e,f,g){var h={id:g.id,originalId:g.originalId,primary:g.primary,presentationTimeOffset:g.presentationTimeOffset||0,contentType:g.type,mimeType:g.mimeType,codecs:g.codecs,frameRate:g.frameRate,kind:g.kind,language:g.language,label:g.label,width:g.width||null,height:g.height||null,initSegmentKey:null,encrypted:g.encrypted,keyId:g.keyId,segments:[],variantIds:[]};f=f.presentationTimeline.lb();var k=g.id;Nk(g,f,function(f){ci(c,k,Ok(b,f),fk(e,g.id,f),function(c){return d.addSegments([{data:c}]).then(function(c){b.c.push(c[0]);
  h.segments.push({startTime:f.startTime,endTime:f.endTime,dataKey:c[0]});})});});(f=g.initSegmentReference)&&ci(c,k,Ok(b,f),.5*gk(e,g.id),function(c){return d.addSegments([{data:c}]).then(function(c){b.c.push(c[0]);h.initSegmentKey=c[0];})});return h}function Nk(b,c,d){c=b.findSegmentPosition(c);for(var e=null==c?null:b.getSegmentReference(c);e;)d(e),e=b.getSegmentReference(++c);}function wk(b){if(b.h.a)throw new B(2,9,7001);}function uk(){if(!ui())throw new B(2,9,9E3);}
  function Ok(b,c){var d=b.a.streaming.retryParameters;d=Ab(c.c(),d);if(0!=c.b||null!=c.a)d.headers.Range="bytes="+c.b+"-"+(null==c.a?"":c.a);return d}function sk(b,c){return t(function e(){return v(e,function(e){switch(e.j){case 1:return b.f.push(c),ra(e,2),u(e,c,4);case 4:return e["return"](e.u);case 2:ua(e),tb(b.f,c),va(e,0);}})})}
  function Hk(b){var c=[];b.periods.forEach(function(b){b.streams.forEach(function(b){null!=b.initSegmentKey&&c.push(b.initSegmentKey);b.segments.forEach(function(b){c.push(b.dataKey);});});});return c}Z.deleteAll=function(){return t(function c(){var d;return v(c,function(c){switch(c.j){case 1:return d=new mi,ra(c,2),u(c,d.erase(),2);case 2:return ua(c),u(c,d.destroy(),5);case 5:va(c,0);}})})};
  function Gk(b,c,d,e){return t(function g(){var h,k,l;return v(g,function(g){switch(g.j){case 1:if(!e.drmInfo)return g["return"]();h=si(d);k=e.sessionIds.map(function(b){return {sessionId:b,keySystem:e.drmInfo.keySystem,licenseUri:e.drmInfo.licenseServerUri,serverCertificate:e.drmInfo.serverCertificate,audioCapabilities:Fk(e,!1),videoCapabilities:Fk(e,!0)}});return u(g,Zi(c,b,k),2);case 2:return l=g.u,u(g,h.remove(l),3);case 3:return u(g,h.add(k.filter(function(b){return -1==l.indexOf(b.sessionId)})),
  0)}})})}function Kk(b){var c=new Set;b=q(b.periods);for(var d=b.next();!d.done;d=b.next()){d=d.value;for(var e=q(d.textStreams),f=e.next();!f.done;f=e.next())c.add(f.value);d=q(d.variants);for(e=d.next();!e.done;e=d.next())e=e.value,e.audio&&c.add(e.audio),e.video&&c.add(e.video);}return c}function Ak(b){if(0==b.periods.length)throw new B(2,4,4014);b=q(b.periods);for(var c=b.next();!c.done;c=b.next())Pk(c.value);}
  function Pk(b){b.variants.map(function(b){return b.video});var c=new Set(b.variants.map(function(b){return b.audio}));b=b.textStreams;for(var d=q(c),e=d.next();!e.done;e=d.next()){e=q(c);for(var f=e.next();!f.done;f=e.next());}c=q(b);for(d=c.next();!d.done;d=c.next())for(d=q(b),e=d.next();!e.done;e=d.next());}rj.offline=rk;y("shaka.polyfill.installAll",function(){for(var b=0;b<Qk.length;++b)Qk[b].Wd();});var Qk=[];function Rk(b,c){c=c||0;for(var d={priority:c,Wd:b},e=0;e<Qk.length;e++)if(Qk[e].priority<c){Qk.splice(e,0,d);return}Qk.push(d);}y("shaka.polyfill.register",Rk);function Sk(b){var c=b.type.replace(/^(webkit|moz|MS)/,"").toLowerCase();if("function"===typeof Event)var d=new Event(c,b);else d=document.createEvent("Event"),d.initEvent(c,b.bubbles,b.cancelable);b.target.dispatchEvent(d);}
  Rk(function(){if(window.Document){var b=Element.prototype;b.requestFullscreen=b.requestFullscreen||b.mozRequestFullScreen||b.msRequestFullscreen||b.webkitRequestFullscreen;b=Document.prototype;b.exitFullscreen=b.exitFullscreen||b.mozCancelFullScreen||b.msExitFullscreen||b.webkitExitFullscreen;"fullscreenElement"in document||(Object.defineProperty(document,"fullscreenElement",{get:function(){return document.mozFullScreenElement||document.msFullscreenElement||document.webkitFullscreenElement}}),Object.defineProperty(document,
  "fullscreenEnabled",{get:function(){return document.mozFullScreenEnabled||document.msFullscreenEnabled||document.webkitFullscreenEnabled}}));document.addEventListener("webkitfullscreenchange",Sk);document.addEventListener("webkitfullscreenerror",Sk);document.addEventListener("mozfullscreenchange",Sk);document.addEventListener("mozfullscreenerror",Sk);document.addEventListener("MSFullscreenChange",Sk);document.addEventListener("MSFullscreenError",Sk);}});Rk(function(){Qb("CrKey")&&delete window.indexedDB;});var Tk;function Uk(b,c,d){if("input"==b)switch(this.type){case "range":b="change";}Tk.call(this,b,c,d);}Rk(function(){Qb("Trident/")&&HTMLInputElement.prototype.addEventListener!=Uk&&(Tk=HTMLInputElement.prototype.addEventListener,HTMLInputElement.prototype.addEventListener=Uk);});Rk(function(){});function Vk(){var b=MediaSource.prototype.addSourceBuffer;MediaSource.prototype.addSourceBuffer=function(c){for(var d=[],e=0;e<arguments.length;++e)d[e]=arguments[e];d=b.apply(this,d);d.abort=function(){};return d};}function Wk(){var b=SourceBuffer.prototype.remove;SourceBuffer.prototype.remove=function(c,d){return b.call(this,c,d-.001)};}
  function Xk(){var b=MediaSource.prototype.endOfStream;MediaSource.prototype.endOfStream=function(c){for(var d=[],e=0;e<arguments.length;++e)d[e]=arguments[e];for(var h=e=0;h<this.sourceBuffers.length;++h){var k=this.sourceBuffers[h];k=k.buffered.end(k.buffered.length-1);e=Math.max(e,k);}if(!isNaN(this.duration)&&e<this.duration)for(this.dd=!0,e=0;e<this.sourceBuffers.length;++e)this.sourceBuffers[e].Rc=!1;return b.apply(this,d)};var c=!1,d=MediaSource.prototype.addSourceBuffer;MediaSource.prototype.addSourceBuffer=
  function(b){for(var e=[],g=0;g<arguments.length;++g)e[g]=arguments[g];e=d.apply(this,e);e.mediaSource_=this;e.addEventListener("updateend",Yk,!1);c||(this.addEventListener("sourceclose",Zk,!1),c=!0);return e};}function Yk(b){var c=b.target,d=c.mediaSource_;if(d.dd){b.preventDefault();b.stopPropagation();b.stopImmediatePropagation();c.Rc=!0;for(b=0;b<d.sourceBuffers.length;++b)if(0==d.sourceBuffers[b].Rc)return;d.dd=!1;}}
  function Zk(b){b=b.target;for(var c=0;c<b.sourceBuffers.length;++c)b.sourceBuffers[c].removeEventListener("updateend",Yk,!1);b.removeEventListener("sourceclose",Zk,!1);}function $k(){var b=MediaSource.isTypeSupported;MediaSource.isTypeSupported=function(c){return "mp2t"==c.split(/ *; */)[0].split("/")[1]?!1:b(c)};}
  function al(){var b=MediaSource.isTypeSupported,c=/^dv(?:he|av)\./;MediaSource.isTypeSupported=function(d){for(var e=d.split(/ *; */),f=e[0],g={},h=1;h<e.length;++h){var k=e[h].split("="),l=k[0];k=k[1].replace(/"(.*)"/,"$1");g[l]=k;}e=g.codecs;if(!e)return b(d);var m=!1,p=!1;d=e.split(",").filter(function(b){if(c.test(b))return p=!0,!1;/^(hev|hvc)1\.2/.test(b)&&(m=!0);return !0});p&&(m=!1);g.codecs=d.join(",");m&&(g.eotf="smpte2084");for(var r in g)f+="; "+r+'="'+g[r]+'"';return cast.__platform__.canDisplayType(f)};}
  Rk(function(){if(window.MediaSource)if(window.cast&&cast.__platform__&&cast.__platform__.canDisplayType)al();else if(navigator.vendor&&navigator.vendor.includes("Apple")){var b=navigator.appVersion;$k();if(b.includes("Version/8"))window.MediaSource=null;else if(b.includes("Version/9"))Vk();else if(b.includes("Version/10"))Vk(),Xk();else if(b.includes("Version/11")||b.includes("Version/12"))Vk(),Wk();}});function bl(b){this.f=[];this.b=[];this.a=[];(new Q).aa("pssh",this.c.bind(this)).parse(b.buffer);}bl.prototype.c=function(b){if(!(1<b.version)){var c=ac(b.reader.Ja(16)),d=[];if(0<b.version)for(var e=b.reader.C(),f=0;f<e;++f){var g=ac(b.reader.Ja(16));d.push(g);}e=b.reader.C();b.reader.I(e);this.b.push.apply(this.b,d);this.f.push(c);this.a.push({start:b.start,end:b.start+b.size-1});}};function cl(b,c){try{var d=new dl(b,c);return Promise.resolve(d)}catch(e){return Promise.reject(e)}}
  function dl(b,c){this.keySystem=b;for(var d=!1,e=0;e<c.length;++e){var f=c[e],g={audioCapabilities:[],videoCapabilities:[],persistentState:"optional",distinctiveIdentifier:"optional",initDataTypes:f.initDataTypes,sessionTypes:["temporary"],label:f.label},h=!1;if(f.audioCapabilities)for(var k=0;k<f.audioCapabilities.length;++k){var l=f.audioCapabilities[k];if(l.contentType){h=!0;var m=l.contentType.split(";")[0];MSMediaKeys.isTypeSupported(this.keySystem,m)&&(g.audioCapabilities.push(l),d=!0);}}if(f.videoCapabilities)for(k=
  0;k<f.videoCapabilities.length;++k)l=f.videoCapabilities[k],l.contentType&&(h=!0,m=l.contentType.split(";")[0],MSMediaKeys.isTypeSupported(this.keySystem,m)&&(g.videoCapabilities.push(l),d=!0));h||(d=MSMediaKeys.isTypeSupported(this.keySystem,"video/mp4"));"required"==f.persistentState&&(d=!1);if(d){this.a=g;return}}d=Error("Unsupported keySystem");d.name="NotSupportedError";d.code=DOMException.NOT_SUPPORTED_ERR;throw d;}dl.prototype.createMediaKeys=function(){var b=new el(this.keySystem);return Promise.resolve(b)};
  dl.prototype.getConfiguration=function(){return this.a};function fl(b){var c=this.mediaKeys;c&&c!=b&&gl(c,null);delete this.mediaKeys;return (this.mediaKeys=b)?gl(b,this):Promise.resolve()}function el(b){this.a=new MSMediaKeys(b);this.b=new Eb;}el.prototype.createSession=function(b){b=b||"temporary";if("temporary"!=b)throw new TypeError("Session type "+b+" is unsupported on this platform.");return new hl(this.a,b)};el.prototype.setServerCertificate=function(){return Promise.resolve(!1)};
  function gl(b,c){function d(){c.msSetMediaKeys(e.a);c.removeEventListener("loadedmetadata",d);}Fb(b.b);if(!c)return Promise.resolve();G(b.b,c,"msneedkey",il);var e=b;try{return 1<=c.readyState?c.msSetMediaKeys(b.a):c.addEventListener("loadedmetadata",d),Promise.resolve()}catch(f){return Promise.reject(f)}}function hl(b){E.call(this);this.c=null;this.g=b;this.b=this.a=null;this.f=new Eb;this.sessionId="";this.expiration=NaN;this.closed=new z;this.keyStatuses=new jl;}Ga(hl,E);n=hl.prototype;
  n.generateRequest=function(b,c){this.a=new z;try{this.c=this.g.createSession("video/mp4",new Uint8Array(c),null),G(this.f,this.c,"mskeymessage",this.Pe.bind(this)),G(this.f,this.c,"mskeyadded",this.Ne.bind(this)),G(this.f,this.c,"mskeyerror",this.Oe.bind(this)),kl(this,"status-pending");}catch(d){this.a.reject(d);}return this.a};n.load=function(){return Promise.reject(Error("MediaKeySession.load not yet supported"))};n.update=function(b){this.b=new z;try{this.c.update(new Uint8Array(b));}catch(c){this.b.reject(c);}return this.b};
  n.close=function(){try{this.c.close(),this.closed.resolve(),Fb(this.f);}catch(b){this.closed.reject(b);}return this.closed};n.remove=function(){return Promise.reject(Error("MediaKeySession.remove is only applicable for persistent licenses, which are not supported on this platform"))};function il(b){if(b.initData){var c=document.createEvent("CustomEvent");c.initCustomEvent("encrypted",!1,!1,null);c.initDataType="cenc";c.initData=ll(b.initData);this.dispatchEvent(c);}}
  function ll(b){if(!b)return b;var c=new bl(b);if(1>=c.a.length)return b;for(var d=[],e=0;e<c.a.length;e++)d.push(b.subarray(c.a[e].start,c.a[e].end+1));b=[];c={};e=q(d);for(d=e.next();!d.done;c={Nb:c.Nb},d=e.next())c.Nb=d.value,b.some(function(b){return function(c){return bc(c,b.Nb)}}(c))||b.push(c.Nb);c=0;e=q(b);for(d=e.next();!d.done;d=e.next())c+=d.value.length;c=new Uint8Array(c);e=0;b=q(b);for(d=b.next();!d.done;d=b.next())d=d.value,c.set(d,e),e+=d.length;return c}
  n.Pe=function(b){this.a&&(this.a.resolve(),this.a=null);this.dispatchEvent(new D("message",{messageType:void 0==this.keyStatuses.a?"license-request":"license-renewal",message:b.message.buffer}));};n.Ne=function(){this.a?(kl(this,"usable"),this.a.resolve(),this.a=null):this.b&&(kl(this,"usable"),this.b.resolve(),this.b=null);};
  n.Oe=function(){var b=Error("EME PatchedMediaKeysMs key error");b.errorCode=this.c.error;if(null!=this.a)this.a.reject(b),this.a=null;else if(null!=this.b)this.b.reject(b),this.b=null;else switch(this.c.error.code){case MSMediaKeyError.MS_MEDIA_KEYERR_OUTPUT:case MSMediaKeyError.MS_MEDIA_KEYERR_HARDWARECHANGE:kl(this,"output-not-allowed");break;default:kl(this,"internal-error");}};function kl(b,c){var d=b.keyStatuses;d.size=void 0==c?0:1;d.a=c;b.dispatchEvent(new D("keystatuseschange"));}
  function jl(){this.size=0;this.a=void 0;}var ml;n=jl.prototype;n.forEach=function(b){this.a&&b(this.a,ml);};n.get=function(b){if(this.has(b))return this.a};n.has=function(b){var c=ml;return this.a&&bc(new Uint8Array(b),new Uint8Array(c))?!0:!1};n.entries=function(){};n.keys=function(){};n.values=function(){};
  Rk(function(){!window.HTMLVideoElement||!window.MSMediaKeys||navigator.requestMediaKeySystemAccess&&MediaKeySystemAccess.prototype.getConfiguration||(ml=(new Uint8Array([0])).buffer,delete HTMLMediaElement.prototype.mediaKeys,HTMLMediaElement.prototype.mediaKeys=null,HTMLMediaElement.prototype.setMediaKeys=fl,window.MediaKeys=el,window.MediaKeySystemAccess=dl,navigator.requestMediaKeySystemAccess=cl);});function nl(){return Promise.reject(Error("The key system specified is not supported."))}function ol(b){return null==b?Promise.resolve():Promise.reject(Error("MediaKeys not supported."))}function pl(){throw new TypeError("Illegal constructor.");}pl.prototype.createSession=function(){};pl.prototype.setServerCertificate=function(){};function ql(){throw new TypeError("Illegal constructor.");}ql.prototype.getConfiguration=function(){};ql.prototype.createMediaKeys=function(){};
  Rk(function(){!window.HTMLVideoElement||navigator.requestMediaKeySystemAccess&&MediaKeySystemAccess.prototype.getConfiguration||(navigator.requestMediaKeySystemAccess=nl,delete HTMLMediaElement.prototype.mediaKeys,HTMLMediaElement.prototype.mediaKeys=null,HTMLMediaElement.prototype.setMediaKeys=ol,window.MediaKeys=pl,window.MediaKeySystemAccess=ql);},-10);var rl="";function sl(b){var c=rl;return c?c+b.charAt(0).toUpperCase()+b.slice(1):b}function tl(b,c){try{var d=new ul(b,c);return Promise.resolve(d)}catch(e){return Promise.reject(e)}}function vl(b){var c=this.mediaKeys;c&&c!=b&&wl(c,null);delete this.mediaKeys;(this.mediaKeys=b)&&wl(b,this);return Promise.resolve()}
  function ul(b,c){this.a=this.keySystem=b;var d=!1;"org.w3.clearkey"==b&&(this.a="webkit-org.w3.clearkey",d=!1);var e=!1;var f=document.getElementsByTagName("video");f=f.length?f[0]:document.createElement("video");for(var g=0;g<c.length;++g){var h=c[g],k={audioCapabilities:[],videoCapabilities:[],persistentState:"optional",distinctiveIdentifier:"optional",initDataTypes:h.initDataTypes,sessionTypes:["temporary"],label:h.label},l=!1;if(h.audioCapabilities)for(var m=0;m<h.audioCapabilities.length;++m){var p=
  ...
  e=!1);if(e){this.b=k;return}}d="Unsupported keySystem";if("org.w3.clearkey"==b||"com.widevine.alpha"==b)d="None of the requested configurations were supported.";d=Error(d);d.name="NotSupportedError";d.code=DOMException.NOT_SUPPORTED_ERR;throw d;}ul.prototype.createMediaKeys=function(){var b=new xl(this.a);return Promise.resolve(b)};ul.prototype.getConfiguration=function(){return this.b};function xl(b){this.g=b;this.b=null;this.a=new Eb;this.c=[];this.f={};}
  function wl(b,c){b.b=c;Fb(b.a);var d=rl;c&&(G(b.a,c,d+"needkey",b.af.bind(b)),G(b.a,c,d+"keymessage",b.$e.bind(b)),G(b.a,c,d+"keyadded",b.Ye.bind(b)),G(b.a,c,d+"keyerror",b.Ze.bind(b)));}n=xl.prototype;n.createSession=function(b){b=b||"temporary";if("temporary"!=b&&"persistent-license"!=b)throw new TypeError("Session type "+b+" is unsupported on this platform.");var c=this.b||document.createElement("video");c.src||(c.src="about:blank");b=new yl(c,this.g,b);this.c.push(b);return b};
  n.setServerCertificate=function(){return Promise.resolve(!1)};n.af=function(b){var c=document.createEvent("CustomEvent");c.initCustomEvent("encrypted",!1,!1,null);c.initDataType="webm";c.initData=b.initData;this.b.dispatchEvent(c);};n.$e=function(b){var c=zl(this,b.sessionId);c&&(b=new D("message",{messageType:void 0==c.keyStatuses.a?"licenserequest":"licenserenewal",message:b.message}),c.b&&(c.b.resolve(),c.b=null),c.dispatchEvent(b));};
  n.Ye=function(b){if(b=zl(this,b.sessionId))Al(b,"usable"),b.a&&b.a.resolve(),b.a=null;};
  n.Ze=function(b){var c=zl(this,b.sessionId);if(c){var d=Error("EME v0.1b key error");d.errorCode=b.errorCode;d.errorCode.systemCode=b.systemCode;!b.sessionId&&c.b?(d.method="generateRequest",45==b.systemCode&&(d.message="Unsupported session type."),c.b.reject(d),c.b=null):b.sessionId&&c.a?(d.method="update",c.a.reject(d),c.a=null):(d=b.systemCode,b.errorCode.code==MediaKeyError.MEDIA_KEYERR_OUTPUT?Al(c,"output-restricted"):1==d?Al(c,"expired"):Al(c,"internal-error"));}};
  function zl(b,c){var d=b.f[c];return d?d:(d=b.c.shift())?(d.sessionId=c,b.f[c]=d):null}function yl(b,c,d){E.call(this);this.f=b;this.h=!1;this.a=this.b=null;this.c=c;this.g=d;this.sessionId="";this.expiration=NaN;this.closed=new z;this.keyStatuses=new Bl;}Ga(yl,E);
  function Cl(b,c,d){if(b.h)return Promise.reject(Error("The session is already initialized."));b.h=!0;try{if("persistent-license"==b.g)if(d)var e=new Uint8Array(Wb("LOAD_SESSION|"+d));else{var f=Wb("PERSISTENT|"),g=new Uint8Array(f.byteLength+c.byteLength);g.set(new Uint8Array(f),0);g.set(new Uint8Array(c),f.byteLength);e=g;}else e=new Uint8Array(c);}catch(k){return Promise.reject(k)}b.b=new z;var h=sl("generateKeyRequest");try{b.f[h](b.c,e);}catch(k){if("InvalidStateError"!=k.name)return b.b=null,Promise.reject(k);
  setTimeout(function(){try{this.f[h](this.c,e);}catch(l){this.b.reject(l),this.b=null;}}.bind(b),10);}return b.b}n=yl.prototype;
  n.Cc=function(b,c){if(this.a)this.a.then(this.Cc.bind(this,b,c))["catch"](this.Cc.bind(this,b,c));else{this.a=b;if("webkit-org.w3.clearkey"==this.c){var d=Sb(c);var e=JSON.parse(d);"oct"!=e.keys[0].kty&&(this.a.reject(Error("Response is not a valid JSON Web Key Set.")),this.a=null);d=Zb(e.keys[0].k);e=Zb(e.keys[0].kid);}else d=new Uint8Array(c),e=null;var f=sl("addKey");try{this.f[f](this.c,d,e,this.sessionId);}catch(g){this.a.reject(g),this.a=null;}}};
  function Al(b,c){var d=b.keyStatuses;d.size=void 0==c?0:1;d.a=c;b.dispatchEvent(new D("keystatuseschange"));}n.generateRequest=function(b,c){return Cl(this,c,null)};n.load=function(b){return "persistent-license"==this.g?Cl(this,null,b):Promise.reject(Error("Not a persistent session."))};n.update=function(b){var c=new z;this.Cc(c,b);return c};
  n.close=function(){if("persistent-license"!=this.g){if(!this.sessionId)return this.closed.reject(Error("The session is not callable.")),this.closed;var b=sl("cancelKeyRequest");try{this.f[b](this.c,this.sessionId);}catch(c){}}this.closed.resolve();return this.closed};n.remove=function(){return "persistent-license"!=this.g?Promise.reject(Error("Not a persistent session.")):this.close()};function Bl(){this.size=0;this.a=void 0;}var Dl;n=Bl.prototype;n.forEach=function(b){this.a&&b(this.a,Dl);};n.get=function(b){if(this.has(b))return this.a};
  n.has=function(b){var c=Dl;return this.a&&bc(new Uint8Array(b),new Uint8Array(c))?!0:!1};n.entries=function(){};n.keys=function(){};n.values=function(){};
  Rk(function(){if(!(!window.HTMLVideoElement||navigator.requestMediaKeySystemAccess&&MediaKeySystemAccess.prototype.getConfiguration)){if(HTMLMediaElement.prototype.webkitGenerateKeyRequest)rl="webkit";else if(!HTMLMediaElement.prototype.generateKeyRequest)return;Dl=(new Uint8Array([0])).buffer;navigator.requestMediaKeySystemAccess=tl;delete HTMLMediaElement.prototype.mediaKeys;HTMLMediaElement.prototype.mediaKeys=null;HTMLMediaElement.prototype.setMediaKeys=vl;window.MediaKeys=xl;window.MediaKeySystemAccess=
  ul;}});Rk(function(){if(window.HTMLMediaElement){var b=HTMLMediaElement.prototype.play;HTMLMediaElement.prototype.play=function(){var c=b.apply(this);c&&c["catch"](function(){});return c};}});function El(){return {droppedVideoFrames:this.webkitDroppedFrameCount,totalVideoFrames:this.webkitDecodedFrameCount,corruptedVideoFrames:0,creationTime:NaN,totalFrameDelay:0}}Rk(function(){if(window.HTMLVideoElement){var b=HTMLVideoElement.prototype;!b.getVideoPlaybackQuality&&"webkitDroppedFrameCount"in b&&(b.getVideoPlaybackQuality=El);}});function Fl(b,c,d){return new window.TextTrackCue(b,c,d)}function Gl(b,c,d){return new window.TextTrackCue(b+"-"+c+"-"+d,b,c,d)}Rk(function(){if(!window.VTTCue&&window.TextTrackCue){var b=TextTrackCue.length;if(3==b)window.VTTCue=Fl;else if(6==b)window.VTTCue=Gl;else{try{var c=!!Fl(1,2,"");}catch(d){c=!1;}c&&(window.VTTCue=Fl);}}});function hd(b,c,d){this.startTime=b;this.direction=Hl;this.endTime=c;this.payload=d;this.region=new Il;this.position=null;this.positionAlign=Jl;this.size=100;this.textAlign=Kl;this.writingMode=Ll;this.lineInterpretation=Ml;this.line=null;this.lineHeight="";this.lineAlign=Nl;this.displayAlign=Ol;this.fontSize=this.backgroundColor=this.color="";this.fontWeight=Pl;this.fontStyle=Ql;this.fontFamily="";this.textDecoration=[];this.wrapLine=!0;this.id="";}y("shaka.text.Cue",hd);var Jl="auto";
  hd.positionAlign={LEFT:"line-left",RIGHT:"line-right",CENTER:"center",AUTO:Jl};var Kl="center",Rl={LEFT:"left",RIGHT:"right",CENTER:Kl,START:"start",END:"end"};hd.textAlign=Rl;var Ol="after",Sl={BEFORE:"before",CENTER:"center",AFTER:Ol};hd.displayAlign=Sl;var Hl="ltr";hd.direction={HORIZONTAL_LEFT_TO_RIGHT:Hl,HORIZONTAL_RIGHT_TO_LEFT:"rtl"};var Ll="horizontal-tb";hd.writingMode={HORIZONTAL_TOP_TO_BOTTOM:Ll,VERTICAL_LEFT_TO_RIGHT:"vertical-lr",VERTICAL_RIGHT_TO_LEFT:"vertical-rl"};var Ml=0;
  hd.lineInterpretation={LINE_NUMBER:Ml,PERCENTAGE:1};var Nl="start",Tl={CENTER:"center",START:Nl,END:"end"};hd.lineAlign=Tl;var Pl=400;hd.fontWeight={NORMAL:Pl,BOLD:700};var Ql="normal",Ul={NORMAL:Ql,ITALIC:"italic",OBLIQUE:"oblique"};hd.fontStyle=Ul;hd.textDecoration={UNDERLINE:"underline",LINE_THROUGH:"lineThrough",OVERLINE:"overline"};
  function Il(){this.id="";this.regionAnchorY=this.regionAnchorX=this.viewportAnchorY=this.viewportAnchorX=0;this.height=this.width=100;this.viewportAnchorUnits=this.widthUnits=this.heightUnits=Vl;this.scroll=Wl;}y("shaka.text.CueRegion",Il);var Vl=1;Il.units={PX:0,PERCENTAGE:Vl,LINES:2};var Wl="";Il.scrollMode={NONE:Wl,UP:"up"};function Xl(){}Xl.prototype.parseInit=function(){};
  Xl.prototype.parseMedia=function(b,c){var d=Sb(b),e=[],f=new DOMParser,g=null;try{g=f.parseFromString(d,"text/xml");}catch(P){throw new B(2,2,2005);}if(g){if(f=g.getElementsByTagName("tt")[0]){g=M.getAttributeNS(f,"http://www.w3.org/ns/ttml#parameter","frameRate");var h=M.getAttributeNS(f,"http://www.w3.org/ns/ttml#parameter","subFrameRate");var k=M.getAttributeNS(f,"http://www.w3.org/ns/ttml#parameter","frameRateMultiplier");var l=M.getAttributeNS(f,"http://www.w3.org/ns/ttml#parameter","tickRate");
  d=f.getAttribute("xml:space")||"default";}else throw new B(2,2,2005);if("default"!=d&&"preserve"!=d)throw new B(2,2,2005);d="default"==d;g=new Yl(g,h,k,l);h=Zl(f.getElementsByTagName("styling")[0]);k=Zl(f.getElementsByTagName("layout")[0]);l=[];for(var m=0;m<k.length;m++){var p=k[m],r=h;var w=new Il;var x=p.getAttribute("xml:id");if(x){w.id=x;var A;if(A=$l(p,r,"extent"))A=(x=am.exec(A))||bm.exec(A),null!=A&&(w.width=Number(A[1]),w.height=Number(A[2]),w.widthUnits=x?Vl:0,w.heightUnits=x?Vl:0);if(p=
  $l(p,r,"origin"))A=(x=am.exec(p))||bm.exec(p),null!=A&&(w.viewportAnchorX=Number(A[1]),w.viewportAnchorY=Number(A[2]),w.viewportAnchorUnits=x?Vl:0);}else w=null;w&&l.push(w);}f=Zl(f.getElementsByTagName("body")[0]);for(m=0;m<f.length;m++)(w=cm(f[m],c.periodStart,g,h,k,l,d))&&e.push(w);}return e};
  var am=/^(\d{1,2}|100)% (\d{1,2}|100)%$/,dm=/^(\d+px|\d+em)$/,bm=/^(\d+)px (\d+)px$/,em=/^(\d{2,}):(\d{2}):(\d{2}):(\d{2})\.?(\d+)?$/,fm=/^(?:(\d{2,}):)?(\d{2}):(\d{2})$/,gm=/^(?:(\d{2,}):)?(\d{2}):(\d{2}\.\d{2,})$/,hm=/^(\d*(?:\.\d*)?)f$/,im=/^(\d*(?:\.\d*)?)t$/,jm=/^(?:(\d*(?:\.\d*)?)h)?(?:(\d*(?:\.\d*)?)m)?(?:(\d*(?:\.\d*)?)s)?(?:(\d*(?:\.\d*)?)ms)?$/,km={left:Nl,center:"center",right:"end",start:Nl,end:"end"},lm={left:"line-left",center:"center",right:"line-right"};
  function Zl(b){var c=[];if(!b)return c;for(var d=b.childNodes,e=0;e<d.length;e++){var f="span"==d[e].nodeName&&"p"==b.nodeName;d[e].nodeType!=Node.ELEMENT_NODE||"br"==d[e].nodeName||f||(f=Zl(d[e]),c=c.concat(f));}c.length||c.push(b);return c}function mm(b,c){for(var d=b.childNodes,e=0;e<d.length;e++)if("br"==d[e].nodeName&&0<e)d[e-1].textContent+="\n";else if(0<d[e].childNodes.length)mm(d[e],c);else if(c){var f=d[e].textContent.trim();f=f.replace(/\s+/g," ");d[e].textContent=f;}}
  function cm(b,c,d,e,f,g,h){if(!b.hasAttribute("begin")&&!b.hasAttribute("end")&&/^\s*$/.test(b.textContent))return null;mm(b,h);h=nm(b.getAttribute("begin"),d);var k=nm(b.getAttribute("end"),d);d=nm(b.getAttribute("dur"),d);var l=b.textContent;null==k&&null!=d&&(k=h+d);if(null==h||null==k)throw new B(2,2,2001);c=new hd(h+c,k+c,l);if((f=om(b,"region",f))&&f.getAttribute("xml:id")){var m=f.getAttribute("xml:id");g=g.filter(function(b){return b.id==m});c.region=g[0];}pm(c,b,f,e);return c}
  function pm(b,c,d,e){"rtl"==qm(c,d,e,"direction")&&(b.direction="rtl");var f=qm(c,d,e,"writingMode");"tb"==f||"tblr"==f?b.writingMode="vertical-lr":"tbrl"==f?b.writingMode="vertical-rl":"rltb"==f||"rl"==f?b.direction="rtl":f&&(b.direction=Hl);if(f=qm(c,d,e,"textAlign"))b.positionAlign=lm[f],b.lineAlign=km[f],b.textAlign=Rl[f.toUpperCase()];if(f=qm(c,d,e,"displayAlign"))b.displayAlign=Sl[f.toUpperCase()];if(f=qm(c,d,e,"color"))b.color=f;if(f=qm(c,d,e,"backgroundColor"))b.backgroundColor=f;if(f=qm(c,
  d,e,"fontFamily"))b.fontFamily=f;(f=qm(c,d,e,"fontWeight"))&&"bold"==f&&(b.fontWeight=700);(f=qm(c,d,e,"wrapOption"))&&"noWrap"==f&&(b.wrapLine=!1);(f=qm(c,d,e,"lineHeight"))&&f.match(dm)&&(b.lineHeight=f);(f=qm(c,d,e,"fontSize"))&&f.match(dm)&&(b.fontSize=f);if(f=qm(c,d,e,"fontStyle"))b.fontStyle=Ul[f.toUpperCase()];(d=$l(d,e,"textDecoration"))&&rm(b,d);(c=sm(c,e,"textDecoration"))&&rm(b,c);}
  function rm(b,c){for(var d=c.split(" "),e=0;e<d.length;e++)switch(d[e]){case "underline":b.textDecoration.includes("underline")||b.textDecoration.push("underline");break;case "noUnderline":b.textDecoration.includes("underline")&&tb(b.textDecoration,"underline");break;case "lineThrough":b.textDecoration.includes("lineThrough")||b.textDecoration.push("lineThrough");break;case "noLineThrough":b.textDecoration.includes("lineThrough")&&tb(b.textDecoration,"lineThrough");break;case "overline":b.textDecoration.includes("overline")||
  b.textDecoration.push("overline");break;case "noOverline":b.textDecoration.includes("overline")&&tb(b.textDecoration,"overline");}}function qm(b,c,d,e){return (b=sm(b,d,e))?b:$l(c,d,e)}function $l(b,c,d){for(var e=Zl(b),f=0;f<e.length;f++){var g=M.getAttributeNS(e[f],"http://www.w3.org/ns/ttml#styling",d);if(g)return g}return (b=om(b,"style",c))?M.getAttributeNS(b,"http://www.w3.org/ns/ttml#styling",d):null}
  function sm(b,c,d){return (b=om(b,"style",c))?M.getAttributeNS(b,"http://www.w3.org/ns/ttml#styling",d):null}function om(b,c,d){if(!b||1>d.length)return null;var e=null,f=b;for(b=null;f&&!(b=f.getAttribute(c))&&(f=f.parentNode,f instanceof Element););if(c=b)for(b=0;b<d.length;b++)if(d[b].getAttribute("xml:id")==c){e=d[b];break}return e}
  function nm(b,c){var d=null;if(em.test(b)){d=em.exec(b);var e=Number(d[1]),f=Number(d[2]),g=Number(d[3]),h=Number(d[4]);h+=(Number(d[5])||0)/c.b;g+=h/c.frameRate;d=g+60*f+3600*e;}else fm.test(b)?d=tm(fm,b):gm.test(b)?d=tm(gm,b):hm.test(b)?(d=hm.exec(b),d=Number(d[1])/c.frameRate):im.test(b)?(d=im.exec(b),d=Number(d[1])/c.a):jm.test(b)&&(d=tm(jm,b));return d}
  function tm(b,c){var d=b.exec(c);return null==d||""==d[0]?null:(Number(d[4])||0)/1E3+(Number(d[3])||0)+60*(Number(d[2])||0)+3600*(Number(d[1])||0)}function Yl(b,c,d,e){this.frameRate=Number(b)||30;this.b=Number(c)||1;this.a=Number(e);0==this.a&&(this.a=b?this.frameRate*this.b:1);d&&(b=/^(\d+) (\d+)$/g.exec(d))&&(this.frameRate*=b[1]/b[2]);}cd["application/ttml+xml"]=Xl;function um(){this.a=new Xl;}um.prototype.parseInit=function(b){var c=!1;(new Q).F("moov",R).F("trak",R).F("mdia",R).F("minf",R).F("stbl",R).aa("stsd",Ce).F("stpp",function(b){c=!0;b.parser.stop();}).parse(b);if(!c)throw new B(2,2,2007);};um.prototype.parseMedia=function(b,c){var d=!1,e=[];(new Q).F("mdat",De(function(b){d=!0;e=e.concat(this.a.parseMedia(b,c));}.bind(this))).parse(b);if(!d)throw new B(2,2,2007);return e};cd['application/mp4; codecs="stpp"']=um;
  cd['application/mp4; codecs="stpp.TTML.im1t"']=um;function vm(){}vm.prototype.parseInit=function(){};
  vm.prototype.parseMedia=function(b,c){var d=Sb(b);d=d.replace(/\r\n|\r(?=[^\n]|$)/gm,"\n");d=d.split(/\n{2,}/m);if(!/^WEBVTT($|[ \t\n])/m.test(d[0]))throw new B(2,2,2E3);var e=c.segmentStart;if(null==e&&(e=0,d[0].includes("X-TIMESTAMP-MAP"))){var f=d[0].match(/LOCAL:((?:(\d{1,}):)?(\d{2}):(\d{2})\.(\d{3}))/m),g=d[0].match(/MPEGTS:(\d+)/m);f&&g&&(e=wm(new Gf(f[1])),e=c.periodStart+(Number(g[1])/9E4-e));}g=[];var h=d[0].split("\n");for(f=1;f<h.length;f++)if(/^Region:/.test(h[f])){var k=new Gf(h[f]),
  l=new Il;Jf(k);Hf(k);for(var m=Jf(k);m;){var p=l,r=m;(m=/^id=(.*)$/.exec(r))?p.id=m[1]:(m=/^width=(\d{1,2}|100)%$/.exec(r))?p.width=Number(m[1]):(m=/^lines=(\d+)$/.exec(r))?(p.height=Number(m[1]),p.heightUnits=2):(m=/^regionanchor=(\d{1,2}|100)%,(\d{1,2}|100)%$/.exec(r))?(p.regionAnchorX=Number(m[1]),p.regionAnchorY=Number(m[2])):(m=/^viewportanchor=(\d{1,2}|100)%,(\d{1,2}|100)%$/.exec(r))?(p.viewportAnchorX=Number(m[1]),p.viewportAnchorY=Number(m[2])):/^scroll=up$/.exec(r)&&(p.scroll="up");Hf(k);
  m=Jf(k);}g.push(l);}f=[];for(k=1;k<d.length;k++){h=d[k].split("\n");m=h;r=e;h=g;if(1==m.length&&!m[0]||/^NOTE($|[ \t])/.test(m[0])||"STYLE"==m[0])h=null;else{l=null;m[0].includes("--\x3e")||(l=m[0],m.splice(0,1));p=new Gf(m[0]);var w=wm(p),x=If(p,/[ \t]+--\x3e[ \t]+/g),A=wm(p);if(null==w||null==x||null==A)throw new B(2,2,2001);m=new hd(w+r,A+r,m.slice(1).join("\n").trim());Hf(p);for(r=Jf(p);r;)xm(m,r,h),Hf(p),r=Jf(p);null!=l&&(m.id=l);h=m;}h&&f.push(h);}return f};
  function xm(b,c,d){var e;if(e=/^align:(start|middle|center|end|left|right)$/.exec(c))c=e[1],"middle"==c?b.textAlign=Kl:b.textAlign=Rl[c.toUpperCase()];else if(e=/^vertical:(lr|rl)$/.exec(c))b.writingMode="lr"==e[1]?"vertical-lr":"vertical-rl";else if(e=/^size:([\d.]+)%$/.exec(c))b.size=Number(e[1]);else if(e=/^position:([\d.]+)%(?:,(line-left|line-right|center|start|end))?$/.exec(c))b.position=Number(e[1]),e[2]&&(c=e[2],b.positionAlign="line-left"==c||"start"==c?"line-left":"line-right"==c||"end"==
  c?"line-right":"center");else if(e=/^region:(.*)$/.exec(c)){if(c=ym(d,e[1]))b.region=c;}else if(d=/^line:([\d.]+)%(?:,(start|end|center))?$/.exec(c))b.lineInterpretation=1,b.line=Number(d[1]),d[2]&&(b.lineAlign=Tl[d[2].toUpperCase()]);else if(d=/^line:(-?\d+)(?:,(start|end|center))?$/.exec(c))b.lineInterpretation=Ml,b.line=Number(d[1]),d[2]&&(b.lineAlign=Tl[d[2].toUpperCase()]);}function ym(b,c){var d=b.filter(function(b){return b.id==c});return d.length?d[0]:null}
  function wm(b){b=If(b,/(?:(\d{1,}):)?(\d{2}):(\d{2})\.(\d{3})/g);if(null==b)return null;var c=Number(b[2]),d=Number(b[3]);return 59<c||59<d?null:Number(b[4])/1E3+d+60*c+3600*(Number(b[1])||0)}cd["text/vtt"]=vm;cd['text/vtt; codecs="vtt"']=vm;function zm(){this.a=null;}zm.prototype.parseInit=function(b){var c=!1;(new Q).F("moov",R).F("trak",R).F("mdia",R).aa("mdhd",function(b){0==b.version?(b.reader.I(4),b.reader.I(4),this.a=b.reader.C(),b.reader.I(4)):(b.reader.I(8),b.reader.I(8),this.a=b.reader.C(),b.reader.I(8));b.reader.I(4);}.bind(this)).F("minf",R).F("stbl",R).aa("stsd",Ce).F("wvtt",function(){c=!0;}).parse(b);if(!this.a)throw new B(2,2,2008);if(!c)throw new B(2,2,2008);};
  zm.prototype.parseMedia=function(b,c){var d=this;if(!this.a)throw new B(2,2,2008);var e=0,f=[],g,h=[],k=!1,l=!1,m=!1,p=null;(new Q).F("moof",R).F("traf",R).aa("tfdt",function(b){k=!0;e=0==b.version?b.reader.C():b.reader.ab();}).aa("tfhd",function(b){var c=b.flags;b=b.reader;b.I(4);c&1&&b.I(8);c&2&&b.I(4);p=c&8?b.C():null;}).aa("trun",function(b){l=!0;var c=b.version,d=b.flags;b=b.reader;var e=b.C();d&1&&b.I(4);d&4&&b.I(4);for(var g=[],h=0;h<e;h++){var k={duration:null,sampleSize:null,Ec:null};d&256&&
  (k.duration=b.C());d&512&&(k.sampleSize=b.C());d&1024&&b.I(4);d&2048&&(k.Ec=0==c?b.C():b.xd());g.push(k);}f=g;}).F("mdat",De(function(b){m=!0;g=b;})).parse(b);if(!m&&!k&&!l)throw new B(2,2,2008);var r=e,w=new DataView(g.buffer,g.byteOffset,g.byteLength),x=new O(w,0);f.forEach(function(b){var f=b.duration||p,g=b.Ec?e+b.Ec:r;r=g+(f||0);var k=0;do{var l=x.C();k+=l;var m=x.C(),w=null;"vttc"==Ee(m)?8<l&&(w=x.Ja(l-8)):x.I(l-8);f&&w&&h.push(Am(w,c.periodStart+g/d.a,c.periodStart+r/d.a));}while(b.sampleSize&&
  k<b.sampleSize)});return h.filter(H.wa)};function Am(b,c,d){var e,f,g;(new Q).F("payl",De(function(b){e=Sb(b);})).F("iden",De(function(b){f=Sb(b);})).F("sttg",De(function(b){g=Sb(b);})).parse(b);return e?Bm(e,f,g,c,d):null}function Bm(b,c,d,e,f){b=new hd(e,f,b);c&&(b.id=c);if(d)for(c=new Gf(d),d=Jf(c);d;)xm(b,d,[]),Hf(c),d=Jf(c);return b}cd['application/mp4; codecs="wvtt"']=zm;function Xj(b){this.a=null;for(var c=0;c<b.textTracks.length;++c){var d=b.textTracks[c];d.mode="disabled";"Shaka Player TextTrack"==d.label&&(this.a=d);}this.a||(this.a=b.addTextTrack("subtitles","Shaka Player TextTrack"));this.a.mode="hidden";}y("shaka.text.SimpleTextDisplayer",Xj);Xj.prototype.remove=function(b,c){if(!this.a)return !1;Cm(this.a,function(d){return d.startTime<c&&d.endTime>b});return !0};Xj.prototype.remove=Xj.prototype.remove;
  Xj.prototype.append=function(b){for(var c=Dm,d=[],e=0;e<b.length;e++){var f=c(b[e]);f&&d.push(f);}d.slice().sort(function(b,c){return b.startTime!=c.startTime?b.startTime-c.startTime:b.endTime!=c.endTime?b.endTime-c.startTime:d.indexOf(c)-d.indexOf(b)}).forEach(function(b){this.a.addCue(b);}.bind(this));};Xj.prototype.append=Xj.prototype.append;Xj.prototype.destroy=function(){this.a&&Cm(this.a,function(){return !0});this.a=null;return Promise.resolve()};Xj.prototype.destroy=Xj.prototype.destroy;
  Xj.prototype.isTextVisible=function(){return "showing"==this.a.mode};Xj.prototype.isTextVisible=Xj.prototype.isTextVisible;Xj.prototype.setTextVisibility=function(b){this.a.mode=b?"showing":"hidden";};Xj.prototype.setTextVisibility=Xj.prototype.setTextVisibility;
  function Dm(b){if(b.startTime>=b.endTime)return null;var c=new VTTCue(b.startTime,b.endTime,b.payload);c.lineAlign=b.lineAlign;c.positionAlign=b.positionAlign;c.size=b.size;try{c.align=b.textAlign;}catch(d){}"center"==b.textAlign&&"center"!=c.align&&(c.align="middle");"vertical-lr"==b.writingMode?c.vertical="lr":"vertical-rl"==b.writingMode&&(c.vertical="rl");1==b.lineInterpretation&&(c.snapToLines=!1);null!=b.line&&(c.line=b.line);null!=b.position&&(c.position=b.position);return c}
  function Cm(b,c){var d=b.mode;b.mode="showing"==d?"showing":"hidden";for(var e=b.cues,f=e.length-1;0<=f;f--){var g=e[f];g&&c(g)&&b.removeCue(g);}b.mode=d;}}).call(exportTo,innerGlobal,innerGlobal);for(var k in exportTo.shaka)exports[k]=exportTo.shaka[k];})();
  ...
  */
  ...
  DownloadService.VERSION = '2.1.106-411';
  ...
  */
  ...
  EmpShaka.VERSION = '2.1.106-411'; // Unset source handlers set by Html5 super class.
