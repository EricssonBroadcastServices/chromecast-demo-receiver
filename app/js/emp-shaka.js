...
(function (global, factory) {
  ...
  */
  ...
  function (_Plugin) {
    ...
    _proto.initStorage_ = function initStorage_(useNoPersistentLicense) {
      if (this.storage_) {
  ...
  DownloadService.VERSION = '2.1.100-288';
  ...
  function (_Html) {
    ...
    _proto.handleSource = function handleSource(source, tech) {
      ...
      this.shakaPlayer_.load(source.src, startTime).then(function () {
        ...
        if (error.code === shaka$1.util.Error.Code.LOAD_INTERRUPTED) {
    ...
    _proto.techVersion = function techVersion() {
      if (shaka$1 && shaka$1.Player) {
        return shaka$1.Player.version || 'N/A';
      }
    ...
    _proto.createPlayer_ = function createPlayer_() {
      ...
      this.shakaPlayer_ = new shaka$1.Player(this.el_);
        ...
        if (_this3.shakaPlayer_.drmInfo()) {
          ...
          if (_this3.shakaPlayer_.drmInfo().keySystem === 'com.microsoft.playready') {
            message = {
              ...
              'code': undefined,
              'info': _this3.shakaPlayer_.drmInfo().licenseServerUri
            };
    ...
    _proto.addErrorMessage = function addErrorMessage(error) {
      ...
      for (var k in shaka$1.util.Error.Category) {
        if (shaka$1.util.Error.Category[k] === error.category) categoryName = k;
      }

      for (var c in shaka$1.util.Error.Code) {
        if (shaka$1.util.Error.Code[c] === error.code) codeName = c;
      }
    ...
    */
    ...
    _proto.addLicenseRequestHeaders = function addLicenseRequestHeaders(headers, requestType, request) {
      if (requestType !== shaka$1.net.NetworkingEngine.RequestType.LICENSE) {
        return;
      ...
      get: function get() {
        return {
          ...
          canPlayType: function canPlayType(type, options) {
            ...
            if (dashTypeRE.test(type) && shaka$1.Player.isBrowserSupported()) {
              return 'probably';
            }
  ...
  EmpShaka.VERSION = '2.1.100-288'; // Unset source handlers set by Html5 super class.
