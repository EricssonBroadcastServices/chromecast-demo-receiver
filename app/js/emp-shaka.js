...
(function (global, factory) {
  ...
  1],"t",M.Wa);if(null==w)break;else if(x>=w)break;w=Math.ceil((w-x)/A)-1;}else{if(Infinity==l)break;else if(x/f>=l)break;w=Math.ceil((l*f-x)/A)-1;}0<m.length&&x!=p&&(m[m.length-1].end=x/f);for(var R=0;R<=w;++R)p=x+A,m.push({start:x/f,end:p/f,Kf:x}),x=p;}f=m;}return {timescale:e,U:d,Ka:h,ga:g/e||0,Dc:g,K:f}}function ue(b,c,d){return [c(b.w),c(b.X),c(b.ea)].filter(H.wa).map(function(b){return b.getAttribute(d)}).reduce(function(b,c){return b||c})}
  ...
  O.prototype.readTerminatedString=O.prototype.rc;function Ae(){throw new B(2,3,3E3);}function P(){this.c=[];this.b=[];this.a=!1;}y("shaka.util.Mp4Parser",P);P.prototype.F=function(b,c){var d=Be(b);this.c[d]=0;this.b[d]=c;return this};P.prototype.box=P.prototype.F;P.prototype.aa=function(b,c){var d=Be(b);this.c[d]=1;this.b[d]=c;return this};P.prototype.fullBox=P.prototype.aa;P.prototype.stop=function(){this.a=!0;};P.prototype.stop=P.prototype.stop;
  P.prototype.parse=function(b,c){var d=new Uint8Array(b);d=new O(new DataView(d.buffer,d.byteOffset,d.byteLength),0);for(this.a=!1;d.ja()&&!this.a;)this.Mb(0,d,c);};P.prototype.parse=P.prototype.parse;
  P.prototype.Mb=function(b,c,d){var e=c.W(),f=c.C(),g=c.C();switch(f){case 0:f=c.H.byteLength-e;break;case 1:f=c.Ya();}var h=this.b[g];if(h){var k=null,l=null;1==this.c[g]&&(l=c.C(),k=l>>>24,l&=16777215);g=e+f;d&&g>c.H.byteLength&&(g=c.H.byteLength);g-=c.W();c=0<g?c.Ia(g):new Uint8Array(0);c=new O(new DataView(c.buffer,c.byteOffset,c.byteLength),0);h({parser:this,partialOkay:d||!1,version:k,flags:l,reader:c,size:f,start:e+b});}else c.I(Math.min(e+f-c.W(),c.H.byteLength-c.W()));};
  P.prototype.parseNext=P.prototype.Mb;function Q(b){for(;b.reader.ja()&&!b.parser.a;)b.parser.Mb(b.start,b.reader,b.partialOkay);}P.children=Q;function Ce(b){for(var c=b.reader.C();0<c&&!b.parser.a;--c)b.parser.Mb(b.start,b.reader,b.partialOkay);}P.sampleDescription=Ce;function De(b){return function(c){b(c.reader.Ia(c.reader.H.byteLength-c.reader.W()));}}P.allData=De;function Be(b){for(var c=0,d=0;d<b.length;d++)c=c<<8|b.charCodeAt(d);return c}
  function Ee(b){return String.fromCharCode(b>>24&255,b>>16&255,b>>8&255,b&255)}P.typeToString=Ee;function Fe(b,c,d,e){var f,g=(new P).aa("sidx",function(b){f=Ge(c,e,d,b);});b&&g.parse(b);if(f)return f;throw new B(2,3,3004);}
  ...
  function hf(b,c,d,e){return t(function g(){var h,k,l,m,p,r,w,x,A,R;return v(g,function(g){switch(g.l){case 1:if(e&&(h=e.toLowerCase(),k=df[h]))return g["return"](k);l=new Qa(b);m=l.da.split("/");p=m.pop();r=p.split(".");return 1<r.length&&(w=r.pop().toLowerCase(),x=ef[w])?g["return"](x):u(g,jf(b,c,d),2);case 2:A=g.v;if(R=df[A])return g["return"](R);throw new B(2,4,4E3,b);}})})}
  ...
  function of(b,c,d){return t(function f(){var g,h,k,l,m,p,r,w,x,A,R,W,X,fa,ia,Ka,xa,Y,eg,Xa,fg,gg,hg,ig,jg,kg;return v(f,function(f){switch(f.l){case 1:l=H;m=M;p=[d];r=m.M(c,"Location").map(m.Ib).filter(l.wa);0<r.length&&(w=Tc(p,r),p=b.h=w);x=m.M(c,"BaseURL").map(m.Ib);A=Tc(p,x);(R=b.b.dash.ignoreMinBufferTime)||(W=m.G(c,"minBufferTime",m.ra));b.o=m.G(c,"minimumUpdatePeriod",m.ra,-1);X=m.G(c,"availabilityStartTime",m.Ze);fa=m.G(c,"timeShiftBufferDepth",m.ra);ia=m.G(c,"suggestedPresentationDelay",m.ra);
  Ka=m.G(c,"maxSegmentDuration",m.ra);xa=c.getAttribute("type")||"static";b.c?Y=b.c.presentationTimeline:(eg=Math.max(b.b.dash.defaultPresentationDelay,1.5*W),Xa=null!=ia?ia:eg,Y=new T(X,Xa));fg={Na:"static"!=xa,presentationTimeline:Y,ea:null,N:null,X:null,w:null,bandwidth:0,ad:!1};for(var lg=fg,Sj=A,Ic=M.G(c,"mediaPresentationDuration",M.ra),Jc=[],Ya=0,Sb=M.M(c,"Period"),tb=0;tb<Sb.length;tb++){var hb=Sb[tb];Ya=M.G(hb,"start",M.ra,Ya);var Kc=M.G(hb,"duration",M.ra),Za=null;if(tb!=Sb.length-1){var mg=
  ...
  (fa=b.b.availabilityWindowOverride);null==fa&&(fa=Infinity);Y.yc(fa);Y.kc(Ka||1);if(b.c){f.B(0);break}b.c={presentationTimeline:Y,periods:hg,offlineSessionIds:[],minBufferTime:W||0};if(!Y.Hd()){f.B(0);break}jg=m.M(c,"UTCTiming");return u(f,qf(b,A,jg,ig),4);case 4:kg=f.v;if(!b.a)return f["return"]();Y.Ad(kg);f.l=0;}})})}
  ...
  function $f(b,c){var d=c.a,e=Df(c.a,"EXT-X-MEDIA"),f=e.filter(function(b){return "SUBTITLES"==U(b,"TYPE")}.bind(b)).map(function(b){return bg(this,b)}.bind(b));e=e.filter(function(b){return "CLOSED-CAPTIONS"==U(b,"TYPE")});cg(b,e);return Promise.all(f).then(function(b){var e=Df(d,"EXT-X-STREAM-INF").map(function(b){return dg(this,b,c)}.bind(this));return Promise.all(e).then(function(c){return {startTime:0,variants:c.reduce(H.Vb,[]),textStreams:b}}.bind(this))}.bind(b))}
  function dg(b,c,d){var e=Bf(c,"CODECS","avc1.42E01E,mp4a.40.2").split(/\s*,\s*/),f=c.getAttribute("RESOLUTION"),g=null,h=null,k=Bf(c,"FRAME-RATE"),l=Number(U(c,"BANDWIDTH"));if(f){var m=f.value.split("x");g=m[0];h=m[1];}d=Df(d.a,"EXT-X-MEDIA");d=d.filter(function(b){return "CLOSED-CAPTIONS"!=U(b,"TYPE")});d=d.filter(function(b){var c=Bf(b,"URI")||"";return "SUBTITLES"==(Bf(b,"TYPE")||"")||""!=c});var p=Bf(c,"AUDIO"),r=Bf(c,"VIDEO");p?d=Ff(d,"AUDIO",p):r&&(d=Ff(d,"VIDEO",r));if(m=ng("text",e)){var w=
  Bf(c,"SUBTITLES");w&&(w=Ff(d,"SUBTITLES",w),w.length&&(b.D.get(w[0].id).stream.codecs=m));sb(e,m);}d=d.map(function(b){return og(this,b,e)}.bind(b));var x=[],A=[];return Promise.all(d).then(function(b){p?x=b:r&&(A=b);b=!1;if(x.length||A.length)if(x.length)if(U(c,"URI")==x[0].Rb){var d="audio";b=!0;}else d="video";else d="audio";else 1==e.length?(d=ng("video",e),d=f||k||d?"video":"audio"):(d="video",e=[e.join(",")]);return b?Promise.resolve():pg(this,c,e,d)}.bind(b)).then(function(b){b&&("audio"==b.stream.type?
  ...
  "");b.P.has(w)||(p=sg(b,p,r,e,A),k.push(p),b.P.add(w));}return k}function sg(b,c,d,e,f){return {id:b.$++,language:c?c.language:"und",primary:!!c&&c.primary||!!d&&d.primary,audio:c,video:d,bandwidth:e,drmInfos:f,allowedByApplication:!0,allowedByKeySystem:!0}}function bg(b,c){U(c,"TYPE");return og(b,c,[]).then(function(b){return b.stream})}
  function cg(b,c){for(var d=q(c),e=d.next();!e.done;e=d.next()){e=e.value;U(e,"TYPE");var f=Bf(e,"LANGUAGE")||"und";f=I(f);var g=U(e,"GROUP-ID");e=U(e,"INSTREAM-ID");b.m.get(g)||b.m.set(g,new Map);b.m.get(g).set(e,f);}}
  ...
  e,r,p)}).then(function(d){w=d;d=Ef(p.a,"EXT-X-MEDIA-SEQUENCE");return Yf(b,c,p,d?Number(d.value):0,w,r)}).then(function(d){var A=d[0].startTime,x=d[d.length-1].endTime,W=x-A;d=new S(d);var X=xg(p),fa=void 0;"text"==e&&(fa="subtitle");var ia=[];p.segments.forEach(function(b){b=Df(b.b,"EXT-X-KEY");ia.push.apply(ia,b);});var Ka=!1,xa=[],Y=null;ia.forEach(function(b){if("NONE"!=U(b,"METHOD")){Ka=!0;var c=U(b,"KEYFORMAT");if(b=(c=yg[c])?c(b):null)b.keyIds.length&&(Y=b.keyIds[0]),xa.push(b);}});if(Ka&&!xa.length)throw new B(2,
  4,4026);return {stream:{id:b.$++,originalId:h,createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:d.find.bind(d),getSegmentReference:d.get.bind(d),initSegmentReference:X,presentationTimeOffset:0,mimeType:w,codecs:r,kind:fa,encrypted:Ka,keyId:Y,language:f,label:h,type:e,primary:g,trickModeVideo:null,emsgSchemeIdUris:null,frameRate:void 0,width:void 0,height:void 0,bandwidth:void 0,roles:[],channelsCount:k,closedCaptions:l},qb:d,drmInfos:xa,Rb:c,Qd:m,jc:A,Wf:x,duration:W}})}
  function xg(b){var c=Df(b.a,"EXT-X-MAP");if(!c.length)return null;if(1<c.length)throw new B(2,4,4020);c=c[0];var d=U(c,"URI"),e=Tc([b.b],[d])[0];b=0;d=null;if(c=Bf(c,"BYTERANGE"))b=c.split("@"),c=Number(b[0]),b=Number(b[1]),d=b+c-1;return new ye(function(){return [e]},b,d)}
  ...
  4,4030);}.bind(b))}function Cg(b,c){var d=0;(new P).F("moov",Q).F("trak",Q).F("mdia",Q).aa("mdhd",function(b){b.reader.I(0==b.version?8:16);d=b.reader.C();b.parser.stop();}).parse(c,!0);if(!d)throw new B(2,4,4030);var e=0,f=!1;(new P).F("moof",Q).F("traf",Q).aa("tfdt",function(b){e=(0==b.version?b.reader.C():b.reader.Ya())/d;f=!0;b.parser.stop();}).parse(b,!0);if(!f)throw new B(2,4,4030);return e}
  ...
  function U(b,c){var d=b.getAttribute(c);if(!d)throw new B(2,4,4023,c);return d.value}function vg(b,c){var d=Ef(b,c);if(!d)throw new B(2,4,4024,c);return d}function Tf(b,c){var d=b.c.networkingEngine.request(0,Ab([c],b.g.retryParameters));xb(b.h,d);return d.promise}
  ...
  var yg={"urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed":function(b){var c=U(b,"METHOD");Cd("HLS SAMPLE-AES-CENC","SAMPLE-AES-CENC will no longer be supported, see Issue #1227");if(!["SAMPLE-AES","SAMPLE-AES-CTR","SAMPLE-AES-CENC"].includes(c))return null;c=U(b,"URI");c=Qf.parse(c);c=new Uint8Array(c.data);c=Uc("com.widevine.alpha",[{initDataType:"cenc",initData:c}]);if(b=Bf(b,"KEYID"))c.keyIds=[b.substr(2).toLowerCase()];return c}},Sf="VOD",Wf={Ca:Sf,Ld:"EVENT",Fc:"LIVE"};ef.m3u8=Rf;
  ...
  Qh.h=function(b,c,d,e,f,g){return t(function k(){var l,m,p,r,w,x,A,R,W,X,fa,ia;return v(k,function(k){switch(k.l){case 1:return l=Qh.g,m=Qh.c,x=w=0,A=Date.now(),pa(k,2,3),u(k,l(b,d),5);case 5:return p=k.v,R=p.clone().body.getReader(),W=function(b){function c(){return t(function Xa(){var d,e;return v(Xa,function(f){switch(f.l){case 1:return u(f,R.read(),2);case 2:d=f.v;d.done||(w+=d.value.byteLength);e=Date.now();if(100<e-A||d.done)g(e-A,w-x),x=w,A=e;d.done?b.close():(b.enqueue(d.value),c());f.l=0;}})})}
  c();},new m({start:W}),u(k,p.arrayBuffer(),6);case 6:r=k.v;case 3:ta(k);clearTimeout(f);ua(k,4);break;case 2:X=sa(k);if(e.Lc)throw new B(1,1,7001,b,c);if(e.Gd)throw new B(1,1,1003,b,c);throw new B(1,1,1002,b,X,c);case 4:return fa={},ia=p.headers,ia.forEach(function(b,c){fa[c.trim()]=b;}),k["return"](Ph(fa,r,p.status,b,p.url,c))}})})};Qh.isSupported=function(){if(window.ReadableStream)try{new ReadableStream({});}catch(b){return !1}else return !1;return !(!window.fetch||!window.AbortController)};
  ...
  V.prototype.load=function(b,c,d){c=void 0===c?null:c;var e=this;return t(function g(){var h,k,l,m,p,r,w,x,A,R,W,X,fa,ia,Ka,xa;return v(g,function(g){switch(g.l){case 1:if(!e.f)throw new B(2,7,7002);k=new z;l=function(){h=new B(2,7,7E3);return k};e.dispatchEvent(new D("loading"));pa(g,2);m=e.f;p=e.ub();e.$=l;return u(g,p,4);case 4:e.j=new tj(m);e.j.g=Date.now()/1E3;G(e.o,m,"playing",function(){Fj(e);});G(e.o,m,"pause",function(){Fj(e);});G(e.o,m,"ended",function(){Fj(e);});r=e.b.abrFactory;e.g&&e.Tb==
  r||(e.Tb=r,e.g=new r,e.g.configure(e.b.abr));if(h)throw h;x=w=null;d&&("string"==typeof d?x=d:(Cd("Loading with a manifest parser factory","Please register a manifest parser and for the mime-type."),w=d));A=e;if(w){R=new w;g.B(5);break}return u(g,Cj(e,b,x),6);case 6:R=g.v;case 5:return A.m=R,e.m.configure(e.b.manifest),e.ua=b,u(g,Dj(e),7);case 7:W=g.v;e.c=W;if(h)throw h;Ej(e);X=e;return u(g,Gj(e,W),8);case 8:X.h=g.v;if(h)throw h;e.Pc(e.c.periods);Hj(e,e.c.periods);e.vb=new Og(e.b.preferredAudioLanguage,
  ...
  if(h)throw h;e.$=null;ra(g,0);break;case 2:return xa=sa(g),k.resolve(),e.$==l&&(e.$=null,e.dispatchEvent(new D("unloading"))),g["return"](Promise.reject(h||xa))}})})};V.prototype.load=V.prototype.load;
  ...
  V.prototype.configure=function(b,c){if(2==arguments.length&&"string"==typeof b){for(var d=b,e={},f=e,g=0,h=0;;){g=d.indexOf(".",g);if(0>g)break;if(0==g||"\\"!=d[g-1])h=d.substring(h,g).replace(/\\\./g,"."),f[h]={},f=f[h],h=g+1;g+=1;}f[d.substring(h).replace(/\\\./g,".")]=c;b=e;}d=nj(this.b,b,vj(this));Tj(this);return d};V.prototype.configure=V.prototype.configure;
  function Tj(b){b.m&&b.m.configure(b.b.manifest);b.h&&b.h.configure(b.b.drm);if(b.a){b.a.configure(b.b.streaming);try{b.c.periods.forEach(b.Yb.bind(b));}catch(f){b.Ja(f);}var c=mh(b.a),d=oh(b.a),e=Pj(b);c=J.Yc(c,d,e.variants);b.g&&c&&c.allowedByApplication&&c.allowedByKeySystem?Qj(b,e.variants):Uj(b,e);}b.g&&(b.g.configure(b.b.abr),b.b.abr.enabled&&!b.ha?b.g.enable():b.g.disable());}V.prototype.getConfiguration=function(){var b=vj(this);nj(b,this.b,vj(this));return b};V.prototype.getConfiguration=V.prototype.getConfiguration;
  V.prototype.mf=function(){for(var b in this.b)delete this.b[b];nj(this.b,vj(this),vj(this));Tj(this);};V.prototype.resetConfiguration=V.prototype.mf;V.prototype.le=function(){return this.f};V.prototype.getMediaElement=V.prototype.le;V.prototype.fb=function(){return this.D};V.prototype.getNetworkingEngine=V.prototype.fb;V.prototype.Zb=function(){return this.ua};V.prototype.getAssetUri=V.prototype.Zb;V.prototype.ke=function(){Cd("getManifestUri",'Please use "getAssetUri" instead.');return this.ua};
  V.prototype.getManifestUri=V.prototype.ke;V.prototype.T=function(){return this.c?this.c.presentationTimeline.T():!1};V.prototype.isLive=V.prototype.T;V.prototype.Ga=function(){return this.c?this.c.presentationTimeline.Ga():!1};V.prototype.isInProgress=V.prototype.Ga;V.prototype.ze=function(){if(!this.c||!this.c.periods.length)return !1;var b=this.c.periods[0].variants;return b.length?!b[0].video:!1};V.prototype.isAudioOnly=V.prototype.ze;
  V.prototype.pf=function(){var b=0,c=0;this.c&&(c=this.c.presentationTimeline,b=c.Pa(),c=c.pa());return {start:b,end:c}};V.prototype.seekRange=V.prototype.pf;V.prototype.keySystem=function(){return this.h?this.h.keySystem():""};V.prototype.keySystem=V.prototype.keySystem;V.prototype.drmInfo=function(){return this.h?this.h.a:null};V.prototype.drmInfo=V.prototype.drmInfo;V.prototype.Jb=function(){return this.h?this.h.Jb():Infinity};V.prototype.getExpiration=V.prototype.Jb;V.prototype.bd=function(){return this.$a};
  V.prototype.isBuffering=V.prototype.bd;V.prototype.ub=function(b){var c=this;return t(function e(){return v(e,function(e){switch(e.l){case 1:if(c.ab.a)return e["return"]();void 0===b&&(b=!0);c.dispatchEvent(new D("unloading"));return u(e,xj(c),2);case 2:return c.Ab||(c.Ab=Vj(c).then(function(){c.Dd(!1);c.Ab=null;})),u(e,c.Ab,3);case 3:if(b)return c.s=Bj(c),u(e,c.s.o,0);e.B(0);}})})};V.prototype.unload=V.prototype.ub;V.prototype.gb=function(){return this.i?this.i.gb():0};
  V.prototype.getPlaybackRate=V.prototype.gb;V.prototype.Hf=function(b){this.i&&$g(this.i.b,b);this.a&&th(this.a,1!=b);};V.prototype.trickPlay=V.prototype.Hf;V.prototype.Vd=function(){this.i&&$g(this.i.b,1);this.a&&th(this.a,!1);};V.prototype.cancelTrickPlay=V.prototype.Vd;V.prototype.ue=function(){for(var b=Wj(this),c=[],d=q(Xj(this)),e=d.next();!e.done;e=d.next()){e=e.value;var f=J.Ec(e);f.active=e==b;c.push(f);}return c};V.prototype.getVariantTracks=V.prototype.ue;
  V.prototype.Xc=function(){var b=Pj(this);if(null==b)b=null;else{if(!Hg(this.u,b).text){var c=J.Fb(b.textStreams,this.P,this.va);c.length&&(c=c[0],Hg(this.u,b).text=c);}b=Hg(this.u,b).text;}c=[];for(var d=q(Yj(this)),e=d.next();!e.done;e=d.next()){e=e.value;var f=J.Ac(e);f.active=e==b;c.push(f);}return c};V.prototype.getTextTracks=V.prototype.Xc;V.prototype.yd=function(b){var c=Pj(this);null!=c&&(b=J.be(c,b))&&(Hg(this.u,c).text=b,sj(this.j.a,b,!1),Zj(this,b),this.P=b.language);};
  V.prototype.selectTextTrack=V.prototype.yd;V.prototype.rf=function(){Cd("selectEmbeddedTextTrack","If closed captions are signaled in the manifest, a text stream will be created to represent them. Please use SelectTextTrack.");var b=this.Xc().filter(function(b){return "application/cea-608"==b.mimeType});0<b.length&&this.yd(b[0]);};V.prototype.selectEmbeddedTextTrack=V.prototype.rf;
  V.prototype.Mf=function(){Cd("usingEmbeddedTextTrack","If closed captions are signaled in the manifest, a text stream will be created to represent them. There should be no reason to know if the player is playing embedded text.");var b=this.a?nh(this.a,"text"):null;return null!=b&&"application/cea-608"==b.mimeType};V.prototype.usingEmbeddedTextTrack=V.prototype.Mf;
  V.prototype.tf=function(b,c,d){d=void 0===d?0:d;var e=Pj(this);null!=e&&(this.b.abr.enabled&&Na("Changing tracks while abr manager is enabled will likely result in the selected track being overriden. Consider disabling abr before calling selectVariantTrack()."),(b=J.ce(e,b))&&J.Ra(b)&&(Jj(this,e,b,!1),ak(this,b,c,d),this.vb=new Ng(b),Qj(this,e.variants)));};V.prototype.selectVariantTrack=V.prototype.tf;
  V.prototype.fe=function(){for(var b=[],c=q(Xj(this)),d=c.next();!d.done;d=c.next())b.push(d.value.audio);return bk(b)};V.prototype.getAudioLanguagesAndRoles=V.prototype.fe;V.prototype.se=function(){return bk(Yj(this))};V.prototype.getTextLanguagesAndRoles=V.prototype.se;V.prototype.ee=function(){for(var b=[],c=q(Xj(this)),d=c.next();!d.done;d=c.next())b.push(d.value.audio);return Array.from(ck(b))};V.prototype.getAudioLanguages=V.prototype.ee;V.prototype.re=function(){return Array.from(ck(Yj(this)))};
  V.prototype.getTextLanguages=V.prototype.re;V.prototype.qf=function(b,c){var d=Pj(this);null!=d&&(this.vb=new Og(b,c||"",0),Uj(this,d));};V.prototype.selectAudioLanguage=V.prototype.qf;V.prototype.sf=function(b,c){var d=Pj(this);null!=d&&(this.P=b,this.va=c||"",Uj(this,d));};V.prototype.selectTextLanguage=V.prototype.sf;V.prototype.ec=function(){return this.bb};V.prototype.isTextTrackVisible=V.prototype.ec;
  V.prototype.Bd=function(b){var c=this;return t(function e(){var f,g,h,k;return v(e,function(e){switch(e.l){case 1:if(b==c.bb)return e["return"]();c.s&&c.s.j.setTextVisibility(b);c.bb=b;dk(c);if(c.b.streaming.alwaysStreamText||!c.a)return e["return"]();f=J;if(b){if(g=Pj(c),h=f.Fb(g.textStreams,c.P,c.va),k=h[0])return u(e,ph(c.a,k),0)}else{var l=c.a;l.A=!0;var p=l.c.get("text");p&&(kh(p),l.c["delete"]("text"));}e.B(0);}})})};V.prototype.setTextTrackVisibility=V.prototype.Bd;
  V.prototype.oe=function(){return this.c?new Date(1E3*this.c.presentationTimeline.f+1E3*this.f.currentTime):null};V.prototype.getPlayheadTimeAsDate=V.prototype.oe;V.prototype.qe=function(){return this.c?new Date(1E3*this.c.presentationTimeline.f):null};V.prototype.getPresentationStartTimeAsDate=V.prototype.qe;V.prototype.$b=function(){return this.s?this.s.$b():{total:[],audio:[],video:[],text:[]}};V.prototype.getBufferedInfo=V.prototype.$b;
  V.prototype.getStats=function(){if(null==this.j)return {width:NaN,height:NaN,streamBandwidth:NaN,decodedFrames:NaN,droppedFrames:NaN,estimatedBandwidth:NaN,loadLatency:NaN,playTime:NaN,bufferingTime:NaN,switchHistory:[],stateHistory:[]};uj(this.j,this.$a);Fj(this);var b=this.f;if(b.getVideoPlaybackQuality){b=b.getVideoPlaybackQuality();var c=this.j,d=Number(b.totalVideoFrames);c.s=Number(b.droppedVideoFrames);c.o=d;}if(b=Wj(this))this.j.u=b.bandwidth;b&&b.video&&(c=this.j,d=b.video.height||NaN,c.A=
  ...
  width:null,height:null}}}.bind(this))};V.prototype.addTextTrack=V.prototype.addTextTrack;V.prototype.xc=function(b,c){this.yb.width=b;this.yb.height=c;};V.prototype.setMaxHardwareResolution=V.prototype.xc;V.prototype.vc=function(){if(this.a){var b=this.a;if(b.f)b=!1;else if(b.m)b=!1;else{for(var c=q(b.c.values()),d=c.next();!d.done;d=c.next())d=d.value,d.jb&&(d.jb=!1,sh(b,d,.1));b=!0;}}else b=!1;return b};V.prototype.retryStreaming=V.prototype.vc;V.prototype.je=function(){return this.c};
  V.prototype.getManifest=V.prototype.je;function Jj(b,c,d,e){Hg(b.u,c).variant=d;b=b.j.a;b.c!=d&&(b.c=d,b.a.push({timestamp:Date.now()/1E3,id:d.id,type:"variant",fromAdaptation:e,bandwidth:d.bandwidth}));}
  ...
  codecs:"",kind:"caption",encrypted:!1,keyId:null,language:h.closedCaptions.get(l),label:null,type:"text",primary:!1,trickModeVideo:null,emsgSchemeIdUris:null,roles:h.roles,channelsCount:null,closedCaptions:null};f.set(l,m);}}f=q(f.values());for(g=f.next();!g.done;g=f.next())e.textStreams.push(g.value);}}n=V.prototype;
  ...
  Wk(function(){if(window.MediaSource)if(window.cast&&cast.__platform__&&cast.__platform__.canDisplayType)fl();else if(navigator.vendor&&navigator.vendor.includes("Apple")){var b=navigator.appVersion;el();if(b.includes("Version/8"))window.MediaSource=null;else if(b.includes("Version/9"))$k();else if(b.includes("Version/10"))$k(),bl();else if(b.includes("Version/11")||b.includes("Version/12"))$k(),al();}});function gl(b){this.f=[];this.b=[];this.a=[];(new P).aa("pssh",this.c.bind(this)).parse(b.buffer);}gl.prototype.c=function(b){if(!(1<b.version)){var c=ac(b.reader.Ia(16)),d=[];if(0<b.version)for(var e=b.reader.C(),f=0;f<e;++f){var g=ac(b.reader.Ia(16));d.push(g);}e=b.reader.C();b.reader.I(e);this.b.push.apply(this.b,d);this.f.push(c);this.a.push({start:b.start,end:b.start+b.size-1});}};function hl(b,c){try{var d=new il(b,c);return Promise.resolve(d)}catch(e){return Promise.reject(e)}}
  ...
  Ml.prototype.parseMedia=function(b,c){var d=Rb(b),e=[],f=new DOMParser,g=null;try{g=f.parseFromString(d,"text/xml");}catch(R){throw new B(2,2,2005);}if(g){if(f=g.getElementsByTagName("tt")[0]){g=M.getAttributeNS(f,"http://www.w3.org/ns/ttml#parameter","frameRate");var h=M.getAttributeNS(f,"http://www.w3.org/ns/ttml#parameter","subFrameRate");var k=M.getAttributeNS(f,"http://www.w3.org/ns/ttml#parameter","frameRateMultiplier");var l=M.getAttributeNS(f,"http://www.w3.org/ns/ttml#parameter","tickRate");
  ...
  function im(b,c){var d=b.exec(c);return null==d||""==d[0]?null:(Number(d[4])||0)/1E3+(Number(d[3])||0)+60*(Number(d[2])||0)+3600*(Number(d[1])||0)}function Nl(b,c,d,e){this.frameRate=Number(b)||30;this.b=Number(c)||1;this.a=Number(e);0==this.a&&(this.a=b?this.frameRate*this.b:1);d&&(b=/^(\d+) (\d+)$/g.exec(d))&&(this.frameRate*=b[1]/b[2]);}bd["application/ttml+xml"]=Ml;function jm(){this.a=new Ml;}jm.prototype.parseInit=function(b){var c=!1;(new P).F("moov",Q).F("trak",Q).F("mdia",Q).F("minf",Q).F("stbl",Q).aa("stsd",Ce).F("stpp",function(b){c=!0;b.parser.stop();}).parse(b);if(!c)throw new B(2,2,2007);};jm.prototype.parseMedia=function(b,c){var d=!1,e=[];(new P).F("mdat",De(function(b){d=!0;e=e.concat(this.a.parseMedia(b,c));}.bind(this))).parse(b);if(!d)throw new B(2,2,2007);return e};bd['application/mp4; codecs="stpp"']=jm;
  ...
  function lm(b){b=If(b,/(?:(\d{1,}):)?(\d{2}):(\d{2})\.(\d{3})/g);if(null==b)return null;var c=Number(b[2]),d=Number(b[3]);return 59<c||59<d?null:Number(b[4])/1E3+d+60*c+3600*(Number(b[1])||0)}bd["text/vtt"]=km;bd['text/vtt; codecs="vtt"']=km;function om(){this.a=null;}om.prototype.parseInit=function(b){var c=!1;(new P).F("moov",Q).F("trak",Q).F("mdia",Q).aa("mdhd",function(b){0==b.version?(b.reader.I(4),b.reader.I(4),this.a=b.reader.C(),b.reader.I(4)):(b.reader.I(8),b.reader.I(8),this.a=b.reader.C(),b.reader.I(8));b.reader.I(4);}.bind(this)).F("minf",Q).F("stbl",Q).aa("stsd",Ce).F("wvtt",function(){c=!0;}).parse(b);if(!this.a)throw new B(2,2,2008);if(!c)throw new B(2,2,2008);};
  om.prototype.parseMedia=function(b,c){var d=this;if(!this.a)throw new B(2,2,2008);var e=0,f=[],g,h=[],k=!1,l=!1,m=!1,p=null;(new P).F("moof",Q).F("traf",Q).aa("tfdt",function(b){k=!0;e=0==b.version?b.reader.C():b.reader.Ya();}).aa("tfhd",function(b){var c=b.flags;b=b.reader;b.I(4);c&1&&b.I(8);c&2&&b.I(4);p=c&8?b.C():null;}).aa("trun",function(b){l=!0;var c=b.version,d=b.flags;b=b.reader;var e=b.C();d&1&&b.I(4);d&4&&b.I(4);for(var g=[],h=0;h<e;h++){var k={duration:null,sampleSize:null,Bc:null};d&256&&
  ...
  */
  ...
  function (_Plugin) {
    ...
    _proto.initStorage_ = function initStorage_() {
      ...
      //this.player.tech_.shakaPlayer_.configure({
      //  'offline': {
      //    'progressCallback': this.setDownloadProgress_.bind(this),
      //    //'trackSelectionCallback': this.selectTracks_.bind(this),
      ...
      this.storage_ = new shaka.offline.Storage(this.player.tech_.shakaPlayer_); //this.storage_.configure({
      //  'progressCallback': this.setDownloadProgress_.bind(this),
      //  //'trackSelectionCallback': this.selectTracks_.bind(this),
      //  'usePersistentLicense': !useNoPersistentLicense
      //});
  ...
  DownloadService.VERSION = '2.1.100-303';
  ...
  function (_Html) {
    ...
    _proto.handleSource = function handleSource(source, tech) {
      ...
      else if (this.options_.source && !this.options_.source.isDynamicCachupAsLive && this.options_.source.entitlementType) {
          startTime = 2.1;
        }
  ...
  EmpShaka.VERSION = '2.1.100-303'; // Unset source handlers set by Html5 super class.
