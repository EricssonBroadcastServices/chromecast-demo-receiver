...
(function (global, factory) {
  ...
  */
  ...
  DownloadService.VERSION = '2.2.136-575';
  ...
  */
  ...
  var EmpShaka = /*#__PURE__*/function (_Html) {
    ...
    */
    ...
    _proto.setCurrentTime = function setCurrentTime(time) {
      if (!this.shakaPlayer_ || this.loading_) {
        log('setCurrentTime blocked, loding');
        return;
      } // handle restrictions
      ...
      if (!this.timeShiftEnabled() || this.duration() === Infinity) {
        return;
      }
      ...
      if (seekRange) {
        ...
        time = time < seekRange.end ? time : seekRange.end - 1;
    ...
    */
    ...
    _proto.pause = function pause() {
      if (this.live() && (!this.timeShiftEnabled() || this.duration() === Infinity)) {
        return;
      }
  ...
  EmpShaka.VERSION = '2.2.136-575'; // Unset source handlers set by Html5 super class.
